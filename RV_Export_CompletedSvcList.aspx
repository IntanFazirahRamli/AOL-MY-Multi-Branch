<%@ Page Title="Completed Service Listing" Language="VB" AutoEventWireup="false"  MasterPageFile="~/MasterPage.master" CodeFile="RV_Export_CompletedSvcList.aspx.vb" Inherits="RV_Export_CompletedSvcList" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
     <div style="text-align:center">
        <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">Completed Service Record</h3>
    <br />
