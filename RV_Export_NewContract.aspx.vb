...
Partial Class RV_Export_NewContract
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                If Convert.ToString(Session("ReportType")) = "NewContract01" Then

                    crReportDocument.Load(Server.MapPath("~/Reports/ServiceContractReports/NewContract01.rpt"))

                ElseIf Convert.ToString(Session("ReportType")) = "NewContract02" Then

                    crReportDocument.Load(Server.MapPath("~/Reports/ServiceContractReports/NewContract02.rpt"))

                ElseIf Convert.ToString(Session("ReportType")) = "NewContract03" Then
                    crReportDocument.Load(Server.MapPath("~/Reports/ServiceContractReports/NewContract03.rpt"))
                ...
                Dim FilePath As String = Server.MapPath("~/PDFs/" + Convert.ToString(Session("UserID") + "_NewContract.PDF"))
                ...
                If FileBuffer IsNot Nothing Then
                    ...
                    Response.AddHeader("content-disposition", "inline; filename=NewContract.pdf")
