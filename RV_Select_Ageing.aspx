<%@ Page Title="Ageing Report" Language="VB" MasterPageFile="~/MasterPage_Report.master" AutoEventWireup="false" CodeFile="RV_Select_Ageing.aspx.vb" Inherits="RV_Select_Ageing" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
      ...
      <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" ScriptMode="Release">
       ...
       <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">AGEING REPORT</h4>
                ...
                <asp:Panel ID="Panel2" runat="server" Height="90%" BorderStyle="Solid" BorderColor="#CCCCCC" BorderWidth="2px" Width="60%" HorizontalAlign="Center">
                    <div style="padding-left: 20px; text-align: left; padding-bottom: 20px;">
                        <asp:RadioButtonList ID="rbtnSelect" runat="server" CellSpacing="5" CellPadding="5" RepeatDirection="Vertical" RepeatColumns="3" Width="90%">
                             <asp:ListItem Text="SalesPerson" Value="1"></asp:ListItem>
                            <asp:ListItem Text="InvoiceType" Value="2"></asp:ListItem>
                             <asp:ListItem Text="InvoiceNumber" Value="3"></asp:ListItem>
                             <asp:ListItem Text="Department" Value="4"></asp:ListItem>
                            <asp:ListItem Text="CompanyGroup" Value="5"></asp:ListItem>
                             <asp:ListItem Text="Client" Value="6" Selected="true"></asp:ListItem>
                        </asp:RadioButtonList>
                    </div>
                </asp:Panel>
            </td>
