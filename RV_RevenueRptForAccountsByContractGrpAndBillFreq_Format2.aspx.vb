...
Public Class RV_RevenueRptForAccountsByContractGrpAndBillFreq_Format2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                Dim repPath As String = Server.MapPath("~/Reports/RevenueReports/RevenueRptForAccountsByContractGrpAndBillFreq_Format2.rpt")
