...
Partial Class RV_Export_ServiceTeam
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                If Convert.ToString(Session("ReportType")) = "ServiceTeamMember" Then

                    crReportDocument.Load(Server.MapPath("~/Reports/ServiceRecordReports/ServiceTeamMember.rpt"))
                ElseIf Convert.ToString(Session("ReportType")) = "ServiceTeamEquipment" Then

                    crReportDocument.Load(Server.MapPath("~/Reports/ServiceRecordReports/ServiceTeamEquipment.rpt"))
                ElseIf Convert.ToString(Session("ReportType")) = "ServiceTeamVehicle" Then
                    crReportDocument.Load(Server.MapPath("~/Reports/ServiceRecordReports/ServiceTeamVehicle.rpt"))
                ...
                Dim FilePath As String = Server.MapPath("~/PDFs/" + Convert.ToString(Session("UserID") + "_ServiceTeam.PDF"))
                ...
                If FileBuffer IsNot Nothing Then
                    ...
                    Response.AddHeader("content-disposition", "inline; filename=ServiceTeam.pdf")
