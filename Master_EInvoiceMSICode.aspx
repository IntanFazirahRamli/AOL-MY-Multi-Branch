<%@ Page Title="E-Invoice Industrial Classification ID" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Master_EInvoiceMSICode.aspx.vb" Inherits="Master_EInvoiceMSICode"  enableeventvalidation="false" Culture="en-GB"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="text-align:center">
        ...
        <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">E-Invoice Industrial Classification ID</h3>
...
<asp:Button ID="btnDelete" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="DELETE" Width="100px" OnClientClick = "Confirm(); currentdatetime()"/>
          ...
          <tr>
            ...
            <tr>
                               ...
                               <td class="CellFormatADM">Industrial Classification Code<asp:Label ID="Label23" runat="server" visible="true" Font-Size="14px" ForeColor="Red" Text="*" Height="20px"></asp:Label></td>
                     

                    <td class="CellTextBoxADM"> <asp:TextBox ID="txtIndustrialClassificationCode" runat="server" MaxLength="25" Height="16px" Width="30%"></asp:TextBox></td>
...
<asp:Button ID="btnCancel" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="CANCEL" Width="100px" />
      ...
      <asp:ModalPopupExtender ID="mdlPopupImportMsg" runat="server" CancelControlID="btnCancelImportMsg" PopupControlID="pnlImportMsg" TargetControlID="btndummImportMsg" BackgroundCssClass="modalBackground" DynamicServicePath="" ></asp:ModalPopupExtender>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>" SelectCommand="SELECT * FROM tbleinvoicemalaysiaSICode where rcno&lt;&gt;0"></asp:SqlDataSource>

         <asp:TextBox ID="txtResult" runat="server" ForeColor ="black" Visible="False" /><br />
        <asp:TextBox ID="txtCount" runat="server" ForeColor ="black" Visible="False" /><br />
