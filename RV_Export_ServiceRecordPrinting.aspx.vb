...
Partial Class RV_Export_ServiceRecordPrinting
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                '  InsertIntoTblWebEventLog("Page_Load", Request.QueryString("Type").ToString, "REPORT")

                If Request.QueryString("Type") = "PrintWithPhotos" Then
                ...
                ElseIf Request.QueryString("Type") = "PrintWithPhotosInvoice" Then
                    crReportDocument.Load(Server.MapPath("~/Reports/ServiceReportBatchPrinting.rpt"))
                    crReportDocument.SetParameterValue("pCompanyName", Convert.ToString(Session("CompanyName")))
                    crReportDocument.SetParameterValue("pCompanyAddress", Convert.ToString(Session("OfficeAddress")))
                    crReportDocument.SetParameterValue("pRegNo", Convert.ToString(Session("BusinessRegNumber")))
                ...
                Next
                '   InsertIntoTblWebEventLog("Page_Load", Request.QueryString("Type").ToString, "REPORT2")

                If Request.QueryString("Type") = "Print" Then
                    crReportDocument.RecordSelectionFormula = Convert.ToString(Session("selFormula"))
                ElseIf Request.QueryString("Type") = "PrintWithPhotos" Then
                    crReportDocument.RecordSelectionFormula = Convert.ToString(Session("selFormula"))
                    ' InsertIntoTblWebEventLog("Page_Load", Request.QueryString("Type").ToString, "REPORT3")
                ...
                End If
                '    InsertIntoTblWebEventLog("Page_Load", Request.QueryString("Type").ToString, "REPORT4")
                ...
                '   InsertIntoTblWebEventLog("Page_Load", Request.QueryString("Type").ToString, "REPORT5")
    ...
    Public Sub InsertIntoTblWebEventLog(events As String, errorMsg As String, ID As String)
        Try
            ...
            insCmds.Parameters.AddWithValue("@LoginId", "SERVICE REPORT PRINTING - " + Session("UserID"))
