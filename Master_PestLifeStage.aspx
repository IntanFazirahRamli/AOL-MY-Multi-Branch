<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Master_PestLifeStage.aspx.vb" Inherits="Master_PestLifeStage" Title="Pest Life Stage"  Culture="en-GB"%>
...
<script type="text/javascript">
    ...
    <div style="text-align:center">
        ...
        <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">Pest Life Stage</h3>
       ...
       <asp:Panel ID="pnlGrid" runat="server" BackColor="White" BorderColor="#003366" BorderWidth="0" Height="100%" ScrollBars="Auto" style="text-align:center;  margin-left:auto; margin-right:auto;"    Visible="true" Width="800px">
            ...
            <Columns>
                 ...
                 <asp:BoundField DataField="LifeStage" HeaderText="Life Stage" >
                ...
                <td style="text-align:center;">
                        ...
                        <tr><td style="width:40%"></td>
                         ...
                         <tr style="padding-top:3px;"><td style="width:40%"></td>
                            <td style="width:10%;text-align:left;font-size:15px;font-weight:bold;font-family:'Calibri';color:black;">Life Stage</td>
                             <td style="text-align:left;">
                                <asp:TextBox ID="txtLifeStage" runat="server" MaxLength="25" Height="16px" Width="200px"></asp:TextBox></td>
                        </tr>
...
<asp:Button ID="btnCancel" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="CANCEL" Width="100px" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>" SelectCommand="SELECT *  FROM tblPestLifeStage order by LifeStage "></asp:SqlDataSource>
