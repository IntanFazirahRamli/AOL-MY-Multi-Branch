...
Partial Class Master_UOM
    ...
    Protected Sub GridView1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles GridView1.SelectedIndexChanged
        ...
        If GridView1.SelectedRow.Cells(1).Text = "&nbsp;" Then
            txtUnitMS.Text = ""
        Else
            txtUnitMS.Text = Server.HtmlDecode(GridView1.SelectedRow.Cells(1).Text).ToString
        End If
        If GridView1.SelectedRow.Cells(2).Text = "&nbsp;" Then
            txtType.Text = ""
        Else
            txtType.Text = Server.HtmlDecode(GridView1.SelectedRow.Cells(2).Text).ToString
        End If
    ...
    Private Sub AccessControl()
        Try
            ...
            If Session("SecGroupAuthority") <> "ADMINISTRATOR" Then
                ...
                command.CommandText = "SELECT x0129,  x0129Add, x0129Edit, x0129Delete FROM tblGroupAccess where GroupAccess = '" & Session("SecGroupAuthority") & "'"
                ...
                If dt.Rows.Count > 0 Then
                    If Not IsDBNull(dt.Rows(0)("x0129")) Then
                        If String.IsNullOrEmpty(Convert.ToBoolean(dt.Rows(0)("x0129"))) = False Then
                            If Convert.ToBoolean(dt.Rows(0)("x0129")) = False Then
                    ...
                    If Not IsDBNull(dt.Rows(0)("x0129Add")) Then
                        If String.IsNullOrEmpty(dt.Rows(0)("x0129Add")) = False Then
                            Me.btnADD.Enabled = dt.Rows(0)("x0129Add").ToString()
                        End If
                    End If


                    If txtMode.Text = "View" Then
                        If Not IsDBNull(dt.Rows(0)("x0129Edit")) Then
                            If String.IsNullOrEmpty(dt.Rows(0)("x0129Edit")) = False Then
                                Me.btnEdit.Enabled = dt.Rows(0)("x0129Edit").ToString()
                            End If
                        End If

                        If Not IsDBNull(dt.Rows(0)("x0129Delete")) Then
                            If String.IsNullOrEmpty(dt.Rows(0)("x0129Delete")) = False Then
                                Me.btnDelete.Enabled = dt.Rows(0)("x0129Delete").ToString()
                            End If
                        End If
                    Else
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        If txtMode.Text = "New" Then
            Try
                ...
                command1.CommandText = "SELECT * FROM tblUnitMS where UnitMS=@UnitMs"
                command1.Parameters.AddWithValue("@UnitMS", txtUnitMS.Text)
                ...
                Else
                    ...
                    command.CommandType = CommandType.Text
                    Dim qry As String = "INSERT INTO tblUnitMS(UnitMS,UnitTYpe,CreatedBy,CreatedOn,LastModifiedBy,LastModifiedOn)"
                    qry = qry + "VALUES(@UnitMS,@UnitTYpe,@CreatedBy,@CreatedOn,@LastModifiedBy,@LastModifiedOn);"
                    ...
                    If ConfigurationManager.AppSettings("UPPERCASE").ToString() = "YES" Then
                        ...
                        command.Parameters.AddWithValue("@UnitTYpe", txtType.Text.ToUpper)
                    ...
                    conn.Close()
                    If txtMode.Text = "NEW" Then
                        CType(Me.Master, MasterPage).EventLog_Insert(Session("UserID"), "UOM", txtUnitMS.Text, "ADD", Convert.ToDateTime(txtCreatedOn.Text), 0, 0, 0, "", "", txtRcno.Text)
                    Else
                        CType(Me.Master, MasterPage).EventLog_Insert(Session("UserID"), "UOM", txtUnitMS.Text, "EDIT", Convert.ToDateTime(txtCreatedOn.Text), 0, 0, 0, "", "", txtRcno.Text)
                    End If
            Catch ex As Exception
                MessageBox.Message.Alert(Page, ex.ToString, "str")
            End Try
        ...
        ElseIf txtMode.Text = "Edit" Then
            ...
            Try
                ...
                command2.CommandText = "SELECT * FROM tblUnitMS where UnitMS=@UnitMS and rcno<>" & Convert.ToInt32(txtRcno.Text)
                command2.Parameters.AddWithValue("@UnitMS", txtUnitMS.Text)
                ...
                If dt1.Rows.Count > 0 Then
                    ...
                    lblAlert.Text = "UNIT ALREADY EXISTS"
                    txtUnitMS.Focus()
                    Exit Sub
                Else
                    Dim command1 As MySqlCommand = New MySqlCommand
                    ...
                    If dt.Rows.Count > 0 Then
                        ...
                        If txtExists.Text = "True" Then
                            qry = "update tblUnitMS set UnitMS=@UnitMS,UnitTYpe=@UnitTYpe, LastModifiedBy=@LastModifiedBy,LastModifiedOn=@LastModifiedOn where rcno=" & Convert.ToInt32(txtRcno.Text)
                        Else
                            qry = "update tblUnitMS set UnitMS=@UnitMS,UnitTYpe=@UnitTYpe,LastModifiedBy=@LastModifiedBy,LastModifiedOn=@LastModifiedOn where rcno=" & Convert.ToInt32(txtRcno.Text)
                        End If
                        ...
                        If txtExists.Text = "True" Then
                            ...
                            lblMessage.Text = "EDIT: RECORD SUCCESSFULLY UPDATED. RECORD IS IN USE, SO UNIT MS CANNOT BE UPDATED"
                            lblAlert.Text = ""
                        Else
        ...
        If confirmValue = "Yes" Then
            ...
            Try
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    CType(Me.Master, MasterPage).EventLog_Insert(Session("UserID"), "UOM", txtUnitMS.Text, "DELETE", Convert.ToDateTime(txtCreatedOn.Text), 0, 0, 0, "", "", txtRcno.Text)
                End If
                conn.Close()
