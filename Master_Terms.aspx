<%@ Page Title="Terms" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Master_Terms.aspx.vb" Inherits="Master_Terms" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="text-align:center">
        ...
        <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">Terms</h3>
...
<asp:Button ID="btnDelete" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="DELETE" Width="100px" OnClientClick = "Confirm(); currentdatetime()"/>
            ...
            <tr class="Centered">
                <td colspan="2">
                    ...
                    <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataKeyNames="Terms" Font-Size="15px" HorizontalAlign="Center" AllowSorting="True">
                         <Columns>
                ...
                <ItemStyle Width="200px" HorizontalAlign="Left" />
                              ...
                              <asp:BoundField DataField="TermsDay" HeaderText="TermsDay" ReadOnly="True" SortExpression="TermsDay" />
          ...
          <tr>
            ...
            <tr>
                    ...
                    <td class="CellFormatADM">Terms<asp:Label ID="Label23" runat="server" visible="true" Font-Size="14px" ForeColor="Red" Text="*" Height="20px"></asp:Label></td>
                     

                    <td class="CellTextBoxADM"> <asp:TextBox ID="txtTerms" runat="server" MaxLength="25" Height="16px" Width="30%"></asp:TextBox></td>
              ...
              <tr>
                    ...
                    <td class="CellFormatADM">TermsDay</td>
                     

                    <td class="CellTextBoxADM"><asp:TextBox ID="txtTermsDay" runat="server" MaxLength="100" Height="16px" Width="30%"></asp:TextBox></td>
...
<asp:Button ID="btnCancel" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="CANCEL" Width="100px" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>" SelectCommand="SELECT * FROM tblterms order by TermsDay"></asp:SqlDataSource>
