...
Partial Class RV_Select_DebitNote
    Inherits System.Web.UI.Page
        ...
        Protected Sub btnPrintServiceRecordList_Click(sender As Object, e As EventArgs) Handles btnPrintServiceRecordList.Click
            ...
            selection = ""
        selFormula = "{tblsales1.rcno} <> 0 and {tblsales1.postStatus}='P' and {tblsales1.docType}='ARDN'"
        ...
        End If
            ...
            If rbtnSelectDetSumm.SelectedValue = "1" Then
                Session.Add("ReportType", "DebitNoteListingByClient_Details")
                Response.Redirect("RV_DebitNoteListingByClient_Details.aspx")
            ElseIf rbtnSelectDetSumm.SelectedValue = "2" Then
                Session.Add("ReportType", "DebitNoteListingByClient_Summary")
                Response.Redirect("RV_DebitNoteListingByClient_Summary.aspx")
            End If
            ElseIf rbtnSelect.SelectedValue = "2" Then
            If rbtnSelectDetSumm.SelectedValue = "1" Then
                Session.Add("ReportType", "DebitNoteListingByCompanyGrp_Details")
                Response.Redirect("RV_DebitNoteListingByCompanyGrp_Details.aspx")
            ElseIf rbtnSelectDetSumm.SelectedValue = "2" Then
                Session.Add("ReportType", "DebitNoteListingByCompanyGrp_Summary")
                Response.Redirect("RV_DebitNoteListingByCompanyGrp_Summary.aspx")
            End If

            ElseIf rbtnSelect.SelectedValue = "3" Then
            If rbtnSelectDetSumm.SelectedValue = "1" Then
                Session.Add("ReportType", "DebitNoteListingBySalesPerson_Details")
                Response.Redirect("RV_DebitNoteListingBySalesPerson_Details.aspx")
            ElseIf rbtnSelectDetSumm.SelectedValue = "2" Then
                Session.Add("ReportType", "DebitNoteListingBySalesPerson_Summary")
                Response.Redirect("RV_DebitNoteListingBySalesPerson_Summary.aspx")
            End If
            ElseIf rbtnSelect.SelectedValue = "4" Then
            If rbtnSelectDetSumm.SelectedValue = "1" Then
                Session.Add("ReportType", "DebitNoteListingByGLCode_Details")
                Response.Redirect("RV_DebitNoteListingByGLCode_Details.aspx")
            ElseIf rbtnSelectDetSumm.SelectedValue = "2" Then
                Session.Add("ReportType", "DebitNoteListingByGLCode_Summary")
                Response.Redirect("RV_DebitNoteListingByGLCode_Summary.aspx")
            End If
        ElseIf rbtnSelect.SelectedValue = "5" Then
            If rbtnSelectDetSumm.SelectedValue = "1" Then
                Session.Add("ReportType", "DebitNoteListingByDocumentNo_Details")
                Response.Redirect("RV_DebitNoteListingByDocumentNo_Details.aspx")
            ElseIf rbtnSelectDetSumm.SelectedValue = "2" Then
                Session.Add("ReportType", "DebitNoteListingByDocumentNo_Summary")
                Response.Redirect("RV_DebitNoteListingByDocumentNo_Summary.aspx")
            End If
            End If
            '  
