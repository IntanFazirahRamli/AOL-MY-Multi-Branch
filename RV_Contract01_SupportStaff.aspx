<%@ Page Language="vb" AutoEventWireup="false" CodeFile="RV_Contract01_SupportStaff.aspx.vb" MasterPageFile="~/MasterPage.Master"
    Inherits="RV_Contract01_SupportStaff" Title="Service Contract Listing By Salesman" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
     <div style="text-align:center">
        <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">Service Contract Listing By Salesman</h3>
    <br />
            ...
            <td colspan="2">
             <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="true"
                ...
                <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                    <Report FileName="Reports\ServiceContractReports\Contract01_SupportStaff.rpt">
                    </Report>
