<%@ Page Title="Credit Note" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="CN1.aspx.vb" Inherits="CN1" Culture="en-GB" EnableEventValidation="false"   %>
...
<script type="text/javascript">
    ...
    function DoValidationSave() {
        ...
        var lvoucherType = document.getElementById("<%=ddlDocType.ClientID%>").value;

        if (lvoucherType == '--SELECT--') {
            document.getElementById("<%=lblAlert.ClientID%>").innerText = "PLEASE SELECT VOUCHER TYPE";
            ResetScrollPosition();
            document.getElementById("<%=ddlDocType.ClientID%>").focus();
            valid = false;
            return valid;
        }
                ...
                if ((input[0].checked) == false) {
                    ...
                    for (var i = 1; i < table.rows.length; i++) {
                        ...
                        for (var j = 0; j < inputs.length; j++) {
                            ...
                            //get the textbox1
                          //  if (inputs[j].id.indexOf("lblInvNo") > -1) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Button ID="dummy" runat="server" Text="" cssclass="dummybutton" />
     ...
     <div style="text-align:center">
            ...
            <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">CREDIT/DEBIT NOTE</h3>
            ...
            <tr>
              ...
              <tr>
                ...
                <asp:Button ID="btnPrint" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="PRINT" Visible="true" Width="95%" />
                 ...
                 <td style="width:8%;text-align:center;">
                                 <asp:Button ID="btnMultiPrint" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="MULTI PRINT" Width="95%" />
                      </td>
                  ...
                  <td style="width:8%;text-align:center;">
                   ...
                   <td style="width:8%;text-align:center;">
                       <asp:Button ID="btnRecalculate" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" OnClientClick="currentdatetime()" Text="RECALCULATE" Visible="True" Width="95%" />
                    </td>
                    <td style="width:7%;text-align:center;">
                          <asp:Button ID="btnPostECN" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" OnClientClick="currentdatetime()" Text="SUBMIT E-CN" Width="100%" Visible="True" />
         
                  </td>
                   <td style="width:8%;text-align:center;">
                         <asp:Button ID="btnFilter" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" OnClientClick="currentdatetime()" Text="FILTER" Visible="True" Width="95%" />
                  </td>
                    ...
                    <table border="0" style="font-family: calibri; font-size: 15px; font-weight: bold; color: #000000;width:100%;padding-left:2px;">
                         <tr>
                            ...
                            <td style="text-align:left;width:7%; ">
                                        ...
                                        <cc1:DropDownCheckBoxes ID="ddlLocationSearch" runat="server" AddJQueryReference="true" style="top: -11px; left: -150px" UseButtons="false" UseSelectAllNode="true" Width="15%">
                                            <Style2 DropDownBoxBoxHeight="120" DropDownBoxBoxWidth="95.5%" SelectBoxWidth="95.5%" />
                                        </cc1:DropDownCheckBoxes>
                            
                                       <asp:DropDownList ID="ddlBranch" runat="server" AppendDataBoundItems="True" DataTextField="locationID" DataValueField="LocationID" Height="20px" Width="6%" DataSourceID="SqlDSLocation">
                             ...
                             <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black;  width:13%; ">
                                 ...
                                 <asp:TextBox ID="txtInvoiceNoSearch" runat="server" AutoCompleteType="Disabled" Height="16px" MaxLength="50" style="text-align: left;" Width="80%"></asp:TextBox>
                             </td>
                        ...
                        <tr>
                               <td colspan="1" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:right; color:black;">
                                  <asp:CheckBox ID="chkEInvoiceSearch" Text="E-CN/DN      " TextAlign="left" runat="server"  Enabled="true" Checked="false" />
                            </td><td></td>
                                   <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; text-align:right; ">
                                  <asp:Label ID="lblInvStatus" runat="server" Text="CNDN Status" CssClass="CellFormat"></asp:Label>
                            </td>
                              <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black;  width:9%; ">
    ...
    <tr><td style="padding-left:100px;width:100px"><asp:Label ID="Label38" runat="server" Text="E-Invoice Status" CssClass="CellFormat"></asp:Label></td>
        ...
        <td class="CellFormat" style="text-align:left;width:90px">Cancelled</td>
           ...
           <%-- <asp:Panel ID="pnlGrid" runat="server" BackColor="White" BorderColor="#003366" BorderWidth="1" Height="100%" ScrollBars="None"    Visible="true" Width="100%">--%>
            <asp:Panel ID="pnlGrid" runat="server" BackColor="White" BorderColor="#003366" BorderWidth="1" Height="100%" ScrollBars="Auto" style="text-align:center; width:1350px; margin-left:auto; margin-right:auto;"    Visible="true" Width="1330px">
                                          ...
                                          <asp:GridView ID="GridView1" Width="100%" Font-Size="15px" runat="server" OnRowDataBound = "OnRowDataBoundg1" OnSelectedIndexChanged = "OnSelectedIndexChangedg1"  AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" BorderWidth="1px" CellPadding="2" CellSpacing="2" DataKeyNames="Rcno" DataSourceID="SQLDSCN" ForeColor="#333333" GridLines="Vertical"> 
                                              <AlternatingRowStyle BackColor="White"/>
                                                ...
                                                <ItemTemplate>
                                                  ...
                                                  <asp:BoundField DataField="InvoiceNumber" HeaderText="CN/DN Number" SortExpression="CNNumber" >
                                                      <ControlStyle Width="6%" />
                                                    <ItemStyle Width="6%" Wrap="False" />
                                                    </asp:BoundField>
                                                  <asp:BoundField DataField="SalesDate" HeaderText="CN/DN Date" SortExpression="CNDate" DataFormatString="{0:dd/MM/yyyy}">
                                                  <ItemStyle Width="5%" />
                                                  </asp:BoundField>
                                                  ...
                                                  <asp:BoundField DataField="CustName" HeaderText="Client Name" SortExpression="CustomerName" ItemStyle-Wrap="false">
                                                    <ControlStyle Width="25%" />
                                                  <ItemStyle HorizontalAlign="Left" Wrap="False" Width="25%" />
                                                  </asp:BoundField>
                                                 
                                                    <asp:BoundField DataField="ValueBase" HeaderText="Amount" SortExpression="ValueBase">
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="GSTBase" HeaderText="Tax Amount" SortExpression="GSTBase" />
                                                 
                                                  <asp:BoundField DataField="AppliedBase" HeaderText="Net Amount" SortExpression="AppliedBase">
                                                    <ControlStyle Width="6%" />
                                                    <ItemStyle Width="6%" HorizontalAlign="Right" Wrap="True" />
                                                  </asp:BoundField>
                                                    <asp:BoundField DataField="BalanceBase" HeaderText="Balance Amount" SortExpression="BalanceBase">
                                                    <ItemStyle Wrap="False" />
                                                    </asp:BoundField>
                                                    ...
                                                    <ItemStyle Wrap="False" />
                                                         ...
                                                         <asp:BoundField DataField="EInvoiceStatus" HeaderText="E-CN Status" />
                                                 ...
                                                 <asp:BoundField DataField="SubmissionBy" HeaderText="Last Posted By" />
                                                    <asp:TemplateField HeaderText="Remaining Time to Cancel" >
                                                           <EditItemTemplate>
                                                              <asp:TextBox ID="TextBox9" runat="server" Text='<%# Eval("TimeToCancel") %>'></asp:TextBox>
                                                          
                                                                </EditItemTemplate>
                                                              <ItemTemplate> 
                                                                  
                                                             <asp:Label ID="Label14" runat="server" Text='<%# Eval("TimeToCancel") %>'></asp:Label>
                                                  ...
                                                  <asp:BoundField DataField="LastModifiedOn" HeaderText="Last Modified On" SortExpression="LastModifiedOn" >
                                                    ...
                                                    <asp:BoundField DataField="PrintCounter">
                                                    <ControlStyle CssClass="dummybutton" />
                                                    <HeaderStyle CssClass="dummybutton" />
                                                    <ItemStyle CssClass="dummybutton" />
                                                    </asp:BoundField>
                                                      <asp:BoundField DataField="TaxIdentificationNo">
                                                    <ControlStyle CssClass="dummybutton" />
                                                    <HeaderStyle CssClass="dummybutton" />
                                                    <ItemStyle CssClass="dummybutton" />
                                                    </asp:BoundField>
                                                     <asp:BoundField DataField="SalesTaxRegistrationNo">
                                                    <ControlStyle CssClass="dummybutton" />
                                                    <HeaderStyle CssClass="dummybutton" />
                                                    <ItemStyle CssClass="dummybutton" />
                                                    </asp:BoundField>
                             ...
                             <asp:TextBox ID="txtPostUponSave" runat="server" Visible="False"></asp:TextBox> 
                                ...
                                <asp:TextBox ID="txtDefaultTaxCode" runat="server" Visible="False"></asp:TextBox> 
                                      <asp:TextBox ID="txtDefaultTaxRate" runat="server" Visible="False"></asp:TextBox> 
                                       ...
                                       <asp:TextBox ID="txtAutoEmailDebitNote" runat="server" Visible="False"></asp:TextBox> 
                                       <asp:TextBox ID="txtAutoEmailCreditNote" runat="server" Visible="False"></asp:TextBox> 
                                    ...
                                    <asp:TextBox ID="txtEI" runat="server" Height="16px"  Visible="false" Width="1px"></asp:TextBox>
                                             <asp:TextBox ID="txtECNStatus" runat="server" Height="16px"  Visible="false" Width="1px"></asp:TextBox>
              ...
              <table border="0" style="width:90%; margin:auto; border:solid; border-color:ButtonFace;">
               ...
               <tr style="width:100%">
                 <td colspan="1" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:right; color:#800000; width:80% ">TOTAL CN/DN AMOUNT
                 </td>
         ...
         <asp:TabPanel runat="server" HeaderText=" Credit Note Info" ID="TabPanel1" TabIndex="1">
             <HeaderTemplate>
...
<ContentTemplate>
          ...
          <table border="0" style="width:90%; margin:auto; border:solid; border-color:ButtonFace;">
               ...
               <tr style="width:100%">
                 <td colspan="4" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; text-decoration: underline;padding-left:10%; color:#800000; background-color: #C0C0C0;">
                     <asp:Label ID="Label47" runat="server" Text="CREDIT/DEBIT NOTE INFORMATION"></asp:Label>
                 </td>
           </tr>
                ...
                <tr >
                           ...
                           <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; ">
                               ...
                               <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:0%; width:20%; text-align:left; ">
                                   ...
                                   <asp:CheckBox ID="chkInternal" runat="server" Enabled="False" />
               ...
               <tr>
                   <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; ">&nbsp;</td>
                   <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:10%; text-align:right; ">Account Type<asp:Label ID="Label66" runat="server" Font-Size="14px" ForeColor="Red" Text="*"></asp:Label>
                   </td>
                   <td style="width:20%;font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:left;">
                       <asp:DropDownList ID="ddlContactType" runat="server" DataTextField="ContType" DataValueField="ContType" Height="20px" Width="80.5%" TabIndex="20" AutoPostBack="True">
                        <asp:ListItem>--SELECT--</asp:ListItem>
                              <asp:ListItem Value="COMPANY">CORPORATE</asp:ListItem>
                           <asp:ListItem Value="PERSON">RESIDENTIAL</asp:ListItem>
                       </asp:DropDownList>
      ...
      <table style="margin-left:auto; margin-right:auto; "><tr><td colspan="2" style="text-align:center;"><h4 style="color: #000000">Customer</h4></td><td style="width:1%;text-align:right;"><asp:ImageButton ID="btnPnlClientClose" runat="server" ImageUrl="~/Images/closebutton.png" Height="27px" Width="30px" />
        ...
        <asp:ControlParameter ControlID="ddlContactType" Name="@contType" PropertyName="Text" />
                  ...
                  <tr><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; "><asp:TextBox ID="TextBox4" runat="server" AutoCompleteType="Disabled" BackColor="#CCCCCC" Height="16px" TabIndex="20" Visible="False" Width="10%"></asp:TextBox></td>
    <td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:10%; text-align:right; ">TaxIdentificationNo(TIN)</td><td style="width:20%;font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:left;"><asp:TextBox ID="txtTIN" runat="server" Height="16px" Width="81%" BackColor="#CCCCCC" AutoCompleteType="Disabled" TabIndex="110" BorderStyle="None" ></asp:TextBox></td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; ">&#160;</td></tr>
      ...
      <tr><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; "><asp:TextBox ID="TextBox8" runat="server" AutoCompleteType="Disabled" BackColor="#CCCCCC" Height="16px" TabIndex="20" Visible="False" Width="10%"></asp:TextBox></td>
              ...
              <tr>
               ...
               <tr>
                       <td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; ">   
                          ...
                          <td style="width:20%;font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:left;"> 
                            <asp:TextBox ID="txtPONo" runat="server" Height="16px" Width="80%" AutoCompleteType="Disabled" TabIndex="24" MaxLength="30" ></asp:TextBox>
               ...
               <tr>
                       <td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; ">   
                            ...
                            <td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:10%; text-align:right; ">   
                                Credit Terms<asp:Label ID="Label44" runat="server" Font-Size="14px" ForeColor="Red" Text="*"></asp:Label></td>
                            
                          <td style="width:20%;font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:left;"> 
                               <asp:DropDownList ID="ddlCreditTerms" runat="server" AppendDataBoundItems="True" CssClass="chzn-select" DataTextField="UPPER(Terms)" DataValueField="UPPER(Terms)" Height="25px" Width="80.5%" TabIndex="25" AutoPostBack="True">
               ...
               <tr>
                   ...
                   <td style="width:20%;font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:left;">
                       <asp:TextBox ID="txtCreditDays" runat="server" AutoCompleteType="Disabled" Height="16px" TabIndex="26" Width="80%"></asp:TextBox>
                   </td>
                   <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; ">&nbsp;</td>
              </tr>
               ...
               <tr>
                       <td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; ">   
                           <asp:TextBox ID="TextBox7" runat="server" BorderStyle="None" ForeColor="White" Width="1%" TabIndex="108"></asp:TextBox>
                         </td>
                            <td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:10%; text-align:right; ">   
                                Salesman<asp:Label ID="Label45" runat="server" Font-Size="14px" ForeColor="Red" Text="*"></asp:Label></td>
                            
                          <td style="width:20%;font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:left;"> 
                               <asp:DropDownList ID="ddlSalesmanBilling" runat="server" AppendDataBoundItems="True" CssClass="chzn-select" DataTextField="StaffId" DataValueField="StaffId" Height="25px" Width="80.5%" TabIndex="27">
                                   <asp:ListItem Text="--SELECT--" Value="-1" /></asp:DropDownList>
                 ...
                 <tr>
                               <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; ">&nbsp;</td>
                               <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:10%; text-align:right; vertical-align:top">Contract Group</td>
                               <td style="width:20%;font-size:14px;font-weight:bold;font-family:Calibri;color:black;text-align:left;">
                                   <asp:DropDownList ID="ddlContractGroupBilling" runat="server" AppendDataBoundItems="True" CssClass="chzn-select" DataTextField="UPPER(contractgroup)" DataValueField="UPPER(contractgroup)" Height="25px" Value="-1" Width="80.6%" AutoPostBack="True">
                       ...
                       <tr>
                           <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; ">&nbsp;</td>
                           <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:10%; text-align:right; vertical-align:top">Amount</td>
                           <td style="width:20%;font-size:14px;font-weight:bold;font-family:Calibri;color:black;text-align:left;">
                               <asp:TextBox ID="txtCNAmount" runat="server" AutoCompleteType="Disabled" BackColor="#CCCCCC" BorderStyle="None" Height="16px" style="text-align:right" Width="81%"></asp:TextBox>
                           </td>
                           <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; ">&nbsp;</td>
               </tr>
                       ...
                       <tr>
                           <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; ">
                               <asp:TextBox ID="txtGSTSelected" runat="server" AutoCompleteType="Disabled" BackColor="#CCCCCC" BorderStyle="None" Height="18px" Rows="121" style="text-align:right" Visible="False" Width="20%"></asp:TextBox>
                           </td>
                           <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:10%; text-align:right; vertical-align:top">Tax Code</td>
                           <td style="width:20%;font-size:14px;font-weight:bold;font-family:Calibri;color:black;text-align:left;">
                               <asp:DropDownList ID="txtGST" runat="server" AppendDataBoundItems="True" AutoPostBack="True" CssClass="chzn-select" DataTextField="TaxType" DataValueField="TaxType" Height="25px" Value="-1" Width="80.6%">
                                   <asp:ListItem Text="--SELECT--" Value="-1" />
                               </asp:DropDownList>
                           </td>
                           <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; ">&nbsp;</td>
                       ...
                       <tr>
                           <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; ">&nbsp;</td>
                           <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:10%; text-align:right; vertical-align:top">Tax Rate</td>
                           <td style="width:20%;font-size:14px;font-weight:bold;font-family:Calibri;color:black;text-align:left;">
                               <asp:TextBox ID="txtGST1" runat="server" AutoCompleteType="Disabled" BackColor="#CCCCCC" Height="16px" style="text-align:right" TabIndex="20" Width="81%"></asp:TextBox>
                           </td>
                           <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; ">&nbsp;</td>
               </tr>
               <tr>
                   <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; ">&nbsp;</td>
                   <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:10%; text-align:right; vertical-align:top">Tax Amount</td>
                   <td style="width:20%;font-size:14px;font-weight:bold;font-family:Calibri;color:black;text-align:left;">
                       <asp:TextBox ID="txtCNGSTAmount" runat="server" AutoCompleteType="Disabled" BackColor="#CCCCCC" BorderStyle="None" Height="16px" style="text-align:right" Width="81%"></asp:TextBox>
                   </td>
                   <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; ">&nbsp;</td>
               </tr>
                       ...
                       <tr>
                           ...
                           <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:10%; text-align:right; vertical-align:top">Net Amount</td>
                           <td style="width:20%;font-size:14px;font-weight:bold;font-family:Calibri;color:black;text-align:left;">
                               <asp:TextBox ID="txtCNNetAmount" runat="server" AutoCompleteType="Disabled" Height="16px" style="text-align:right" Width="81%" BackColor="#CCCCCC" BorderStyle="None"></asp:TextBox>
                           </td>
                           <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; ">&nbsp;</td>
               </tr>
                 ...
                 <td colspan="6" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; text-decoration: underline;padding-left:5%; color:#800000; background-color: #C0C0C0;"> SEARCH INVOICE RECORDS 
                     ...
                     <tr>
                            <td style="width:10%; font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:left;">
                                <asp:SqlDataSource ID="SqlDSSalesDetail" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>" SelectCommand="SELECT InvoiceNumber, SubCode, CostCode, RefType, Description, Comments, Quantity, UnitMS, UnitBase, ValueBase, AppliedBase, GST, GSTBase, LedgerCode, LedgerName, LocationID, InvoiceType,ItemDescription, ServiceStatus, UnitOriginal, TotalPrice, Discp, DiscAmount, GSTRate, BillingFrequency, ServiceBy, RcnoServiceRecord, Rcno, ServiceDate, ItemCode, SourceInvoice,ItemClassificationCode, ItemClassificationDesc, UOMDesc, TaxTypeDesc from tblsalesdetail where InvoiceNumber= @InvoiceNumber">
                         <SelectParameters>
                          ...
                          <td style="font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:left;" colspan="4"> &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
                            ...
                            <tr>
                                <td style="width:6%;font-size:12px;font-weight:bold;font-family:'Calibri';color:black;text-align:left;">
                                    <asp:DropDownList ID="ddlCompanyGrpII" runat="server" AppendDataBoundItems="True" CssClass="chzn-select" DataTextField="companygroup" DataValueField="companygroup" Height="25px" Value="-1" Width="90%">
                                       <asp:ListItem>--SELECT--</asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                            ...
                            <tr>
                                ...
                                <td style="width:6%;font-size:12px;font-weight:bold;font-family:'Calibri';color:black;text-align:left;">
                                    <asp:DropDownList ID="ddlContractGroup" runat="server" AppendDataBoundItems="True" CssClass="chzn-select" DataTextField="UPPER(contractgroup)" DataValueField="UPPER(contractgroup)" Height="25px" Value="-1" Visible="False" Width="95%">
                                        <asp:ListItem Text="--SELECT--" Value="-1" />
                                    </asp:DropDownList>
                                </td>
                            </tr>
...
a.CompanyGroup=@CompanyGroup and a.AccountId=@AccountID order by a.Salesdate">
             ...
             <asp:Panel ID="pnlImportServices" runat="server" BackColor="White" Width="95%" Height="650px" BorderColor="#003366" BorderWidth="1px" HorizontalAlign="Center">
               ...
               <%--  aaa--%>
                 ...
                 <td colspan="6" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; text-decoration: underline;padding-left:5%; color:#800000; background-color: #C0C0C0;"> SEARCH SERVICE RECORDS 
                    ...
                    <tr>
                            <td style="width:10%;font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:left;">
                                <asp:SqlDataSource ID="SqlDSUnitMS" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>" SelectCommand="SELECT UnitMSID as UnitMs FROM tblunitms order by UnitMSID"></asp:SqlDataSource>
                            </td>
 ...
 CommandName="CHECK" ></asp:CheckBox></ItemTemplate></asp:TemplateField>            
                  ...
                  <asp:TemplateField HeaderText="Service Record"><ItemTemplate><asp:TextBox ID="txtServiceRecordNoGV" runat="server" Font-Size="12px" ReadOnly="true" Text='<%# Bind("RecordNo")%>' BackColor="#CCCCCC" BorderStyle="None" Height="18px"  Width="140px"></asp:TextBox></ItemTemplate></asp:TemplateField>
              ...
              <asp:TemplateField HeaderText="Acct. Id" HeaderStyle-HorizontalAlign="Center"><ItemTemplate><asp:TextBox ID="txtAccountIdGV" runat="server" Text='<%# Bind("AccountId")%>' Font-Size="12px" ReadOnly="true" BackColor="#CCCCCC" BorderStyle="None" Height="18px" Width="60px"></asp:TextBox></ItemTemplate></asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Bill Amount"><ItemTemplate><asp:TextBox ID="txtBillAmountGV" runat="server" Font-Size="12px" ReadOnly="true" Text='<%# Bind("BillAmount")%>' BackColor="#CCCCCC" BorderStyle="None" Height="18px"  Width="80px" style="text-align:right" ></asp:TextBox></ItemTemplate></asp:TemplateField>                             
 ...
 FROM tblServiceRecord A  where 1 = 1  ">
               ...
               <tr style="width:100%;">
                 <td colspan="20" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; text-decoration: underline;padding-left:10%; color:#800000; background-color: #C0C0C0;">
                     ...
                     <asp:Label ID="Label5" runat="server" Text="CREDIT/DEBIT NOTE DETAILS"></asp:Label>
                 </td>
             ...
             <asp:GridView ID="grvBillingDetailsNew"  runat="server" AllowSorting="True" 
               AutoGenerateColumns="False" CellPadding="1"  Height="12px" Font-Size="13px" Style="text-align: left" Width="99%" DataSourceID="SqlDSSalesDetail" GridLines="Horizontal" BorderStyle="None">
                 <Columns>
                   ...
                   <asp:TemplateField HeaderText=" Item Type"><ItemTemplate><asp:TextBox ID="txtItemTypeGVB" runat="server"  Text='<%# Bind("SuBcode")%>' Font-Size="11px" Height="15px" ReadOnly="true" Width="65px" Enabled="False" AppendDataBoundItems="True" AutoPostBack="True"  ></asp:TextBox></ItemTemplate></asp:TemplateField>
              

                     <asp:TemplateField HeaderText="Ref Type." HeaderStyle-HorizontalAlign="Center"><ItemTemplate><asp:TextBox ID="txtServiceRecordGVB" runat="server" Text='<%# Bind("RefType")%>'  Font-Size="11px" style="text-align:left" Height="15px" Width="120px" Align="left" Enabled="False" AutoPostBack="false" AppendDataBoundItems="True"    ></asp:TextBox></ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center" />
                     </asp:TemplateField>

                     <asp:TemplateField HeaderText="Contract No." HeaderStyle-HorizontalAlign="Center"><ItemTemplate><asp:TextBox ID="txtContractNoGVB" runat="server" Text='<%# Bind("CostCode")%>' Height="15px" Width="115px" Font-Size="11px" Enabled="False"> </asp:TextBox></ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center" />
                  
                     </asp:TemplateField>


                       <asp:TemplateField HeaderText="Invoice No." HeaderStyle-HorizontalAlign="Center"><ItemTemplate><asp:TextBox ID="txtInvoiceNoGVB" runat="server" Text='<%# Bind("SourceInvoice")%>' Font-Size="11px" Enabled="True" OnTextChanged="txtInvoiceNoGVB_TextChanged" style="text-align:left" Height="15px" Width="110px" Align="right"  AutoPostBack="True" AppendDataBoundItems="True" ></asp:TextBox></ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center" />
                     </asp:TemplateField>
                                  
                
                  <asp:TemplateField HeaderText="Item Description"><ItemTemplate><asp:DropDownList ID="txtItemCodeGVB" runat="server" SelectedValue='<%# Bind("ItemDescription")%>' DataSourceID="SQLDSBillingCode" DataTextField="Description" Text='<%# Bind("ItemDescription")%>'  Font-Size="11px"  Height="20px" AutoPostBack="True"  Width="95px" AppendDataBoundItems="True"  ><asp:ListItem Text="--SELECT--" Value="-1" /> </asp:DropDownList></ItemTemplate></asp:TemplateField>
                ...
                <asp:TemplateField HeaderText=""><ItemTemplate><asp:ImageButton ID="BtnGLGVB" runat="server" OnClick="BtnGLGVB_Click" CssClass="righttextbox" Height="22px" ImageAlign="Middle" ImageUrl="~/Images/searchbutton.jpg" Width="24px" />
                   ...
                   <asp:TemplateField HeaderText="GL Description"><ItemTemplate><asp:TextBox ID="txtGLDescriptionGVB" runat="server" Text='<%# Bind("LedgerName")%>'  Font-Size="11px" Height="15px"  Width="90px"></asp:TextBox></ItemTemplate></asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="UOM"  HeaderStyle-HorizontalAlign="Center"><ItemTemplate><asp:DropDownList ID="txtUOMGVB" runat="server" Text='<%# Bind("UnitMS")%>' SelectedValue='<%# Bind("UnitMS")%>' DataSourceID="SQLDSUnitMS"  DataTextField="UnitMS" Font-Size="11px" Height="20px" Width="53px" AppendDataBoundItems="True"><asp:ListItem Text="--SELECT--" Value="-1" /> </asp:DropDownList></ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center" />
                     </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Unit Price"><ItemTemplate><asp:TextBox ID="txtPricePerUOMGVB" runat="server" Text='<%# Bind("UnitOriginal", "{0:n2}")%>'   Font-Size="11px"  style="text-align:right" Height="15px"  Width="50px" AutoPostBack="true" OnTextChanged="txtPricePerUOMGVB_TextChanged"></asp:TextBox></ItemTemplate></asp:TemplateField>
                <asp:TemplateField HeaderText="Total Price"  HeaderStyle-HorizontalAlign="Right"><ItemTemplate><asp:TextBox ID="txtTotalPriceGVB" runat="server" Text='<%# Bind("TotalPrice")%>' Font-Size="11px"   Enabled="false" style="text-align:right" Height="15px" Width="70px" Align="right"></asp:TextBox></ItemTemplate>
                    <HeaderStyle HorizontalAlign="Right" />
                     </asp:TemplateField>
                <asp:TemplateField HeaderText="Tax Code"><ItemTemplate><asp:TextBox ID="txtTaxTypeGVB" runat="server"  Text='<%# bind("GST") %>' DataSourceID="SQLDSTaxType" DataTextField="TaxType" Font-Size="11px" style="text-align:right" Height="15px" Width="40px" AutoPostBack="False" Enabled="false"  ></asp:TextBox></ItemTemplate></asp:TemplateField>
                <asp:TemplateField HeaderText="Tax %" HeaderStyle-HorizontalAlign="Center"><ItemTemplate><asp:TextBox ID="txtGSTPercGVB" runat="server" Text='<%# Bind("GstRate", "{0:n2}")%>'  Font-Size="11px" Enabled="false" style="text-align:right" Height="15px" Width="35px"></asp:TextBox></ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center" />
                     </asp:TemplateField>
                <asp:TemplateField HeaderText="Tax Amt."><ItemTemplate><asp:TextBox ID="txtGSTAmtGVB" runat="server" Text='<%# Bind("GSTBase")%>' Font-Size="11px" Enabled="true"  style="text-align:right" Height="15px" Width="50px" Align="right"></asp:TextBox></ItemTemplate></asp:TemplateField>
                <asp:TemplateField HeaderText="Net Price" HeaderStyle-HorizontalAlign="Right"><ItemTemplate><asp:TextBox ID="txtTotalPriceWithGSTGVB" runat="server"  Text='<%# Bind("AppliedBase")%>' Font-Size="11px" Enabled="false" style="text-align:right" Height="15px" Width="65px" Align="right"></asp:TextBox></ItemTemplate>
                    <HeaderStyle HorizontalAlign="Right" />
                     </asp:TemplateField>
              
                <asp:TemplateField HeaderText=""><ItemTemplate><asp:TextBox ID="txtLocationIdGVB" runat="server"  Font-Size="11px" ReadOnly="true" BackColor="#CCCCCC" BorderStyle="None" Height="18px"  Width="0px"></asp:TextBox></ItemTemplate></asp:TemplateField>
                <asp:TemplateField HeaderText=""><ItemTemplate><asp:TextBox ID="txtServiceLocationGroupGVB" runat="server" Font-Size="11px" ReadOnly="true" BackColor="#CCCCCC" BorderStyle="None" Height="18px"  Width="0px"></asp:TextBox></ItemTemplate></asp:TemplateField>
                <asp:TemplateField HeaderText="" HeaderStyle-HorizontalAlign="Center"><ItemTemplate><asp:TextBox ID="txtBillingFrequencyGVB" runat="server"  Font-Size="11px" ReadOnly="true" BackColor="#CCCCCC" BorderStyle="None" Height="18px" Width="0px"></asp:TextBox></ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center" />
                     </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="" ><ItemTemplate><asp:TextBox ID="txtServiceByGVB" runat="server"  Font-Size="11px" ReadOnly="true" BackColor="#CCCCCC" Visible="false" BorderStyle="None" Height="18px" Width="10px"></asp:TextBox></ItemTemplate></asp:TemplateField>
                    
               
                            
                <asp:TemplateField><ItemTemplate><asp:TextBox ID="txtRcnoServiceRecordGVB" runat="server" Visible="false" Height="15px"  Width="0px"></asp:TextBox></ItemTemplate></asp:TemplateField>
                ...
                <asp:TemplateField><ItemTemplate><asp:TextBox ID="txtServiceDateGVB" runat="server" Visible="false"  Height="15px" Width="10px"></asp:TextBox></ItemTemplate></asp:TemplateField>
                       <asp:TemplateField HeaderText=""><ItemTemplate><asp:TextBox ID="txtItemDescriptionGVB" runat="server"  Font-Size="11px" Height="15px" Enabled="false" Width="0px" AutoPostBack="False" visible="false"></asp:TextBox></ItemTemplate></asp:TemplateField>
          
                    <asp:TemplateField HeaderText=""><ItemTemplate><asp:TextBox ID="txtServiceStatusGVB" runat="server"  Visible="false" Height="15px" Width="0px" Font-Size="11px" Enabled="false"></asp:TextBox></ItemTemplate></asp:TemplateField>
            
                         <asp:TemplateField HeaderText=""  HeaderStyle-HorizontalAlign="Center"><ItemTemplate><asp:TextBox ID="txtDiscPercGVB" runat="server" Visible="false" Font-Size="11px"  style="text-align:right" Height="15px"  Width="0px" AutoPostBack="true" OnTextChanged="txtDiscPercGVB_TextChanged"></asp:TextBox></ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center" />
                     </asp:TemplateField>
                <asp:TemplateField HeaderText=""><ItemTemplate><asp:TextBox ID="txtDiscAmountGVB" runat="server"  Font-Size="11px" Visible="false" style="text-align:right" Height="15px" Enabled="false"  Width="0px" AutoPostBack="true" OnTextChanged="txtDiscAmountGVB_TextChanged"></asp:TextBox></ItemTemplate></asp:TemplateField>
                <asp:TemplateField HeaderText=""><ItemTemplate><asp:TextBox ID="txtPriceWithDiscGVB" runat="server" Font-Size="11px" Visible="false"  Enabled="false" style="text-align:right" Height="15px" Width="0px" Align="right"></asp:TextBox></ItemTemplate></asp:TemplateField>
    ...
    <table border="0" style="width:90%; margin:auto">
            ...
            <asp:TemplateField HeaderText=" Item Type"><ItemTemplate><asp:DropDownList ID="txtItemTypeGV" runat="server" Font-Size="11px" Height="20px" ReadOnly="true" Width="72px"  AppendDataBoundItems="True" AutoPostBack="True" onselectedindexchanged="txtItemTypeGV_SelectedIndexChanged"><asp:ListItem Text="--SELECT--" Value="-1" /><asp:ListItem Text="SERVICE" Value="SERVICE" /><asp:ListItem Text="OTHERS" Value="OTHERS" /></asp:DropDownList></ItemTemplate></asp:TemplateField>
                  ...
                  <asp:TemplateField HeaderText="Ref No." HeaderStyle-HorizontalAlign="Center"><ItemTemplate><asp:TextBox ID="txtServiceRecordGV" runat="server" Font-Size="11px" Enabled="True" style="text-align:left" Height="15px" Width="120px" Align="right"  AutoPostBack="True" AppendDataBoundItems="True" OnTextChanged="txtServiceRecordGV_TextChanged"></asp:TextBox></ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center" />
                     </asp:TemplateField>

                 
               <asp:TemplateField HeaderText="Contract No." HeaderStyle-HorizontalAlign="Center"><ItemTemplate><asp:TextBox ID="txtContractNoGV" runat="server" Height="15px" Width="115px" Visible="true"  Font-Size="11px" Enabled="True"> </asp:TextBox></ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center" />
                     </asp:TemplateField>

                    <asp:TemplateField HeaderText="Invoice No." HeaderStyle-HorizontalAlign="Center"><ItemTemplate><asp:TextBox ID="txtInvoiceNoGV" runat="server" Font-Size="11px" Enabled="True" style="text-align:left" Height="15px" Width="110px" Align="right"  AutoPostBack="True" AppendDataBoundItems="True" OnTextChanged="txtInvoiceNoGV_TextChanged"></asp:TextBox></ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center" />
                     </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Item Description"><ItemTemplate><asp:DropDownList ID="txtItemCodeGV" runat="server" Font-Size="11px"  Height="20px" AutoPostBack="True"  Width="95px" AppendDataBoundItems="True"  onselectedindexchanged="txtItemCodeGV_SelectedIndexChanged"><asp:ListItem Text="--SELECT--" Value="-1" /> </asp:DropDownList></ItemTemplate></asp:TemplateField>
                ...
                <asp:TemplateField HeaderText=""><ItemTemplate><asp:ImageButton ID="BtnGL" runat="server" OnClick="BtnGL_Click" CssClass="righttextbox" Height="22px" ImageAlign="Middle" ImageUrl="~/Images/searchbutton.jpg" Width="24px" />
                        
                    </ItemTemplate></asp:TemplateField>
                 <asp:TemplateField HeaderText="GL Description"><ItemTemplate><asp:TextBox ID="txtGLDescriptionGV" runat="server" Font-Size="11px" Height="15px"  Width="90px"></asp:TextBox></ItemTemplate></asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="UOM"  HeaderStyle-HorizontalAlign="Center"><ItemTemplate><asp:DropDownList ID="txtUOMGV" runat="server" Font-Size="11px" Height="20px" Width="53px"  AppendDataBoundItems="True"><asp:ListItem Text="--SELECT--" Value="-1" /> </asp:DropDownList></ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center" />
                     </asp:TemplateField>
                <asp:TemplateField HeaderText="Qty."><ItemTemplate><asp:TextBox ID="txtQtyGV" runat="server" Font-Size="11px" Text="1" style="text-align:right" Height="15px"  Width="30px" AutoPostBack="true" OnTextChanged="txtQtyGV_TextChanged"></asp:TextBox></ItemTemplate></asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Total Price"  HeaderStyle-HorizontalAlign="center"><ItemTemplate><asp:TextBox ID="txtTotalPriceGV" runat="server" Font-Size="11px" Text="0.00"  Enabled="false" style="text-align:right" Height="15px" Width="70px" Align="right"></asp:TextBox></ItemTemplate>
                    <HeaderStyle HorizontalAlign="center" />
                     </asp:TemplateField>
                  
                    <asp:TemplateField HeaderText="Tax Code"><ItemTemplate><asp:TextBox ID="txtTaxTypeGV" runat="server" Font-Size="11px" style="text-align:right" Height="15px" Width="40px" AutoPostBack="True" Enabled="false"></asp:TextBox></ItemTemplate></asp:TemplateField>
                <asp:TemplateField HeaderText="Tax %" HeaderStyle-HorizontalAlign="Center"><ItemTemplate><asp:TextBox ID="txtGSTPercGV" runat="server" Text="0.00"  Font-Size="11px" Enabled="false" style="text-align:right" Height="15px" Width="35px"></asp:TextBox></ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center" />
                     </asp:TemplateField>
                <asp:TemplateField HeaderText="Tax Amt."><ItemTemplate><asp:TextBox ID="txtGSTAmtGV" runat="server" Font-Size="11px" Enabled="true" Text="0.00" style="text-align:right" Height="15px" Width="50px" Align="right" AutoPostBack="true" OnTextChanged="txtGSTAmtGV_TextChanged"></asp:TextBox></ItemTemplate></asp:TemplateField>
                <asp:TemplateField HeaderText="Net Price" HeaderStyle-HorizontalAlign="Right"><ItemTemplate><asp:TextBox ID="txtTotalPriceWithGSTGV" runat="server" Text="0.00" Font-Size="11px" Enabled="false" style="text-align:right" Height="15px" Width="65px" Align="right"></asp:TextBox></ItemTemplate>
                    <HeaderStyle HorizontalAlign="Right" />
                     </asp:TemplateField>
              

                <asp:TemplateField HeaderText=""><ItemTemplate><asp:TextBox ID="txtServiceStatusGV" runat="server"  Height="15px" Width="10px" Visible="false"  Font-Size="11px" Enabled="false"></asp:TextBox></ItemTemplate></asp:TemplateField>
               

                <asp:TemplateField HeaderText=""  HeaderStyle-HorizontalAlign="Center"><ItemTemplate><asp:TextBox ID="txtDiscPercGV" runat="server" Visible="false"  Font-Size="11px" Text="0.00" style="text-align:right" Height="15px"  Width="0px" AutoPostBack="true" OnTextChanged="txtDiscPercGV_TextChanged"></asp:TextBox></ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center" />
                     </asp:TemplateField>
                <asp:TemplateField HeaderText=""><ItemTemplate><asp:TextBox ID="txtDiscAmountGV" runat="server" Font-Size="11px" Text="0.00" Visible="false"  style="text-align:right" Height="15px" Enabled="false"  Width="0px" AutoPostBack="true" OnTextChanged="txtDiscAmountGV_TextChanged"></asp:TextBox></ItemTemplate></asp:TemplateField>
                ...
                <asp:TemplateField HeaderText=""><ItemTemplate><asp:TextBox ID="txtPriceWithDiscGV" runat="server" Font-Size="11px" Text="0.00" Visible="false"   Enabled="false" style="text-align:right" Height="15px" Width="0px" Align="right"></asp:TextBox></ItemTemplate></asp:TemplateField>
            
                <asp:TemplateField HeaderText=""><ItemTemplate><asp:TextBox ID="txtLocationIdGV" runat="server" Font-Size="11px" Visible="false" ReadOnly="true" BackColor="#CCCCCC" BorderStyle="None" Height="18px"  Width="0px"></asp:TextBox></ItemTemplate></asp:TemplateField>
                <asp:TemplateField HeaderText=""><ItemTemplate><asp:TextBox ID="txtServiceLocationGroupGV" runat="server" Font-Size="11px" ReadOnly="true" BackColor="#CCCCCC" BorderStyle="None" Height="18px"  Width="0px"></asp:TextBox></ItemTemplate></asp:TemplateField>
                <asp:TemplateField HeaderText="" HeaderStyle-HorizontalAlign="Center"><ItemTemplate><asp:TextBox ID="txtBillingFrequencyGV" runat="server" Font-Size="11px" ReadOnly="true" BackColor="#CCCCCC" BorderStyle="None" Height="18px" Width="0px"></asp:TextBox></ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center" />
                     </asp:TemplateField>
                                
                <asp:TemplateField HeaderText="" ><ItemTemplate><asp:TextBox ID="txtServiceByGV" runat="server" Font-Size="11px" ReadOnly="true" BackColor="#CCCCCC" Visible="false" BorderStyle="None" Height="18px" Width="0px"></asp:TextBox></ItemTemplate></asp:TemplateField>
                ...
                <asp:TemplateField><ItemTemplate><asp:TextBox ID="txtServiceDateGV" runat="server" Visible="false" Height="15px" Width="10px"></asp:TextBox></ItemTemplate></asp:TemplateField>
                    <asp:TemplateField HeaderText=""><ItemTemplate><asp:TextBox ID="txtItemDescriptionGV" runat="server" Font-Size="11px" Height="15px" Enabled="false" Width="0px" AutoPostBack="False" visible="false"></asp:TextBox></ItemTemplate></asp:TemplateField>
        ...
        <FooterStyle BackColor="#F7DFB5" Font-Bold="True" ForeColor="White" Height="5px" />
                ...
                <PagerStyle BackColor="#2461BF" ForeColor="White" HorizontalAlign="Center" /><HeaderStyle BackColor="#000066" Font-Bold="True" ForeColor="White" /><AlternatingRowStyle BackColor="White" />
                      ...
                      <table border="0" style="width:95%; padding-left:6%;">
                         <tr style="width:100%; padding-left:1%;">
                              ...
                              <td colspan="1" style="width:75px;font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:right;">
                                  ...
                                  <asp:TextBox ID="txtTotalCNAmt" runat="server" AutoCompleteType="Disabled" BackColor="#CCCCCC" BorderStyle="None" Font-Bold="true" Height="18px" style="text-align:right" Visible="False" Width="95%"></asp:TextBox>
                               </td>
                              <td colspan="1" style="width:60px;font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:right;">
                                      <asp:TextBox ID="txtTotalCNGSTAmt" runat="server" AutoCompleteType="Disabled" BackColor="#CCCCCC" BorderStyle="None" Font-Bold="true" Height="18px" style="text-align:right" Width="98%" Visible="False"></asp:TextBox>
                           
                                  </td>
                              <td colspan="1" style="width:80px;font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:right;">
                                              <asp:TextBox ID="txtTotalWithDiscAmt" runat="server" AutoCompleteType="Disabled" BackColor="#CCCCCC" BorderStyle="None" Font-Bold="true" Height="18px" style="text-align:right" Visible="True" Width="100%"></asp:TextBox>
                              ...
                              <td colspan="1" style="width:70px;font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:right;">
                                     ...
                                     <asp:TextBox ID="txtTotalGSTAmt" runat="server" AutoCompleteType="Disabled" BackColor="#CCCCCC" BorderStyle="None" Font-Bold="true" Height="18px" style="text-align:right" Visible="True" Width="100%"></asp:TextBox>
                            
                                     </td>
                              <td colspan="1" style="width:80px;font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:right;">
                                  <asp:TextBox ID="txtTotalWithGST" runat="server" AutoCompleteType="Disabled" BackColor="#CCCCCC" BorderStyle="None" Font-Bold="true" Height="18px" style="text-align:right" Visible="True" Width="95%"></asp:TextBox>
                      ...
                      <tr style="width:100%; padding-left:10%;">
                          ...
                          <td colspan="1" style="width:80px;font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:right;">
                                             <asp:Button ID="btnSave" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="SAVE" Width="95%" OnClientClick="if(this.value === 'Saving...') { return false; } else { this.value = 'Saving...'; } ; return DoValidationSave()" />
                    
                               
                                   </td>
                             
                            <td colspan="1" style="width:80px;font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:right;">
                                                 <asp:Button ID="btnCancel" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="CANCEL" Width="95%" />
       ...
       <asp:LinkButton ID="btnTop" runat="server" Font-Names="Calibri" Font-Bold="True" ForeColor="Brown">Go to Top</asp:LinkButton></div>
              ...
              <ContentTemplate>
                  <table style="width:100%;height:1000px">
                      <tr style="height:30%">
                          <td><table class="centered" style="text-align:center;width:100%;padding-top:10px;">
                              <tr><td class="CellFormat">CN No </td>
                                  <td class="CellTextBox"><asp:Label ID="lblFileUploadCNNo" runat="server" BackColor="#CCCCCC" Height="16px" MaxLength="100" ReadOnly="True" Width="50%"></asp:Label></td>
    ...
    <HeaderStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" Font-Names="Calibri" />
      ...
      <asp:ModalPopupExtender ID="mdlUpdateGSTCode" runat="server" TargetControlID="btnUpdateGSTCode"   PopupControlID="pnlUpdateGSTCode" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
         ...
         <%--end--%>
             ...
             ''''''''''
                <asp:Panel ID="pnlStatus" runat="server" BackColor="White" Width="40%" Height="41%" BorderColor="#003366" BorderWidth="1px" ScrollBars="Auto">
                      ...
                      <asp:Label ID="lblAlertStatus" runat="server" BackColor="Red" ForeColor="White"></asp:Label>
                          ...
                          <tr>
                               <td class="CellFormat">Change Status
                                   <asp:Label ID="Label64" runat="server" Font-Size="14px" ForeColor="Red" Text="*"></asp:Label>
                               </td>
                         ...
                         <tr>
                             <td class="CellFormat">Reason<asp:Label ID="Label65" runat="server" Font-Size="14px" ForeColor="Red" Text="*"></asp:Label>
                             </td>
            ...
            <asp:GridView ID="grdViewMultiPrint" Width="100%" Font-Size="15px" runat="server"  AllowSorting="True" AutoGenerateColumns="False" BorderWidth="1px" CellPadding="2" CellSpacing="2" DataKeyNames="Rcno" DataSourceID="SqlDSMultiPrint" ForeColor="#333333" GridLines="Vertical"> 
               ...
               <ItemTemplate><asp:CheckBox ID="chkSelectMultiPrintGV" runat="server" Font-Size="12px" Enabled="true" Height="18px"  Width="5%" AutoPostBack="false" CommandName="CHECK" ></asp:CheckBox></ItemTemplate>
                                                  ...
                                                  <ItemStyle HorizontalAlign="Left" Wrap="False" Width="15%" />
                                                    ...
                                                    <asp:BoundField DataField="GSTbase" HeaderText="Tax Amount">
                                                    </asp:BoundField>
...
<%--         Search Start--%>
            ...
            <asp:Panel ID="pnlConfirmPrint" runat="server" BackColor="White" Width="400px" Height="200px" BorderColor="#003366" BorderWidth="1px" ScrollBars="Auto">
               ...
               <tr>
                      <td class="CellFormat" colspan="2" style="text-align:center; margin-left:auto; margin-right:auto;"">
                       ...
                       <%--            <a href="RV_CreditNote.aspx?Export=PDF" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/Print.jpg" width="25" height="20" /></imagebutton></a>
                                 ...
                                 &nbsp;&nbsp; 
                               <a href="Email.aspx?Type=CreditNote" target="_blank"><button style="border:none;background-color:white;" type="button"><img src="Images/email1.png" width="20" height="20" /></button></a>
                                 &nbsp;&nbsp; <label style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px; vertical-align: super;">Format 1 : Print Credit Note</label><br /><br />

                               </td>
                         </tr> 
               <tr style="padding-top:0px;" runat="server" id="trformat2">
                             <%--<td colspan="2" style="text-align:center">
                                      <a href="RV_CreditNote.aspx?Export=Word" target="_blank"><imagebutton style="border:none;background-color:white;" type="button"><img src="Images/word.jpg" width="20" height="20" /></imagebutton></a>
                                    &nbsp;&nbsp;
                                   <a href="Email.aspx?Type=CreditNote" target="_blank"><button style="border:none;background-color:white;" type="button"><img src="Images/email1.png" width="20" height="20" /></button></a>
                       ...
                       <%--            <a href="RV_CreditNote.aspx?Export=PDF" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/Print.jpg" width="25" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp;--%>
                                 <a href="RV_CreditNote.aspx?Export=PDF&Format=Format2" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/view.jpg" width="28" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp;
                                  <a href="RV_CreditNote.aspx?Export=Word&Format=Format2" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/word.jpg" width="20" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp; 
                               <a href="Email.aspx?Type=CreditNote2" target="_blank"><button style="border:none;background-color:white;" type="button"><img src="Images/email1.png" width="20" height="20" /></button></a>
                                 &nbsp;&nbsp; <label style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px; vertical-align: super;">Format 2 : Print Credit Note with Invoice No</label><br /><br />
                       ...
                       <asp:CalendarExtender ID="CalendarExtender21" runat="server" Format="dd/MM/yyyy" PopupButtonID="txtSearchEntryDateTo" TargetControlID="txtSearchEntryDateTo"/>
                               ...
                               <tr>
                                     ...
                                     <td style="width:8%;font-size:15px;font-weight:bold;font-family:Calibri;color:black;text-align:left;">
                                       &nbsp;</td>
                                       <td style="width:8%;font-size:15px;font-weight:bold;font-family:Calibri;color:black;text-align:left;">
                                           <asp:CheckBox ID="chkSearchShowUnPrintedInvoice" runat="server" AutoPostBack="false" Text="Show UnPrinted CN/DN Only" Visible="False" />
                                      </td>
                               </tr>
         ...
         <table border="0" style="font-family: Calibri; font-size: 15px; font-weight: bold; color: white;text-align:left;padding-left:2px;">
               ...
               <tr>
                    ...
                    <tr>
                      <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          &nbsp;<asp:Label ID="Label36" runat="server" Text="Do you want to SUBMIT this E-CN/DN "></asp:Label>
                      </td>
                     </tr>
              ...
              <tr>
                      <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          &nbsp;<asp:Label ID="Label37" runat="server" Text="to MALAYSIA PORTAL? "></asp:Label>
                      </td>
                     </tr>
             ...
             <tr>
               <td colspan="2" style="width:100%;text-align:center;font-size:18px;font-weight:bold;font-family:'Calibri';"> 
                      <asp:Label ID="lblAlertCancelEInvoice" runat="server" BackColor="Red" ForeColor="White"></asp:Label>
                          ...
                          <tr>
                      <td class="CellFormat" style="text-align:right;" >CN/DN Number </td>
                    <td class="CellTextBox">  
                        <asp:TextBox ID="txtCancelInvoiceNo" runat="server" Forecolor="Black" Height="16px" MaxLength="200" Width="70%" Enabled="false"></asp:TextBox>
                    ...
                    <td class="CellTextBox">  
                      ...
                      <td class="CellFormat" colspan="2" style="width:100%;text-align:center; margin-left:auto; margin-right:auto;"">
                         ...
                         &nbsp;<asp:Label ID="Label49" runat="server" Text="Do you want to CANCEL this CN/DN? "></asp:Label>
                   <br /> <br />  </td>
                     </tr>
