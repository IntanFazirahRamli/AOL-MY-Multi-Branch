<%@ Page Title="Terminated Service Contract Report Selection" Language="VB" MasterPageFile="~/MasterPage_Report.master" AutoEventWireup="false" CodeFile="RV_Select_TerminatedServiceContract.aspx.vb" Inherits="RV_Select_TerminatedServiceContract" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
       ...
       <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">TERMINATED SERVICE CONTRACT LISTING REPORT</h4>
...
<%--            <tr>
     ...
     <table style="font-family: Calibri; font-size: 15px; font-weight: bold; color: black;text-align:left;padding-left:50px;line-height:20px;">
            <tr>
                      <td class="CellFormat" style="width:25%">
                         Status
                             </td>
                      <td colspan="2" style="width:75%">
                            <asp:checkboxlist ID="chkStatusSearch" runat="server" Width="100%" RepeatDirection="Horizontal" RepeatLayout="Table" RepeatColumns="3" CellPadding="1" CellSpacing="1" TextAlign="Right" Enabled="True">
                              
                                    <asp:ListItem Value="T" Selected="True">T - Terminated</asp:ListItem>
                                   <asp:ListItem Value="E" Selected="True">E - Expired</asp:ListItem>  
         ...
         <tr>
                      <td class="CellFormat">TerminatedDate</td>
              ...
              <tr>
                      <td class="CellFormat">TerminationCode</td>
                    <td class="CellTextBox"><%--<asp:DropDownList ID="ddlTermCode1" runat="server" AppendDataBoundItems="True" CssClass="chzn-select" DataSourceID="SqlDSTermination" DataTextField="TerminationCode" DataValueField="Code" Width="60%" Height="25px" ><asp:ListItem Text="--SELECT--" Value="-1" /></asp:DropDownList>--%>
                   <cc1:dropdowncheckboxes ID="ddlTermCode" runat="server" Width="60.5%" UseSelectAllNode = "true" DataSourceID="SqlDSTermination" DataTextField="TerminationCode" DataValueField="TerminationCode" AddJQueryReference="true" UseButtons="false" >
     ...
     <Style2 SelectBoxWidth="60.5%" DropDownBoxBoxWidth="60.5%" DropDownBoxBoxHeight="120" />
               ...
               <tr>
                    ...
                    <td class="CellTextBox"> <%--<asp:DropDownList ID="ddlContractGroup" runat="server" CssClass="chzn-select" DataSourceID="SqlDSContractGroup" DataTextField="contractgroup" DataValueField="contractgroup" Width="60%" Height="25px" AppendDataBoundItems="True">
                                          <asp:ListItem Text="--SELECT--" Value="-1" />
                                     </asp:DropDownList>--%>
                         <cc1:dropdowncheckboxes ID="txtServiceID" runat="server" Width="60.5%" UseSelectAllNode = "true" DataSourceID="SqlDSContractGroup" DataTextField="ContractGroup" DataValueField="ContractGroup" AddJQueryReference="true" UseButtons="false" >
     <Style2 SelectBoxWidth="60.5%" DropDownBoxBoxWidth="60.5%" DropDownBoxBoxHeight="120" />                    
 </cc1:dropdowncheckboxes>
                         </td>
          ...
          <tr>
               ...
               <tr>
                    ...
                    <td class="CellTextBox" colspan="2" style="text-align:left">  <asp:TextBox ID="txtCustName" runat="server" MaxLength="200" Height="16px" Width="90%"></asp:TextBox>
                               </td>
                  
                  </tr>
                   
         <tr>
                         <td colspan="3" style="font-size:15px;font-weight:bold;font-family:'Calibri';color:#800000; text-align:left; text-decoration: underline;padding-left:10%;">Sort By</td>
                    </tr>
                            ...
                            <tr>
                                <td rowspan="2"><asp:ListBox ID="lstSort1" runat="server" width="120px" Rows="5" SelectionMode="Multiple">
                                    ...
                                    <asp:ListItem Text="Account Name" Value="CustName">Account Name</asp:ListItem>
                                     <asp:ListItem Text="TerminatedDate" Value="TerminatedDate">Terminated Date</asp:ListItem>
                                   <asp:ListItem Text="Salesman" Value="Salesman">Salesman</asp:ListItem>
                                  
                                    </asp:ListBox></td>
                                <td colspan="2"><asp:Button ID="btnSort1" runat="server" Text=">>" /></td>
                                 <td rowspan="2"><asp:ListBox ID="lstSort2" runat="server" width="120px" Rows="5" SelectionMode="Multiple">
...
<td><asp:Button ID="btnSort2" runat="server" Text="<<" /></td>
            ...
            <%--  <tr>
                  <td colspan="3" class="CellFormat" style="text-align:left;padding-top:20px;padding-left:100px;padding-bottom:20px;">
                      <asp:CheckBox ID="chkIncludeRevised" runat="server" Text="Include REVISED Service Contract [STATUS = 'R']" Checked="false" /></td>
              </tr>--%>
              <tr>
...
<%--                    <asp:BoundField DataField="Address1" >
      ...
      <asp:SqlDataSource ID="SqlDSSalesman" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>" SelectCommand="Select StaffId from tblStaff where Roles = 'SALES MAN'">
        ...
        <asp:SqlDataSource ID="SqlDSIndustry" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>" SelectCommand="SELECT UPPER(industry) FROM tblindustry ORDER BY industry"></asp:SqlDataSource>
         <asp:SqlDataSource ID="SqlDSTermination" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>" SelectCommand="SELECT CONCAT(Code, ' - ', Description) AS TerminationCode FROM tblterminationcode ORDER BY code"></asp:SqlDataSource>
