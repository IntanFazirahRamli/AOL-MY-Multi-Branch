<%@ Page Title="Sales Performance Summary By Salesman" Language="VB" ValidateRequest="false" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="RV_SalesPerformanceSummaryBySalesman.aspx.vb" Inherits="RV_SalesPerformanceSummaryBySalesman" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
     <div style="text-align:center">
        <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">Sales Performance Summary By Salesman Report</h3>
    <br />
        ...
        <tr>
            <td colspan="2">
                ...
                <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                    <Report FileName="Reports\ManagementReports\SalesPerformanceReports\SalesPerformaceSummaryBySalesman.rpt">
                    </Report>
