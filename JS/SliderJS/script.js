$(function() {
  ...
  $('#slider').slider({
    ...
    min: 0,
    max: $("[id*=HiddenShowDataValue]").val(),
    // step
    ...
    //},
    {
        //value: $("[id*=HiddenShowDataValue]").val(),
        value: 0,
      type: "Time"
    }],
    // display type names
    ...
    slide: function (e, ui) {
        ...
        isSlideScroll = true;
        $("[id*=HiddenSliderValue]").val(ui.value);

        onclickGraphDashBoard();
        //console.log("11 test ", $("[id*=HiddenSliderValue]").val());
