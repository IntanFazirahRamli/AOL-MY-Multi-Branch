<%@ Page Title="Service Record with Payment Collection" Language="VB" MasterPageFile="~/MasterPage_Report.master" AutoEventWireup="false" CodeFile="RV_Select_SvcRecwithPaymentType.aspx.vb" Inherits="RV_Select_SvcRecwithPaymentType" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <script type="text/javascript">
     ...
     <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" ScriptMode="Release">
       ...
       <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">Service Record with Payment Type</h4>
...
<%--            <tr>
      ...
      <tr>
             ...
             <tr>
                     ...
                     <td class="CellTextBox" colspan="1">
                            <asp:DropDownList ID="ddlPaymentType" runat="server" CssClass="chzn-select" DataSourceID="SqlDSPaymentType" DataTextField="SettleType" DataValueField="SettleType" Width="37.5%" Height="25px" AppendDataBoundItems="True">
                    <asp:ListItem Text="--SELECT--" Value="-1" />
                </asp:DropDownList>
                         <%--<asp:TextBox ID="txtPaymentType" runat="server" MaxLength="200" Height="16px" Width="38%"></asp:TextBox>--%>
                     </td>
    ...
    <asp:SqlDataSource ID="SqlDSPaymentType" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>" SelectCommand="SELECT SettleType FROM tblsettletype order by SettleType"></asp:SqlDataSource>
