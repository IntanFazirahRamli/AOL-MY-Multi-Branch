...
Partial Class RV_Select_ServiceContractExpiry
    ...
    Protected Sub btnPrintServiceContractList_Click(sender As Object, e As EventArgs) Handles btnPrintServiceContractList.Click
        If GetData() = True Then
            ...
            If rdbFormat.SelectedValue = "Format1" Then
                Session.Add("ReportType", "SvcContractExpRenew")
                Response.Redirect("RV_SvcContractExpRenew.aspx")

            ElseIf rdbFormat.SelectedValue = "Format2" Then
                Session.Add("ReportType", "SvcContractExpRenew_Format2")
                Response.Redirect("RV_SvcContractExpRenew_Format2.aspx")
    ...
    Private Function GetData() As Boolean
        ...
        If rdbFormat.SelectedValue = "Format1" Then
            qry = qry + "tblcontract.Status, tblcontract.CompanyGroup,tblcontract.ContractGroup,tblcontract.CategoryID,tblcontract.SalesMan,tblcontract.ContractNo, tblcontract.AccountID,  tblcontract.CustName,  replace(replace(tblcontract.ServiceAddress, char(10), ' '), char(13), ' ') as ServiceAddress, replace(replace(tblcontract.ServiceDescription, char(10), ' '), char(13), ' ') as ServiceDescription, tblcontract.ContractDate, tblcontract.AgreeValue, tblcontract.StartDate,tblcontract.EndDate, tblcontract.ActualEnd, replace(replace(replace(tblcontract.Notes, char(10), ' '), char(13), ' '), char(9), ' ') as Notes, tblcontract.InChargeId, tblcontract.RenewalSt, tblcontract.RenewalDate, tblcontract.TerminationCode,  tblcontract.TerminationDescription"
        ElseIf rdbFormat.SelectedValue = "Format2" Then
            qry = qry + "tblcontract.ContractNo, tblcontract.AgreeValue, replace(replace(replace(tblcontract.Notes, char(10), ' '), char(13), ' '), char(9), ' ') as Notes, tblcontract.RenewalDate, tblcontract.SalesMan, replace(replace(tblcontract.ServiceDescription, char(10), ' '), char(13), ' ') as ServiceDescription, tblcontract.AccountID, tblcontract.ServiceAddress, tblcontractdet.LocationID, tblcontract.CompanyGroup,tblcontract.ContractGroup"
        End If

        qry = qry + " FROM tblcontract inner JOIN tblcontractdet ON (tblcontract.ContractNo=tblcontractdet.ContractNo) AND (tblcontract.AccountID=tblcontractdet.AccountID) where tblcontract.rcno<>0"
        ...
        Else
            qry = qry + " and tblcontract.CategoryID = '" + ddlCategory.Text + "'"
        ...
        If String.IsNullOrEmpty(txtTeam.Text) = False Then
            qry = qry + " and tblcontract.StaffID = '" + txtTeam.Text + "'"
        ...
        Else
            qry = qry + " and tblcontract.ServiceID = '" + txtServiceID.Text + "'"
        ...
        If String.IsNullOrEmpty(txtRenewalDateFrom.Text) = False Then
            Dim d As DateTime
            If Date.TryParseExact(txtRenewalDateFrom.Text, "dd/MM/yyyy", Globalization.CultureInfo.InvariantCulture, Globalization.DateTimeStyles.None, d) Then
            ...
            Else
                ...
                Return False
            End If
            qry = qry + " and tblcontract.RenewalDate >='" + Convert.ToDateTime(txtRenewalDateFrom.Text).ToString("yyyy-MM-dd") + "'"
        ...
        If String.IsNullOrEmpty(txtRenewalDateTo.Text) = False Then
            Dim d As DateTime
            If Date.TryParseExact(txtRenewalDateTo.Text, "dd/MM/yyyy", Globalization.CultureInfo.InvariantCulture, Globalization.DateTimeStyles.None, d) Then
            ...
            Else
                ...
                Return False
            End If
            qry = qry + " and tblcontract.RenewalDate <='" + Convert.ToDateTime(txtRenewalDateTo.Text).ToString("yyyy-MM-dd") + "'"
    ...
    Protected Sub btnExportToExcel_Click(sender As Object, e As EventArgs) Handles btnExportToExcel.Click
        If GetData() = True Then
            ...
            Dim attachment As String = "attachment; filename=ServiceContractExpiry.xls"
    ...
    Public Sub WriteExcelWithNPOI(ByVal dt As DataTable, ByVal extension As String)
            ...
            If rdbFormat.SelectedValue = "Format1" Then
                For i As Integer = 0 To dt.Rows.Count - 1
                    ...
                    For j As Integer = 0 To dt.Columns.Count - 1
                        ...
                        ElseIf j = 11 Or j = 15 Or j = 13 Or j = 14 Or j = 19 Then
                            If String.IsNullOrEmpty(dt.Rows(i)(j).ToString) = False Then
        ...
        Using exportData = New MemoryStream()
            ...
            If extension = "xlsx" Then
                ...
                Response.AddHeader("Content-Disposition", String.Format("attachment;filename={0}", "ServiceContractExpiry.xlsx"))
                Response.BinaryWrite(exportData.ToArray())
            ElseIf extension = "xls" Then
                Response.ContentType = "application/vnd.ms-excel"
                Response.AddHeader("Content-Disposition", String.Format("attachment;filename={0}", "ServiceContractExpiry.xls"))
