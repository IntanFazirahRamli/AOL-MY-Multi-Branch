<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Master_PestLevelofInfestation.aspx.vb" Inherits="Master_PestLevelofInfestation" Title="Infestation Level"  Culture="en-GB"%>
...
<script type="text/javascript">
    ...
    <div style="text-align:center">
        ...
        <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">Pest Level of Infestation</h3>
       ...
       <asp:Panel ID="pnlGrid" runat="server" BackColor="White" BorderColor="#003366" BorderWidth="0" Height="100%" ScrollBars="Auto" style="text-align:center;  margin-left:auto; margin-right:auto;"    Visible="true" Width="600px">
            ...
            <Columns>
                 ...
                 <asp:BoundField DataField="LevelofInfestation" HeaderText="Level of Infestation" SortExpression="LevelofInfestation" >
            ...
            <tr style="text-align:center;">
                <td style="text-align:center;">
                        ...
                        <tr><td style="width:30%"></td>
                            <td style="width:10%;font-size:15px;font-weight:bold;font-family:'Calibri';color:black;text-align:left;">Level of Infestation<asp:Label ID="Label23" runat="server" Font-Size="14px" ForeColor="Red" Height="20px" Text="*" visible="true"></asp:Label>
                            </td>
                            <td style="text-align:left;">
                                <asp:TextBox ID="txtLevelofInfestation" runat="server" MaxLength="50" Height="16px" Width="200px"></asp:TextBox></td>
                        </tr>
...
<asp:Button ID="btnCancel" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="CANCEL" Width="100px" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>" SelectCommand="SELECT *  FROM tblPestLevelofInfestation order by LevelofInfestation "></asp:SqlDataSource>
