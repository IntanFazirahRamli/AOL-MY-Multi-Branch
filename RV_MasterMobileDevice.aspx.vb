...
Public Class RV_MasterMobileDevice
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                Dim repPath As String = Server.MapPath("~/Reports/AdministrationReports/Rpt_Master_MobileDevice.rpt")
    ...
    Protected Sub btnQuit_Click(sender As Object, e As EventArgs)
        Response.Redirect("Master_MobileDevice.aspx")
    End Sub
