...
Partial Class RV_Export_SalesByLedger
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                If Convert.ToString(Session("ReportType")) = "Detail" Then

                    crReportDocument.Load(Server.MapPath("~/Reports/ARNewReports/SalesInvListingReports/SalesInvoiceLedgerDetail.rpt"))
                ElseIf Convert.ToString(Session("ReportType")) = "Summary" Then

                    crReportDocument.Load(Server.MapPath("~/Reports/ARNewReports/SalesInvListingReports/SalesInvoiceLedgerSummary.rpt"))
                ...
                Dim FilePath As String = Server.MapPath("~/PDFs/" + Convert.ToString(Session("UserID") + "_SalesListingByLedger.PDF"))
                ...
                If FileBuffer IsNot Nothing Then
                    ...
                    Response.AddHeader("content-disposition", "inline; filename=SalesListingByLedger.pdf")
