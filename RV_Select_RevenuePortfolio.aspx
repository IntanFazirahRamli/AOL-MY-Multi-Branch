<%@ Page Title="Revenue Portfolio Comparison" Language="VB" MasterPageFile="~/MasterPage_Report.master" AutoEventWireup="false" CodeFile="RV_Select_RevenuePortfolio.aspx.vb" Inherits="RV_Select_RevenuePortfolio" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <table style="width:90%;">
        <tr>
            <td colspan="2">
                  <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">REVENUE PORTFOLIO COMPARISON</h4>
