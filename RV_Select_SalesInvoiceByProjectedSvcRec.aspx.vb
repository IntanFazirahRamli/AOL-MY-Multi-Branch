...
Partial Class RV_Select_SalesInvoiceByProjectedSvcRec
    ...
    Protected Sub btnExportToExcel_Click(sender As Object, e As EventArgs) Handles btnExportToExcel.Click
        ...
        If Convert.ToString(Session("LocationEnabled")) = "Y" Then
            ...
            If chkDistribution.Checked = True Then
                cmd.CommandText = "spSalesByServicePeriodDistributionLocation"
            Else

                cmd.CommandText = "spSalesByServicePeriodLocation"
            End If

        Else
            If chkDistribution.Checked = True Then
                cmd.CommandText = "spSalesByServicePeriodDistribution"
            Else

                cmd.CommandText = "spSalesByServicePeriod"
            End If
        ...
        '        Return
        '    End If
        '    cmd.Parameters.AddWithValue("pr_glperiodfrom", d.ToString("yyyyMM"))
        '    criteria = "_" + d.ToString("yyyyMM")
        'Else
        '    cmd.Parameters.AddWithValue("pr_glperiodfrom", DBNull.Value)
        ...
        '        Return
        '    End If
        '    cmd.Parameters.AddWithValue("pr_glperiodto", d.ToString("yyyyMM"))

        '    criteria = criteria + "-" + d.ToString("yyyyMM")
        'Else
        '    cmd.Parameters.AddWithValue("pr_glperiodto", DBNull.Value)
    ...
    Public Sub WriteExcelWithNPOI(ByVal dt As DataTable, ByVal extension As String, ByVal criteria As String)
        ...
        If Convert.ToString(Session("LocationEnabled")) = "Y" Then
            If chkDistribution.Checked Then
                For i As Integer = 0 To dt.Rows.Count - 1
                    ...
                    For j As Integer = 0 To dt.Columns.Count - 1
                        ...
                        If j >= 20 Then
                            ...
                            '   ElseIf j = 2 Or j = 6 Then
                        ElseIf j = 2 Or j = 9 Then
                            If String.IsNullOrEmpty(dt.Rows(i)(j).ToString) = False Then
                ...
                Next
                'If chkDistribution.Checked =False Then
            Else
            ...
            'else Statement for If Convert.ToString(Session("LocationEnabled")) = "N" Then
        Else
            For i As Integer = 0 To dt.Rows.Count - 1
                Dim row As IRow = sheet1.CreateRow(i + 2)
        ...
        Using exportData = New MemoryStream()
            ...
            If extension = "xlsx" Then
                ...
                Response.AddHeader("Content-Disposition", String.Format("attachment;filename={0}", "SalesByServicePeriod" + criteria + ".xlsx"))
