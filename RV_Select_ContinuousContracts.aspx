<%@ Page Title="ContinuousContracts" Language="VB" MasterPageFile="~/MasterPage_Report.master" AutoEventWireup="false" CodeFile="RV_Select_ContinuousContracts.aspx.vb" Inherits="RV_Select_ContinuousContracts" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
     <style type="text/css">
      ...
      <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" ScriptMode="Release">
       ...
       <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">CONTINUOUS CONTRACT LISTING REPORT</h4>
...
<%--            <tr>
      ...
      <table style="width:100%;font-family: Calibri; font-size: 15px; font-weight: bold; color: black;text-align:left;padding-left:20px;line-height:20px;">
           ...
           <%--    <tr>
                      ...
                      <td colspan="2" style="width:75%">
                            <asp:checkboxlist ID="chkStatusSearch" runat="server" Width="100%" RepeatDirection="Horizontal" RepeatLayout="Table" RepeatColumns="5" CellPadding="3" CellSpacing="3" TextAlign="Right" Enabled="True">
                              
                                 <asp:ListItem Selected="true" Value="O">O - Open</asp:ListItem>
             ...
             <tr>
                      <td class="CellFormat">Last Schedule</td>
     ...
     <Style2 SelectBoxWidth="60.5%" DropDownBoxBoxWidth="60.5%" DropDownBoxBoxHeight="120" />
            ...
            <tr>
                      <td class="CellFormat">Category</td>
                    <td class="CellTextBox"><asp:DropDownList ID="ddlCategory" runat="server" CssClass="chzn-select" Width="60%" Height="25px" AppendDataBoundItems="True">
                                          <asp:ListItem Text="--SELECT--" Value="-1" />
         ...
         <%--  <tr>
                    ...
                    <td class="CellTextBox" colspan="2">  <asp:CheckBox ID="chkContinuousContracts" runat="server"  Text="Include Continuous Contracts that are Due to Generate New Schedule" Font-Size="15px" Font-Names="Calibri" Font-Bold="True" BorderColor="White" BorderWidth="4px" Checked="false" />
            </td>
                    <td class="CellTextBox">  &nbsp;</td>
                  </tr>--%>
                            ...
                            <tr>
                                <td rowspan="2"><asp:ListBox ID="lstSort1" runat="server" width="120px" Rows="5" SelectionMode="Multiple">
                                    ...
                                    <asp:ListItem Text="Account Name" Value="CustName">Account Name</asp:ListItem>
                                     <asp:ListItem Text="ExpiryDate" Value="EndDate">Expiry Date</asp:ListItem>
...
<td><asp:Button ID="btnSort2" runat="server" Text="<<" /></td>
           ...
           <tr>
               ...
               <asp:Button ID="btnPrintServiceContractList" runat="server" CssClass="button" BackColor="#CFC6C0"  Font-Bold="True" Text="Print" Width="100px"/>
                  ...
                  <td style="text-align:LEFT"> <asp:Button ID="btnCloseServiceContractList" runat="server" CssClass="button" BackColor="#CFC6C0"  Font-Bold="True" Text="Cancel" Width="100px" />
                      </td>
