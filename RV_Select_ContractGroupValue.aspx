<%@ Page Title="Contract Group Value Report" Language="VB" MasterPageFile="~/MasterPage_Report.master" AutoEventWireup="false" CodeFile="RV_Select_ContractGroupValue.aspx.vb" Inherits="RV_Select_ContractGroupValue" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold; color: #000099;">CONTRACT GROUP VALUE REPORT</h4>
