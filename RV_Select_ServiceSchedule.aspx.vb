...
Partial Class RV_Select_ServiceSchedule
    ...
    Protected Sub btnPrintServiceSchedule_Click(sender As Object, e As EventArgs) Handles btnPrintServiceSchedule.Click
        ...
        If rdbFormat.SelectedValue = "Format1" Then
            Session.Add("ReportType", "ServiceSchedule")
            Response.Redirect("RV_ServiceSchedule.aspx")
        ElseIf rdbFormat.SelectedValue = "Format2" Then
            Session.Add("ReportType", "ServiceSchedule_Format2")
            Response.Redirect("RV_ServiceSchedule_Format2.aspx")
        ElseIf rdbFormat.SelectedValue = "Format3" Then
            Session.Add("ReportType", "ServiceSchedule_Format3")
            Response.Redirect("RV_ServiceSchedule_Format3.aspx")
        ElseIf rdbFormat.SelectedValue = "Format4" Then
            Session.Add("ReportType", "ServiceSchedule_Format4")
            Response.Redirect("RV_ServiceSchedule_Format4.aspx")
        End If
    ...
    Protected Sub btnCloseServiceSchedule_Click(sender As Object, e As EventArgs) Handles btnCloseServiceSchedule.Click
        txtSchDateFrom.Text = ""
        txtSchDateTo.Text = ""
    ...
    Public Sub InsertIntoTblWebEventLog(events As String, errorMsg As String, ID As String)
        Try
            ...
            insCmds.Parameters.AddWithValue("@LoginId", "ServiceScheduleReport")
    ...
    Protected Sub btnExportToExcel_Click(sender As Object, e As EventArgs) Handles btnExportToExcel.Click
        ...
        If GetData() = True Then
            ...
            'Return
            InsertIntoTblWebEventLog("Excel", "Test", "1")

            Dim dt As DataTable = GetDataSet()
            InsertIntoTblWebEventLog("Excel", "Test", "2")

            WriteExcelWithNPOI(dt, "xlsx")
            InsertIntoTblWebEventLog("Excel", "Test", "3")
    ...
    Private Function GetData() As Boolean
        ...
        qry = qry + " and tblservicerecord.Status in ('O')"
    ...
    Public Sub WriteExcelWithNPOI(ByVal dt As DataTable, ByVal extension As String)
        ...
        If Convert.ToString(Session("LocationEnabled")) = "Y" Then
            For i As Integer = 0 To dt.Rows.Count - 1
                ...
                For j As Integer = 0 To dt.Columns.Count - 1
                    ...
                    ElseIf j = 9 Or j = 23 Or j = 26 Or j = 28 Then
                        If String.IsNullOrEmpty(dt.Rows(i)(j).ToString) = False Then
            ...
            For i As Integer = 0 To dt.Rows.Count - 1
                ...
                For j As Integer = 0 To dt.Columns.Count - 1
                    ...
                    If j = 12 Or j = 13 Then
                        ...
                        End If
                        cell.CellStyle = _doubleCellStyle
                    ElseIf j = 8 Or j = 22 Or j = 25 Or j = 27 Then
                        If String.IsNullOrEmpty(dt.Rows(i)(j).ToString) = False Then
                            Dim d As DateTime = Convert.ToDateTime(dt.Rows(i)(j).ToString())
                            cell.SetCellValue(d)
                            'Else
        ...
        Using exportData = New MemoryStream()
            ...
            If extension = "xlsx" Then
                ...
                Response.AddHeader("Content-Disposition", String.Format("attachment;filename={0}", "ScheduledServiceRecordListing.xlsx"))
                Response.BinaryWrite(exportData.ToArray())
            ElseIf extension = "xls" Then
                Response.ContentType = "application/vnd.ms-excel"
                Response.AddHeader("Content-Disposition", String.Format("attachment;filename={0}", "ScheduledServiceRecordListing.xls"))
