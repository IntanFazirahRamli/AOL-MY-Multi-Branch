<%@ Page Language="vb" AutoEventWireup="false" CodeFile="RV_SvcRecDetailListingByStaff.aspx.vb" 
    Inherits="RV_SvcRecDetailListingByStaff" MasterPageFile="~/MasterPage.Master"
    Title="Service Record Detail Listing By Staff" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div style="text-align:center">
        <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">Service Record Details Listing By Staff</h3>
    <br />
        ...
        <tr>
            <td colspan="2">
                ...
                <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                    <Report FileName="Reports\ServiceRecordReports\SvcRecDetailListingByStaff.rpt">
                    </Report>
