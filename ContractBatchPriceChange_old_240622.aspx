<%@ Page Title="Mass Change of Contract Price" Language="vb" AutoEventWireup="false" CodeFile="ContractBatchPriceChange_old_240622.aspx.vb" Inherits="ContractBatchPriceChange_old_240622" MasterPageFile="~/MasterPage.Master" Culture="en-GB" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
               ...
               <tr style="text-align:center;width:100%">
                <td style="text-align:center;padding-left:5px;" colspan="8">
                     ...
                     <table border="0" style="width:100%;text-align:center;padding-left:10px;padding-top:0px; padding-bottom:2px; margin-bottom:2px; ">
                           ...
                           <tr>
                                        <td style="width: 9%; font-size: 15px; font-weight: bold; font-family: 'Calibri'; color: black; text-align: left;" >Contract Group</td>
                                           <td style="text-align: left; width:15%" >
                                               <asp:DropDownList ID="ddlContractGrp" runat="server" AppendDataBoundItems="True" Height="22px" Width="95%" AutoPostBack="True">
                                                 <asp:ListItem>--SELECT--</asp:ListItem>
                                             </asp:DropDownList>
                                        </td>
                                        <td style="width: 5%; font-size: 15px; font-weight: bold; font-family: 'Calibri'; color: black; text-align: left;">% Change</td>
                                       <td style="text-align: left; width:8%" >
                                            <asp:TextBox ID="txtPercChange" runat="server" MaxLength="50" Height="16px" Width="100px"
                                       ...
                                       <td style="text-align: left; width:12%" >
                                        ...
                                        <td style="width: 16%; font-size: 15px; font-weight: bold; font-family: 'Calibri'; color: black; text-align: left; padding-left:1%">
                                            
                                            <asp:CheckBox ID="chkUpdateServiceRecords" runat="server" Text="Update Service Records" />
                                  ...
                                  <td style="width:1%; font-size: 15px; font-weight: bold; font-family: 'Calibri'; color: black; text-align: right; padding-left:0%">
                                   ...
                                   <asp:Label ID="lblIncreaseDecrease" runat="server" ForeColor="Red"></asp:Label>
                                        ...
                                        <td style="text-align: left; width: 10%">
                                             <asp:Button ID="btnQuit0" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="QUIT" Visible="False" Width="100px" />
                    ...
                    <%--'26.02--%> 
                     ...
                     <table border="0" style="width:100%;text-align:center;padding-left:10px;padding-top:5px; margin-top:5px;">
                                     ...
                                     <tr style="padding-top: 2px;">
                                        <td style="width: 9%; text-align: left; font-size: 15px; font-weight: bold; font-family: 'Calibri'; color: black;" >Contract No.</td>
                                        ...
                                        <td style="width: 6%; text-align: left; font-size: 15px; font-weight: bold; font-family: 'Calibri'; color: black;">Account ID</td>
                                        <td  style="text-align: left; width:10%" >
                                            <asp:TextBox ID="txtClient" runat="server" Height="16px" Width="70%" AutoCompleteType="Disabled"></asp:TextBox>
                                            <asp:ImageButton ID="imgbtnClient" runat="server" CssClass="righttextbox" ImageUrl="~/Images/searchbutton.jpg" Height="22" Width="24" />
                                        </td>

                                        <td style="width: 8%; text-align: right; font-size: 15px; font-weight: bold; font-family: 'Calibri'; color: black;">Name</td>
                                        <td style="text-align: left; width:18%" >
                                            <asp:TextBox ID="txtName" runat="server" Height="16px" Width="80%" AutoCompleteType="Disabled"></asp:TextBox>
                                           <asp:ImageButton ID="ImageButton2" runat="server" CssClass="righttextbox" ImageUrl="~/Images/searchbutton.jpg" Height="22" Width="24" />
  ...
  --%>         <asp:Panel ID="pnlServiceRecord" runat="server" BackColor="White" BorderColor="#003366" BorderWidth="1" Height="280px" ScrollBars="Auto" style="text-align:center; width:99%; margin-left:auto; margin-right:auto;"    Visible="true" >
                        ...
                        <tr style="text-align: center;">
                            <td style="width: 100%; text-align: left">
                                ...
                                <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" AutoGenerateColumns="False" 
                                      Font-Size="14px"  CellPadding="1" CellSpacing="2" DataKeyNames="" 
              ...
              <asp:TemplateField HeaderText="Status"><ItemTemplate><asp:TextBox ID="txtStatusGV" runat="server" Text='<%# Bind("Status")%>' Font-Size="12px" ReadOnly="true" BackColor="#CCCCCC" BorderStyle="None" Height="18px" style="text-align:center" Width="35px"></asp:TextBox></ItemTemplate></asp:TemplateField>
                 ...
                 <asp:TemplateField HeaderText="Contract No."><ItemTemplate><asp:TextBox ID="txtContractNoGV" runat="server" Text='<%# Bind("ContractNo")%>' Font-Size="12px" ReadOnly="true" BackColor="#CCCCCC" BorderStyle="None" Height="18px"  Width="160px"></asp:TextBox></ItemTemplate></asp:TemplateField>
             <asp:TemplateField HeaderText="Contract Group"><ItemTemplate><asp:TextBox ID="txtContractGroupGV" runat="server" Text='<%# Bind("ContractGroup")%>' Font-Size="12px" ReadOnly="true" BackColor="#CCCCCC" BorderStyle="None" Height="18px"  Width="95px"></asp:TextBox></ItemTemplate></asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Name"><ItemTemplate><asp:TextBox ID="txtClientNameGV" runat="server" Text='<%# Bind("CustName")%>' Font-Size="12px" ReadOnly="true" BackColor="#CCCCCC" BorderStyle="None" Height="18px"  Width="260px"></asp:TextBox></ItemTemplate></asp:TemplateField>
             ...
             <asp:TemplateField HeaderText="Service Address"><ItemTemplate><asp:TextBox ID="txtServiceAddressGV" runat="server" Text='<%# Bind("ServiceAddress")%>' Font-Size="12px" ReadOnly="true" BackColor="#CCCCCC" BorderStyle="None" Height="18px"  Width="300px"></asp:TextBox></ItemTemplate></asp:TemplateField>
            
               <asp:TemplateField HeaderText="Total Service Value"><ItemTemplate><asp:TextBox ID="txtTotalServiceValueGV" runat="server" Text='0.00' Font-Size="12px" ReadOnly="false"  BorderStyle="None" BackColor="#CCCCCC" style="text-align:right" Height="18px" Width="85px" Align="right"></asp:TextBox></ItemTemplate></asp:TemplateField>
                   
                <asp:TemplateField HeaderText="Current Contract Value"><ItemTemplate><asp:TextBox ID="txtAgreeValueGV" runat="server" Text='<%# Bind("AgreeValue")%>' Font-Size="12px" ReadOnly="true" BackColor="#CCCCCC" BorderStyle="None" style="text-align:right" Height="18px" Width="95px" Align="right"></asp:TextBox></ItemTemplate></asp:TemplateField>
               <asp:TemplateField HeaderText="New Contract Value"><ItemTemplate><asp:TextBox ID="txtNewAgreeValueGV" runat="server" Text='0.00' Font-Size="12px" ReadOnly="false"  BorderStyle="None" BackColor="#CCCCCC" style="text-align:right" Height="18px" Width="85px" Align="right"></asp:TextBox></ItemTemplate></asp:TemplateField>
