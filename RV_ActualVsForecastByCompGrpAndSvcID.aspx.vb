...
Partial Class RV_ActualVsForecastByCompGrpAndSvcID
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Dim repPath As String = Server.MapPath("~/Reports/RevenueReports/ActualVsForecastRevenueByCompGrpAndSvcID.rpt")
