<%@ Page Title="Manpower Productivity by Team Member - Normal & OT Hour Report Selection" Language="VB" MasterPageFile="~/MasterPage_Report.master" AutoEventWireup="false" CodeFile="RV_Select_ManpowerProductivityByTeamMember_NormalOT.aspx.vb" Inherits="RV_Select_ManpowerProductivityByTeamMember_NormalOT" Culture="en-GB" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <script type="text/javascript">
     ...
     <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" ScriptMode="Release">
       ...
       <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">MANPOWER PRODUCTIVITY BY TEAM MEMBER - NORMAL & OVERTIME REPORT</h4>
                 ...
                 <tr>
                    <td class="CellTextBox" colspan="3" style="padding-left: 30%;padding-top:20px;padding-bottom:20px; text-align:left; width:600px; word-spacing: 20px; text-indent: 40px;">
                      <asp:RadioButtonList ID="rdbSelect" runat="server" CellPadding="2" CellSpacing="2" RepeatDirection="Horizontal" Width="350px" Visible="true">
                          <asp:ListItem Selected="false">Detail</asp:ListItem>
