<%@ Page Title="Sales Commission Report" Language="VB" MasterPageFile="~/MasterPage_Report.master" AutoEventWireup="false" CodeFile="RV_Select_SalesCommission.aspx.vb" Inherits="RV_Select_SalesCommission" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <table style="width:100%;text-align:center;">
        <tr>
            <td colspan="2">
                  <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">COMMISSION LISTING REPORT</h4>
      ...
      <table style="width:100%;font-family: Calibri; font-size: 15px; font-weight: bold; color: black;text-align:center;padding-left:0%;line-height:20px;">
            <tr style="text-align:center;">
                      <td class="CellFormat" style="width:40%">AccountingPeriod</td>
           ...
           <tr style="text-align:center;">
             ...
             <tr>
                ...
                <asp:CheckBox ID="chkIncludeJournalEntries" runat="server" Text="Include Journal Transactions" TextAlign="Right" Font-Bold="True" Font-Names="Calibri" ForeColor="Black" />
         ...
         <tr><td colspan="3"><br /><br /></td></tr>
              ...
              <tr>
                  <td colspan="3" style="text-align:center; ">
                     ...
                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   <asp:Button ID="btnCancel" runat="server" CssClass="button" BackColor="#CFC6C0"  Font-Bold="True" Text="Cancel" Width="100px" />
              </td>
              </tr>
        </table>
