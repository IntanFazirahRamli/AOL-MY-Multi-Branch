<%@ Page Title="Event Log" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EventLog.aspx.vb" Inherits="EventLog" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      ...
      <div style="text-align:center">
        ...
        <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">Event Log</h3>
          </div>
...
<asp:Button ID="btnDelete" runat="server"  CssClass="button" BackColor="#CFC6C0"  Font-Bold="True" Text="DELETE" Width="100px" OnClientClick = "Confirm()"/>
     ...
     <td colspan="2" style="text-align:right">
        ...
        <table id="tablesearch" runat="server" style="border: 1px solid #CC3300; text-align:right; padding:2px; border-radius: 25px;width:100%; height:120px; background-color: #F3F3F3;">
            <tr>
                  <td class="CellFormatSearch" style="text-align:left;">Module</td>
                <td class="CellTextBoxSearch" style="width:6%">
                    <asp:TextBox ID="txtModule" runat="server" Width="80%"></asp:TextBox> <asp:ImageButton ID="btnImgModule" runat="server" CssClass="righttextbox" ImageUrl="~/Images/searchbutton.jpg"
                                    Height="22px" Width="24px" ImageAlign="TOP" /></td>
                  <td class="CellFormatSearch" style="text-align:left;">StaffID</td>
                <td class="CellTextBoxSearch" style="width:6%">
                    <asp:TextBox ID="txtStaffID" runat="server" Width="80%"></asp:TextBox> <asp:ImageButton ID="btnImgStaff" runat="server" CssClass="righttextbox" ImageUrl="~/Images/searchbutton.jpg"
                                    Height="22px" Width="24px" ImageAlign="TOP" /></td>
                 <td class="CellFormatSearch" style="text-align:left;">DocRefNo</td>
                <td class="CellTextBoxSearch" style="width:6%">
                    <asp:TextBox ID="txtDocRefNo" runat="server" Width="95%"></asp:TextBox></td>
                 <td class="CellFormatSearch" style="text-align:left;">AccountID</td>
                <td class="CellTextBoxSearch" style="width:6%">
                    <asp:TextBox ID="txtAccountID" runat="server" Width="95%"></asp:TextBox></td>
            </tr>
             <tr>
                ...
                <td class="CellTextBoxSearch" style="width:6%">
                    ...
                    <td class="CellFormatSearch" style="text-align:left;" rowspan="2">Comments</td>
                <td class="CellTextBoxSearch" style="width:6%" colspan="4" rowspan="2">
                    <asp:TextBox ID="txtComments" runat="server" Width="99%" Height="90%"></asp:TextBox></td>
             ...
             <tr>
                ...
                <td class="CellTextBoxSearch" style="width:6%">
                    <asp:TextBox ID="txtDateTo" runat="server" Width="95%"></asp:TextBox><asp:CalendarExtender ID="CalendarExtender2" runat="server" PopupButtonID="txtDateTo" TargetControlID="txtDateTo" Format="dd/MM/yyyy" Enabled="True"></asp:CalendarExtender></td>
      ...
      <asp:GridView ID="GridView1" runat="server" CssClass="Centered" AutoGenerateColumns="False" DataKeyNames="Rcno" DataSourceID="SqlDataSource1" AllowPaging="True">
          <Columns>
             ...
             <ControlStyle Width="80px" />
              ...
              <asp:BoundField DataField="DocRef" HeaderText="DocRef" SortExpression="DocRef" >
              ...
              <asp:BoundField DataField="BaseValue" HeaderText="BaseValue" SortExpression="BaseValue" >
                <ItemStyle HorizontalAlign="Right" />
                </asp:BoundField>
              <asp:BoundField DataField="BaseGSTValue" HeaderText="BaseGSTValue" SortExpression="BaseGSTValue" >
                <ItemStyle HorizontalAlign="Right" />
                </asp:BoundField>
              <asp:BoundField DataField="CustCode" HeaderText="AccountID" SortExpression="CustCode" >
                   <ControlStyle Width="100px" />
              ...
              <asp:BoundField DataField="SOURCESQLID" HeaderText="SOURCESQLID" SortExpression="SOURCESQLID" Visible="False" />
     ...
     <asp:Panel ID="pnlModule" runat="server" BackColor="White" Width="45%" Height="80%" BorderColor="#003366" BorderWidth="1px" ScrollBars="Auto">
         <table><tr>
                               ...
                               <asp:TextBox ID="txtPopUpModule" runat="server" MaxLength="50" Height="16px" Width="400px" Text = "Search Here for Module" ForeColor = "Gray" onblur = "WaterMarkModule(this, event);" onfocus = "WaterMarkModule(this, event);" AutoPostBack="True"></asp:TextBox>
      ...
      <asp:Panel ID="pnlStaff" runat="server" BackColor="White" Width="45%" Height="80%" BorderColor="#003366" BorderWidth="1px" ScrollBars="Auto">
         <table><tr>
                               ...
                               <td style="width:1%;text-align:right;"><asp:ImageButton ID="btnPnlStaffClose" runat="server" ImageUrl="~/Images/closebutton.png" Height="27px" Width="30px" /></td></tr>
                                  <tr>
                               <td colspan="2" style="font-size:15px;font-weight:bold;font-family:'Calibri';color:black;text-align:center;">
                               <asp:TextBox ID="txtPopUpStaff" runat="server" MaxLength="50" Height="16px" Width="400px" Text = "Search Here for Staff" ForeColor = "Gray" onblur = "WaterMarkStaff(this, event);" onfocus = "WaterMarkStaff(this, event);" AutoPostBack="True"></asp:TextBox>
     ...
     <asp:ModalPopupExtender ID="mdlPopupStaff" runat="server" CancelControlID="btnPnlStaffClose" PopupControlID="pnlStaff" TargetControlID="dummy" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
      ...
      <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>" SelectCommand="SELECT * FROM tbleventlog order by logdate desc"></asp:SqlDataSource>
