<%@ Page Title="Recurring Sales Invoice Listing" Language="VB" MasterPageFile="~/MasterPage_Report.master" AutoEventWireup="false" CodeFile="RV_Select_RecurringSales.aspx.vb" Inherits="RV_Select_RecurringSales" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
      ...
      <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" ScriptMode="Release">
       ...
       <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">RECURRING SALES INVOICE LISTING REPORT</h4>
...
<%--            <tr>
     ...
     <Style2 SelectBoxWidth="25.5%" DropDownBoxBoxWidth="25.5%" DropDownBoxBoxHeight="120" />
           ...
           <tr>
                    ...
                    <td class="CellTextBox"> <asp:DropDownList ID="ddlFrequency" runat="server" CssClass="chzn-select" DataSourceID="SqlDSFrequency" DataTextField="Frequency" DataValueField="Frequency" Width="25.5%" Height="25px" AppendDataBoundItems="True">
                ...
                <asp:Panel ID="Panel2" runat="server" Height="90%" BorderStyle="Solid" BorderColor="#CCCCCC" BorderWidth="2px" Width="80%" HorizontalAlign="Center">
                    <div style="padding-left: 20px; text-align: left; padding-bottom: 10px;">
                        <asp:RadioButtonList ID="rbtnSelect" runat="server" CellSpacing="5" CellPadding="5" RepeatDirection="Vertical" RepeatColumns="4" Width="90%">
                              ...
                              <asp:ListItem Text="CompanyGroup" Value="2" Enabled="TRUE"></asp:ListItem>                       
                        
                            <asp:ListItem Text="BillingFrequency" Value="3" Enabled="TRUE"></asp:ListItem>
