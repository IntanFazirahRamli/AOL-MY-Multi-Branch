<%@ Page Language="vb" AutoEventWireup="false" CodeFile="RV_NewContract02.aspx.vb" MasterPageFile="~/MasterPage.Master"
    Inherits="RV_NewContract02" Title="New Service Contract Listing by Contract Group" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
      <div style="text-align:center">
        <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">New Service Contract Listing By Contract Group</h3>
    <br />
    <table style="width: 100%; text-align: center;">
           <tr>
             <td style="text-align:left">
                  ...
                  <a href="RV_Export_NewContract.aspx" target="_blank"><button class="button" style="background-color:#CFC6C0;font-weight:bold;width:100px;font-family:Calibri;font-size:14px;" type="button">View as PDF</button></a>
        ...
        <tr>
            <td colspan="2">
                ...
                <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                    <Report FileName="Reports\ServiceContractReports\NewContract02.rpt">
                    </Report>
