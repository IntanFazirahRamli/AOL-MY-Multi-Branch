<%@ Page Title="Manpower Productivity by Team Member Report Selection" Language="VB" MasterPageFile="~/MasterPage_Report.master" AutoEventWireup="false" CodeFile="RV_Select_ManpowerProductivityByTeamMember_New.aspx.vb" Inherits="RV_Select_ManpowerProductivityByTeamMember_New" %>
...
<%--            <tr>
     ...
     <Style2 SelectBoxWidth="35.5%" DropDownBoxBoxWidth="35.5%" DropDownBoxBoxHeight="120" />
                 ...
                 <tr>
                    <td class="CellTextBox" colspan="3" style="padding-left: 20%;padding-top:20px;padding-bottom:20px; text-align:left; width:600px; word-spacing: 20px; text-indent: 40px;">
