...
Public Class RV_MasterLocationGroup
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                Dim repPath As String = Server.MapPath("~/Reports/AdministrationReports/Rpt_Master_LocationGroup.rpt")
                crReportDocument.Load(repPath)
                Dim selectFormula As String = "{tblLocationGroup1.RcNo} <> 0"
    ...
    Protected Sub btnQuit_Click(sender As Object, e As EventArgs)
        Response.Redirect("Master_LocationGroup.aspx")
    End Sub
End Class