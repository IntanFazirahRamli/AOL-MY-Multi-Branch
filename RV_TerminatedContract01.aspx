<%@ Page Language="vb" AutoEventWireup="false" CodeFile="RV_TerminatedContract01.aspx.vb" MasterPageFile="~/MasterPage.Master"
     Inherits="RV_TerminatedContract01" Title="Terminated Service Contract Listing by Account ID" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div style="text-align:center">
        <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">Terminated Service Contract Listing By Account ID</h3>
    <br />
        ...
        <tr>
            <td colspan="2">
                ...
                <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                    <Report FileName="Reports\ServiceContractReports\TerminatedContract01.rpt">
                    </Report>
