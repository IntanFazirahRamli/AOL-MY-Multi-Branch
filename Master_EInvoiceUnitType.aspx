<%@ Page Title="E-Invoice Unit Type" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Master_EInvoiceUnitType.aspx.vb" Inherits="Master_EInvoiceUnitType"  enableeventvalidation="false" Culture="en-GB"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="text-align:center">
        ...
        <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">E-Invoice Unit Type</h3>
...
<asp:Button ID="btnDelete" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="DELETE" Width="100px" OnClientClick = "Confirm(); currentdatetime()"/>
                     <asp:Button ID="btnPrint" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0" visible="false" Font-Bold="True" Text="PRINT" Width="100px" />
          ...
          <tr>
            ...
            <tr>
                               ...
                               <td class="CellFormatADM">Unit Code<asp:Label ID="Label23" runat="server" visible="true" Font-Size="14px" ForeColor="Red" Text="*" Height="20px"></asp:Label></td>
                     

                    <td class="CellTextBoxADM"> <asp:TextBox ID="txtUnitCode" runat="server" MaxLength="25" Height="16px" Width="30%"></asp:TextBox></td>
                     
                   
                 </tr>
              <tr>
                                            
                    <td class="CellFormatADM">Name</td>
                     

                    <td class="CellTextBoxADM"><asp:TextBox ID="txtName" runat="server" MaxLength="100" Height="16px" Width="70%"></asp:TextBox></td>
...
<asp:Button ID="btnCancel" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="CANCEL" Width="100px" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>" SelectCommand="SELECT * FROM tblEInvoiceMalaysiaUnitType where rcno<>0"></asp:SqlDataSource>
