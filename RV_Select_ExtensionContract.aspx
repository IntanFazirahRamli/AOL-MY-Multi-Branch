<%@ Page Title="Extension Contract Report" Language="VB" MasterPageFile="~/MasterPage_Report.master" AutoEventWireup="false" CodeFile="RV_Select_ExtensionContract.aspx.vb" Inherits="RV_Select_ExtensionContract" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <script type="text/javascript">
      ...
      <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" ScriptMode="Release">
       ...
       <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">EXTENSION SERVICE CONTRACT LISTING REPORT</h4>
...
<%--            <tr>
      ...
      <table style="width:100%;font-family: Calibri; font-size: 15px; font-weight: bold; color: black;text-align:left;padding-left:20px;line-height:20px;">
                      ...
                      <td colspan="2" style="width:75%">
                            <asp:checkboxlist ID="chkStatusSearch" runat="server" Width="100%" RepeatDirection="Horizontal" RepeatLayout="Table" RepeatColumns="3" CellPadding="3" CellSpacing="3" TextAlign="Right" Enabled="True">
                                 ...
                                 <asp:ListItem Selected="true" Value="O">O - Open</asp:ListItem>
                                   ...
                                   <asp:ListItem Selected="true" Value="T">T - Terminated</asp:ListItem>
             ...
             <tr>
                      <td class="CellFormat">ActualEndDate</td>
