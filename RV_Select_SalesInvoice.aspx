<%@ Page Title="Sales Invoice Listing" Language="VB" MasterPageFile="~/MasterPage_Report.master" EnableEventValidation="false" AutoEventWireup="false" CodeFile="RV_Select_SalesInvoice.aspx.vb" Inherits="RV_Select_SalesInvoice" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <table style="width:100%;">
        <tr>
            <td colspan="2">
                  <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">SALES INVOICE LISTING REPORT</h4>
      ...
      <table style="width:100%;font-family: Calibri; font-size: 15px; font-weight: bold; color: black;text-align:left;padding-left:50px;line-height:20px;">
            ...
            <tr>
                    ...
                    <td class="CellTextBox"><asp:TextBox ID="txtInvoiceNoFrom" runat="server" MaxLength="20" Height="16px" Width="85.5%"></asp:TextBox>                        
                                </td>
                 <td class="CellFormat" style="text-align: right; ">TO</td>
                    <td class="CellTextBox"><asp:TextBox ID="txtInvoiceNoTo" runat="server" MaxLength="20" Height="16px" Width="85.5%"></asp:TextBox>                        
                                 </td>
     ...
     <Style2 SelectBoxWidth="85.5%" DropDownBoxBoxWidth="85.5%" DropDownBoxBoxHeight="120" />
              ...
              <tr>
                    ...
                    <td class="CellTextBox"><asp:DropDownList ID="ddlPaidStatus" runat="server" Width="86%" Height="20px" AutoPostBack="true" CssClass="chzn-select" >
                                ...
                                </asp:DropDownList><br />           <asp:CheckBox ID="chkVoid" runat="server" Text="Include Void" TextAlign="Left" Font-Bold="True" Font-Names="Calibri" ForeColor="Black" />
              
                                 </td>
                      <td class="CellFormat" style="text-align: right; ">Status</td>
                    <td class="CellTextBox"><asp:DropDownList ID="ddlStatus" runat="server" Width="85.5%" Height="25px">
                         ...
                         <asp:ListItem Value="P" Selected="true">P - Posted</asp:ListItem>
                           ...
                           <asp:TextBox ID="txtGLStatus" runat="server" MaxLength="1" Visible="false" Height="16px" Width="85.5%"></asp:TextBox>                        
...
<td colspan="1" style="text-align: right; padding-right: 50px;"><asp:Button ID="btnSort2" runat="server" Text="<<" /></td>
           ...
           <br />     </td>
              ...
              <tr>
                  <td colspan="4" style="text-align:center; ">
                              <asp:Button ID="btnEmailSalesInv" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="Email Report" Width="120px" Visible="true" OnClientClick="clearLabelValue();"/>
                  ...
                  <td style="text-align:LEFT">   <asp:Button ID="btnCancel" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="Cancel" Width="100px" />
              </td>
              </tr>
        </table>
    ...
    <asp:TextBox ID="txtQueryGst" runat="server" CssClass="dummybutton" ></asp:TextBox>
