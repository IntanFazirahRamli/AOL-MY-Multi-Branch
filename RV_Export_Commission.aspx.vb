...
Partial Class RV_Export_Commission
        ...
        Try
            If Not IsPostBack Then
                btnQuit.Attributes.Add("onClick", "javascript:history.back(); return false;")
                    ...
                    crReportDocument.Load(Server.MapPath("~/Reports/ARNewReports/CommissionReports/CommissionReportListing.rpt"))
                ...
                Dim FilePath As String = Server.MapPath("~/PDFs/" + Convert.ToString(Session("UserID") + "_SalesInvListing.PDF"))
                ...
                If FileBuffer IsNot Nothing Then
                    ...
                    Response.AddHeader("content-disposition", "inline; filename=SalesInvListing.pdf")
