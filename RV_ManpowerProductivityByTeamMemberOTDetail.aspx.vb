...
Public Class RV_ManpowerProductivityByTeamMemberOTDetail
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                Dim repPath As String = Server.MapPath("~/Reports/ManagementReports/ManpowerProductivityByTeamMemberOTDetail.rpt")
