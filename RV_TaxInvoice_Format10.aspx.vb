...
Partial Class RV_TaxInvoice_Format10
        ...
        Try
            If Not IsPostBack Then
                ...
                If Convert.ToString(Session("InvoiceType")) = "Invoice" Then
                    If Request.QueryString("Export") = "PDF" Then
                        crReportDocument.Load(Server.MapPath("~/Reports/ARReports/TaxInvoice_Format10.rpt"))
                ...
                Else
                    If Request.QueryString("Export") = "PDF" Then
                        crReportDocument.Load(Server.MapPath("~/Reports/ARReports/TaxInvoiceE_Format10.rpt"))
                    ElseIf Request.QueryString("Export") = "Word" Or Request.QueryString("Export") = "View" Then
                        crReportDocument.Load(Server.MapPath("~/Reports/ARReports/TaxInvoiceE_Format10_New.rpt"))
                    End If
