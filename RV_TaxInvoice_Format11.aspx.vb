...
Partial Class RV_TaxInvoice_Format11
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                CType(Me.Master, MasterPage).EventLog_Insert(Session("UserID"), "TAX INVOICE FORMAT-11", Left(Convert.ToString(Session("InvoiceNumber")), 50), "ADD", DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss", New System.Globalization.CultureInfo("en-GB")), 0, 0, 0, Left(Convert.ToString(Session("InvoiceNumber")), 20), "", "")
                ...
                If Request.QueryString("Export") = "PDF" Or Request.QueryString("Export") = "View" Then
                    ...
                    Else
                        ...
                        End If
                    End If
                    ' InsertIntoTblWebEventLog("Page_Load3", FileBuffer.Length.ToString, txtFileType.Text)
    ...
    Private Sub InsertIntoTblWebEventLog(events As String, errorMsg As String, ID As String)
        Try
            ...
            insCmds.Parameters.AddWithValue("@LoginId", "RV-TAXINVOICE11 - " + Session("userid"))
