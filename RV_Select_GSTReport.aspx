<%@ Page Title="GST Output Tax Report" Language="VB" MasterPageFile="~/MasterPage_Report.master" AutoEventWireup="false" CodeFile="RV_Select_GSTReport.aspx.vb" Inherits="RV_Select_GSTReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
      ...
      <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" ScriptMode="Release">
       ...
       <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">GST OUTPUT TAX REPORT</h4>
...
<%--            <tr>
      ...
      <table style="width:100%;font-family: Calibri; font-size: 15px; font-weight: bold; color: black;text-align:left;padding-left:50px;line-height:20px;">
         ...
         <%--    <tr>
                    ...
                    <td class="CellTextBox"><asp:TextBox ID="txtInvDateFrom" runat="server" MaxLength="10" Height="16px" Width="11.5%"></asp:TextBox>                        
                                 <asp:CalendarExtender ID="CalendarExtender3" runat="server" PopupButtonID="txtInvDateFrom" TargetControlID="txtInvDateFrom" Format="dd/MM/yyyy" Enabled="True"></asp:CalendarExtender> &nbsp;TO&nbsp; <asp:TextBox ID="txtInvDateTo" runat="server" MaxLength="10" Height="16px" Width="11.5%"></asp:TextBox>                        
     ...
     <Style2 SelectBoxWidth="25.5%" DropDownBoxBoxWidth="25.5%" DropDownBoxBoxHeight="120" />
              ...
              <tr>
                      <td class="CellFormat">BillingPeriod</td>
                    <td class="CellTextBox"> <asp:TextBox ID="txtBillingPeriod" runat="server" MaxLength="10" Height="16px" Width="25%"></asp:TextBox> 
                           </td>
                 
                  </tr>
           <tr>
                      <td class="CellFormat">Tax Code</td>
                    <td class="CellTextBox"> <asp:DropDownList ID="ddlTaxCode" runat="server" CssClass="chzn-select" DataSourceID="SqlDSTaxCode" DataTextField="TaxType" DataValueField="TaxType" Width="25.5%" Height="25px" AppendDataBoundItems="True">
                ...
                <asp:Panel ID="Panel2" runat="server" Height="90%" BorderStyle="Solid" BorderColor="#CCCCCC" BorderWidth="2px" Width="80%" HorizontalAlign="Center">
                    <div style="padding-left: 20px; text-align: left; padding-bottom: 10px;">
                        <asp:RadioButtonList ID="rbtnSelect" runat="server" CellSpacing="5" CellPadding="5" RepeatDirection="Vertical" RepeatColumns="4" Width="90%">
                               <asp:ListItem Text="BillingPeriod" Value="1" Selected="true"></asp:ListItem>
                              <asp:ListItem Text="InvoiceNo" Value="2"></asp:ListItem>                       
                        
                             <asp:ListItem Text="ReceiptDate" Value="3"></asp:ListItem>
...
<%--                    <asp:BoundField DataField="Address1" >
    ...
    <asp:SqlDataSource ID="SqlDSTaxCode" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>" SelectCommand="SELECT * FROM tbltaxtype WHERE ARIN = 1"></asp:SqlDataSource>
