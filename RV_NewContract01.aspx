<%@ Page Language="vb" AutoEventWireup="false" CodeFile="RV_NewContract01.aspx.vb" MasterPageFile="~/MasterPage.Master"
    Inherits="RV_NewContract01" Title="New Service Contract Listing By Account ID" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
      <div style="text-align:center">
        <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">New Service Contract Listing By Account ID</h3>
    <br />
        ...
        <tr>
            <td colspan="2">
                ...
                <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                    <Report FileName="Reports\ServiceContractReports\NewContract01.rpt">
                    </Report>
