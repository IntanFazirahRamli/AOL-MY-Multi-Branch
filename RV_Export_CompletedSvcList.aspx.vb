...
Partial Class RV_Export_CompletedSvcList
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                If Convert.ToString(Session("ReportType")) = "CompletedSvcList01" Then

                    crReportDocument.Load(Server.MapPath("~/Reports/ServiceRecordReports/CompletedSvcList01.rpt"))
                
                ElseIf Convert.ToString(Session("ReportType")) = "CompletedSvcList02" Then

                    crReportDocument.Load(Server.MapPath("~/Reports/ServiceRecordReports/CompletedSvcList02.rpt"))
                
                ElseIf Convert.ToString(Session("ReportType")) = "CompletedSvcList03" Then

                    crReportDocument.Load(Server.MapPath("~/Reports/ServiceRecordReports/CompletedSvcList03.rpt"))
                ...
                Dim FilePath As String = Server.MapPath("~/PDFs/" + Convert.ToString(Session("UserID") + "_CompletedServiceRecord.PDF"))
