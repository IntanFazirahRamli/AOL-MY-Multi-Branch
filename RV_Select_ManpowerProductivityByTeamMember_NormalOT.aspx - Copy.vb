...
Partial Class RV_Select_ManpowerProductivityByTeamMember_NormalOT
    ...
    Private Sub GetData1()
        ...
        If rdbSelect.Text = "Detail" Then
            command2.CommandText = "delete from tblrptserviceanalysis where CREATEDBY='" + txtCreatedBy.Text.Trim + "' and Report='ProdTeamMemberNormalOTDet';"

        ElseIf rdbSelect.Text = "Summary" Then
            command2.CommandText = "delete from tblrptserviceanalysis where CREATEDBY='" + txtCreatedBy.Text.Trim + "' and Report='ProdTeamMemberNormalOTSumm';"
        ...
        If rdbSelect.SelectedValue = "Detail" Then
            For i As Integer = 0 To dt.Rows.Count - 1
                ...
                For j As Integer = 0 To dt.Columns.Count - 1
                    ...
                    If j = 8 Or j = 17 Or j = 18 Or j = 19 Or j = 21 Or j = 22 Or j = 23 Then
        ...
        ElseIf rdbSelect.SelectedValue = "Summary" Then
            For i As Integer = 0 To dt.Rows.Count - 1
                ...
                For j As Integer = 0 To dt.Columns.Count - 1
                    ...
                    If j = 2 Or j = 4 Or j = 5 Or j = 7 Or j = 9 Or j = 10 Or j = 12 Or j = 13 Or j = 14 Then
                        If String.IsNullOrEmpty(dt.Rows(i)(j).ToString) = False Then
                            Dim d As Double = Convert.ToDouble(dt.Rows(i)(j).ToString)
                            cell.SetCellValue(d)
                        Else
