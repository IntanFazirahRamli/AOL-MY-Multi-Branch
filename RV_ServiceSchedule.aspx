<%@ Page Title="Service Schedule Report" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="RV_ServiceSchedule.aspx.vb" Inherits="RV_ServiceSchedule" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <CR:CrystalReportSource ID="CRSServiceSchedule" runat="server">
        <Report FileName="Reports\ServiceRecordReports\ServiceSchedule.rpt">
        </Report>
