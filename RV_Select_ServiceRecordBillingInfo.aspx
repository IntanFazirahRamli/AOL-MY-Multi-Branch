<%@ Page Title="Service Records with Contract and Billing Info" Language="VB" MasterPageFile="~/MasterPage_Report.master" AutoEventWireup="false" CodeFile="RV_Select_ServiceRecordBillingInfo.aspx.vb" Inherits="RV_Select_ServiceRecordBillingInfo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
   ...
   <link rel="Stylesheet" type="text/css" href="CSS/DefaultStyles.css" />
      ...
      <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" ScriptMode="Release">
       ...
       <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">SERVICE RECORD WITH CONTRACT AND BILLING INFORMATION</h4>
...
<%--            <tr>
      ...
      <table style="width:100%;font-family: Calibri; font-size: 15px; font-weight: bold; color: black;text-align:left;padding-left:0px;line-height:20px;">
              <%--   <tr>
     ...
     <Style2 SelectBoxWidth="26.5%" DropDownBoxBoxWidth="26.5%" DropDownBoxBoxHeight="120" />
               ...
               <tr style="text-align:center">
                      <td class="CellFormat" style="text-align:right; width: 39%;">ServiceDate</td>
                    <td class="CellTextBox" style="text-align:left"><asp:TextBox ID="txtSvcDateFrom" runat="server" MaxLength="10" Height="16px" Width="150px"></asp:TextBox>                        
                                 <asp:CalendarExtender ID="CalendarExtender2" runat="server" PopupButtonID="txtSvcDateFrom" TargetControlID="txtSvcDateFrom" Format="dd/MM/yyyy" Enabled="True"></asp:CalendarExtender> &nbsp;TO&nbsp; <asp:TextBox ID="txtSvcDateTo" runat="server" MaxLength="10" Height="16px" Width="150px"></asp:TextBox>                        
