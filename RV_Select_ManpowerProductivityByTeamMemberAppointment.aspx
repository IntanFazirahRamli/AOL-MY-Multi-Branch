<%@ Page Title="Manpower Productivity by Team Member - Appointment & Vehicle" Language="VB" MasterPageFile="~/MasterPage_Report.master" AutoEventWireup="false" CodeFile="RV_Select_ManpowerProductivityByTeamMemberAppointment.aspx.vb" Inherits="RV_Select_ManpowerProductivityByTeamMemberAppointment" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <script type="text/javascript">
     ...
     <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" ScriptMode="Release">
       ...
       <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">MANPOWER PRODUCTIVITY BY TEAM MEMBER - APPOINTMENT & VEHICLE</h4>
...
<%--            <tr>
     ...
     <Style2 SelectBoxWidth="35%" DropDownBoxBoxWidth="35%" DropDownBoxBoxHeight="120" />                    
             ...
             <tr>
                      <td colspan="2" class="CellFormat" style="text-align:left;padding-left: 30%;padding-top:15px;">
            ...
            <tr>
                    <td class="CellTextBox" colspan="3" style="padding-left: 30%;padding-top:20px;padding-bottom:20px; text-align:left; width:600px; word-spacing: 20px; text-indent: 40px;">
                      <asp:RadioButtonList ID="rdbSelect" runat="server" CellPadding="2" CellSpacing="2" RepeatDirection="Horizontal" Width="350px" Visible="true">
                          <asp:ListItem Selected="true">Detail</asp:ListItem>
                          <asp:ListItem Selected="false">Summary</asp:ListItem>
