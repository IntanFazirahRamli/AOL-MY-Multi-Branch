...
Partial Class Master_EInvoiceClassificationID
    ...
    Private Sub DisableControls()
        ...
        txtClassificationID.Enabled = True
    ...
    Protected Sub GridView1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles GridView1.SelectedIndexChanged
        ...
        Else
            ...
            txtClassificationID.Text = Server.HtmlDecode(GridView1.SelectedRow.Cells(1).Text).ToString
        End If
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        If txtClassificationID.Text = "" Then
        ...
        If txtMode.Text = "New" Then
            Try
                ...
                command1.CommandText = "SELECT * FROM tblEInvoiceMalaysiaClassificationID where ClassificationCode=@ClassificationCode"
                command1.Parameters.AddWithValue("@ClassificationCode", txtClassificationID.Text)
                ...
                Else
                    ...
                    command.CommandType = CommandType.Text
                    Dim qry As String = "INSERT INTO tblEInvoiceMalaysiaClassificationID(ClassificationCode,CreatedBy,CreatedOn,ModifiedBy,ModifiedOn,Description)"
                    qry = qry + "VALUES(@ClassificationCode,@CreatedBy,@CreatedOn,@ModifiedBy,@ModifiedOn,@Description);"
                    ...
                    If ConfigurationManager.AppSettings("UPPERCASE").ToString() = "YES" Then
                        ...
                        command.Parameters.AddWithValue("@ClassificationCode", txtClassificationID.Text.ToUpper)
        ...
        ElseIf txtMode.Text = "Edit" Then
            ...
            Try
                ...
                command2.CommandText = "SELECT * FROM tblEInvoiceMalaysiaClassificationID where ClassificationCode=@ClassificationCode and rcno<>" & Convert.ToInt32(txtRcno.Text)
                command2.Parameters.AddWithValue("@ClassificationCode", txtClassificationID.Text)
                ...
                Else
                    ...
                    command1.CommandText = "SELECT * FROM tblEInvoiceMalaysiaClassificationID where rcno=" & Convert.ToInt32(txtRcno.Text)
                    command1.Connection = conn
                    ...
                    If dt.Rows.Count > 0 Then
                        ...
                        Dim qry As String
                        If txtExists.Text = "True" Then
                            qry = "update tblEInvoiceMalaysiaClassificationID set ModifiedBy=@ModifiedBy,ModifiedOn=@ModifiedOn,Description=@Description where rcno=" & Convert.ToInt32(txtRcno.Text)
                        Else
                            qry = "update tblEInvoiceMalaysiaClassificationID set ClassificationCode=@ClassificationCode,ModifiedBy=@ModifiedBy,ModifiedOn=@ModifiedOn,Description=@Description where rcno=" & Convert.ToInt32(txtRcno.Text)
                ...
                If txtMode.Text = "NEW" Then
                    CType(Me.Master, MasterPage).EventLog_Insert(Session("UserID"), "ClassificationID", txtClassificationID.Text, "ADD", Convert.ToDateTime(txtCreatedOn.Text), 0, 0, 0, "", "", txtRcno.Text)
                Else
                    CType(Me.Master, MasterPage).EventLog_Insert(Session("UserID"), "ClassificationID", txtClassificationID.Text, "EDIT", Convert.ToDateTime(txtCreatedOn.Text), 0, 0, 0, "", "", txtRcno.Text)
                End If
            Catch ex As Exception
                lblAlert.Text = ex.Message
                'MessageBox.Message.Alert(Page, ex.ToString, "str")
        ...
        If confirmValue = "Yes" Then
            ...
            Try
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    command.CommandType = CommandType.Text
                    Dim qry As String = "delete from tblEInvoiceMalaysiaClassificationID where rcno=" & Convert.ToInt32(txtRcno.Text)
                    ...
                    CType(Me.Master, MasterPage).EventLog_Insert(Session("UserID"), "ClassificationID", txtClassificationID.Text, "DELETE", Convert.ToDateTime(txtCreatedOn.Text), 0, 0, 0, "", "", txtRcno.Text)
                End If
                conn.Close()
    ...
    Private Function CheckIfExists() As Boolean
        ...
        command1.Parameters.AddWithValue("@data", txtClassificationID.Text)
        command1.Connection = conn
        ...
        command2.Parameters.AddWithValue("@data", txtClassificationID.Text)
        command2.Connection = conn
        ...
        command3.Parameters.AddWithValue("@data", txtClassificationID.Text)
        ...
        command4.Parameters.AddWithValue("@data", txtClassificationID.Text)
    ...
    Protected Function InsertClassificationCodeData(dt As DataTable, conn As MySqlConnection) As Boolean
        ...
        Dim query As String = "INSERT INTO tbleinvoicemalaysiaclassificationid(ClassificationCode,Description,CreatedBy,CreatedOn,"
        query = query + "ModifiedBy,ModifiedOn,Source) values(@ClassificationCode,@Description,@CreatedBy,@CreatedOn,"
        ...
        Dim drow As DataRow
        Dim dc1 As DataColumn = New DataColumn("ClassificationCode", GetType(String))
        ...
        For Each r As DataRow In dt.Rows
            ...
            If IsDBNull(r("Code")) Then
                Failure = Failure + 1
                FailureString = FailureString + " " + ClassificationCode + "(CODE_BLANK)"
                drow("Status") = "Failed"
            ...
            Else
                ...
                drow("ClassificationCode") = ClassificationCode
            ...
            command2.CommandText = "SELECT * FROM tbleinvoicemalaysiaclassificationid where ClassificationCode=@code and Description=@desc"
            command2.Parameters.AddWithValue("@code", ClassificationCode)
            ...
            If dt1.Rows.Count > 0 Then
                ...
                Failure = Failure + 1
                FailureString = FailureString + " " + ClassificationCode + "(DUPLICATE)"
                drow("Status") = "Failed"
            ...
            Else
                ...
                command3.CommandText = "SELECT * FROM tbleinvoicemalaysiaclassificationid where ClassificationCode=@code"
                command3.Parameters.AddWithValue("@code", ClassificationCode)
                command3.Connection = conn
                ...
                Else
                    ...
                    Else
                        cmd.Parameters.AddWithValue("@ClassificationCode", r("Code").ToString.ToUpper)
                    End If

                    If IsDBNull(r("Description")) Then
                        Failure = Failure + 1
                        FailureString = FailureString + " " + ClassificationCode + "(DESC_BLANK)"
                        drow("Status") = "Failed"
