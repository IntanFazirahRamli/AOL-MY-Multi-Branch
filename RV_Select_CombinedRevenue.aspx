<%@ Page Title="Combined (Actual & Forecast) Revenue Report Selection" Language="VB" MasterPageFile="~/MasterPage_Report.master" AutoEventWireup="false" CodeFile="RV_Select_CombinedRevenue.aspx.vb" Inherits="RV_Select_CombinedRevenue" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <script type="text/javascript">
     ...
     <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" ScriptMode="Release">
       ...
       <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">ACTUAL & FORECAST REVENUE REPORT</h4>
    ...
    <asp:Panel ID="pnlClientID" runat="server" BackColor="White" Width="50%" Height="50%" BorderColor="#003366" BorderWidth="1px" ScrollBars="Auto">
             ...
             <tr>
               ...
               <tr>
                    ...
                    <td class="CellTextBox">  <asp:TextBox ID="txtServiceLocationID" runat="server" MaxLength="10" Height="16px" Width="60%"></asp:TextBox>
