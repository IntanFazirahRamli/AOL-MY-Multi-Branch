...
Partial Class RV_Export_ReceiptListing
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                Else
                    crReportDocument.Load(Server.MapPath("~/Reports/ARNewReports/ReceiptListingReports/ReceiptListingSummary.rpt"))
                    crReportDocument.SetParameterValue("pUserId", Convert.ToString(Session("UserId")))
                    crReportDocument.SetParameterValue("pSelectedFields", Convert.ToString(Session("selection")))
                ...
                Dim FilePath As String = Server.MapPath("~/PDFs/" + Convert.ToString(Session("UserID") + "_ReceiptListing.PDF"))
                ...
                If FileBuffer IsNot Nothing Then
                    ...
                    Response.AddHeader("content-disposition", "inline; filename=ReceiptListing.pdf")
