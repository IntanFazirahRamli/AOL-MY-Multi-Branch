...
Public Class RV_SvcRecWithDuplicateTeamMembers_Format2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                Dim repPath As String = Server.MapPath("~/Reports/ServiceRecordReports/SvcRecWithDuplicateTeamMembers_Format2.rpt")
