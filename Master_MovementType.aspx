<%@ Page Title="Asset Movement Type" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="Master_MovementType.aspx.vb" Inherits="Master_MovementType" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="text-align:center">
        ...
        <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">Asset Movement Type</h3>
...
<asp:Button ID="btnDelete" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="DELETE" Width="100px" OnClientClick = "Confirm(); currentdatetime()"/>
            ...
            <tr class="Centered">
                <td colspan="2">
                    ...
                    <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataKeyNames="MovementType" Font-Size="15px" HorizontalAlign="Center" AllowSorting="True">
                         <Columns>
                               <asp:CommandField HeaderText="Select" ShowHeader="True" ShowSelectButton="True" Visible="false" >
                <ControlStyle Width="150px" />
                <ItemStyle Width="150px" />
                </asp:CommandField>
                             <asp:BoundField DataField="MovementType" HeaderText="MovementType" ReadOnly="True" SortExpression="MovementType" >
                ...
                <ItemTemplate>
                      <asp:CheckBox ID="chkGrdAvailable" runat="server" Checked='<%# IIf(Eval("Availability").ToString().Equals("1"), True, False)%>' Enabled="False" Font-Bold="False" /> 
                      </ItemTemplate>
            </asp:TemplateField>
                ...
                <ItemStyle Width="100px" HorizontalAlign="Left" />
                             ...
                             <asp:BoundField DataField="MovementTo" HeaderText="MovementTo" ReadOnly="True" SortExpression="MovementTo" >
                                  <ControlStyle Width="100px" />
                <HeaderStyle Font-Size="12pt" />
                <ItemStyle Width="100px" HorizontalAlign="Left" />
                </asp:BoundField>
          ...
          <tr>
            ...
            <tr>
                    ...
                    <td class="CellFormatADM">Asset MovementType<asp:Label ID="Label23" runat="server" visible="true" Font-Size="14px" ForeColor="Red" Text="*" Height="20px"></asp:Label></td>
                     

                    <td class="CellTextBoxADM"> <asp:TextBox ID="txtAssetMovementType" runat="server" MaxLength="25" Height="16px" Width="30%"></asp:TextBox></td>
            ...
            <tr>
                    ...
                    <td class="CellFormatADM">Type</td>
                     

                    <td class="CellTextBoxADM"> <asp:DropDownList ID="ddlType" runat="server" Width="30.5%" CssClass="chzn-select" >
           ...
           <tr>
                    ...
                    <td class="CellFormatADM">MovementTo</td>
                     

                    <td class="CellTextBoxADM"> <asp:DropDownList ID="ddlMovementTo" runat="server" Width="30.5%" CssClass="chzn-select" >
                                   <asp:ListItem Text="--SELECT--" Value="-1" />   
           ...
           <tr>
                    ...
                    <td class="CellFormatADM">Availability</td>
                     

                    <td class="CellTextBoxADM"> <asp:DropDownList ID="ddlAvailability" runat="server" Width="30.5%" CssClass="chzn-select" >
                                   <asp:ListItem Text="--SELECT--" Value="-1" />   
...
<asp:Button ID="btnCancel" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="CANCEL" Width="100px" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>" SelectCommand="SELECT * FROM tblassetMovementType where rcno<>0"></asp:SqlDataSource>
