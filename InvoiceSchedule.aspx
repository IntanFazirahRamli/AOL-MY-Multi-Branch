<%@ page title="Batch Invoice" language="VB" masterpagefile="~/MasterPage.master" autoeventwireup="false" CodeFile="InvoiceSchedule.aspx.vb" inherits="InvoiceSchedule" culture="en-GB" enableeventvalidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Button ID="dummy" runat="server" Text="" cssclass="dummybutton" />
     ...
     <div style="text-align:center">
            ...
            <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">BATCH INVOICE</h3>
            ...
            <tr>
              ...
              <tr>
                <td style="width:8%;text-align:center;"> 
                  ...
                  <td>
                     <a href="RV_BatchInvoice.aspx" target="_blank"><button id="btnPrintBatchInvoice" class="roundbutton1" style="background-color:#CFC6C0;font-weight:bold;width:95%; font-size:15px;text-align:CENTER;font-family:'CALIBRI';" type="button" >PRINT</button></a>
                    ...
                    <table border="0" style="font-family: calibri; font-size: 15px; font-weight: bold; color: #000000;width:100%;padding-left:2px;">
                         <tr>
                            ...
                            <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black;  width:10%; ">
                              ...
                              <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black;  width:10%; ">
                                  <asp:DropDownList ID="ddlCompanyGrpSearch" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDSCompanyGroup" DataTextField="companygroup" DataValueField="companygroup" Height="20px" Width="90%">
                            ...
                            <asp:ImageButton ID="ImageButton3" runat="server" CssClass="righttextbox" ImageUrl="~/Images/searchbutton.jpg"  Height="22px" Width="24px" ImageAlign="Middle" Visible="False"     />   
                             ...
                             <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black;  width:12%; ">
                                  <asp:TextBox ID="txtAccountIdSearch" runat="server" AutoCompleteType="Disabled" Height="16px" MaxLength="50" style="text-align:left; " Width="75%"></asp:TextBox>
                               ...
                               <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; text-align:right;width:9%; ">Billing Frequency</td>
                              <td>
                                  <asp:DropDownList ID="ddlBillingFrequencySearch" runat="server" AppendDataBoundItems="True" CssClass="chzn-select" DataSourceID="SqlDSBillingFrequency" DataTextField="Frequency" DataValueField="Frequency" Height="25px" Width="90%">
                              ...
                              <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; text-align:right; width:8%; ">
                                    &nbsp;</td>
                            <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black;  width:10%; ">
                                 <asp:TextBox ID="txtNextInvoiceDate" runat="server" style="text-align:left; " MaxLength="50" Height="16px" Width="10%" AutoCompleteType="Disabled" Visible="False" ></asp:TextBox>         
                                     <asp:CalendarExtender ID="CalendarExtender6" runat="server" Format="dd/MM/yyyy" PopupButtonID="txtNextInvoiceDate" TargetControlID="txtNextInvoiceDate" Enabled="True" />
                          ...
                          <tr>
                            ...
                            <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black;  width:11%; ">
                                   <asp:TextBox ID="txtBillingPeriodSearch" runat="server" AutoCompleteType="Disabled" Height="16px" MaxLength="50" style="text-align:left;padding-left:5px;" Width="90%"></asp:TextBox>
                             ...
                             <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; text-align:right; ">
                                    Account Type</td>
                             <td>
                                 <asp:DropDownList ID="ddlContactTypeSearch" runat="server" DataTextField="ContType" DataValueField="ContType" Height="20px" Width="90%">
                                  <asp:ListItem>--SELECT--</asp:ListItem>
                            ...
                            <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; text-align:right; width:7%; ">
                                    ...
                                    Client Name</td>
                             <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black;  width:12%; ">
                                  <asp:TextBox ID="txtClientNameSearch" runat="server" AutoCompleteType="Disabled" Height="16px" MaxLength="50" style="text-align:left;padding-left:5px;" Width="90%"></asp:TextBox>
                            </td>
                             ...
                             <td>
                                 ...
                                 <asp:ImageButton ID="btnSearch1Status" runat="server" CssClass="righttextbox" ImageUrl="~/Images/searchbutton.jpg" ImageAlign="Middle"
                                    Height="22px" Width="24px" Visible="False" />  
                               ...
                               <td colspan="2" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; text-align:right; width:8%; ">
                                    <asp:Panel ID="Panel6" runat="server" BorderColor="#993300" BorderStyle="Solid" BorderWidth="1px" Height="19%" Width="15%" Font-Size="14px" Visible="False">
                                        <asp:CheckBoxList ID="cbxRecurring" runat="server" Font-Size="15px" ForeColor="Black" RepeatDirection="Horizontal" Width="95%" Visible="False">
                                            <asp:ListItem Text="Recurrig Inv." Value="Recur" Selected="True"></asp:ListItem>
                                            <asp:ListItem Text="Scheduled" Value="Scheduled" Selected="False"></asp:ListItem></asp:CheckBoxList>
         ...
         <table  style="width:97%;text-align:center; padding-top:2px; margin-left: 0%; margin-right:0% " >
                                          ...
                                          <asp:GridView ID="GridView1" Width="100%" Font-Size="15px" runat="server" OnRowDataBound = "OnRowDataBound" OnSelectedIndexChanged = "OnSelectedIndexChanged" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" BorderWidth="1px" CellPadding="2" CellSpacing="2" DataKeyNames="Rcno" DataSourceID="SQLDSInvoice" ForeColor="#333333" GridLines="Vertical"> 
                                              <AlternatingRowStyle BackColor="White"/>
                                                <Columns>
                                                  ...
                                                  <asp:BoundField DataField="BillSchedule" HeaderText="Batch No." SortExpression="BillSchedule" >
                                                    <ControlStyle Width="6%" />
                                                    <ItemStyle Width="6%" Wrap="False" />
                                                    </asp:BoundField>
                                                 
                                                  <asp:BoundField DataField="BSDate" HeaderText="Batch Date" DataFormatString="{0:dd/MM/yyyy}" SortExpression="SalesDate">
                                  ...
                                  <tr>
                                    ...
                                    <asp:TextBox ID="txtDisplayRecordsLocationwise" runat="server" Visible="False"></asp:TextBox>
                                       ...
                                       <asp:TextBox ID="txtDeSelectContractGroup" runat="server" Visible="False"></asp:TextBox> 
                                        <asp:TextBox ID="txtBatchInvoiceCompanyGroupOptional" runat="server" Visible="False"></asp:TextBox>

                                        <asp:TextBox ID="txtDeSelectCompanyGroup" runat="server" Visible="False"></asp:TextBox> 
          ...
          <tr style="width:100%">
               ...
               <tr>
                   ...
                   <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:10%; text-align:right; ">Batch No.<asp:Label ID="Label13" runat="server" Font-Size="14px" ForeColor="Red" Text="*"></asp:Label>
                   </td>
               ...
               <tr>
                   ...
                   <td style="font-size: 15px; font-weight: bold; font-family: Calibri; text-align: left; color: black; padding-left: 1%; width: 20%; text-align: right;">
                       <asp:TextBox ID="txtTaxRatePct" runat="server" AutoCompleteType="Disabled" BorderStyle="None" ForeColor="#003366" Height="16px" Width="15%" Enabled="False"></asp:TextBox>
                   </td>
              </tr>
                ...
                <tr>
                    ...
                    <td style="font-size: 15px; font-weight: bold; font-family: Calibri; text-align: left; color: black; padding-left: 1%; width: 20%; text-align: right;">
                        <asp:TextBox ID="txtDefaultTaxCode" runat="server" AutoCompleteType="Disabled" BorderStyle="None" ForeColor="#003366" Height="16px" Width="15%" Enabled="False"></asp:TextBox></td>
                </tr>
...
<asp:CollapsiblePanelExtender ID="cpnl2" runat="server" CollapseControlID="Panel4" TargetControlID="Panel5" CollapsedImage="~/Images/plus.png" ExpandedImage="~/Images/minus.png" ImageControlID="imgCollapsible2" Enabled="True" ExpandControlID="Panel4" CollapsedText="Click to show" Collapsed="false"></asp:CollapsiblePanelExtender>
     ...
     <asp:Panel ID="Panel5" runat="server" >
        ...
        <table border="0"  style="width:97%;text-align:center; padding-top:2px; margin-left: 0%; margin-right:0%; border:solid; border-color:ButtonFace; "  >
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
                     ...
                     <tr>
                            <td style="width:6%;font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:left;">Company Group<asp:Label ID="Label44" runat="server" Font-Size="14px" ForeColor="Red" Text="*"></asp:Label>
                            </td>
                          ...
                          <td style="width:6%;font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:left;"> Account Id
                           ...
                           <td colspan="2" style="width:10%;font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:left;"> Customer Name
                   ...
                   <tr>
                          ...
                          <td colspan="1" style="width:10%;font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:right;">
                            ...
                            <tr>
                                ...
                                <td colspan="1" style="width:10%;font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:right;">
                                    <asp:Button ID="btnShowRecords" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="SHOW SERVICES" Width="80%" />
                                </td>
                            </tr>
            </table>
       </ContentTemplate>
