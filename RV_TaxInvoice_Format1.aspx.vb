...
Public Class RV_TaxInvoice_Format1
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                '  CType(Me.Master, MasterPage).EventLog_Insert(Session("UserID"), "TAX INVOICE FORMAT-1", Left(Convert.ToString(Session("InvoiceNumber")), 50), "ADD", DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss", New System.Globalization.CultureInfo("en-GB")), 0, 0, 0, Left(Convert.ToString(Session("InvoiceNumber")), 20), "", "")

                '   InsertIntoTblWebEventLog("Page_Load1", Request.QueryString("Export"), Session("InvoiceNumber"))
                ...
                'myBarcode.SaveAsImage(Server.MapPath("~/PDFs/" + Convert.ToString(Session("InvoiceNo") + "_QR.PDF"))
                ...
                If Request.QueryString("Export") = "PDF" Then
                    ...
                    '    InsertIntoTblWebEventLog("Page_Load2", Session("InvoiceNo"), Session("InvoiceNo"))
                ...
                '     InsertIntoTblWebEventLog("Page_Load3", Server.MapPath("~/Reports/ARReports/TaxInvoice_Format1.rpt").ToString, Session("InvoiceNo"))
                ...
                Else
                    If Request.QueryString("Export") = "PDF" Then
                        crReportDocument.Load(Server.MapPath("~/Reports/ARReports/TaxInvoiceE_Format1.rpt"))

                    ElseIf Request.QueryString("Export") = "Word" Or Request.QueryString("Export") = "View" Then
                        crReportDocument.Load(Server.MapPath("~/Reports/ARReports/TaxInvoiceE_Format1_New.rpt"))
                ...
                End If
                    ...
                    '   crReportDocument.RecordSelectionFormula = "{tblSales1.InvoiceNumber} in ['AR202004-012794','AR202004-012793','AR202004-012796','AR202003-012011']"
                    ' crReportDocument.RecordSelectionFormula = "{tblSales1.InvoiceNumber} in ['AR202004-012794','AR202004-012793']"
                    '   InsertIntoTblWebEventLog("Page_Load4", Server.MapPath("~/Reports/ARReports/TaxInvoice_Format1.rpt").ToString, Session("InvoiceNo"))
                    ...
                    If Request.QueryString("Export") = "PDF" Or Request.QueryString("Export") = "View" Then
                        ...
                        '    InsertIntoTblWebEventLog("Page_Load5", FilePath, Session("InvoiceNo"))
                        ...
                        '     InsertIntoTblWebEventLog("Page_Load6", FilePath, Session("InvoiceNo"))
                    ...
                    ' InsertIntoTblWebEventLog("Page_Load7", "", Session("InvoiceNo"))
    ...
    Protected Sub PrintCount(lPrintInvoice As String)
        Try
    ...
    Private Sub InsertIntoTblWebEventLog(events As String, errorMsg As String, ID As String)
        Try
            ...
            insCmds.Parameters.AddWithValue("@LoginId", "RV-TAXINVOICE1 - " + Session("userid"))
