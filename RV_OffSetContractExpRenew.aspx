<%@ Page Language="vb" AutoEventWireup="false" CodeFile="RV_OffSetContractExpRenew.aspx.vb" 
    Inherits="RV_OffSetContractExpRenew" MasterPageFile="~/MasterPage.Master"
    Title="Offset Contract Expiry/Renewal Listing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div style="text-align:center">
        <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">Offset Contract Expiry/Renewal Listing</h3>
      <%--  <a href="RV_OffSetContractExpRenew.aspx"><span class="auto-style1">RV_OffSetContractExpRenew.aspx</span></a><br />--%>
            ...
            <td colspan="2">
               <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="true"
                ...
                <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                    <Report FileName="Reports\ServiceContractReports\OffSetContractExpRenew.rpt">
                    </Report>
