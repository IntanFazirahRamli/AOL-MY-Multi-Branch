...
Partial Class ConsolidatedEInvoice
...
'    End Sub
    Protected Sub GridView1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles GridView1.SelectedIndexChanged
        ...
        Try
            ...
            sql = "select ConsolidatedInvoiceNo,CIDate,AccountId,CustName,InvoiceNo,SalesDate,BillingFrequency,LocationId,"
            sql = sql + "Address1,BillAmount,RcnoInvoice,RcnoInvoiceDetail,BillNo,ContractNo,Name,OurRef,YourRef,PoNo,CreditTerms,"
            sql = sql + "Salesman,BillAddress1,BillBuilding,BillStreet,BillPostal,BillState,BillCity,BillCountry,ContactType,"
            sql = sql + "CompanyGroup,CreatedBy,CreatedOn,LastModifiedBy,LastModifiedOn,Rcno,DiscountPerc,DiscountAmount,GSTAmount,"
            sql = sql + "TotalWithGST,NetAmount,Status,ContractGroup,Posted,RetentionAmt,BillSchedule,ArTerm,TermsDay,Location,Remarks,Gst,"
            sql = sql + "GstRate,Internal,SubmissionDate,DocTypeCode,CancellationDate,CancellationReason,TaxIdentificationNo,BRN,"
            sql = sql + "SalesTaxRegistrationNo,LongID,SubmissionBy,EI,EInvoiceStatus,UUID,SubmissionID "
            sql = sql + " FROM tbleinvoiceconsolidateddetail "
...
'        Catch ex As Exception
    '            InsertIntoTblWebEventLog("CONSOLIDATED INV - " + Session("UserID"), "GenerateInvoiceNo", ex.Message.ToString, "")
'            Exit Sub
'        End Try
'    End Sub
...
'    End Sub
    ...
    Private Sub AccessControl()
        ...
        command.CommandText = "SELECT X0253,  X0253Add, X0253Edit, X0253Delete, X0253Print, X0253Post, X0253Reverse, X0253MultiPrint, x253DeSelectContractGroup FROM tblGroupAccess where GroupAccess = '" & Session("SecGroupAuthority") & "'"
...
'    'End: Populate Recurring Invoice
    ...
    Protected Sub btnADD_Click(sender As Object, e As EventArgs) Handles btnADD.Click
        Try
            ...
            InsertIntoTblWebEventLog("CONSOLDATED INV", "btnAdd1", txtBatchDate.Text, txtCreatedBy.Text)

            MakeMeNull()

            InsertIntoTblWebEventLog("CONSOLDATED INV", "btnAdd2", txtBatchDate.Text, txtCreatedBy.Text)

            MakeMeNullBillingDetails()

            InsertIntoTblWebEventLog("CONSOLDATED INV", "btnAdd3", txtBatchDate.Text, txtCreatedBy.Text)

            EnableControls()

            InsertIntoTblWebEventLog("CONSOLDATED INV", "btnAdd4", txtBatchDate.Text, txtCreatedBy.Text)
            ...
            InsertIntoTblWebEventLog("CONSOLDATED INV", "btnAdd5", txtBatchDate.Text, txtCreatedBy.Text)
...
'    ''''''' Start: Service Details
    ...
    Protected Sub btnEdit_Click(sender As Object, e As EventArgs) Handles btnEdit.Click
        Try
            ...
            For rowindex = 0 To grvInvoiceRecDetails.Rows.Count - 1
                Dim TextBoxToBillAmt As TextBox = CType(grvInvoiceRecDetails.Rows(rowindex).Cells(0).FindControl("txtToBillAmtGV"), TextBox)
    ...
    Private Sub PopulateServiceGrid()
        ...
        Try
            ...
            If txtMode.Text = "NEW" Then
                ...
                sql = "select * from tblsales A where PostStatus='P' and (EI='N' OR EI IS NULL OR EI='')"
            ...
            If txtMode.Text = "EDIT" Then
                ...
                sql = "select * from tblsales A where PostStatus='P' and (EI='N' OR EI IS NULL OR EI='') and InvoiceNo not in ("
            ...
            sql2 = sql2 + " order by SalesDate,AccountID"
            ...
            InsertIntoTblWebEventLog("CInvoice2", "PopulateServiceGrid", sql, txtCreatedBy.Text)


            SqlDSInvoice.SelectCommand = sql
            grvInvoiceRecDetails.DataSourceID = "SqlDSInvoice"
            grvInvoiceRecDetails.DataBind()
                ...
                If txtPostStatus.Text = "O" Then
                    If (grvInvoiceRecDetails.Rows.Count > 0) Then
                        For i As Integer = 0 To (grvInvoiceRecDetails.Rows.Count) - 1
                            Dim TextBoxSel As CheckBox = CType(grvInvoiceRecDetails.Rows(i).Cells(7).FindControl("chkSelectGV"), CheckBox)
...
'            exstr = ex.ToString
'            lblAlert.Text = exstr
    '            InsertIntoTblWebEventLog("CONSOLIDATED INV - " + Session("UserID"), "btnPost_Click", ex.Message.ToString, "")
'            Exit Sub
'        End Try
'    End Sub
...
'            End If
'        Catch ex As Exception
    '            InsertIntoTblWebEventLog("CONSOLIDATED INV - " + Session("UserID"), "txtPopUpClient_TextChanged", ex.Message.ToString, "")
'            Exit Sub
'        End Try
...
'            exstr = ex.ToString
'            lblAlert.Text = exstr
    '            InsertIntoTblWebEventLog("CONSOLIDATED INV - " + Session("UserID"), "btnClient_Click", ex.Message.ToString, "")
'            Exit Sub
'        End Try
'    End Sub
...
'            exstr = ex.ToString
'            lblAlert.Text = exstr
    '            InsertIntoTblWebEventLog("CONSOLIDATED INV - " + Session("UserID"), "btnGenerateInvoice_Click", ex.Message.ToString, "")
'            Exit Sub
'        End Try
'    End Sub
...
'            mdlPopupStaff.Show()
'        Catch ex As Exception
    '            InsertIntoTblWebEventLog("CONSOLIDATED INV - " + Session("UserID"), "ImageButton1_Click", ex.Message.ToString, "")
'            Exit Sub
'        End Try
'    End Sub
...
'            exstr = ex.ToString
'            lblAlert.Text = exstr
    '            InsertIntoTblWebEventLog("CONSOLIDATED INV - " + Session("UserID"), "ImageButton5_Click", ex.Message.ToString, txtAccountId.Text & " - " & ddlContractNo.Text)
'            Exit Sub
'        End Try
...
'            exstr = ex.ToString
'            lblAlert.Text = exstr
    '            InsertIntoTblWebEventLog("CONSOLIDATED INV - " + Session("UserID"), "UpdateLastBillDate", ex.Message.ToString, query)
'            Exit Sub
'        End Try
'    End Sub
...
'            exstr = ex.ToString
'            lblAlert.Text = exstr
    '            InsertIntoTblWebEventLog("CONSOLIDATED INV - " + Session("UserID"), "btnConfirmNoUpdateServiceRecord_Click", ex.Message.ToString, "")
'            Exit Sub
'        End Try
'    End Sub
