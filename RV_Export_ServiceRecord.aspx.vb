...
Partial Class RV_Export_ServiceRecord
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                If Convert.ToString(Session("ReportType")) = "ServiceRecord02" Then

                    crReportDocument.Load(Server.MapPath("~/Reports/ServiceRecordReports/ServiceRecord02.rpt"))
                ...
                ElseIf Convert.ToString(Session("ReportType")) = "ServiceRecordStaff" Then

                    crReportDocument.Load(Server.MapPath("~/Reports/ServiceRecordReports/ServiceRecordStaff.rpt"))
                ...
                ElseIf Convert.ToString(Session("ReportType")) = "ServiceRecordClient" Then
                    crReportDocument.Load(Server.MapPath("~/Reports/ServiceRecordReports/ServiceRecordClient.rpt"))
                ...
                ElseIf Convert.ToString(Session("ReportType")) = "ServiceRecordBilling" Then
                    crReportDocument.Load(Server.MapPath("~/Reports/ServiceRecordReports/ServiceRecordBilling.rpt"))
                ...
                ElseIf Convert.ToString(Session("ReportType")) = "PostponedServices" Then
                    crReportDocument.Load(Server.MapPath("~/Reports/ServiceRecordReports/PostponedServices.rpt"))

                ElseIf Convert.ToString(Session("ReportType")) = "InActiveContractswithSchServices" Then
                    crReportDocument.Load(Server.MapPath("~/Reports/ServiceRecordReports/SchServicesInactiveContracts.rpt"))
                ElseIf Convert.ToString(Session("ReportType")) = "SvcRecWithPaymentType" Then
                    crReportDocument.Load(Server.MapPath("~/Reports/ServiceRecordReports/SvcRecWithPaymentType.rpt"))
                ...
                Dim FilePath As String = Server.MapPath("~/PDFs/" + Convert.ToString(Session("UserID") + "_ServiceRecord.PDF"))
                ...
                If FileBuffer IsNot Nothing Then
                    ...
                    Response.AddHeader("content-disposition", "inline; filename=ServiceRecord.pdf")
