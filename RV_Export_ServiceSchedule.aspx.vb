...
Partial Class RV_Export_ServiceSchedule
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                If Convert.ToString(Session("ReportType")) = "ServiceSchedule" Then

                    crReportDocument.Load(Server.MapPath("~/Reports/ServiceRecordReports/ServiceSchedule.rpt"))

                ElseIf Convert.ToString(Session("ReportType")) = "ServiceSchedule_Format2" Then

                    crReportDocument.Load(Server.MapPath("~/Reports/ServiceRecordReports/ServiceSchedule_Format2.rpt"))

                ElseIf Convert.ToString(Session("ReportType")) = "ServiceSchedule_Format3" Then

                    crReportDocument.Load(Server.MapPath("~/Reports/ServiceRecordReports/ServiceSchedule_Format3.rpt"))

                ElseIf Convert.ToString(Session("ReportType")) = "ServiceSchedule_Format4" Then

                    crReportDocument.Load(Server.MapPath("~/Reports/ServiceRecordReports/ServiceSchedule_Format4.rpt"))
                ...
                Dim FilePath As String = Server.MapPath("~/PDFs/" + Convert.ToString(Session("UserID") + "_ServiceSchedule.PDF"))
                ...
                If FileBuffer IsNot Nothing Then
                    ...
                    Response.AddHeader("content-disposition", "inline; filename=ServiceSchedule.pdf")
