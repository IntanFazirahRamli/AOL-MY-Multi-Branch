...
Partial Class RV_Select_ManpowerProductivityByTeamLead
    ...
    Private Sub LockReport()
        Try
            ...
            commandLock.Parameters.AddWithValue("@pr_ReportName", "ManpowerProd-Report")
        ...
        Catch ex As Exception
            InsertIntoTblWebEventLog("MANPOWER-MEMBER - " + Session("UserID"), "FUNCTION LOCKREPORT", ex.Message.ToString)
    ...
    Private Sub UnLockReport()
        ...
        Try
            ...
            commandUnLock.Parameters.AddWithValue("@ReportName", "ManpowerProd-Report")
    ...
    Protected Sub btnPrintServiceRecordList_Click(sender As Object, e As EventArgs) Handles btnPrintServiceRecordList.Click
        ...
        Try
            ...
            commandIsLock.CommandText = "select StartDateTime, RunBy from tbllock where  ReportName ='ManpowerProd-Report' and Status ='Locked'"
            ...
            If dtLock.Rows.Count > 0 Then
                If Convert.ToDateTime(dtLock.Rows(0)("StartDateTime").ToString).AddMinutes(10) <= DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") Then
                    UnLockReport()
                    LockReport()
                Else
            ...
            If rdbSelect.Text = "Detail" Then
                selFormula = "{tblrptserviceanalysis1.rcno} <> 0 and {tblrptserviceanalysis1.Status} = 'P' and {tblrptserviceanalysis1.Report}='ProdTeamLeaderDet'"
            ...
            Else
                ...
                Else
                    selFormula = selFormula + " and ({tblservicerecord1.ServiceBy} = '" + ddlIncharge.Text + "' or {tblServiceRecordStaff1.StaffID} = '" + ddlIncharge.Text + "')"
                End If
            ...
            If rdbSelect.Text = "Detail" Then
                ...
                '        command2.CommandText = "delete from tblrptserviceanalysis where recordno='" + dtSvcRec.Rows(i)("RecordNo") + "' and Report='ProdTeamLeaderDet';"
                ...
                '        command.Parameters.AddWithValue("@Report", "ProdTeamLeaderDet")
            ...
            If rdbSelect.SelectedValue = "Detail" Then
                Session.Add("ReportType", "ManpowerProductivityByTeamLeadDetail")
                Response.Redirect("RV_ManpowerProductivityByTeamLeadDetail.aspx")
            ElseIf rdbSelect.SelectedValue = "Summary" Then
                Session.Add("ReportType", "ManpowerProductivityByTeamLeadSummary")
                Response.Redirect("RV_ManpowerProductivityByTeamLeadSummary.aspx")
        ...
        Catch ex As Exception
            UnLockReport()
            lblAlert.Text = ex.Message.ToString
            InsertIntoTblWebEventLog("btnPrintServiceRecordList_Click", ex.Message.ToString, "")
    ...
    Private Sub GetData()
        ...
        command2.CommandText = "delete from tblrptserviceanalysis where CREATEDBY='" + txtCreatedBy.Text.Trim + "' and Report='ProdTeamLeaderDet';"
        ...
        If chkTimeSheet.Checked Then
            command.CommandText = "SaveProductivityTeamLeadTimeSheet"
            '   InsertIntoTblWebEventLog("SaveProductivityByTeamLeadTimeSheet", "GetData", chkTimeSheet.Checked.ToString, txtCreatedBy.Text)
        Else
            command.CommandText = "SaveProductivityTeamLead"
            '  InsertIntoTblWebEventLog("SaveProductivityByTeamLead", "GetData", chkTimeSheet.Checked.ToString, txtCreatedBy.Text)
        End If
        ...
        command.Parameters.AddWithValue("@pr_Report", "ProdTeamLeaderDet")
    ...
    Protected Sub btnExportToExcel_Click(sender As Object, e As EventArgs) Handles btnExportToExcel.Click
        Try
            ...
            If GetData1() = True Then
                ...
                Dim attachment As String = "attachment; filename=ManpowerProductivityTeamLead.xls"
    ...
    Private Function GetData1() As Boolean
        ...
        If rdbSelect.Text = "Detail" Then
            ...
            qry = qry + " from tblrptserviceanalysis A where report = 'ProdTeamLeaderDet' and createdby='" & Session("UserID") & "'"

        ElseIf rdbSelect.Text = "Summary" Then
            qry = "Select A.ServiceBy,count(A.recordno) as NoofServices,Sum(A.billamount) as TotalBillAmount"
        ...
        ElseIf rdbSelect.Text = "Summary" Then
            txtQuery.Text = qry + " group by A.ServiceBy"
        End If
    ...
    Public Sub WriteExcelWithNPOI(ByVal dt As DataTable, ByVal extension As String)
        ...
        Using exportData = New MemoryStream()
            ...
            Dim attachment As String = "attachment; filename=ManpowerProductivityTeamLead"
            If extension = "xlsx" Then
