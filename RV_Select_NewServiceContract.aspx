<%@ Page Title="New Service Contract Listing Report Selection" Language="VB" MasterPageFile="~/MasterPage_Report.master" AutoEventWireup="false" CodeFile="RV_Select_NewServiceContract.aspx.vb" Inherits="RV_Select_NewServiceContract" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <script type="text/javascript">
       ...
       <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">NEW SERVICE CONTRACT LISTING REPORT</h4>
...
<%--            <tr>
      ...
      <table style="width:100%;font-family: Calibri; font-size: 15px; font-weight: bold; color: black;text-align:left;padding-left:20px;line-height:20px;">
           ...
           <tr>
                      <td class="CellFormat">AgreementType</td>
                    <td class="CellTextBox"><asp:DropDownList ID="ddlAgreementType" runat="server" CssClass="chzn-select" Width="60%" Height="25px" AppendDataBoundItems="True">
                                          <asp:ListItem Text="--SELECT--" Value="-1" />
                        <asp:ListItem Value="NEW">NEW</asp:ListItem>
                        <asp:ListItem Value="NEW & ADDITION">NEW & ADDITION</asp:ListItem>
                                      </asp:DropDownList>
                           </td>
...
<td><asp:Button ID="btnSort2" runat="server" Text="<<" /></td>
           ...
           <%--   <tr>
              ...
              <tr>
                  <td colspan="2" style="text-align:center"><asp:Button ID="btnPrintServiceContractList" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="Print" Width="100px"/>
