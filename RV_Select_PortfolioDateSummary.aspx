<%@ Page Title="Portfolio Report Selection" Language="VB" MasterPageFile="~/MasterPage_Report.master" AutoEventWireup="false" CodeFile="RV_Select_PortfolioDateSummary.aspx.vb" Inherits="RV_Select_PortfolioDateSummary" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold; color: #000099;">PORTFOLIO DATE SUMMARY</h4>
    ...
    <table style="width: 100%; font-family: Calibri; font-size: 15px; font-weight: bold; color: black; text-align: left; padding-left: 20px; line-height: 25px;">
        <tr>
           ...
           <tr>
            <td colspan="5" style="padding-left: 20%; padding-top: 1%">
                    ...
                    <div style="padding-left: 20px; text-align: left; padding-bottom: 20px;">
                        <asp:RadioButtonList ID="rbtnSelect" runat="server" CellSpacing="5" CellPadding="5" RepeatDirection="Horizontal">
                           <%-- <asp:ListItem Text="Contract Group Value Report" Value="1" Selected="true"></asp:ListItem>--%>
                            <asp:ListItem Text="List View" Value="2" Selected="true"></asp:ListItem>
                            <asp:ListItem Text="ChartView" Value="3"></asp:ListItem>
        ...
        <tr>
            <td style="width:25%">
                <%--<asp:CheckBox ID="chkNew" runat="server" BorderColor="White" BorderStyle="None" Checked="True" />--%>
                <asp:TextBox ID="txtQuery" runat="server" CssClass="dummybutton" ></asp:TextBox>
            </td>
          
            <td style="text-align: left;width:15%">
                <asp:Button ID="btnPrintServiceRecordList" runat="server" CssClass="button" BackColor="#CFC6C0" Font-Bold="True" Text="Print" Width="100%" OnClientClick="currentdatetime()" />
            </td>
          
            <td style="text-align: left;width:15%">
                <%--<asp:Button ID="btnPrintExportToExcel" runat="server" CssClass="button" BackColor="#CFC6C0" Font-Bold="True" Text="Export to Excel" Width="100%" />--%>
            ...
            <td style="text-align: left; width:15%">
                <asp:Button ID="btnCloseServiceRecordList" runat="server" CssClass="button" BackColor="#CFC6C0" Font-Bold="True" Text="Cancel" Width="100%" OnClientClick="currentdatetime()"/>
            </td>
