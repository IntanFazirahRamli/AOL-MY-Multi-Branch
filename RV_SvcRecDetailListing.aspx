<%@ Page Language="vb" AutoEventWireup="false" CodeFile="RV_SvcRecDetailListing.aspx.vb" 
    Inherits="RV_SvcRecDetailListing" MasterPageFile="~/MasterPage.Master"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div style="text-align:center">
        <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">Service Record Details Listing</h3>
    <br />
        ...
        <tr>
            <td colspan="2">
                ...
                <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                    <Report FileName="Reports\ServiceRecordReports\SvcRecDetailListing.rpt">
                    </Report>
