<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Master_PestGender.aspx.vb" Inherits="Master_PestGender" Title="Pest Gender"  Culture="en-GB"%>
...
<script type="text/javascript">
    ...
    <div style="text-align:center">
        ...
        <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">Pest Gender</h3>
                ...
                <td style="text-align:center;">
                        ...
                        <tr><td style="width:40%"></td>
                         ...
                         <tr style="padding-top:3px;"><td style="width:40%"></td>
                            <td style="width:10%;text-align:left;font-size:15px;font-weight:bold;font-family:'Calibri';color:black;">Gender</td>
                             <td style="text-align:left;">
                                <asp:TextBox ID="txtGender" runat="server" MaxLength="25" Height="16px" Width="200px"></asp:TextBox></td>
                        </tr>
...
<asp:Button ID="btnCancel" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="CANCEL" Width="100px" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>" SelectCommand="SELECT *  FROM tblPestGender order by PestID"></asp:SqlDataSource>
