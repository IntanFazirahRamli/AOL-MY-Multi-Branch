<%@ Page Language="vb" AutoEventWireup="false" CodeFile="RV_TerminatedContract03.aspx.vb" MasterPageFile="~/MasterPage.Master"
     Inherits="RV_TerminatedContract03" Title="Terminated Service Contract Listing by Salesman" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div style="text-align:center">
        <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">Terminated Service Contract Listing By Salesman</h3>
    <br />
        ...
        <tr>
            <td colspan="2">
                ...
                <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                    <Report FileName="Reports\ServiceContractReports\TerminatedContract03.rpt">
                    </Report>
