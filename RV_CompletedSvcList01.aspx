<%@ Page Language="vb" AutoEventWireup="false" CodeFile="RV_CompletedSvcList01.aspx.vb" 
    Inherits="RV_CompletedSvcList01" MasterPageFile="~/MasterPage.Master"
            ...
            <td colspan="2">
               <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="true"
                ...
                <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                    <Report FileName="Reports\ServiceRecordReports\CompletedSvcList01.rpt">
                    </Report>
