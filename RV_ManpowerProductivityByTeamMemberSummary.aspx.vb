...
Public Class RV_ManpowerProductivityByTeamMemberSummary
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                If Convert.ToString(Session("ReportType")) = "ManpowerProductivityByTeamMemberSummary" Then
                ...
                '  Dim repPath As String = Server.MapPath("~/Reports/ManagementReports/ManpowerProductivityByTeamMemberSummary.rpt")
