<%@ Page Title="Service Record Moved to Next Month" Language="VB" MasterPageFile="~/MasterPage_Report.master" AutoEventWireup="false" CodeFile="RV_Select_ServicesMovedToNextMonth.aspx.vb" Inherits="RV_Select_ServicesMovedToNextMonth" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold; color: #000099;">Postponed Services</h4>
    ...
    <table style="width: 100%; font-family: Calibri; font-size: 15px; font-weight: bold; color: black; text-align: left; padding-left: 20px; line-height: 25px;">
        <tr>
            <td class="CellFormat" style="width: 25%">ServiceDatePeriod</td>
            <td class="CellTextBox">
                <asp:TextBox ID="txtSvcDateFrom" runat="server" MaxLength="10" Height="16px" Width="16.5%"></asp:TextBox>
                <asp:CalendarExtender ID="CalendarExtender2" runat="server" PopupButtonID="txtSvcDateFrom"  OnClientShown="onCalendarShown2" OnClientHidden="onCalendarHidden2" TargetControlID="txtSvcDateFrom" Format="yyyyMM" Enabled="True" BehaviorID="calendar2"></asp:CalendarExtender>
                <%--&nbsp;&nbsp;&nbsp;TO&nbsp;&nbsp;&nbsp;--%>
             <%--   <asp:TextBox ID="txtSvcDateTo" runat="server" MaxLength="10" Height="16px" Width="16.5%"></asp:TextBox>
                <asp:CalendarExtender ID="CalendarExtender1" runat="server" PopupButtonID="txtSvcDateTo" TargetControlID="txtSvcDateTo" Format="yyyyMM" Enabled="True"></asp:CalendarExtender>
       --%>     </td>
        </tr>
          <tr>
