...
Partial Class RV_Select_Adjustment
    ...
    End Sub
        ...
        Protected Sub btnPrintServiceRecordList_Click(sender As Object, e As EventArgs) Handles btnPrintServiceRecordList.Click
            ...
            selection = ""
        selFormula = "{tblcn1.rcno} <> 0 and {tblcn1.GLStatus}='P' and {tblcn1.ModuleType}='AN'"
            ...
            If String.IsNullOrEmpty(txtSvcDateFrom.Text) = False Then
                ...
                Else
                    ...
                    Return
                End If
            selFormula = selFormula + " and {tblcn1.CNDate} >=" + "#" + d.ToString("MM-dd-yyyy") + "#"
        ...
        'Else
        '    selFormula = selFormula + " and {tblcn1.CompanyGroup} = '" + ddlCompanyGrp.Text + "'"
        '    If selection = "" Then
        ...
        If YrStrList1.Count > 0 Then
            ...
            selFormula = selFormula + " and {tblcn1.CompanyGroup} in [" + YrStr + "]"
            If selection = "" Then
        ...
        End If
            ...
            Else
                selFormula = selFormula + " and {tblcn1.Salesman} = '" + ddlSalesMan.Text + "'"
                If selection = "" Then
            ...
            If ddlAccountType.Text = "-1" Then
            Else
                selFormula = selFormula + " and {tblcn1.ContactType} = '" + ddlAccountType.Text + "'"
                If selection = "" Then
            ...
            If String.IsNullOrEmpty(txtAccountID.Text) = False Then
                selFormula = selFormula + " and {tblcn1.Accountid} = '" + txtAccountID.Text + "'"
                If selection = "" Then
            ...
            selFormula = selFormula + " and {tblcn1.CustomerName} like '*" + txtCustName.Text + "*'"
                If selection = "" Then
            ...
            If rbtnSelect.SelectedValue = "1" Then
                ...
                Response.Redirect("RV_AdjNoteByClient_Details.aspx")
                ElseIf rbtnSelectDetSumm.SelectedValue = "2" Then
                Response.Redirect("RV_AdjNoteByClient_Summary.aspx")
                End If
            ElseIf rbtnSelect.SelectedValue = "2" Then
                If rbtnSelectDetSumm.SelectedValue = "1" Then
                Response.Redirect("RV_AdjNoteByCompanyGroup_Details.aspx")
                ElseIf rbtnSelectDetSumm.SelectedValue = "2" Then
                Response.Redirect("RV_AdjNoteByCompanyGroup_Summary.aspx")
                End If

            ElseIf rbtnSelect.SelectedValue = "3" Then
                If rbtnSelectDetSumm.SelectedValue = "1" Then
                Response.Redirect("RV_AdjNoteBySalesPerson_Details.aspx")
                ElseIf rbtnSelectDetSumm.SelectedValue = "2" Then
                Response.Redirect("RV_AdjNoteBySalesPerson_Summary.aspx")
                End If
            ElseIf rbtnSelect.SelectedValue = "4" Then
                If rbtnSelectDetSumm.SelectedValue = "1" Then
                Response.Redirect("RV_AdjNoteByGLCode_Details.aspx")
                ElseIf rbtnSelectDetSumm.SelectedValue = "2" Then
                Response.Redirect("RV_AdjNoteByGLCode_Summary.aspx")
                End If
            End If
            '  
