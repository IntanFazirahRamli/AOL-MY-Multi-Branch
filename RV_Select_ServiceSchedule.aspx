<%@ Page Title="Service Schedule Report Selection" Language="VB" MasterPageFile="~/MasterPage_Report.master" AutoEventWireup="false" CodeFile="RV_Select_ServiceSchedule.aspx.vb" Inherits="RV_Select_ServiceSchedule" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
      ...
      <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" ScriptMode="Release">
       ...
       <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">SCHEDULED SERVICE LISTING REPORT</h4>
     ...
     <table style="WIDTH:100%;font-family: Calibri; font-size: 15px; font-weight: bold; color: black;text-align:left;padding-left:20px;line-height:25px;">
                 <%--<tr>
                  ...
                  <tr>
                      <td class="CellFormat" style="width:30%">Schedule Date</td>
         ...
         <tr>
                    ...
                    <td class="CellTextBox"><asp:TextBox ID="txtContractNo" runat="server" MaxLength="30" Height="16px" Width="35%"></asp:TextBox>
                           </td>
     ...
     <Style2 SelectBoxWidth="35.5%" DropDownBoxBoxWidth="35.5%" DropDownBoxBoxHeight="120" />
 ...
 </cc1:dropdowncheckboxes> <%--<asp:DropDownList ID="ddlCompanyGrp" runat="server" CssClass="chzn-select" DataSourceID="SqlDSCompanyGroup" DataTextField="companygroup" DataValueField="companygroup" Width="35.5%" Height="25px" AppendDataBoundItems="True">
                                          <asp:ListItem Text="--SELECT--" Value="-1" />
                                     </asp:DropDownList>--%>
                           </td>
                  </tr>
            <tr>
               ...
               <tr>
                    ...
                    <td class="CellTextBox">  <asp:TextBox ID="txtCustName" runat="server" MaxLength="200" Height="16px" Width="60%"></asp:TextBox>
                               </td>
                  </tr>
           <tr>
                    <td class="CellTextBox" colspan="2" style="padding-left: 130px;padding-top:20px;padding-bottom:20px; text-align:CENTER; width:600px; word-spacing: 20px; text-indent: 40px;">
           ...
           <tr>
                  <td colspan="2" style="text-align:center"><asp:Button ID="btnPrintServiceSchedule" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="Print" Width="100px"/>
           ...
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btnCloseServiceSchedule" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="Cancel" Width="100px" />
                        </td>
            ...
            <%--  <tr>
                  <td colspan="2" style="text-align:center"><asp:Button ID="btnPrintServiceSchedule" runat="server" CssClass="button" BackColor="#CFC6C0"  Font-Bold="True" Text="Print" Width="100px"/>
                                  &nbsp;<asp:Button ID="btnCloseServiceSchedule" runat="server" CssClass="button" BackColor="#CFC6C0"  Font-Bold="True" Text="Cancel" Width="100px" />
                        </td>
              </tr>--%>
        </table>
