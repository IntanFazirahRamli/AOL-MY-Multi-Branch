<%@ Page Title="Mobile Device EndPoint Master" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Master_MobileDeviceEndPoint.aspx.vb" Inherits="Master_MobileDeviceEndPoint" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="text-align:center">
        ...
        <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">Mobile Device End Point</h3>
    <br />
...
<asp:Button ID="btnEdit" runat="server" Font-Bold="True" Text="EDIT" Width="100px"  CssClass="roundbutton1" BackColor="#CFC6C0" Visible="true" />
                    ...
                    <asp:Button ID="btnDelete" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="DELETE" Width="100px" Visible="false" OnClientClick = "Confirm(); currentdatetime()"/>
          ...
          <tr>
                <td style="text-align:right;display:inline;">
                    ...
                    <td style="text-align:right;width:35%">  <asp:ImageButton ID="btnResetSearch" runat="server" ImageUrl="~/Images/reset1.png" Height="25px" Width="25px" ToolTip="RESET SEARCH" />  <asp:TextBox ID="txtSearchEndPoint" runat="server" Width="370px" Height="25px" Text = "Search Here" ForeColor = "Gray" onblur = "WaterMark1(this, event);" onfocus = "WaterMark1(this, event);" AutoPostBack="True"></asp:TextBox>      
 ...
 <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataKeyNames="Country" Font-Size="15px" HorizontalAlign="Center" AllowSorting="True">
            <Columns>
               ...
               <ControlStyle Width="200px" />
                ...
                <asp:BoundField DataField="WebServiceURL" HeaderText="WebServiceURL" SortExpression="WebServiceURL" >
               ...
               <ControlStyle Width="100px" />
                ...
                <%--<asp:TemplateField HeaderText="Active">
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="chkActive" runat="server"  Enabled="false" Checked='<%#If(Eval("Active").ToString() = "Y", True, False)%>' />
                                                 </ItemTemplate>
                                                   </asp:TemplateField>--%>
                <%-- <asp:TemplateField HeaderText="Include in Portfolio">
                          <ItemTemplate>
                              <asp:CheckBox ID="chkIncludeinPortfolio" runat="server" Enabled="false" Checked='<%#Eval("Active").ToString()%>' />
                          </ItemTemplate>
          ...
          <tr>
            ...
            <tr>
                    ...
                    <td class="CellTextBoxADM"><asp:TextBox ID="txtWebServiceURL" runat="server" MaxLength="100" Height="16px" Width="60%"></asp:TextBox></td>
                     

                 </tr>
         
                                              <tr>
                                   <td class="CellFormatADM" >Active  </td>
                     <td style="text-align:left;padding-left:5px"> <asp:CheckBox ID="chkActive" runat="server" Visible="true" /></td>
...
<asp:Button ID="btnCancel" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="CANCEL" Width="100px" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>" SelectCommand="SELECT * FROM tblmobiledevicecountry where rcno<>0"></asp:SqlDataSource>
