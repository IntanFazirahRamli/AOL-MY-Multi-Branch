<%@ Page Title="Service Record with Different Schedule Date and Service Date" Language="VB" MasterPageFile="~/MasterPage_Report.master" AutoEventWireup="false" CodeFile="RV_Select_SvcWithDiffSchDateAndSvcDate.aspx.vb" Inherits="RV_Select_SvcWithDiffSchDateAndSvcDate" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
      <script type="text/javascript">
       ...
       <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;padding-left:5%">SERVICE RECORD WITH DIFFERENT SCHEDULE DATE AND SERVICE DATE</h4>
...
<%--            <tr>
     ...
     <table style="font-family: Calibri; font-size: 15px; font-weight: bold; color: black;text-align:left;padding-left:20px;line-height:20px;">
             ...
             <tr>
                      <td class="CellFormat" style="width:30%">CompanyGroup</td>
     ...
     <Style2 SelectBoxWidth="60.5%" DropDownBoxBoxWidth="60.5%" DropDownBoxBoxHeight="120" />
                          ...
                          <%--<asp:DropDownList ID="ddlCompanyGrp" runat="server" CssClass="chzn-select" DataSourceID="SqlDSCompanyGroup" DataTextField="companygroup" DataValueField="companygroup" Width="60.5%" Height="25px" AppendDataBoundItems="True">
         ...
         <tr>
                    ...
                    <td class="CellTextBox"><asp:TextBox ID="txtContractNo" runat="server" MaxLength="30" Height="16px" Width="60%"></asp:TextBox>
                           </td>
                    <td class="CellTextBox">  &nbsp;</td>
                  </tr>
           <tr>
               ...
               <tr>
                    ...
                    <td class="CellTextBox" colspan="3" style="padding-left: 180px;padding-top:20px;padding-bottom:20px; text-align:left; width:600px; word-spacing: 20px; text-indent: 40px;">
                      <asp:RadioButtonList ID="rdbFormat" runat="server" CellPadding="4" CellSpacing="4" RepeatDirection="Horizontal" Width="545px">
                          <asp:ListItem Selected="True" Value="Format2">Detail</asp:ListItem>
                          <asp:ListItem value="Format1">Summary</asp:ListItem>
