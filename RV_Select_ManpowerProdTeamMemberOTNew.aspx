<%@ Page Title="Manpower Productivity by Team Member - OT Report Selection" Language="VB" MasterPageFile="~/MasterPage_Report.master" AutoEventWireup="false" CodeFile="RV_Select_ManpowerProdTeamMemberOTNew.aspx.vb" Inherits="RV_Select_ManpowerProdTeamMemberOTNew" %>
...
<%--            <tr>
     ...
     <Style2 SelectBoxWidth="35.5%" DropDownBoxBoxWidth="35.5%" DropDownBoxBoxHeight="120" />
            ...
            <tr>
               <td colspan="3" style="padding-left:20%;padding-top:1%">   <asp:Panel ID="Panel1" runat="server" Height="95%" BorderStyle="Solid" BorderColor="#FF9900" BorderWidth="2px" Width="50%" HorizontalAlign="Center">
