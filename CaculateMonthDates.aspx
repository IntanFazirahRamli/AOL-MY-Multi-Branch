<%@ Page Title="Contract" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="CaculateMonthDates.aspx.vb" Inherits="CaculateMonthDates" Culture="en-GB" MaintainScrollPositionOnPostback="true" ValidateRequest="false" %>
...
<asp:TabContainer ID="tb1" runat="server" ActiveTabIndex="0" Font-Names="Calibri" Height="100%" Width="90%" CssClass="ajax__tab_xp" AutoPostBack="True">
    <asp:TabPanel  runat="server"   HeaderText=" General & Billing Info" ID="TabPanel1"><HeaderTemplate>General Info &amp; Summary</HeaderTemplate><ContentTemplate><table border="0" style="width:75%; margin:auto"></table><br /><asp:SqlDataSource ID="SqlDSContractNo" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>" SelectCommand="SELECT ContractNo, ProspectId, StaffId, Status, ContactType, CustCode, CustName, CustAddr, InChargeId, EntryDate, ContractDate, Contact, Telephone, Fax, AgreeValue, Duration, DurationMs, StartDate, EndDate, ActualEnd, ServiceNo, ServiceBal, ServiceAmt, HourNo, HourBal, HourAmt, CallNo, CallBal, CallAmt, ResponseHours, CancelCharges, CompensatePct, CompensateMax, WeekDayFrom1, WeekDayFrom2, WeekDayFrom3, WeekDayTo1, WeekDayTo2, WeekDayTo3, WeekEndFrom1, WeekEndFrom2, WeekEndFrom3, WeekEndTo1, WeekEndTo2, WeekEndTo3, DayVisitRate1, DayVisitRate2, DayVisitRate3, DayHourRate1, DayHourRate2, DayHourRate3, DayTransport1, DayTransport2, DayTransport3, EndVisitRate1, EndVisitRate2, EndVisitRate3, EndHourRate1, EndHourRate2, EndHourRate3, EndTransport1, EndTransport2, EndTransport3, Notes, Rcno, Comments, ActualStaff, ServiceNoActual, HourNoActual, CallNoActual, MinDuration, OContractNo, RenewalSt, RenewalDate, UnitNo, UnitBal, UnitAmt, UnitNoActual, NotedSt, NotedDate, settle, ActualServHrs, CreatedBy, CreatedOn, LastModifiedBy, LastModifiedOn, YourReference, ContractGroup, PrintBody, RenewalContractNo, ServDayMethod, ServDay, GSt, ServiceStart, ServiceEnd, ServiceFrequence, TimeIn, TimeOut, WarrantyStart, WarrantyEnd, ContractValue, PerServiceValue, Disc_Percent, DiscAmt, BillingFrequency, DayService1, DayService2, DayService3, DayService4, Support, ScheduleType, TeamID, WebCreateDeviceID, WebCreateSource, WebFlowFrom, WebFlowTo, WebEditSource, WebDeleteStatus, WebLastEditDevice, Postal, LocateGrp, Scheduler, ContactPersonMobile, SalesMan, OurReference, GSTNos, ServiceDescription, PrintingRemarks, Rev, MainContractNo, AmtCompleted, AmtBalance, AllocatedSvcTime, Remarks, QuotePrice, QuoteUnitMS, CompanyGroup, SalesGRP, AmtBalance FROM tblcontract WHERE (ContractNo = @contractno)"><FilterParameters><asp:ControlParameter ControlID="txtcontractno" Name="ContractNo" PropertyName="Text" /></FilterParameters><SelectParameters><asp:ControlParameter ControlID="txtContractNo" Name="@contractno" PropertyName="Text" /></SelectParameters></asp:SqlDataSource><asp:Panel ID="pnlPopUpClient" runat="server" BackColor="White" Width="98%" Height="80%" BorderColor="#003366" BorderWidth="1px" HorizontalAlign="Center"><table border="0" style="margin-left:auto; margin-right:auto; "><tr><td colspan="2" style="text-align:center;"><h4 style="color: #000000">Select Customer</h4></td><td style="width:1%;text-align:right;"><asp:ImageButton ID="btnPnlClientClose" runat="server" ImageUrl="~/Images/closebutton.png" Height="27px" Width="30px" /></td></tr><tr><td colspan="2" style="width:10%;font-size:15px;font-weight:bold;font-family:Calibri; color:black;text-align:center;padding-left:20px;">&#160;Search Name &#160;&#160; <asp:ImageButton ID="btnPopUpClientReset" runat="server" Height="22px" ImageAlign="Middle" ImageUrl="~/Images/resetbutton.jpg" Width="24px"></asp:ImageButton><asp:TextBox ID="txtPopUpClient" runat="server" Height="16px" MaxLength="50" Width="400px" ForeColor="Gray" onblur = "WaterMarkClient(this, event);" onfocus = "WaterMarkClient(this, event);" AutoPostBack="True">Search Here for AccountID or Client Name or Contact Person</asp:TextBox><asp:ImageButton ID="btnPopUpClientSearch" runat="server" Height="22px" ImageAlign="Middle" ImageUrl="~/Images/searchbutton.jpg" OnClick="btnPopUpClientSearch_Click" Width="24px"></asp:ImageButton></td><td><asp:TextBox ID="txtPopupClientSearch" runat="server" Visible="False"></asp:TextBox></td></tr></table><div style="text-align:center; padding-left: 10px; padding-bottom: 5px;"><div class="AlphabetPager"><asp:Repeater ID="rptClientAlphabets" runat="server" Visible="False"><ItemTemplate><asp:LinkButton ID="LinkButton1" runat="server" Text='<%#Eval("Value")%>' OnClick="ClientAlphabet_Click" ForeColor="Black" /></ItemTemplate></asp:Repeater></div><br /><asp:SqlDataSource ID="SqlDSClient" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>"
            ...
            <asp:Label ID="lblBranch2" runat="server" Text="Branch"></asp:Label></td><td style="font-size: 15px; font-weight: bold; font-family: Calibri; text-align: left; padding-left: 1%; width: 72%">
                <asp:DropDownList ID="txtLocation" runat="server" AppendDataBoundItems="True" Width="25%">
                    ...
                    <tr style="width:95%"><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:18%; text-align:right;">Status</td><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:72%">
                        <asp:TextBox ID="txtStatus" runat="server"   AutoCompleteType="Disabled" Enabled="False" Height="16px" Width="25%"></asp:TextBox>
                       </td></tr>
             <tr style="width:95%">
            ...
            <asp:TextBox ID="txtPONo" runat="server" AutoCompleteType="Disabled" Height="16px" MaxLength="25" Width="40%"></asp:TextBox>
    ...
    <asp:Panel ID="PnlChSt" runat="server" BackColor="White" Width="50%" Height="80%" BorderColor="#003366" BorderWidth="1" Visible="true" ScrollBars="Auto">
              <br />
                 ...
                 <tr>
                   ...
                   <tr>
                       ...
                       <td colspan="2" style="font-size:18px; font-weight:bold;font-family:Calibri;text-align:center;">
                           <asp:TextBox ID="txtAlertStatus" runat="server" style="font-size:18px; font-weight:bold;font-family:Calibri;text-align:center;" AutoCompleteType="Disabled" Height="16px" Width="80%" BackColor="Red" BorderStyle="None" ForeColor="White" ></asp:TextBox>
                       </td>
                   </tr>
              <tr>
                              
                        <td style="width:20%; font-size:15px;font-weight:bold;font-family:Calibri;color:black;text-align:left;" >Status 
                            <asp:Label ID="Label30" runat="server" Font-Size="14px" ForeColor="Red" Text="*"></asp:Label>
                             </td>
                         
                                 <td colspan="1" style="text-align:left;padding-left:3px;width:70%">  
                                  <asp:DropDownList ID="ddlStatusChSt" runat="server" Width="50%"   AutoPostBack="True">
                                <asp:ListItem>--SELECT--</asp:ListItem>
                               </asp:DropDownList>
                            </td>                              
                           </tr>
                    ...
                    <tr>
                               <td style="width:20%; font-size:15px;font-weight:bold;font-family:Calibri;color:black;text-align:left;" class="auto-style6">
                              ...
                              <td colspan="1" style="text-align:left;padding-left:5px;width:10%">  
                                    <asp:DropDownList ID="ddlTerminationCode" runat="server" Width="50%" AppendDataBoundItems="true" DataSourceID="SqlDSTerminationCode" DataTextField="TC" DataValueField="TC">
                                 <asp:ListItem>--SELECT--</asp:ListItem>
                                           </asp:DropDownList>
                            </td>
                             </tr>
                          <tr>
                              <td style="width:20%; font-size:15px;font-weight:bold;font-family:Calibri;color:black;text-align:left;"><asp:Label ID="lblCommetsChSt" runat="server" Text="Comments"></asp:Label>
                                  <asp:Label ID="Label66" runat="server" Font-Size="14px" ForeColor="Red" Text="*"></asp:Label>
                              </td>
                              <td colspan="1" style="text-align:left;padding-left:5px;width:10%">
                                  <asp:TextBox ID="txtCommentChSt" runat="server" Font-Names="calibri" Font-Size="15px" Height="80px" MaxLength="500" TextMode="MultiLine" Width="49%"></asp:TextBox>
                              </td>
                   </tr>
                          ...
                          <tr>
                              ...
                              <td colspan="1" style="text-align:left;padding-left:5px;width:70%">
                                  <asp:DropDownList ID="ddlOnHoldCodeChSt" runat="server" AppendDataBoundItems="true" Width="50%" AutoPostBack="True">
                                      <asp:ListItem>--SELECT--</asp:ListItem>
                                  </asp:DropDownList>
                              </td>
                   </tr>
                   ...
                   <tr>
                       ...
                       <td colspan="1" style="text-align:left;padding-left:5px;width:70%">
                           <asp:TextBox ID="txtOnHoldCommentsChSt" runat="server" Font-Names="calibri" Font-Size="15px" Height="80px" MaxLength="500" TextMode="MultiLine" Width="49%"></asp:TextBox>
                       </td>
                   </tr>
                   <tr>
                       <td style="width:10%;font-size:15px;font-weight:bold;font-family:Calibri;color:black;text-align:left;">&nbsp;</td>
  ...
  <asp:Button ID="btnAddTeam" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="ADD" Width="90px" Height="30px" Visible="False" />
   ...
   <asp:ModalPopupExtender ID="ModalPopupInvoice" runat="server" CancelControlID="ImageButton4" PopupControlID="pnlPopupInvoiceDetails" TargetControlID="btnDummyInvoice" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
        ...
        <%-- start--%>
         ...
         <asp:Panel ID="pnlNotesTemplate" runat="server" BackColor="White" Width="70%" Height="40%" BorderColor="#003366" BorderWidth="1" Visible="true" ScrollBars="Auto">
              <br />
     ...
     <asp:ModalPopupExtender ID="ModalPopupNotestemplateGrid" runat="server"  CancelControlID="btnCloseNotesTemplateGrid" PopupControlID="pnlNotesTemplateGrid" TargetControlID="ImageButton5" BackgroundCssClass="modalBackground"  ></asp:ModalPopupExtender>
         ...
         <%--end--%>
                ...
                <%--Confirm delete uploaded file--%>
                 ...
                 <asp:Panel ID="pnlConfirmDeleteUploadedFile" runat="server" BackColor="White" Width="400px" Height="130px" BorderColor="#003366" BorderWidth="1px" ScrollBars="Auto">
              ...
              <tr style="background-color:navy; color:white;font-size:medium">
               ...
               <tr>
                      <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          &nbsp;<asp:Label ID="Label17" runat="server" Text="Changing the Contract's Agreed Value will not change"></asp:Label>
               ...
               <tr>
                      <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          &nbsp;<asp:Label ID="lblLine2EditAgreeValueSave" runat="server" Text="values of the services. You have to manually adjust"></asp:Label>
               ...
               <tr>
                      <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          &nbsp;<asp:Label ID="lblLine3EditAgreeValueSave" runat="server" Text="the values of the service to match."></asp:Label>
               ...
               <tr>
                      <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          &nbsp;<asp:Label ID="lblLine4EditAgreeValueSave" runat="server" Text="Do you wish to continue?"></asp:Label>
                            ...
                            <tr style="padding-top:40px;">
                             <td colspan="2" style="text-align:center"><asp:Button ID="btnEditAgreeValueSaveYes" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="Yes" Width="100px"/>
      ...
      <asp:ModalPopupExtender ID="mdlEditAgreeValueSave" runat="server" CancelControlID="" PopupControlID="pnlEditAgreeValueSave" TargetControlID="btnDummyEditAgreeValueSave" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
             ...
             <tr>
               <td colspan="2" style="width:100%;text-align:center;font-size:18px;font-weight:bold;font-family:'Calibri';"> 
                      <asp:Label ID="lblAlertSchDate" runat="server" BackColor="Red" ForeColor="White"></asp:Label>
                         ...
                         <tr>
                             <td class="CellFormat">Manual Contract No.</td>
                             <td class="CellTextBox">
                                    <asp:TextBox ID="txtYourReferenceEdit" runat="server" Height="16px" MaxLength="25" Width="50%"></asp:TextBox>
                      </td>
                         </tr>
                          <tr>
                              <td class="CellFormat">PO No.</td>
                              <td class="CellTextBox">
                                  <asp:TextBox ID="txtPONoEdit" runat="server" AutoCompleteType="Disabled" Height="16px" MaxLength="30" Width="50%"></asp:TextBox>
                              </td>
                         </tr>
                          <tr>
                               <td class="CellFormat">Other Reference</td>
               ...
               <td colspan="2" style="width:100%;text-align:center;font-size:18px;font-weight:bold;font-family:'Calibri';"> 
                      <asp:Label ID="lblAlertScheduler" runat="server" BackColor="Red" ForeColor="White"></asp:Label>
                         ...
                         <tr>
                             ...
                             <td class="CellTextBox">
                                    <asp:DropDownList ID="ddlSchedulerEdit" runat="server" AppendDataBoundItems="True" Width="40.5%">
                                        <asp:ListItem>--SELECT--</asp:ListItem>
                                    </asp:DropDownList>
                      </td>
                         </tr>
               ...
               <td colspan="2" style="width:100%;text-align:center;font-size:18px;font-weight:bold;font-family:'Calibri';"> 
                      <asp:Label ID="lblAlertSalesman" runat="server" BackColor="Red" ForeColor="White"></asp:Label>
                         ...
                         <tr>
                             ...
                             <td class="CellTextBox">
                                    <asp:DropDownList ID="ddlSalesmanEdit" runat="server" AppendDataBoundItems="True" Width="40.5%">
                                        <asp:ListItem>--SELECT--</asp:ListItem>
                                    </asp:DropDownList>
                      </td>
                         </tr>
        ...
        <%-- end:Company Group--%>
           ...
           <%-- start: Agree Value--%>
            ...
            <asp:Panel ID="pnlEditAgreeValue" runat="server" BackColor="White" Width="40%" Height="35%" BorderColor="#003366" BorderWidth="1px" ScrollBars="Auto">
             ...
             <tr>
               <td colspan="2" style="width:100%;text-align:center;font-size:18px;font-weight:bold;font-family:'Calibri';"> 
                      <asp:Label ID="Label16" runat="server" BackColor="Red" ForeColor="White"></asp:Label>
                         ...
                         <tr>
                             <td class="CellFormat">Agree Value </td>
                             <td class="CellTextBox">
                                    <asp:TextBox ID="txtAgreeValueEdit" runat="server" onchange="calculateportfoliovaluesAgreeValueEdit()" style="text-align:right" Width="40%">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                         ...
                         <tr>
                             ...
                             <td class="CellFormat"> </td>
                              <td colspan="1" style="text-align:left"><asp:Button ID="btnAgreeValueSave" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="Save" Width="120px" OnClientClick="currentdatetime()"/>
                                 <asp:Button ID="btnAgreeValueCancel" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="Cancel" Width="100px" />
                               </td>
                         </tr>
         ...
         submit1 = 0;
            ...
            function statuschange() {
                ...
                if (Left(SelectedText, 1) == 'O') {
                    ...
                    if ( document.getElementById("<%=txtStatus.ClientID%>").value =='H')
                    {
                ...
                if (dateone != "" && dur != "") {
                    ...
                    if (optionselected1 == 0) {
                        ...
                        if (optionselected == 0) {
                            ...
                            var d = new Date(startyear, startmonth, startdate);
                            //d.setMonth(d.getMonth() + 8);

                            document.getElementById("<%=txtContractEnd.ClientID%>").value = startTime;
                            document.getElementById("<%=txtServEnd.ClientID%>").value = startTime;
                            // start
