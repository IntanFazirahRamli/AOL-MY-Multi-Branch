...
Partial Class RV_Export_ServiceRecordDetail
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                If Convert.ToString(Session("ReportType")) = "SvcRecDetailListing" Then

                    crReportDocument.Load(Server.MapPath("~/Reports/ServiceRecordReports/SvcRecDetailListing.rpt"))
                ...
                ElseIf Convert.ToString(Session("ReportType")) = "SvcRecDetailListingByStaff" Then

                    crReportDocument.Load(Server.MapPath("~/Reports/ServiceRecordReports/SvcRecDetailListingByStaff.rpt"))
                    crReportDocument.SetParameterValue("pselectedFields", Convert.ToString(Session("selection")))
                    crReportDocument.SetParameterValue("pUserId", Convert.ToString(Session("UserId")))

                ElseIf Convert.ToString(Session("ReportType")) = "SvcRecWithoutSign" Then

                    crReportDocument.Load(Server.MapPath("~/Reports/ServiceRecordReports/SvcRecWithoutSign.rpt"))
                ...
                If Convert.ToString(Session("ReportType")) = "SvcRecDetailListing" Then
                    ...
                    FilePath = Server.MapPath("~/PDFs/" + Convert.ToString(Session("UserID") + "_ServiceRecordDetail.PDF"))
                ...
                ElseIf Convert.ToString(Session("ReportType")) = "SvcRecWithoutSign" Then
                    FilePath = Server.MapPath("~/PDFs/" + Convert.ToString(Session("UserID") + "_ServiceRecord.PDF"))
                ...
                If FileBuffer IsNot Nothing Then
                    ...
                    If Convert.ToString(Session("ReportType")) = "SvcRecDetailListing" Then
                         ...
                         Response.AddHeader("content-disposition", "inline; filename=ServiceRecordDetail.pdf")
                    ElseIf Convert.ToString(Session("ReportType")) = "SvcRecDetailListingByStaff" Then
    ...
    Protected Sub Page_Unload(sender As Object, e As EventArgs) Handles Me.Unload
        Dim FilePath As String = Server.MapPath("~/PDFs/" + Convert.ToString(Session("UserID") + "_ServiceRecordDetail.PDF"))
