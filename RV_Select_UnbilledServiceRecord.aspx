<%@ Page Title="Unbilled Service Records Listing" Language="VB" MasterPageFile="~/MasterPage_Report.master" AutoEventWireup="false" CodeFile="RV_Select_UnbilledServiceRecord.aspx.vb" Inherits="RV_Select_UnbilledServiceRecord" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
   ...
   <link rel="Stylesheet" type="text/css" href="CSS/DefaultStyles.css" />
      ...
      <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" ScriptMode="Release">
       ...
       <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">UNBILLED SERVICE RECORD LISTING REPORT</h4>
...
<%--            <tr>
      ...
      <table style="width:100%;font-family: Calibri; font-size: 15px; font-weight: bold; color: black;text-align:left;padding-left:50px;line-height:20px;">
             ...
             <tr>
                    ...
                    <td class="CellTextBox"> <cc1:dropdowncheckboxes ID="ddlCompanyGrp" runat="server" Width="25.5%" UseSelectAllNode = "true" DataSourceID="SqlDSCompanyGroup" DataTextField="CompanyGroup" DataValueField="CompanyGroup" AddJQueryReference="true" UseButtons="false" AutoPostBack="True">
     <Style2 SelectBoxWidth="25.5%" DropDownBoxBoxWidth="25.5%" DropDownBoxBoxHeight="120" />
                    
 </cc1:dropdowncheckboxes>&nbsp;<asp:Label ID="lblCompanygrp" runat="server" Text="" CssClass="CellFormat"></asp:Label>
                           </td>
         ...
         <tr>
                  ...
                  <td class="CellTextBox"> <asp:dropdownlist ID="ddlBillingFrequency" runat="server" AppendDataBoundItems="TRUE" Width="25.5%" DataSourceID="SqlDSBillingFrequency" DataTextField="Frequency" DataValueField="Frequency" >
                    ...
                    <div style="padding-left: 20px; text-align: left; padding-bottom: 20px;">
                        <asp:RadioButtonList ID="rbtnSelect" runat="server" CellSpacing="5" CellPadding="5" RepeatDirection="Vertical" RepeatColumns="4" Width="90%">
                            ...
                            <asp:ListItem Text="CompanyGroup" Value="2"></asp:ListItem>
                              ...
                              <asp:ListItem Text="BillingFrequency" Value="4"></asp:ListItem>
                        </asp:RadioButtonList>
                    </div>
                </asp:Panel>
            </td>
