<%@ Page Title="Service Record Listing Report" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="RV_ServiceRecord02.aspx.vb" Inherits="RV_ServiceRecord02" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <%--  <a href="RV_ServiceRecord02.aspx"><span style="color: #FFFFFF">RV_ServiceRecord02.aspx</span></a>--%><CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="true" 
    ...
    <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
        <Report FileName="Reports\ServiceRecordReports\ServiceRecord02.rpt">
        </Report>
