<%@ Page Title="Outstanding Invoice Details By Due Date" Language="VB" MasterPageFile="~/MasterPage_Report.master" EnableEventValidation="false" AutoEventWireup="false" CodeFile="RV_Select_OutstandingInvoiceDetailsByDueDate_Sasi.aspx.vb" Inherits="RV_Select_OutstandingInvoiceDetailsByDueDate_Sasi" %>
      ...
      <table style="width:100%;font-family: Calibri; font-size: 15px; font-weight: bold; color: black;text-align:left;padding-left:50px;line-height:20px;">
          ...
          <tr>
                 ...
                 <td class="CellFormat" style="text-align: right; ">Salesman</td>
                    <td class="CellTextBox"><asp:DropDownList ID="ddlSalesMan" runat="server" AppendDataBoundItems="True" CssClass="chzn-select" DataSourceID="SqlDSSalesMan" DataTextField="StaffId" DataValueField="StaffId" Height="25px" Width="85.5%"><asp:ListItem Text="--SELECT--" Value="-1" /></asp:DropDownList>
                                 </td>
            ...
            <td colspan="3" style="text-align: left;padding-left:20px ">
              ...
              <tr>
                  <td colspan="4" style="text-align:center; ">
                       <asp:Button ID="btnUpdate" runat="server" CssClass="button" BackColor="#CFC6C0"  Font-Bold="True" Text="Update" Width="100px" Visible="False" />
