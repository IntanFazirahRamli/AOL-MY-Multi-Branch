...
Public Class Rpt_Master_Country
    ...
    Public Overrides Property FullResourceName() As String
        Get
            'Return "SitaPest.Rpt_Master_Country.rpt"
            Return "Rpt_Master_Country.rpt"
        End Get
        Set
            'Do nothing
...
Public Class CachedRpt_Master_Country
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Master_Country = New Rpt_Master_Country()
        rpt.Site = Me.Site
        Return rpt
    End Function
