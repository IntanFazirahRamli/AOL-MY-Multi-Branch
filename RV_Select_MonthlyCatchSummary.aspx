<%@ Page Title="Monthly Catch Summary Report" Language="VB" MasterPageFile="~/MasterPage_Report.master" AutoEventWireup="false" CodeFile="RV_Select_MonthlyCatchSummary.aspx.vb" Inherits="RV_Select_MonthlyCatchSummary" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
   <script>
      ...
      <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" ScriptMode="Release">
       ...
       <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">SMART MONTHLY SUMMARY REPORT</h4>
...
<%--            <tr>
      ...
      <table class="centered" style="width:100%;font-family: Calibri; font-size: 15px; font-weight: bold; color: black;line-height:20px;text-align:center">
                <tr style="text-align:center;">
                      <td class="CellFormat" style="width:40%">LocationID</td>
             ...
             <tr style="text-align:center;">
                      <td class="CellFormat">ServiceMonth</td>
                    <td class="CellTextBox"><asp:TextBox ID="txtSvcDateFrom" runat="server" MaxLength="10" Height="16px" Width="25%" AutoCompleteType="None"></asp:TextBox>                        
                                 <asp:CalendarExtender ID="CalendarExtender2" runat="server" PopupButtonID="txtSvcDateFrom" TargetControlID="txtSvcDateFrom" Format="MMM yyyy"  OnClientHidden="onCalendarHidden" OnClientShown="onCalendarShown" BehaviorID="calendar1"></asp:CalendarExtender> </td>
