<%@ Page Title="Notes Template Master" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Master_NotesTemplate.aspx.vb" Inherits="Master_NotesTemplate"  Culture="en-GB"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="text-align:center">
        ...
        <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">Notes Template</h3>
    <br />
...
<asp:Button ID="btnEdit" runat="server" Font-Bold="True" Text="EDIT" Width="100px"  CssClass="roundbutton1" BackColor="#CFC6C0" Visible="true" />
            ...
            <tr class="Centered">
                <td colspan="2">
 <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataKeyNames="NoteID" Font-Size="15px" HorizontalAlign="Center" AllowSorting="True">
            <Columns>
                 <asp:CommandField HeaderText="Select" ShowHeader="True" ShowSelectButton="True" >
                <ControlStyle Width="150px" />
                <ItemStyle Width="150px" />
                </asp:CommandField>
                <asp:BoundField DataField="NoteID" HeaderText="NoteID" ReadOnly="True" SortExpression="NoteID">
               <ControlStyle Width="200px" />
                ...
                <ItemStyle Width="350px" HorizontalAlign="Left" />
                 ...
                 <asp:BoundField DataField="DefaultDisplay" HeaderText="Default Display" />
          ...
          <tr>
            ...
            <tr>
                    ...
                    <td class="CellFormatADM">Note ID<asp:Label ID="Label23" runat="server" visible="true" Font-Size="14px" ForeColor="Red" Text="*" Height="20px"></asp:Label></td>
                     

                    <td class="CellTextBoxADM"> <asp:TextBox ID="txtNoteID" runat="server" MaxLength="50" Height="16px" Width="30%"></asp:TextBox></td>
              ...
              <tr>
                    ...
                    <td class="CellFormatADM">Content</td>
                     

                    <td class="CellTextBoxADM"> <asp:TextBox ID="txtContent" runat="server" MaxLength="50" Height="16px" Width="60%"></asp:TextBox></td>
            ...
            <tr>
                    ...
                    <td class="CellFormatADM">Module</td>
                     

                    <td class="CellTextBoxADM"><asp:TextBox ID="txtModule" runat="server" MaxLength="100" Height="16px" Width="60%"></asp:TextBox></td>
            ...
            <tr>
                    ...
                    <td class="CellFormatADM">Default Display</td>
                     

                    <td class="CellTextBoxADM"><asp:CheckBox runat="server" ID="ChkDefaultDisplay" onchange="EnableDisableWarranty()"></asp:CheckBox>
                    </td>
...
<asp:Button ID="btnCancel" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="CANCEL" Width="100px" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>" SelectCommand="SELECT * FROM tblNotesTemplate order by NoteID"></asp:SqlDataSource>
