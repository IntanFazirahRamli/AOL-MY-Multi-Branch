<%@ Page Title="ReceiptTransactions" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="RV_ReceiptTransactions.aspx.vb" Inherits="RV_ReceiptTransactions" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
     <div style="text-align:center">
        <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">Receipt Transactions</h3>
    <br />
