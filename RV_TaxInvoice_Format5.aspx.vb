...
Partial Class RV_TaxInvoice_Format5
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                CType(Me.Master, MasterPage).EventLog_Insert(Session("UserID"), "TAX INVOICE FORMAT-5", Left(Convert.ToString(Session("InvoiceNumber")), 50), "ADD", DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss", New System.Globalization.CultureInfo("en-GB")), 0, 0, 0, Left(Convert.ToString(Session("InvoiceNumber")), 20), "", "")
                ...
                ' crReportDocument.Load(Server.MapPath("~/Reports/ARReports/TaxInvoice_Format5.rpt"))
                ...
                Else
                    If Request.QueryString("Export") = "PDF" Then
                        crReportDocument.Load(Server.MapPath("~/Reports/ARReports/TaxInvoiceE_Format5.rpt"))
                    ElseIf Request.QueryString("Export") = "Word" Or Request.QueryString("Export") = "View" Then
                        crReportDocument.Load(Server.MapPath("~/Reports/ARReports/TaxInvoiceE_Format5_New.rpt"))
                    End If
    ...
    Private Sub InsertIntoTblWebEventLog(events As String, errorMsg As String, ID As String)
        Try
            ...
            insCmds.Parameters.AddWithValue("@LoginId", "RV-TAXINVOICE5 - " + Session("userid"))
