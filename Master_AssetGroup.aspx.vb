...
Partial Class Master_AssetGroup
    ...
    Protected Sub GridView1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles GridView1.SelectedIndexChanged
        ...
        Else
            ...
            txtAssetgroup.Text = Server.HtmlDecode(GridView1.SelectedRow.Cells(1).Text).ToString
        End If
    ...
    Private Sub AccessControl()
        ...
        Try
            ...
            If Session("SecGroupAuthority") <> "ADMINISTRATOR" Then
                ...
                command.CommandText = "SELECT x1302AssetGroupView,  x1302AssetGroupAdd, x1302AssetGroupEdit, x1302AssetGroupDelete FROM tblGroupAccess where GroupAccess = '" & Session("SecGroupAuthority") & "'"
                ...
                If dt.Rows.Count > 0 Then
                    If Not IsDBNull(dt.Rows(0)("x1302AssetGroupView")) Then
                        If String.IsNullOrEmpty(Convert.ToBoolean(dt.Rows(0)("x1302AssetGroupView"))) = False Then
                            If Convert.ToBoolean(dt.Rows(0)("x1302AssetGroupView")) = False Then
                                Response.Redirect("Home.aspx")
                            End If
                        End If
                    End If

                    If Not IsDBNull(dt.Rows(0)("x1302AssetGroupAdd")) Then
                        If String.IsNullOrEmpty(dt.Rows(0)("x1302AssetGroupAdd")) = False Then
                            Me.btnADD.Enabled = dt.Rows(0)("x1302AssetGroupAdd").ToString()
                        End If
                    End If

                    If txtMode.Text = "View" Then
                        If Not IsDBNull(dt.Rows(0)("x1302AssetGroupEdit")) Then
                            If String.IsNullOrEmpty(dt.Rows(0)("x1302AssetGroupEdit")) = False Then
                                Me.btnEdit.Enabled = dt.Rows(0)("x1302AssetGroupEdit").ToString()
                            End If
                        End If

                        If Not IsDBNull(dt.Rows(0)("x1302AssetGroupDelete")) Then
                            If String.IsNullOrEmpty(dt.Rows(0)("x1302AssetGroupDelete")) = False Then
                                Me.btnDelete.Enabled = dt.Rows(0)("x1302AssetGroupDelete").ToString()
                            End If
                        End If
                    Else
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        If txtMode.Text = "New" Then
            Try
                ...
                command1.CommandText = "SELECT * FROM tblassetgroup where assetgroup=@assetgroup"
                command1.Parameters.AddWithValue("@assetgroup", txtAssetGroup.Text)
                ...
                Else
                    ...
                    command.CommandType = CommandType.Text
                    Dim qry As String = "INSERT INTO tblassetgroup(assetgroup,CreatedBy,CreatedOn,LastModifiedBy,LastModifiedOn,Description)"
                    qry = qry + "VALUES(@assetgroup,@CreatedBy,@CreatedOn,@LastModifiedBy,@LastModifiedOn,@Description);"
                    ...
                    If ConfigurationManager.AppSettings("UPPERCASE").ToString() = "YES" Then
                        ...
                        command.Parameters.AddWithValue("@assetgroup", txtAssetGroup.Text.ToUpper)
        ...
        ElseIf txtMode.Text = "Edit" Then
            ...
            Try
                ...
                command2.CommandText = "SELECT * FROM tblassetgroup where assetgroup=@assetgroup and rcno<>" & Convert.ToInt32(txtRcno.Text)
                command2.Parameters.AddWithValue("@assetgroup", txtAssetGroup.Text)
                ...
                Else
                    ...
                    command1.CommandText = "SELECT * FROM tblassetgroup where rcno=" & Convert.ToInt32(txtRcno.Text)
                    command1.Connection = conn
                    ...
                    If dt.Rows.Count > 0 Then
                        ...
                        Dim qry As String
                        If txtExists.Text = "True" Then
                            qry = "update tblassetgroup set LastModifiedBy=@LastModifiedBy,LastModifiedOn=@LastModifiedOn,Description=@Description where rcno=" & Convert.ToInt32(txtRcno.Text)
                        Else
                            qry = "update tblassetgroup set assetgroup=@assetgroup,LastModifiedBy=@LastModifiedBy,LastModifiedOn=@LastModifiedOn,Description=@Description where rcno=" & Convert.ToInt32(txtRcno.Text)
                ...
                If txtMode.Text = "NEW" Then
                    CType(Me.Master, MasterPage).EventLog_Insert(Session("UserID"), "ASSETGRP", txtAssetGroup.Text, "ADD", Convert.ToDateTime(txtCreatedOn.Text), 0, 0, 0, "", "", txtRcno.Text)
                Else
                    CType(Me.Master, MasterPage).EventLog_Insert(Session("UserID"), "ASSETGRP", txtAssetGroup.Text, "EDIT", Convert.ToDateTime(txtCreatedOn.Text), 0, 0, 0, "", "", txtRcno.Text)
                End If
            Catch ex As Exception
                lblAlert.Text = ex.Message
                'MessageBox.Message.Alert(Page, ex.ToString, "str")
        ...
        If confirmValue = "Yes" Then
            ...
            Try
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    command.CommandType = CommandType.Text
                    Dim qry As String = "delete from tblassetgroup where rcno=" & Convert.ToInt32(txtRcno.Text)
                    ...
                    CType(Me.Master, MasterPage).EventLog_Insert(Session("UserID"), "ASSETGRP", txtAssetGroup.Text, "DELETE", Convert.ToDateTime(txtCreatedOn.Text), 0, 0, 0, "", "", txtRcno.Text)
                End If
                conn.Close()
    ...
    Private Function CheckIfExists() As Boolean
        ...
        command1.CommandText = "SELECT * FROM tblasset where AssetGrp=@data"
        command1.Parameters.AddWithValue("@data", txtAssetgroup.Text)
        command1.Connection = conn
