...
Partial Class RV_Select_RenewedContract
    ...
    Protected Sub btnPrintServiceContractList_Click(sender As Object, e As EventArgs) Handles btnPrintServiceContractList.Click
        ...
        selection = ""
        selFormula = "{tblcontract1.rcno} <> 0 and {tblcontract1.RenewalSt} = ""R"" and {tblcontract1.Status}<>""V"""
        ...
        If chkGrouping.SelectedValue = "ContractGroup" Then
            Session.Add("ReportType", "RenewedContract02")
            Response.Redirect("RV_RenewedContract02.aspx")

        ElseIf chkGrouping.SelectedValue = "AccountID" Then
            Session.Add("ReportType", "RenewedContract01")
            Response.Redirect("RV_RenewedContract01.aspx")

        ElseIf chkGrouping.SelectedValue = "Salesman" Then
            Session.Add("ReportType", "RenewedContract03")
            Response.Redirect("RV_RenewedContract03.aspx")
    ...
    Private Function GetData() As Boolean
        ...
        qry = qry + " tblcontract.Status,tblcontract.ContractNo,tblcontract.ContactType, tblcontract.AccountID,  tblcontract.CustName,tblcontract.ContractDate, tblcontract.CompanyGroup,tblcontract.ContractGroup,tblcontract.CategoryID,tblcontract.SalesMan,tblcontract.AgreeValue, tblcontract.StartDate,tblcontract.EndDate, tblcontract.ActualEnd, replace(replace(replace(tblcontract.Notes, char(10), ' '), char(13), ' '), char(9), ' ') as Notes, tblcontract.InChargeId, tblcontract.RenewalSt, tblcontract.RenewalDate, replace(replace(tblcontract.ServiceAddress, char(10), ' '), char(13), ' ') as ServiceAddress, replace(replace(tblcontract.ServiceDescription, char(10), ' '), char(13), ' ') as ServiceDescription,tblcontractdet.ContactPerson,tblcontractdet.Email,tblcontractdet.Mobile,tblcontractdet.Telephone,tblcontractdet.ContactPerson2,tblcontractdet.Contact2Email,tblcontractdet.Contact2Mobile,tblcontractdet.Contact2Tel"

        qry = qry + " FROM tblcontract left JOIN tblcontractdet ON (tblcontract.ContractNo=tblcontractdet.ContractNo) "
        qry = qry + "where tblcontract.rcno<>0 and tblcontract.RenewalSt='R' and tblcontract.Status<>'V'"
        ...
        If String.IsNullOrEmpty(txtContractDateFrom.Text) = False Then
            ...
            End If
            selFormula = selFormula + "and {tblcontract1.RenewalDate} >=" + "#" + d.ToString("MM-dd-yyyy") + "#"
            qry = qry + " and tblcontract.RenewalDate >='" + Convert.ToDateTime(txtContractDateFrom.Text).ToString("yyyy-MM-dd") + "'"
        ...
        If String.IsNullOrEmpty(txtContractDateTo.Text) = False Then
            ...
            End If
            selFormula = selFormula + "and {tblcontract1.RenewalDate} <=" + "#" + d.ToString("MM-dd-yyyy") + "#"
            qry = qry + " and tblcontract.RenewalDate <='" + Convert.ToDateTime(txtContractDateTo.Text).ToString("yyyy-MM-dd") + "'"
        ...
        If String.IsNullOrEmpty(lstSort2.Text) = False Then
            ...
            If YrStrList.Count > 0 Then
                ...
                For i As Integer = 0 To YrStrList.Count - 1
                    If i = 0 Then
                        Session.Add("sort1", YrStrList.Item(i).ToString)
                        qry = qry + YrStrList.Item(i).ToString
    ...
    Public Sub WriteExcelWithNPOI(ByVal dt As DataTable, ByVal extension As String)
        ...
        If Convert.ToString(Session("LocationEnabled")) = "Y" Then
            For i As Integer = 0 To dt.Rows.Count - 1
                ...
                For j As Integer = 0 To dt.Columns.Count - 1
                    ...
                    ElseIf j = 6 Or j = 14 Or j = 12 Or j = 13 Or j = 18 Then
                        If String.IsNullOrEmpty(dt.Rows(i)(j).ToString) = False Then
        ...
        Else
            ...
            For i As Integer = 0 To dt.Rows.Count - 1
                ...
                For j As Integer = 0 To dt.Columns.Count - 1
                    ...
                    ElseIf j = 5 Or j = 11 Or j = 12 Or j = 13 Or j = 17 Then
                        If String.IsNullOrEmpty(dt.Rows(i)(j).ToString) = False Then
                            Dim d As DateTime = Convert.ToDateTime(dt.Rows(i)(j).ToString())
                            cell.SetCellValue(d)
        ...
        Using exportData = New MemoryStream()
            ...
            If extension = "xlsx" Then
                ...
                Response.AddHeader("Content-Disposition", String.Format("attachment;filename={0}", "RenewedContractListing.xlsx"))
                Response.BinaryWrite(exportData.ToArray())
            ElseIf extension = "xls" Then
                Response.ContentType = "application/vnd.ms-excel"
                Response.AddHeader("Content-Disposition", String.Format("attachment;filename={0}", "RenewedContractListing.xls"))
