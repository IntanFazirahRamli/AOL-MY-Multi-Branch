...
Partial Class RV_PortfolioDateSummary
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                Dim repPath As String = Server.MapPath("~/Reports/PortfolioReports/PortfolioDateSummary.rpt")
                ...
                '  crReportDocument.SetParameterValue("StartDate", Convert.ToDateTime(Session("StartDate")))
                '  crReportDocument.SetParameterValue("EndDate", Convert.ToDateTime(Session("EndDate")))
