...
Partial Class RV_ContinuousContract01
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                If Session("ReportType") = "ContinuousContract01" Then
                    repPath = Server.MapPath("~/Reports/ServiceContractReports/ContinuousContract01.rpt")
                ElseIf Session("ReportType") = "ContinuousContract02" Then
                    repPath = Server.MapPath("~/Reports/ServiceContractReports/ContinuousContract02.rpt")
                ElseIf Session("ReportType") = "ContinuousContract03" Then
                    repPath = Server.MapPath("~/Reports/ServiceContractReports/ContinuousContract03.rpt")
                End If
