<%@ Page Title="Service Contract Report Selection" Language="VB" MasterPageFile="~/MasterPage_Report.master" AutoEventWireup="false" CodeFile="RV_Select_Contract01.aspx.vb" Inherits="RV_Select_ServiceContract" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function groupchange() {
            ...
            var chkBoxList = document.getElementById("<%=chkGrouping.ClientID%>");
            var chkBoxCount= chkBoxList.getElementsByTagName("input");
            var clicked = this;

            if (chkBoxCount[0].checked == true) {
                document.getElementById("<%=rdbFormat.ClientID%>").style.display = 'inline';
            }
            else if (chkBoxCount[1].checked == true) {
                document.getElementById("<%=rdbFormat.ClientID%>").style.display = 'inline';
            }
            else if (chkBoxCount[2].checked == true) {

                document.getElementById("<%=rdbFormat.ClientID%>").style.display = 'none';
            }
       ...
       <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">SERVICE CONTRACT LISTING REPORT</h4>
...
<%--            <tr>
      ...
      <table style="width:100%;font-family: Calibri; font-size: 15px; font-weight: bold; color: black;text-align:left;padding-left:20px;line-height:20px;">
                      ...
                      <td colspan="2" style="width:75%">
                            <asp:checkboxlist ID="chkStatusSearch" runat="server" Width="100%" RepeatDirection="Horizontal" RepeatLayout="Table" RepeatColumns="3" CellPadding="3" CellSpacing="3" TextAlign="Right" Enabled="True">
                                 ...
                                 <asp:ListItem Value="O" Selected="True">O - Open/Pending</asp:ListItem>
                                   <asp:ListItem Value="C" Selected="True">C - Completed</asp:ListItem>
                                   ...
                                   <asp:ListItem Value="R" Selected="True">R - Revised</asp:ListItem>                              
                            ...
                            <asp:CheckBox ID="chkSearchAll" runat="server"  Text="All Status" Font-Size="15px" Font-Names="Calibri" Font-Bold="True" onchange="EnableDisableStatusSearch()" BorderColor="White" BorderWidth="4px" Checked="True" />
             ...
             <tr>
                      ...
                      <td colspan="2">
                            <asp:checkboxlist ID="chkRenewalStatus" runat="server" Width="50%" RepeatDirection="Horizontal" RepeatLayout="Table" RepeatColumns="2" TextAlign="Right" Enabled="True">
                              
                                 <asp:ListItem Value="O" Selected="True">O - Open</asp:ListItem>
                                 <asp:ListItem Value="R" Selected="true">R - Renewal</asp:ListItem>   
                                 <%--  <asp:ListItem Value="N">N - No Followup</asp:ListItem>
                                   <asp:ListItem Value="D">D - Declined</asp:ListItem>
                                   <asp:ListItem Value="ALL">ALL STATUS</asp:ListItem>--%>
                               </asp:checkboxlist>
                                   <asp:CheckBox ID="chkRenewSearchAll" runat="server"  Text="All Status" Font-Size="15px" Font-Names="Calibri" Font-Bold="True" onchange="EnableDisableRenewStatusSearch()" BorderColor="White" BorderWidth="4px" Checked="True" />
     ...
     <Style2 SelectBoxWidth="60.5%" DropDownBoxBoxWidth="60.5%" DropDownBoxBoxHeight="120" />                    
           ...
           <tr>
            ...
            <tr>
                     ...
                     <td class="CellTextBox" colspan="1"> <asp:dropdownlist ID="txtServiceID" runat="server" Width="60%" DataSourceID="SqlDSService" DataTextField="ProductID" DataValueField="ProductDesc" AutoPostBack="FALSE" AppendDataBoundItems="TRUE" >
                <asp:ListItem Text="--SELECT--" Value="-1" />
                </asp:dropdownlist></td>
...
<td><asp:Button ID="btnSort2" runat="server" Text="<<" /></td>
            ...
            <tr>
                    <td class="CellTextBox" colspan="3" style="padding-left: 130px;padding-top:20px;padding-bottom:20px; text-align:left; width:400px; word-spacing: 20px; text-indent: 40px;">
                      <asp:RadioButtonList ID="rdbFormat" runat="server" CellPadding="4" CellSpacing="4" RepeatDirection="Horizontal" Width="357px">
           ...
           <tr>
                  <td colspan="4" style="text-align:center; ">
                      ...
                      <asp:Button ID="btnPrintServiceContractList" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="Print" Width="100px"/>
