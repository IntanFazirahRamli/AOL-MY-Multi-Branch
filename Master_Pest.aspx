<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Master_Pest.aspx.vb" Inherits="Master_Pest" Title="Pest Master"  Culture="en-GB"%>
...
<script type="text/javascript">
    ...
    <div style="text-align:center">
        ...
        <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">Pest Master</h3>
       ...
       <asp:Panel ID="pnlGrid" runat="server" BackColor="White" BorderColor="#003366" BorderWidth="1" Height="100%" ScrollBars="Auto" style="text-align:center;  margin-left:auto; margin-right:auto;"    Visible="true" Width="1300px">
            ...
            <Columns>
                 ...
                 <asp:TemplateField HeaderText="Show in SMART Portal">
                     <ItemTemplate>
                         <asp:CheckBox ID="chkShowinSMARTPortal" runat="server" Checked='<%# Eval("ShowCatchDatainSMARTPortal")%>' Enabled="false" />
                     </ItemTemplate>
                     <ItemStyle HorizontalAlign="Center" />
                 </asp:TemplateField>
                
                
                 <asp:TemplateField HeaderText="RequireQuantity">
                     <ItemTemplate>
                         <asp:CheckBox ID="chkRequireQuantity" runat="server" Checked='<%# Eval("RequireQuantity")%>' Enabled="false" />
                     </ItemTemplate>
                     <ItemStyle HorizontalAlign="Center" />
                 </asp:TemplateField>
                 <asp:TemplateField HeaderText="RequireLevelOfInfestation">
                     <ItemTemplate>
                         <asp:CheckBox ID="chkRequireLevelOfInfestation" runat="server" Checked='<%# Eval("RequireLevelOfInfestation")%>' Enabled="false" />
                     </ItemTemplate>
                     <ItemStyle HorizontalAlign="Center" />
                 </asp:TemplateField>
                 <asp:TemplateField HeaderText="Require Gender">
                     <ItemTemplate>
                         <asp:CheckBox ID="chkRequireGender" runat="server" Checked='<%# Eval("RequireGender")%>' Enabled="false" />
                     </ItemTemplate>
                     <ItemStyle HorizontalAlign="Center" />
                 </asp:TemplateField>
                 <asp:TemplateField HeaderText="Require Life Stage">
                     <ItemTemplate>
                         <asp:CheckBox ID="chkRequireLifeStage" runat="server" Checked='<%# Eval("RequireLifeStage")%>' Enabled="false" />
                     </ItemTemplate>
                     <ItemStyle HorizontalAlign="Center" />
                 </asp:TemplateField>
                 <asp:TemplateField HeaderText="Require Species">
                     <ItemTemplate>
                         <asp:CheckBox ID="chkRequireSpecies" runat="server" Checked='<%# Eval("RequireSpecies")%>' Enabled="false" />
                     </ItemTemplate>
                     <ItemStyle HorizontalAlign="Center" />
                 </asp:TemplateField>
                ...
                <td style="text-align:center;">
                        ...
                        <tr><td style="width:40%"></td>
                            ...
                            <td style="text-align:left;">
                                <asp:TextBox ID="txtPestID" runat="server" MaxLength="50" Height="16px" Width="200px"></asp:TextBox></td>
                        </tr>
                         ...
                         <tr style="padding-top:3px;"><td style="width:40%">&nbsp;</td>
                            <td style="width:10%;text-align:left;font-size:15px;font-weight:bold;font-family:'Calibri';color:black;">Show Catch Data in SMART Portal</td>
                             <td style="text-align:left;">
                                 <asp:CheckBox ID="chkShowwCatchdatainSmartportal" runat="server" />
                             </td>
                        </tr>

                 
                         <tr style="padding-top:3px;"><td style="width:40%">&nbsp;</td>
                            <td style="width:10%;text-align:left;font-size:15px;font-weight:bold;font-family:'Calibri';color:black;">Require Quantity</td>
                             <td style="text-align:left;">
                                 <asp:CheckBox ID="chkRequireQuantity" runat="server" />
                             </td>
                        </tr>

                 
                         <tr style="padding-top:3px; "><td style="width:40%">&nbsp;</td>
                            <td style="width:10%;text-align:left;font-size:15px;font-weight:bold;font-family:'Calibri';color:black;">Require Level of Infestation</td>
                             <td style="text-align:left;">
                                 <asp:CheckBox ID="chkRequireLevelofInfestation" runat="server" />
                             </td>
                        </tr>

                 
                         <tr style="padding-top:3px; "><td style="width:40%">&nbsp;</td>
                            <td style="width:10%;text-align:left;font-size:15px;font-weight:bold;font-family:'Calibri';color:black;">Require Gender</td>
                             <td style="text-align:left;">
                                 <asp:CheckBox ID="chkRequireGender" runat="server" />
                             </td>
                        </tr>

                 
                         <tr style="padding-top:3px; "><td style="width:40%">&nbsp;</td>
                            <td style="width:10%;text-align:left;font-size:15px;font-weight:bold;font-family:'Calibri';color:black;">Require Life Stage</td>
                             <td style="text-align:left;">
                                 <asp:CheckBox ID="chkRequireLifeStage" runat="server" />
                             </td>
                        </tr>

                 
                         <tr style="padding-top:3px; "><td style="width:40%">&nbsp;</td>
                            <td style="width:10%;text-align:left;font-size:15px;font-weight:bold;font-family:'Calibri';color:black;">Require Species</td>
                             <td style="text-align:left;">
                                 <asp:CheckBox ID="chkRequireSpecies" runat="server" />
                             </td>
                        </tr>
...
<asp:Button ID="btnCancel" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="CANCEL" Width="100px" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>" SelectCommand="SELECT *  FROM tblPest order by PestID"></asp:SqlDataSource>
