...
Partial Class RV_Select_ManpowerProductivity_NormalHour
    ...
    Protected Sub btnPrintServiceRecordList_Click(sender As Object, e As EventArgs) Handles btnPrintServiceRecordList.Click
        ...
        If rdbSelect.Text = "Detail" Then
            selFormula = "{tblservicerecord1.rcno} <> 0 and {tblservicerecord1.Status} = 'P' and {tblrptserviceanalysis1.Report}='ProdTeamMemberNormalDet' AND {tblrptserviceanalysis1.CreatedBy}='" + txtCreatedBy.Text + "' and {tblrptserviceanalysis1.NormalHour} <>0"
        ...
        ElseIf rdbSelect.Text = "Summary" Then
            selFormula = "{tblservicerecord1.rcno} <> 0 and {tblservicerecord1.Status} = 'P' and {tblrptserviceanalysis1.Report}='ProdTeamMemberNormalSumm' AND {tblrptserviceanalysis1.CreatedBy}='" + txtCreatedBy.Text + "' and {tblrptserviceanalysis1.NormalHour} <>0"
        ...
        '    If rdbSelect.Text = "Detail" Then
        '        command2.CommandText = "delete from tblrptserviceanalysis where Report='ProdTeamMemberNormalDet' and CreatedBy='" + txtCreatedBy.Text + "';"

        '    ElseIf rdbSelect.Text = "Summary" Then
        '        command2.CommandText = "delete from tblrptserviceanalysis where Report='ProdTeamMemberNormalSumm' and CreatedBy='" + txtCreatedBy.Text + "';"
        ...
        '                '  command.Parameters.AddWithValue("@Client", temp)
        ...
        '                If rdbSelect.Text = "Detail" Then
        '                    command.Parameters.AddWithValue("@Report", "ProdTeamMemberNormalDet")
        '                ElseIf rdbSelect.Text = "Summary" Then
        '                    command.Parameters.AddWithValue("@Report", "ProdTeamMemberNormalSumm")
        ...
        If rdbSelect.SelectedValue = "Detail" Then
            Session.Add("ReportType", "ManpowerProductivityByTeamMemberNormalDetail")
            Response.Redirect("RV_ManpowerProductivityByTeamMemberNormalDetail.aspx")
        ElseIf rdbSelect.SelectedValue = "Summary" Then
            Session.Add("ReportType", "ManpowerProductivityByTeamMemberNormalSummary")
            Response.Redirect("RV_ManpowerProductivityByTeamMemberNormalSummary.aspx")
    ...
    Private Sub GetData()
        ...
        If rdbSelect.Text = "Detail" Then
            command2.CommandText = "delete from tblrptserviceanalysis where CREATEDBY='" + txtCreatedBy.Text.Trim + "' and Report='ProdTeamMemberNormalDet';"

        ElseIf rdbSelect.Text = "Summary" Then
            command2.CommandText = "delete from tblrptserviceanalysis where CREATEDBY='" + txtCreatedBy.Text.Trim + "' and Report='ProdTeamMemberNormalSumm';"
        ...
        If rdbSelect.Text = "Detail" Then
            command.Parameters.AddWithValue("@pr_Report", "ProdTeamMemberNormalDet")
        ElseIf rdbSelect.Text = "Summary" Then
            command.Parameters.AddWithValue("@pr_Report", "ProdTeamMemberNormalSumm")
        ...
        'If rdbSelect.Text = "Detail" Then
        '    cmdSvcRec.CommandText = "Select * from tblrptserviceanalysis where Report='ProdTeamMemberNormalDet' and CreatedBy='" + txtCreatedBy.Text + "' and serviceday not in ('Sunday','Holiday');"
        'ElseIf rdbSelect.Text = "Summary" Then
        '    cmdSvcRec.CommandText = "Select * from tblrptserviceanalysis where Report='ProdTeamMemberNormalSumm' and CreatedBy='" + txtCreatedBy.Text + "' and serviceday not in ('Sunday','Holiday');"
        'End If
        ...
        If dtSvcRec.Rows.Count > 0 Then
            ...
            For i As Integer = 0 To dtSvcRec.Rows.Count - 1
                ...
                If rdbSelect.Text = "Detail" Then
                    commandUpdate.CommandText = "update tblrptserviceanalysis set otrate=@OTRate,othour=@OTHour,NormalHour=@NormalHour where Report='ProdTeamMemberNormalDet' and CreatedBy='" + txtCreatedBy.Text + "' AND RCNO=@RCNO;"
                ElseIf rdbSelect.Text = "Summary" Then
                    commandUpdate.CommandText = "update tblrptserviceanalysis set otrate=@OTRate,othour=@OTHour,NormalHour=@NormalHour where Report='ProdTeamMemberNormalSumm' and CreatedBy='" + txtCreatedBy.Text + "' AND RCNO=@RCNO;"
    ...
    Private Function GetData1() As Boolean
        ...
        If rdbSelect.SelectedValue = "Detail" Then
            ...
            'qry = "SELECT StaffID,ServiceDate,TimeIn,TimeOut,Client,Service,NoPerson,ServiceValue,"
            'qry = qry + "format((ServiceValue-ManpowerCost)/NoPerson,2) as Profit,concat(format(normalhour/60,0),' Hours ',format(mod((normalhour/60)*60,60),0),' Mins') as NormalHourSpent"
            'qry = qry + " FROM tblrptserviceanalysis a where createdby='" & Session("UserID") & "' and report='ProdTeamMemberNormalDet' and staffid <> ''"
            ...
            qry = qry + "ifnull((select format((ServiceValue-ManpowerCost)/NoPerson,2) FROM tblrptserviceanalysis where createdby='" & Session("UserID") & "' and report='ProdTeamMemberNormalDet' and otrate=1 and staffid=a.staffid  and recordno=a.recordno group by staffid),0) as NormalHourValue,"
            qry = qry + "ifnull((select concat(sum(normalhour) div 60,' Hours ',format(mod((sum(normalHour)/60)*60,60),0),' Mins') from tblrptserviceanalysis where createdby='" & Session("UserID") & "' and report='ProdTeamMemberNormalDet' and otrate=1 and staffid=a.staffid and recordno=a.recordno group by staffid,recordno),'0 Hours 00 Mins') as 'NormalHourSpent (HH:MM)',"
            qry = qry + "ifnull((select sum(normalhour) from tblrptserviceanalysis where createdby='" & Session("UserID") & "' and report='ProdTeamMemberNormalDet' and otrate=1 and staffid=a.staffid and recordno=a.recordno group by staffid),0) as 'NormalHourSpent (Mins)',"
            qry = qry + "ifnull((select format(sum(normalhour)/60,2) from tblrptserviceanalysis where createdby='" & Session("UserID") & "' and report='ProdTeamMemberNormalDet' and otrate=1 and staffid=a.staffid and recordno=a.recordno group by staffid),0) as 'NormalHourSpent (Decimal)',"

            'qry = qry + "ifnull((select format((ServiceValue-ManpowerCost)/NoPerson,2) FROM tblrptserviceanalysis where createdby='" & Session("UserID") & "' and report='ProdTeamMemberNormalDet' and otrate in (1.5,2) and staffid=a.staffid  and recordno=a.recordno group by staffid),0) as OTHourValue,"
            'qry = qry + "ifnull((select concat(sum(OTHour) div 60,' Hours ',format(mod((sum(OTHour)/60)*60,60),0),' Mins') from tblrptserviceanalysis where createdby='" & Session("UserID") & "' and report='ProdTeamMemberNormalDet' and otrate=1.5 and staffid=a.staffid and recordno=a.recordno group by staffid),'0 Hours 00 Mins') as 'OT1.5HourSpent (HH:MM)',"
            'qry = qry + "ifnull((select sum(OThour) from tblrptserviceanalysis where createdby='" & Session("UserID") & "' and report='ProdTeamMemberNormalDet' and otrate=1.5 and staffid=a.staffid and recordno=a.recordno group by staffid),0) as 'OT1.5HourSpent (Mins)',"
            'qry = qry + "ifnull((select format(sum(OThour)/60,2) from tblrptserviceanalysis where createdby='" & Session("UserID") & "' and report='ProdTeamMemberNormalDet' and otrate=1.5 and staffid=a.staffid and recordno=a.recordno group by staffid),0) as 'OT1.5HourSpent (Decimal)',"

            'qry = qry + "ifnull((select concat(sum(OTHour) div 60,' Hours ',format(mod((sum(OTHour)/60)*60,60),0),' Mins') from tblrptserviceanalysis where createdby='" & Session("UserID") & "' and report='ProdTeamMemberNormalDet' and otrate=2 and staffid=a.staffid and recordno=a.recordno group by staffid),'0 Hours 00 Mins') as 'OT2HourSpent (HH:MM)',"
            'qry = qry + "ifnull((select sum(OThour) from tblrptserviceanalysis where createdby='" & Session("UserID") & "' and report='ProdTeamMemberNormalDet' and otrate=2 and staffid=a.staffid and recordno=a.recordno group by staffid),0) as 'OT2HourSpent (Mins)',"
            'qry = qry + "ifnull((select format(sum(OThour)/60,2) from tblrptserviceanalysis where createdby='" & Session("UserID") & "' and report='ProdTeamMemberNormalDet' and otrate=2 and staffid=a.staffid and recordno=a.recordno group by staffid),0) as 'OT2HourSpent (Decimal)'"
        ...
        ElseIf rdbSelect.SelectedValue = "Summary" Then
            ...
            ''qry = qry + "ifnull((select format(sum(servicevalue),2) FROM tblrptserviceanalysis where createdby='" & Session("UserID") & "' and report='ProdTeamMemberNormalSumm' and otrate in (1,1.5,2) and staffid=a.staffid"
            ''qry = qry + " group by staffid),0) as TotalValue"
            'qry = "SELECT staffid,servicedate,count(recordno) as NoofServices,sum(ServiceValue) as ServiceValue,format(sum((ServiceValue-ManpowerCost)/NoPerson),2) as IndividualValue,"
            '' qry = qry + "format(sum(normalhour/60),2) as NormalHourSpent"
            'qry = qry + "concat(format(sum(normalhour/60),0),' Hours ',format(mod(sum((normalhour/60))*60,60),0),' Mins') as NormalHourSpent"
            'qry = qry + " FROM tblrptserviceanalysis a where createdby='" & Session("UserID") & "' and report='ProdTeamMemberNormalSumm' and staffid <> ''"
            ...
            qry = qry + "ifnull((select format(sum((ServiceValue-ManpowerCost)/NoPerson),2) FROM tblrptserviceanalysis where createdby='" & Session("UserID") & "' and report='ProdTeamMemberNormalSumm' and otrate=1 and staffid=a.staffid"
            qry = qry + " group by staffid),0) as NormalHourValue,"

            '  qry = qry + "format(sum(normalhour/60),2) as NormalHourSpent,"

            qry = qry + "ifnull((select concat(sum(normalhour) div 60,' Hours ',format(mod((sum(normalHour)/60)*60,60),0),' Mins') from tblrptserviceanalysis where createdby='" & Session("UserID") & "' and report='ProdTeamMemberNormalSumm' and otrate=1 and staffid=a.staffid and recordno=a.recordno group by staffid),'0 Hours 00 Mins') as 'NormalHourSpent (HH:MM)',"
            qry = qry + "ifnull((select sum(normalhour) from tblrptserviceanalysis where createdby='" & Session("UserID") & "' and report='ProdTeamMemberNormalSumm' and otrate=1 and staffid=a.staffid and recordno=a.recordno group by staffid),0) as 'NormalHourSpent (Mins)',"
            qry = qry + "ifnull((select format(sum(normalhour)/60,2) from tblrptserviceanalysis where createdby='" & Session("UserID") & "' and report='ProdTeamMemberNormalSumm' and otrate=1 and staffid=a.staffid and recordno=a.recordno group by staffid),0) as 'NormalHourSpent (Decimal)',"


            'qry = qry + "ifnull((select count(staffid) FROM tblrptserviceanalysis where createdby='" & Session("UserID") & "' and report='ProdTeamMemberNormalSumm' and otrate in (1.5,2) and staffid=a.staffid"
            'qry = qry + " group by staffid),0) as NoofOTSvcs,"
            'qry = qry + "ifnull((select format(sum((ServiceValue-ManpowerCost)/NoPerson),2) FROM tblrptserviceanalysis where createdby='" & Session("UserID") & "' and report='ProdTeamMemberNormalSumm' and otrate in (1.5,2) and staffid=a.staffid"
            'qry = qry + " group by staffid),0) as OTHourValue,"
            'qry = qry + "ifnull((select concat(sum(othour) div 60,' Hours ',format(mod((sum(otHour)/60)*60,60),0),' Mins') from tblrptserviceanalysis where createdby='" & Session("UserID") & "' and report='ProdTeamMemberNormalSumm' and otrate=1.5 and staffid=a.staffid and recordno=a.recordno group by staffid),'0 Hours 00 Mins') as 'OT1.5HourSpent (HH:MM)',"
            'qry = qry + "ifnull((select sum(othour) from tblrptserviceanalysis where createdby='" & Session("UserID") & "' and report='ProdTeamMemberNormalSumm' and otrate=1.5 and staffid=a.staffid and recordno=a.recordno group by staffid),0) as 'OT1.5HourSpent (Mins)',"

            'qry = qry + "ifnull((select format(sum(OThour/60),2) FROM tblrptserviceanalysis where createdby='" & Session("UserID") & "' and report='ProdTeamMemberNormalSumm' and otrate=1.5 and staffid=a.staffid"
            'qry = qry + " group by staffid),0) as 'OT1.5HourSpent (Decimal)',"
            'qry = qry + "ifnull((select concat(sum(othour) div 60,' Hours ',format(mod((sum(otHour)/60)*60,60),0),' Mins') from tblrptserviceanalysis where createdby='" & Session("UserID") & "' and report='ProdTeamMemberNormalSumm' and otrate=2 and staffid=a.staffid and recordno=a.recordno group by staffid),'0 Hours 00 Mins') as 'OT2HourSpent (HH:MM)',"
            'qry = qry + "ifnull((select sum(othour) from tblrptserviceanalysis where createdby='" & Session("UserID") & "' and report='ProdTeamMemberNormalSumm' and otrate=2 and staffid=a.staffid and recordno=a.recordno group by staffid),0) as 'OT2HourSpent (Mins)',"

            'qry = qry + "ifnull((select format(sum(OThour/60),2) FROM tblrptserviceanalysis where createdby='" & Session("UserID") & "' and report='ProdTeamMemberNormalSumm' and otrate=2 and staffid=a.staffid"
            'qry = qry + " group by staffid),0) as 'OT2.0HourSpent (Decimal)',"
            qry = qry + "ifnull((select format(sum((ServiceValue-ManpowerCost)/NoPerson),2) FROM tblrptserviceanalysis where createdby='" & Session("UserID") & "' and report='ProdTeamMemberNormalSumm' and otrate in (1,1.5,2) and staffid=a.staffid"
            qry = qry + " group by staffid),0) as TotalValue"
        ...
        If YrStrList2.Count > 0 Then
            ...
            If rdbSelect.Text = "Detail" Then
                command2.CommandText = "delete from tblrptserviceanalysis where CREATEDBY='" + txtCreatedBy.Text.Trim + "' and Report='ProdTeamMemberNormalDet' and servdatetype NOT in (" + YrStr + ")"
            ElseIf rdbSelect.Text = "Summary" Then
                command2.CommandText = "delete from tblrptserviceanalysis where CREATEDBY='" + txtCreatedBy.Text.Trim + "' and Report='ProdTeamMemberNormalSumm' and servdatetype NOT in (" + YrStr + ")"
            End If
    ...
    '                If j = 8 Or j = 16 Or j = 17 Or j = 18 Or j = 19 Or j = 21 Or j = 22 Then
    ...
    '        If chkTimeSheet.Checked Then
    '            attachment = "attachment; filename=Manpower Productivity by Team Member - Normal (TimeSheet)"
    '        Else
    '            attachment = "attachment; filename=Manpower Productivity by Team Member - Normal"
    '        End If
    ...
    Protected Sub btnEmailExcel_Click(sender As Object, e As EventArgs) Handles btnEmailExcel.Click
        ...
        If rdbSelect.SelectedValue = "Detail" Then
            command.Parameters.AddWithValue("@ReportType", "ProdTeamMemberNormalDet")

        Else
            command.Parameters.AddWithValue("@ReportType", "ProdTeamMemberNormalSumm")
        ...
        If deleteqry = "delete from tblrptserviceanalysis where createdby='" & Session("UserID") & "' and report='ProdTeamMemberNormalSumm'" Then
    ...
    Protected Sub btnEmailPDF_Click(sender As Object, e As EventArgs) Handles btnEmailPDF.Click
        ...
        commandEventLog.Parameters.AddWithValue("@StaffID", Session("UserID"))
        commandEventLog.Parameters.AddWithValue("@Module", "REPORTS")
        commandEventLog.Parameters.AddWithValue("@DocRef", "MANPOWER-TEAMMEMBERNORMAL")
        commandEventLog.Parameters.AddWithValue("@Action", "")
        commandEventLog.Parameters.AddWithValue("@ComputerName", Strings.Left(My.Computer.Name.ToString, 20))
        commandEventLog.Parameters.AddWithValue("@Serial", "")
        'command.Parameters.AddWithValue("@LogDate", Convert.ToString(Session("SysDate")))
