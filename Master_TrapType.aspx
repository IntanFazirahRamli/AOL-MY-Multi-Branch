<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Master_TrapType.aspx.vb" Inherits="Master_TrapType" Title="Trap Type Master"  Culture="en-GB"%>
...
<script type="text/javascript">
    ...
    <div style="text-align:center">
        ...
        <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">Trap Type Master</h3>
       ...
       <asp:Panel ID="pnlGrid" runat="server" BackColor="White" BorderColor="#003366" BorderWidth="0" Height="100%" ScrollBars="Auto" style="text-align:center;  margin-left:auto; margin-right:auto;"    Visible="true" Width="1000px">
            ...
            <Columns>
                 ...
                 <asp:BoundField DataField="TrapType" HeaderText="Trap Type" SortExpression="TrapType" >
                 <ItemStyle Wrap="False" Width="120px" />
                 </asp:BoundField>
                 <asp:BoundField DataField="Description" HeaderText="Description" SortExpression="Description" >
                 <ItemStyle Wrap="False" Width="250px" />
                 </asp:BoundField>
                 <asp:TemplateField HeaderText="Require Serial No.">
                     <ItemTemplate>
                         <asp:CheckBox ID="chkSerialNo" runat="server" Checked='<%# Eval("RequireSerialNo")%>' Enabled="false" />
                     </ItemTemplate>
            ...
            <tr style="text-align:center;">
                <td style="text-align:center;">
                        ...
                        <tr><td style="width:40%"></td>
                            <td style="width:15%;font-size:15px;font-weight:bold;font-family:'Calibri';color:black;text-align:left;">Trap Type<asp:Label ID="Label23" runat="server" Font-Size="14px" ForeColor="Red" Height="20px" Text="*" visible="true"></asp:Label>
                            </td>
                            <td style="text-align:left;">
                                <asp:TextBox ID="txtTrapType" runat="server" MaxLength="50" Height="16px" Width="200px"></asp:TextBox></td>
                        </tr>
                         ...
                         <tr style="padding-top:3px;"><td style="width:40%">&nbsp;</td>
                            <td style="width:10%;text-align:left;font-size:15px;font-weight:bold;font-family:'Calibri';color:black;">Require Serial&nbsp; No.</td>
                             <td style="text-align:left;">
                                 <asp:CheckBox ID="chkRequireSerialNo" runat="server" />
                             </td>
                        </tr>
...
<asp:Button ID="btnCancel" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="CANCEL" Width="100px" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>" SelectCommand="SELECT *  FROM tblTrapType order by TrapType "></asp:SqlDataSource>
