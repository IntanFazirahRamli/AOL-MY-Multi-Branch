<%@ Page Language="vb" AutoEventWireup="false" CodeFile="RV_ServiceTeamEquipment.aspx.vb" 
    Inherits="RV_ServiceTeamEquipment" MasterPageFile="~/MasterPage.Master"
    Title="Service Team Equipment Listing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div style="text-align:center">
        <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">Service Team Equipment Listing</h3>
    <br />
          ...
          <tr>
             <td style="text-align:left">
                  ...
                  <asp:Button ID="btnExportToExcel" runat="server"  CssClass="button" BackColor="#CFC6C0"  Font-Bold="True" Text="Export To Excel" Width="120px" Visible="False" />
                         <a href="RV_Export_ServiceTeam.aspx" target="_blank"><button class="button" style="background-color:#CFC6C0;font-weight:bold;width:100px;font-family:Calibri;font-size:14px;" type="button">View as PDF</button></a>
        ...
        <tr>
            <td colspan="2">
                ...
                <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                    <Report FileName="Reports\ServiceRecordReports\ServiceTeamEquipment.rpt">
                    </Report>
