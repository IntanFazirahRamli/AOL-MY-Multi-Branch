<%@ Page Title="Service Schedule Report" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="RV_ServiceSchedule_Format3.aspx.vb" Inherits="RV_ServiceSchedule_Format3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <%--<a href="RV_ServiceSchedule.aspx">RV_ServiceSchedule.aspx</a>--%><%--<a href="RV_ServiceSchedule.aspx">RV_ServiceSchedule.aspx</a>--%><a href="RV_ServiceSchedule_Format3.aspx">RV_ServiceSchedule_Format3.aspx</a><CR:CrystalReportViewer ID="CRVServiceSchedule" runat="server" AutoDataBind="true" 
    ...
    <CR:CrystalReportSource ID="CRSServiceSchedule" runat="server">
        <Report FileName="Reports\ServiceRecordReports\ServiceSchedule_Format3.rpt">
        </Report>
