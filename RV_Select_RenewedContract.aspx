<%@ Page Title="Renewed Service Contract Report Selection" Language="VB" MasterPageFile="~/MasterPage_Report.master" AutoEventWireup="false" CodeFile="RV_Select_RenewedContract.aspx.vb" Inherits="RV_Select_RenewedContract" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
       ...
       <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">RENEWED SERVICE CONTRACT LISTING REPORT</h4>
                            ...
                            <tr>
                                <td rowspan="2"><asp:ListBox ID="lstSort1" runat="server" width="120px" Rows="5" SelectionMode="Multiple">
                                    ...
                                    <asp:ListItem Text="Account Name" Value="CustName">Account Name</asp:ListItem>
                                     <asp:ListItem Text="RenewalDate" Value="RenewalDate">Renewal Date</asp:ListItem>
