...
Partial Class Master_TrapType
    ...
    Public Sub MakeMeNull()
        ...
        txtDescription.Text = ""
        txtRcno.Text = ""
        chkRequireSerialNo.Checked = False
        'txtCreatedBy.Text = ""
        txtCreatedOn.Text = ""
    ...
    Private Sub EnableControls()
        ...
        txtTrapType.Enabled = False
        txtDescription.Enabled = False
        chkRequireSerialNo.Enabled = False
    ...
    Private Sub DisableControls()
        ...
        txtTrapType.Enabled = True
        txtDescription.Enabled = True
        chkRequireSerialNo.Enabled = True
    ...
    Private Sub AccessControl()
        Try
            ...
            If Session("SecGroupAuthority") <> "ADMINISTRATOR" Then
                ...
                command.CommandText = "SELECT x0190,  x0190Add, x0190Edit, x0190Delete FROM tblGroupAccess where GroupAccess = '" & Session("SecGroupAuthority") & "'"
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    If String.IsNullOrEmpty(Convert.ToBoolean(dt.Rows(0)("x0190"))) = False Then
                        If Convert.ToBoolean(dt.Rows(0)("x0190")) = False Then
                            Response.Redirect("Home.aspx")
                        End If
                    End If


                    If String.IsNullOrEmpty(dt.Rows(0)("x0190Add")) = False Then
                        Me.btnADD.Enabled = dt.Rows(0)("x0190Add").ToString()
                    End If

                    'Me.btnInsert.Enabled = vpSec2412Add
                    If txtMode.Text = "View" Then
                        If String.IsNullOrEmpty(dt.Rows(0)("x0190Edit")) = False Then
                            Me.btnEdit.Enabled = dt.Rows(0)("x0190Edit").ToString()
                        End If

                        If String.IsNullOrEmpty(dt.Rows(0)("x0190Delete")) = False Then
                            Me.btnDelete.Enabled = dt.Rows(0)("x0190Delete").ToString()
                        End If
                    Else
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        If txtTrapType.Text = "" Then
            '   MessageBox.Message.Alert(Page, "Group cannot be blank!!!", "str")
            lblAlert.Text = "TRAP TYPE CANNOT BE BLANK"
            Return
        ...
        If txtMode.Text = "New" Then
            Try
                ...
                command1.CommandText = "SELECT * FROM tbltraptype where traptype =@traptype"
                command1.Parameters.AddWithValue("@traptype", txtTrapType.Text)
                ...
                Else
                    ...
                    command.CommandType = CommandType.Text
                    Dim qry As String = "INSERT INTO tbltraptype (TrapType, Description, RequireSerialNo, CreatedBy,CreatedOn,LastModifiedBy,LastModifiedOn)"
                    qry = qry + "VALUES(@TrapType,@Description, @RequireSerialNo, @CreatedBy,@CreatedOn,@LastModifiedBy,@LastModifiedOn);"
                    ...
                    If ConfigurationManager.AppSettings("UPPERCASE").ToString() = "YES" Then
                        ...
                        command.Parameters.AddWithValue("@TrapType", txtTrapType.Text.ToUpper)
                        command.Parameters.AddWithValue("@Description", txtDescription.Text.ToUpper)
                        command.Parameters.AddWithValue("@RequireSerialNo", chkRequireSerialNo.Checked)
                    ...
                    ElseIf ConfigurationManager.AppSettings("UPPERCASE").ToString() = "NO" Then
                        ...
                        command.Parameters.AddWithValue("@TrapType", txtTrapType.Text)
        ...
        ElseIf txtMode.Text = "Edit" Then
            ...
            Try
                ...
                command2.CommandText = "SELECT * FROM tbltraptype where TrapType=@TrapType and rcno<>" & Convert.ToInt32(txtRcno.Text)
                command2.Parameters.AddWithValue("@TrapType", txtTrapType.Text)
                ...
                Else
                    ...
                    command1.CommandText = "SELECT * FROM tbltraptype where rcno=" & Convert.ToInt32(txtRcno.Text)
                    command1.Connection = conn
                    ...
                    If dt.Rows.Count > 0 Then
                        ...
                        If txtExists.Text = "True" Then
                            qry = "update tbltraptype set Description=@Description,  RequireSerialNo=@RequireQuantity, LastModifiedBy=@LastModifiedBy,LastModifiedOn=@LastModifiedOn where rcno=" & Convert.ToInt32(txtRcno.Text)
                        Else
                            qry = "update tbltraptype set TrapType=@TrapType, Description=@Description, RequireSerialNo=@RequireSerialNo,  LastModifiedBy=@LastModifiedBy,LastModifiedOn=@LastModifiedOn where rcno=" & Convert.ToInt32(txtRcno.Text)
                        End If
                ...
                conn.Close()
                If txtMode.Text = "NEW" Then
                    CType(Me.Master, MasterPage).EventLog_Insert(Session("UserID"), "TRAPTYPE", txtTrapType.Text, "ADD", Convert.ToDateTime(txtCreatedOn.Text), 0, 0, 0, "", "", txtRcno.Text)
                Else
                    CType(Me.Master, MasterPage).EventLog_Insert(Session("UserID"), "TRAPTYPE", txtTrapType.Text, "EDIT", Convert.ToDateTime(txtCreatedOn.Text), 0, 0, 0, "", "", txtRcno.Text)
                End If
            Catch ex As Exception
                MessageBox.Message.Alert(Page, ex.ToString, "str")
            End Try
        ...
        If confirmValue = "Yes" Then
            ...
            Try
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    command.CommandType = CommandType.Text
                    Dim qry As String = "delete from tbltraptype where rcno=" & Convert.ToInt32(txtRcno.Text)
                ...
                End If
                conn.Close()
                CType(Me.Master, MasterPage).EventLog_Insert(Session("UserID"), "PEST", txtTrapType.Text, "DELETE", Convert.ToDateTime(txtCreatedOn.Text), 0, 0, 0, "", "", txtRcno.Text)
            Catch ex As Exception
                MessageBox.Message.Alert(Page, ex.ToString, "str")
            End Try
            EnableControls()
    ...
    Protected Sub GridView1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles GridView1.SelectedIndexChanged
        ...
        If dt.Rows.Count > 0 Then
            ...
            If dt.Rows(0)("TrapType").ToString <> "" Then : txtTrapType.Text = dt.Rows(0)("TrapType").ToString : End If
            If dt.Rows(0)("Description").ToString <> "" Then : txtDescription.Text = dt.Rows(0)("Description").ToString : End If

            If dt.Rows(0)("RequireSerialNo").ToString = "1" Then
                chkRequireSerialNo.Checked = True
            Else
                chkRequireSerialNo.Checked = False
            End If
    ...
    Protected Sub txtTrapType_TextChanged(sender As Object, e As EventArgs) Handles txtTrapType.TextChanged
