...
Partial Class RV_ExtensionContract
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                If Session("ReportType") = "ExtensionContract01" Then
                    repPath = Server.MapPath("~/Reports/ServiceContractReports/ExtensionContract01.rpt")
                ElseIf Session("ReportType") = "ExtensionContract02" Then
                    repPath = Server.MapPath("~/Reports/ServiceContractReports/ExtensionContract02.rpt")
                ElseIf Session("ReportType") = "ExtensionContract03" Then
                    repPath = Server.MapPath("~/Reports/ServiceContractReports/ExtensionContract03.rpt")
                End If
