<%@ Page Title="Receipt Listing" Language="VB" MasterPageFile="~/MasterPage_Report.master" EnableEventValidation="false" AutoEventWireup ="false" CodeFile="RV_Select_Receipt.aspx.vb" Inherits="RV_Select_Receipt" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <table style="width:100%;">
        <tr>
            <td colspan="2">
                  <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">RECEIPT LISTING REPORT</h4>
      ...
      <table style="width:100%;font-family: Calibri; font-size: 15px; font-weight: bold; color: black;text-align:left;padding-left:50px;line-height:20px;">
             ...
             <tr>
              ...
              <tr>
                    ...
                    <td class="CellFormatADM">ChequeAmount</td>
                     

                    <td class="CellTextBoxADM"> 
                               <asp:TextBox ID="txtChequeAmtFrom" runat="server" MaxLength="10" Height="16px" Width="85.5%"></asp:TextBox>
   </td>
                 <td class="CellFormat" style="text-align: right; ">TO</td>
                    <td class="CellTextBox"><asp:TextBox ID="txtChequeAmtTo" runat="server" MaxLength="10" Height="16px" Width="85.5%"></asp:TextBox>
            ...
            <tr>
                      <td class="CellFormat">ReceiptVoucher</td>
                    <td class="CellTextBox"><asp:TextBox ID="txtReceiptFrom" runat="server" MaxLength="20" Height="16px" Width="85.5%"></asp:TextBox>                        
                                </td>
                 <td class="CellFormat" style="text-align: right; ">TO</td>
                    <td class="CellTextBox"><asp:TextBox ID="txtReceiptTo" runat="server" MaxLength="20" Height="16px" Width="85.5%"></asp:TextBox>                        
                                 </td>
               
             
                  </tr>
          <tr>
                      <td class="CellFormat">Bank</td>
                    <td class="CellTextBox"><asp:DropDownList ID="ddlBankCode" runat="server" AppendDataBoundItems="True" AutoPostBack="True" Height="20px" Width="85.5%" DataSourceID="SqlDSBank" DataTextField="Bank" DataValueField="BankId">
                           <asp:ListItem Value="-1">--SELECT--</asp:ListItem>
                       </asp:DropDownList>
                                </td>
                 <td class="CellFormat" style="text-align: right; ">ChequeNo</td>
                    <td class="CellTextBox"><asp:TextBox ID="txtChequeNo" runat="server" MaxLength="10" Height="16px" Width="85.5%"></asp:TextBox>                        
                                 </td>
          ...
          <tr>
                 ...
                 <td class="CellFormat" style="text-align: right; ">PaymentMode</td>
                    <td class="CellTextBox"> <asp:DropDownList ID="ddlPaymentMode" runat="server" AppendDataBoundItems="True" AutoPostBack="True" Height="20px" Width="85.5%" DataSourceID="SqlDSSettleType" DataTextField="settletype" DataValueField="settletype">
                           <asp:ListItem Value="-1">--SELECT--</asp:ListItem>
                       </asp:DropDownList>                       
                                 </td>
     ...
     <Style2 SelectBoxWidth="85.5%" DropDownBoxBoxWidth="85.5%" DropDownBoxBoxHeight="120" />
              ...
              <tr>
                      <td class="CellFormat">BankStatus</td>
                    <td class="CellTextBox"><asp:DropDownList ID="ddlBankStatus" runat="server" Width="86%" Height="20px" AutoPostBack="true" CssClass="chzn-select" >
                                    <asp:ListItem  Selected="True" Text="--SELECT--" Value="-1" />
              ...
              <tr>
                      <td class="CellFormat">SortBy</td>
                                ...
                                <td class="CellTextBox" rowspan="2"><asp:ListBox ID="lstSort1" runat="server" width="80%" Rows="4" SelectionMode="Multiple">
                                    <asp:ListItem Text="ReceiptNumber" Value="tblrecv.ReceiptNumber">ReceiptNumber</asp:ListItem>
                                      <asp:ListItem Text="ReceiptDate" Value="tblrecv.ReceiptDate">ReceiptDate</asp:ListItem>
                                 
                                    <asp:ListItem Text="ReceiptFrom" Value="tblrecv.ReceiptFrom">ReceiptFrom</asp:ListItem>
...
<%--                    <asp:BoundField DataField="Address1" >
    ...
    <asp:SqlDataSource ID="SqlDSBank" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>" SelectCommand="Select CONCAT(BankId, ' - ', Bank) AS Bank,BankId from tblbank order by BankId">
       ...
       <asp:SqlDataSource ID="SqlDSBillingCode" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>" SelectCommand="SELECT CONCAT(ProductCode, ' - ', Description) AS ItemCode,ProductCode FROM tblbillingproducts order by Description "></asp:SqlDataSource>
           <asp:SqlDataSource ID="SqlDSSettleType" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>" SelectCommand="SELECT settletype FROM tblsettletype "></asp:SqlDataSource>
