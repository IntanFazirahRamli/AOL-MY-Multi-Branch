<%@ Page Title="Holiday Master" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Master_Holiday.aspx.vb" Inherits="Master_Holiday"  Culture="en-GB"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="text-align: center">
        <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold; color: #000099;">Holiday</h3>
...
<asp:Button ID="btnDelete" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="DELETE" Width="100px" OnClientClick = "Confirm(); currentdatetime()"/>
  ...
  <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" AutoGenerateColumns="False" BackColor="#DEBA84" 
                        BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataKeyNames="Holiday" Font-Size="12pt" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Holiday" HeaderText="Holiday" ReadOnly="True" SortExpression="Holiday" DataFormatString="{0:dd/MM/yyyy}">
                            ...
                            <%-- <asp:BoundField DataField="HoliCode" HeaderText="Holiday Code" SortExpression="HoliCode">
                                <ControlStyle Width="250px" />
                                <HeaderStyle Font-Size="15pt" />
                                <ItemStyle Width="250px" HorizontalAlign="Left" />
                            </asp:BoundField>
                             <asp:BoundField DataField="CalendarID" HeaderText="Calendar ID" SortExpression="CalendarID">
                                <ControlStyle Width="250px" />
                                <HeaderStyle Font-Size="15pt" />
                                <ItemStyle Width="250px" HorizontalAlign="Left" />
                            </asp:BoundField>--%>
          ...
          <tr>
            ...
            <tr>
                    ...
                    <td class="CellFormatADM">Holiday<asp:Label ID="Label23" runat="server" visible="true" Font-Size="14px" ForeColor="Red" Text="*" Height="20px"></asp:Label></td>
                     

                    <td class="CellTextBoxADM"> <asp:TextBox ID="txtHoliday" runat="server" MaxLength="50" Height="16px" Width="200px" AutoCompleteType="Disabled"></asp:TextBox>
                                <cc1:CalendarExtender ID="cal" runat="server" Format="dd/MM/yyyy" PopupButtonID="txtHoliday" TargetControlID="txtHoliday"/></td>
              ...
              <tr>
                    ...
                    <td class="CellFormatADM">Description<asp:Label ID="Label4" runat="server" visible="true" Font-Size="14px" ForeColor="Red" Text="*" Height="20px"></asp:Label></td>
                     

                    <td class="CellTextBoxADM"> <asp:TextBox ID="txtDescription" runat="server" MaxLength="100" Height="16px" Width="200px" AutoCompleteType="Disabled"></asp:TextBox></td>
...
<asp:Button ID="btnCancel" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="CANCEL" Width="100px" /></td>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>" 
            SelectCommand="SELECT Holiday, Description, Rcno, CreatedBy, CreatedOn, LastModifiedBy, LastModifiedOn FROM tblHoliday order by Holiday desc"></asp:SqlDataSource>
