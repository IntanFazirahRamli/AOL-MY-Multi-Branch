...
Partial Class RV_Select_GSTReport
    ...
    Protected Sub btnPrintServiceRecordList_Click(sender As Object, e As EventArgs) Handles btnPrintServiceRecordList.Click
        ...
        selection = ""
        selFormula = "{tblsales1.rcno} <> 0 and {tblsales1.poststatus}='P'"
        ...
        '        Return
        '    End If
        '    selFormula = selFormula + " and {tblservicebillingdetail1.InvoiceDate} >=" + "#" + d.ToString("MM-dd-yyyy") + "#"
        ...
        If String.IsNullOrEmpty(txtSvcDateTo.Text) = False Then
            ...
            Else
                MessageBox.Message.Alert(Page, "Invoice Date To is invalid", "str")
                '  lblAlert.Text = "INVALID START DATE"
                Return
            End If
            selFormula = selFormula + " and {tblsales1.SalesDate} <=" + "#" + d.ToString("MM-dd-yyyy") + "#"
        ...
        If String.IsNullOrEmpty(txtBillingPeriod.Text) = False Then
            ...
            End If
        End If
        If ddlTaxCode.Text = "-1" Then
        Else
            selFormula = selFormula + " and {tblsalesdetail1.Gst} = '" + ddlTaxCode.Text + "'"
            If selection = "" Then
                selection = "TaxCode : " + ddlTaxCode.Text
            Else
                selection = selection + ", TaxCode : " + ddlTaxCode.Text
            End If
        End If
        ...
        If rbtnSelect.SelectedValue = "1" Then
            ...
            Response.Redirect("RV_GSTByBillingPeriod.aspx")
        ElseIf rbtnSelect.SelectedValue = "2" Then

            Response.Redirect("RV_GSTByInvoiceNo.aspx")
        ElseIf rbtnSelect.SelectedValue = "3" Then

            Response.Redirect("RV_GSTByReceiptDate.aspx")
        ElseIf rbtnSelect.SelectedValue = "4" Then

            Response.Redirect("RV_GSTByTaxCode.aspx")
        End If
