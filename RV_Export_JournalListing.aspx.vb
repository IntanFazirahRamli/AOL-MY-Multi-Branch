...
Partial Class RV_Export_JournalListing
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                If Convert.ToString(Session("ReportType")) = "Summary" Then
                ...
                ElseIf Convert.ToString(Session("ReportType")) = "Detail" Then
                    crReportDocument.Load(Server.MapPath("~/Reports/ARNewReports/JournalReports/JournalVoucherDetailListing.rpt"))
                ElseIf Convert.ToString(Session("ReportType")) = "DetailLedger" Then
                ...
                Dim FilePath As String = Server.MapPath("~/PDFs/" + Convert.ToString(Session("UserID") + "_JournalListing.PDF"))
                ...
                If FileBuffer IsNot Nothing Then
                    ...
                    Response.AddHeader("content-disposition", "inline; filename=JournalListing.pdf")
