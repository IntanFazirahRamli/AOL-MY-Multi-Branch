<%@ Page Title="Sales Listing By Ledger Summary Report" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="RV_SalesDetailLedgerSummary.aspx.vb" Inherits="RV_SalesDetailLedgerSummary" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
     <div style="text-align:center">
        <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">Sales Listing By Ledger Summary</h3>
    <br />
