<%@ page title="Sales Ledger Summary" language="VB" masterpagefile="~/MasterPage_Report.master" enableeventvalidation="false" autoeventwireup="false" CodeFile="RV_Select_SalesDetailLedgerSummary.aspx.vb" Inherits="RV_Select_SalesDetailLedgerSummary" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <table style="width:100%;">
        <tr>
            <td colspan="2">
                  <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">SALES LISTING BY LEDGER REPORT</h4>
           ...
           <br />     </td>
              ...
              <tr>
                  <td colspan="4" style="text-align:center; ">
                      ...
                      <asp:Button ID="btnPrintServiceRecordList" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="Print" Width="100px"/>
