<%@ Page Title="Receipt Listing Summary" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="RV_ReceiptLisingSummary.aspx.vb" Inherits="RV_ReceiptLisingSummary" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
     <div style="text-align:center">
        <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">Receipt Listing Summary</h3>
    <br />
        ...
        <tr>
            <td colspan="2">
                ...
                <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                    <Report FileName="Reports\ARNewReports\ReceiptListingReports\ReceiptListingSummary.rpt">
                    </Report>
