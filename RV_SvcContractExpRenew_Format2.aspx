<%@ Page Language="vb" AutoEventWireup="false" CodeFile="RV_SvcContractExpRenew_Format2.aspx.vb" 
    Inherits="RV_SvcContractExpRenew_Format2" MasterPageFile="~/MasterPage.Master"
            ...
            <td colspan="2">
              <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="true"
                ...
                <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                    <Report FileName="Reports\ServiceContractReports\SvcContractExpRenew_Format2.rpt">
                    </Report>
