<%@ Page Title="Invoice" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Invoice.aspx.vb" Inherits="Invoice" Culture="en-GB" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" ValidateRequest="false"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Button ID="dummy" runat="server" Text="" cssclass="dummybutton" />
     ...
     <div style="text-align:center">
            ...
            <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">INVOICE</h3>
        ...
        <tr >
            ...
            <tr>
                 <td colspan="15"   style="width:100%;text-align:left;color:brown;font-size:16px;font-weight:bold;font-family:'Calibri';"> 
                         <asp:Label ID="lblInvoiceId" runat="server" Visible="false" Text="Invoice No : " style="width:40%;text-align:left;color:brown;font-size:16px;font-weight:bold;font-family:'Calibri';" ></asp:Label>
                ...
                <td style="width:6%;text-align:center;"> 
                  ...
                  <td style="width:6%;text-align:center;">
                     ...
                     <td style="width:8%;text-align:center;">
                                 <asp:Button ID="btnMultiPrint" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="MULTI PRINT" Width="100%" Visible="true" />
                  ...
                  <td style="width:6%;text-align:center;">
                   ...
                   <td style="width:7%;text-align:center;">
                    ...
                    <td style="width:7%;text-align:center;">
                              <asp:Button ID="btnReceipts" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" OnClientClick="currentdatetimereceipt()" Text="RECEIPTS" Visible="true" Width="100%" />
                  </td>

                   <td style="width:7%;text-align:center;">
                          <asp:Button ID="btnCNDN" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="CN/DN" Visible="true" Width="100%" />
          
                               </td>
                    <td style="width:6%;text-align:center;">
                          <asp:Button ID="btnJournal" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="JOURNAL" Width="100%" />
          
                               </td>
                  
                       <td style="width:7%;text-align:center;">
                           <asp:Button ID="btnRecalculate" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" OnClientClick="currentdatetime()" Text="RECALCULATE" Visible="True" Width="100%" />
                  </td>
                   <td style="width:7%;text-align:center;">
                          <asp:Button ID="btnPostEInvoice" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" OnClientClick="currentdatetime()" Text="SUBMIT E-INVOICE" Width="100%" Visible="True" />
         
                  </td>
                   <td style="width:6%;text-align:center;">
                          <asp:Button ID="btnFilter" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" OnClientClick="currentdatetime()" Text="FILTER" Width="100%" Visible="True" />
                         ...
                         <tr>
                          ...
                          <asp:MaskedEditExtender runat="server" ID="MaskedEditExtender2" ClearMaskOnLostFocus="false"
                            ...
                            <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black;  width:13%; ">
                               ...
                               <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; text-align:right; width:5%;">Paid status</td>
                              <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black;  width:11%; ">
                                  <asp:RadioButtonList ID="rdbSearchPaidStatus" runat="server"  RepeatDirection="Horizontal">
                          ...
                          <tr>
                              ...
                              <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black;  width:9%; ">
                                  <asp:DropDownList ID="ddlCompanyGrpSearch" runat="server" AppendDataBoundItems="True" DataTextField="companygroup" DataValueField="companygroup" Height="20px" Width="97%">
                           ...
                           <asp:TextBox ID="txtAccountIdSearch" runat="server" AutoCompleteType="Disabled" Height="16px" MaxLength="50" style="text-align:left; " Width="72%" AutoPostBack="True"></asp:TextBox>
                            ...
                            <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black;  width:13%; ">
                                 <asp:TextBox ID="txtServiceAddressSearch" runat="server" style="text-align:left; " MaxLength="50" Height="16px" Width="95%" AutoCompleteType="Disabled" ></asp:TextBox>         
                            </td>
                           ...
                           <cc1:dropdowncheckboxes ID="ddlLocationSearch" runat="server" Width="80%" UseSelectAllNode = "true" AddJQueryReference="true" UseButtons="false" style="top: 0px; left: 0px" >
                                                  <Style2 SelectBoxWidth="95.5%" DropDownBoxBoxWidth="95.5%" DropDownBoxBoxHeight="120" />
                    
                                                </cc1:dropdowncheckboxes>
                           <%-- </td>
                            <td colspan="1"> --%> <asp:DropDownList ID="ddlBranch" runat="server" AppendDataBoundItems="True" DataTextField="locationID" DataValueField="LocationID" Height="20px" Width="46%" DataSourceID="SqlDSLocation">
                                     <asp:ListItem>--SELECT--</asp:ListItem>
                                  </asp:DropDownList></td>
                          <!--      <td style="font-size:15px;font-weight:bold;font-family:Calibri; color:black; text-align:right; ">
                                  <asp:Label ID="Label40" runat="server" Text="E-Invoice" CssClass="CellFormat"></asp:Label>
                            </td>-->
                                      <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; text-align:right; width:5%;">
                                    Invoice Type</td>
                             <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black;  width:9%; ">
                               
                         <asp:DropDownList ID="ddlEInvoice" runat="server" AppendDataBoundItems="True" Height="20px" Width="95%">
                                     <asp:ListItem Selected="True">ALL</asp:ListItem>
                                     <asp:ListItem>Normal Invoice</asp:ListItem>
                                     <asp:ListItem>E-Invoice</asp:ListItem>
                                  </asp:DropDownList>
                            </td>
                                 <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; text-align:right; ">
                                  <asp:Label ID="lblInvStatus" runat="server" Text="InvoiceStatus" CssClass="CellFormat"></asp:Label>
                            </td>
                              <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black;  width:9%; ">
                                
                           <cc1:dropdowncheckboxes ID="ddlInvoiceStatusSearch" runat="server" Width="80%" UseSelectAllNode = "true" AddJQueryReference="true" UseButtons="false" style="top: 0px; left: 0px" >
                                                  <Style2 SelectBoxWidth="95.5%" DropDownBoxBoxWidth="95.5%" DropDownBoxBoxHeight="120" />
                                                                    </cc1:dropdowncheckboxes>
                           <%-- </td>
                            <td colspan="1"> --%> </td>
    ...
    <tr><td style="padding-left:100px;width:100px"><asp:Label ID="Label38" runat="server" Text="E-Invoice Status" CssClass="CellFormat"></asp:Label></td>
        ...
        <td class="CellFormat" style="text-align:left;width:90px;">Valid</td>
         ...
         <td style="background-color:blue;width:40px;height:20px">&nbsp;</td>
        <td class="CellFormat" style="text-align:left;width:90px;">Consolidated</td>
        ...
        <td class="CellFormat" style="text-align:left;width:90px">Cancelled</td>
                 ...
                 <td colspan="2" style="text-align:right">
                       <asp:ImageButton ID="btnExportToExcel" runat="server" ImageUrl="~/Images/excel.png" Width="40px" Height="35px" OnClientClick="currentdatetime()" />
                            ...
                            <div style="text-align:center; width:100%; margin-left:auto; margin-right:auto;" >
                                      ...
                                      <asp:Panel ID="pnlGrid" runat="server" BackColor="White" BorderColor="#003366" BorderWidth="1" Height="100%" ScrollBars="Auto" style="text-align:center; width:1420px; margin-left:auto; margin-right:auto;"    Visible="true" Width="1420px">
                                          ...
                                          <asp:GridView ID="GridView1" Width="100%" Font-Size="15px" runat="server" OnRowDataBound = "OnRowDataBoundg1" OnSelectedIndexChanged = "OnSelectedIndexChangedg1" AllowSorting="True" AutoGenerateColumns="False" BorderWidth="1px" CellPadding="2" CellSpacing="2" DataKeyNames="Rcno" DataSourceID="SQLDSInvoice" ForeColor="#333333" GridLines="Vertical" AllowPaging="True"> 
                                              <AlternatingRowStyle BackColor="White"/>
                                                ...
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="chkID" runat="server"  Enabled="false" Checked='<%#If(Eval("EmailSentStatus").ToString() = "Y", True, False)%>' />
                                                 </ItemTemplate>
                                                   </asp:TemplateField>
                                              ...
                                              <%--       <asp:TemplateField HeaderText="E-Inv. Status">
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="chkEIS" runat="server"  Enabled="false" Checked='<%#If(Eval("EInvoiceStatus").ToString() = "Successful", True, False)%>' />
                                                 </ItemTemplate>
                                                   </asp:TemplateField>--%>


                                               <asp:TemplateField >
                                                   <ItemTemplate> <asp:Button ID="btnEInvoiceLogs" runat="server"  Text="E-Inv. Logs" OnClick="btnEInvoiceLogs_Click" CssClass="righttextbox" Height="25px" Visible="FALSE" OnClientClick="currentdatetime()" ImageAlign="Top"   Width="80px"   />
                                               </ItemTemplate>
                                                    <ControlStyle CssClass="dummybutton" />
                                                    <HeaderStyle CssClass="dummybutton" />
                                                    <ItemStyle Width="2%" CssClass="dummybutton" />
                                                 ...
                                                 <%-- <asp:BoundField DataField="CustName" HeaderText="Client Name" SortExpression="CustName">
                                                  ...
                                                  <asp:BoundField DataField="EInvoiceStatus" HeaderText="E-Inv Status" />
                                                         <asp:BoundField DataField="SubmissionDate" HeaderText="Last Posted" />
                                                 <asp:BoundField DataField="SubmissionBy" HeaderText="Last Posted By" />
                                                    <asp:TemplateField HeaderText="Remaining Time to Cancel" >
                                                           <EditItemTemplate>
                                                              <asp:TextBox ID="TextBox8" runat="server" Text='<%# Eval("TimeToCancel") %>'></asp:TextBox>
                                                          
                                                                </EditItemTemplate>
                                                              <ItemTemplate> 
                                                                  
                                                             <asp:Label ID="TextBox9" runat="server" Text='<%# Eval("TimeToCancel") %>'></asp:Label>
                                                  ...
                                                  <asp:BoundField DataField="LastModifiedOn" HeaderText="Edited On" SortExpression="LastModifiedOn" >
                                                    <ItemStyle Wrap="False" />
                                                     ...
                                                     <asp:BoundField DataField="TaxIdentificationNo" InsertVisible="False">
                                                    <ControlStyle CssClass="dummybutton" />
                                                    <HeaderStyle CssClass="dummybutton" />
                                                    <ItemStyle CssClass="dummybutton" />
                                                    </asp:BoundField>
                                                     <asp:BoundField DataField="SalesTaxRegistrationNo" InsertVisible="False">
                                                    <ControlStyle CssClass="dummybutton" />
                                                    <HeaderStyle CssClass="dummybutton" />
                                                    <ItemStyle CssClass="dummybutton" />
                                                    </asp:BoundField>
                                                    ...
                                                    <asp:BoundField DataField="RecurringInvoice" >
                                                    <ControlStyle CssClass="dummybutton" />
                                                    <HeaderStyle CssClass="dummybutton" />
                                                    <ItemStyle CssClass="dummybutton" />
                                                    </asp:BoundField>
                 ...
                 <tr>
                 <td> <asp:TextBox ID="txtPostalValidate" runat="server" text="" CssClass="dummybutton" />
              ...
              <asp:SqlDataSource ID="SqlDSBillingFrequency" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>">
                ...
                <td>
                                  ...
                                  <tr>
                                      ...
                                      <asp:TextBox ID="txtCondition" runat="server" Height="16px"  Visible="false" Width="5px"></asp:TextBox>
                                      ...
                                      <asp:TextBox ID="txtOnlyEditableByCreator" runat="server" Visible="False"></asp:TextBox> 
                                       ...
                                       <asp:TextBox ID="txtDefaultTaxRate" runat="server" Visible="False"></asp:TextBox> 
                                       <asp:TextBox ID="txtAutoEmailInvoice" runat="server" Visible="False"></asp:TextBox> 
                               <asp:TextBox ID="txtContractTE" runat="server" Visible="False"></asp:TextBox> 
                                <asp:TextBox ID="txtLogDocNo" runat="server" Visible="False"></asp:TextBox> 
                                        <asp:TextBox ID="txtConditionMultiPrint" runat="server" Height="16px"  Visible="false" Width="2px"></asp:TextBox>
                                      <asp:TextBox ID="txtAccountIDMPCorporate" runat="server" Height="16px"  Visible="false" Width="2px"></asp:TextBox>
                                      <asp:TextBox ID="txtAccountIDMPResidential" runat="server" Height="16px"  Visible="false" Width="2px"></asp:TextBox>
                                    <asp:TextBox ID="txtConditionCorporate" runat="server" Height="16px"  Visible="false" Width="2px"></asp:TextBox>
                                      <asp:TextBox ID="txtConditionResidential" runat="server" Height="16px"  Visible="false" Width="2px"></asp:TextBox>
                                      <asp:TextBox ID="txtAllowZeroValueInvoice" runat="server" Height="16px"  Visible="false" Width="2px"></asp:TextBox>
                                       <asp:TextBox ID="txtApplyCorporateTax" runat="server" Height="16px"  Visible="false" Width="2px"></asp:TextBox>
                                      <asp:TextBox ID="txtApplyResidentialTax" runat="server" Height="16px"  Visible="false" Width="2px"></asp:TextBox>
                                <asp:TextBox ID="txtDisabledEInvoicing" runat="server" Height="16px"  Visible="false" Width="1px"></asp:TextBox>
                                      <asp:TextBox ID="txtMalaysiaEinvoicing" runat="server" Height="16px"  Visible="false" Width="1px"></asp:TextBox>
                                      <asp:TextBox ID="txtEInvoiceStartDate" runat="server" Height="16px"  Visible="false" Width="1px"></asp:TextBox>
                                  ...
                                  <asp:TextBox ID="txtSubmissionID" runat="server" Visible="False"></asp:TextBox>
                                      <asp:TextBox ID="txtSubmissionDate" runat="server" Visible="False"></asp:TextBox>
                                       <asp:TextBox ID="txtCancellationDate" runat="server" Visible="False"></asp:TextBox>
                                       <asp:TextBox ID="txtCancellationReason" runat="server" Visible="False"></asp:TextBox>
                                      <asp:TextBox ID="txtLastPostedDate" runat="server" Visible="False"></asp:TextBox>
                                       <asp:TextBox ID="txtLastPostedBy" runat="server" Visible="False"></asp:TextBox>
                                       <asp:TextBox ID="txtTimetoCancel" runat="server" Visible="False"></asp:TextBox>
                                          <asp:TextBox ID="txtRejectedDocError" runat="server" Visible="False"></asp:TextBox>
                                  <asp:TextBox ID="txtInternalID" runat="server" Height="16px"  Visible="false" Width="1px"></asp:TextBox>
                                       <asp:TextBox ID="txtEInvoiceLockRcno" runat="server" Height="16px"  Visible="false" Width="1px"></asp:TextBox>
                                                           </tr>
               ...
               <tr style="width:100%">
                   ...
                   <td colspan="1" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:right; color:#800000; width:15% ">TOTAL SALES AMOUNT
                 </td>
                     ...
                     <td colspan="1" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; text-decoration: underline; color:#800000; width:15% ">
                      ...
                      <td colspan="1" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:right; color:#800000; width:15% ">TOTAL INVOICE AMOUNT
                 </td>
                   ...
                   <td colspan="1" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:right; color:#800000; width:15% ">TOTAL O/S AMOUNT
                 </td>

                     <td colspan="1" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; text-decoration: underline; color:#800000; width:15% ">
                         <asp:TextBox ID="txtTotalOSAmount" runat="server" AutoCompleteType="Disabled" BackColor="#CCCCCC" Enabled="False" Height="16px" TabIndex="20" Width="70%" style="text-align:right;" Font-Bold="true" ></asp:TextBox>
...
<table border="0" style="width:95%; margin:auto; border:solid; border-color:ButtonFace;">
    ...
    <tr style="width:100%"><td colspan="4" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; text-decoration: underline;padding-left:1%; color:#800000; background-color: #C0C0C0;">INVOICE&nbsp;INFORMATION </td></tr>
    <tr>
        <td colspan="3"></td>
    ...
    <asp:RadioButtonList ID="rbtInvoiceType" runat="server" Font-Size="15px" ForeColor="Black" RepeatDirection="Horizontal" Width="80%" AutoPostBack="True" Visible="False" ><asp:ListItem Text="Manual Invoice" Value="M" Selected="True"></asp:ListItem><asp:ListItem Text="Service Invoice" Value="S"></asp:ListItem></asp:RadioButtonList></td><td style="font-size:15px;font-weight:bold; font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; ">
         ...
         <tr ><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; ">
             <asp:SqlDataSource ID="SqlDSClassificationCode" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>" SelectCommand="SELECT ClassificationCode FROM tblEInvoiceMalaysiaClassificationID order by ClassificationCode "></asp:SqlDataSource>
             </td><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:10%; text-align:right; vertical-align:top ">
    ...
    <asp:TextBox ID="txtTotalReceiptAmount" runat="server" AutoCompleteType="Disabled" BackColor="#CCCCCC" Height="16px" TabIndex="20" Visible="False" Width="10%"></asp:TextBox><asp:TextBox ID="txtRcnoServiceRecordDetail" runat="server" AutoCompleteType="Disabled" Height="16px" Width="1%" BorderStyle="None" TabIndex="101"></asp:TextBox></td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:10%; text-align:right; ">Invoice Date<asp:Label ID="Label2" runat="server" Font-Size="14px" ForeColor="Red" Text="*"></asp:Label></td><td style="width:20%;font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:left;"><asp:TextBox ID="txtInvoiceDate" runat="server" Height="16px" Width="80%" AutoCompleteType="Disabled" TabIndex="21" AutoPostBack="True" ></asp:TextBox>
    <asp:CalendarExtender ID="CalendarExtender2" runat="server" Format="dd/MM/yyyy" PopupButtonID="txtInvoiceDate" TargetControlID="txtInvoiceDate" Enabled="True" /></td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; "><asp:CheckBox ID="chkQReceiptAccess" runat="server" AutoPostBack="True" Visible="False" /></td></tr><tr><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; "><asp:TextBox ID="txtTotalCNAmount" runat="server" AutoCompleteType="Disabled" BackColor="#CCCCCC" Height="16px" TabIndex="20" Visible="False" Width="10%"></asp:TextBox></td>
        ...
        <td style="width:20%;font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:left;">
            <asp:TextBox ID="txtBillingPeriod" runat="server" AutoCompleteType="Disabled" BackColor="#CCCCCC" Height="18px" Width="81%" TabIndex="109" BorderStyle="None"></asp:TextBox></td>
        <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; ">&#160;</td></tr>
    ...
    <asp:DropDownList ID="txtAccountType" runat="server" DataTextField="ContType" DataValueField="ContType" Height="20px" Width="81%" AutoPostBack="True" TabIndex="22"><asp:ListItem>--SELECT--</asp:ListItem><asp:ListItem Value="COMPANY">CORPORATE</asp:ListItem><asp:ListItem Value="PERSON">RESIDENTIAL</asp:ListItem></asp:DropDownList></td>
        
        <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; ">&#160;</td></tr>
    
    <tr><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; ">
        <asp:TextBox ID="txtBalanceBase" runat="server" AutoCompleteType="Disabled" BackColor="#CCCCCC" Height="16px" TabIndex="20" Visible="False" Width="10%"></asp:TextBox>
    <asp:TextBox ID="txtRcnoInvoice" runat="server" AutoCompleteType="Disabled" BorderStyle="None" ForeColor="White" Height="16px" TabIndex="102" Width="1%"></asp:TextBox></td>
    ...
    <tr><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; "><asp:TextBox ID="txtContractNo" runat="server" AutoCompleteType="Disabled" BorderStyle="None" ForeColor="White" Height="16px" TabIndex="103" Width="1%"></asp:TextBox></td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:10%; text-align:right; ">Account Name<asp:Label ID="Label66" runat="server" Font-Size="14px" ForeColor="Red" Text="*"></asp:Label>
&nbsp;</td><td style="width:20%;font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:left;">
    <asp:TextBox ID="txtAccountName" runat="server" Height="18px" Width="80%" AutoCompleteType="Disabled" TabIndex="23" ></asp:TextBox><asp:ImageButton ID="btnEditBillingName" runat="server" CssClass="righttextbox" Height="22px" ImageAlign="Top" ImageUrl="~/Images/Edit.png" Width="24px" /></td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; "></td></tr>
    
     <tr><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; "><asp:TextBox ID="TextBox6" runat="server" AutoCompleteType="Disabled" BackColor="#CCCCCC" Height="16px" TabIndex="20" Visible="False" Width="10%"></asp:TextBox></td>
    <td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:10%; text-align:right; ">TaxIdentificationNo(TIN)</td><td style="width:20%;font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:left;"><asp:TextBox ID="txtTIN" runat="server" Height="16px" Width="81%" BackColor="#CCCCCC" AutoCompleteType="Disabled" TabIndex="110" BorderStyle="None" ></asp:TextBox></td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; ">&#160;</td></tr>
  
      <tr><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; "><asp:TextBox ID="TextBox7" runat="server" AutoCompleteType="Disabled" BackColor="#CCCCCC" Height="16px" TabIndex="20" Visible="False" Width="10%"></asp:TextBox></td>
    <td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:10%; text-align:right; ">SSTRegistrationNo</td><td style="width:20%;font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:left;"><asp:TextBox ID="txtSSTNo" runat="server" Height="16px" Width="81%" BackColor="#CCCCCC" AutoCompleteType="Disabled" TabIndex="110" BorderStyle="None" ></asp:TextBox></td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; ">&#160;</td></tr>
  
    <tr><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; "><asp:TextBox ID="txtNetInvoiceAmount" runat="server" AutoCompleteType="Disabled" BackColor="#CCCCCC" Height="16px" TabIndex="20" Visible="False" Width="10%"></asp:TextBox></td>
    ...
    <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; ">&nbsp;</td></tr><tr><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; "></td><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:10%; text-align:right; ">Tax Amount</td><td style="width:20%;font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:left;"><asp:TextBox ID="txtGSTAmount" runat="server" AutoCompleteType="Disabled" BackColor="#CCCCCC" BorderStyle="None" Height="18px" Rows="121" style="text-align:right" Text="0.00" Width="81%"></asp:TextBox></td>
...
<asp:Panel ID="Panel2" runat="server" >
                     ...
                     <asp:Label ID="Label41" runat="server" style="font-size:15px;font-weight:bold;font-family:Calibri;  text-decoration: underline;" Text="INVOICE DETAILS"></asp:Label></td>
...
<asp:Button ID="btnDummyGL" runat="server" BackColor="White" CssClass="roundbutton" Font-Bold="True" Text="L" Width="24px" BorderStyle="None" ForeColor="White" /><asp:ModalPopupExtender ID="imgBtnGL_ModalPopupExtender" runat="server" BackgroundCssClass="modalBackground" CancelControlID="btnPnlGLClose" PopupControlID="pnlPopUpGL" TargetControlID="btnDummyGL" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
    ...
    <tr style="width:100%"><td colspan="20" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left;  width:96% ">
        <asp:UpdatePanel runat="server" ID="updPnlBillingRecsNew" UpdateMode="Conditional"><ContentTemplate><asp:GridView ID="grvBillingDetailsNew"  runat="server" AllowSorting="True" 
             ...
             <Columns><asp:TemplateField><ItemTemplate><asp:CheckBox ID="chkSelectRecB" runat="server" Font-Size="12px" Enabled="true" Height="18px" Visible="true"  Width="4%" AutoPostBack="false" Checked="true"    onchange="checkselectrec()"  CommandName="CHECK" ></asp:CheckBox></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText=" Item Type"><ItemTemplate><asp:TextBox ID="txtItemTypeGVB" runat="server" Text='<%# Bind("SuBcode")%>' Font-Size="11px" Height="15px" ReadOnly="true" Width="65px" Enabled="False" AppendDataBoundItems="True" AutoPostBack="True"  ></asp:TextBox></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="Ref. No."><ItemTemplate>
                 ...
                 <asp:TemplateField><ItemTemplate><asp:ImageButton ID="BtnContractGVB" runat="server" OnClick="BtnContractGVB_Click" CssClass="righttextbox" Height="22px" ImageAlign="Middle" ImageUrl="~/Images/searchbutton.jpg" Width="24px" /></ItemTemplate></asp:TemplateField>
                 
                 <asp:TemplateField HeaderText="Class Code"><ItemTemplate>
                     <asp:TextBox ID="txtClassificationCodeGVB" runat="server" Text='<%# Bind("ItemClassificationCode")%>' Font-Size="11px" Height="20px" Width="60px" AppendDataBoundItems="True">
                     </asp:TextBox></ItemTemplate><HeaderStyle HorizontalAlign="Center" /></asp:TemplateField>
            
                  <asp:TemplateField><ItemTemplate><asp:ImageButton ID="BtnClassificationCodeGVB" runat="server" OnClick="BtnClassificationCodeGVB_Click" CssClass="righttextbox" Height="22px" ImageAlign="Middle" ImageUrl="~/Images/searchbutton.jpg" Width="24px" /></ItemTemplate></asp:TemplateField>
                

                 <asp:TemplateField HeaderText="Item Desc."><ItemTemplate><asp:DropDownList ID="txtItemCodeGVB" runat="server" SelectedValue='<%# Bind("ItemDescription")%>' DataSourceID="SQLDSBillingCode" DataTextField="Description" Text='<%# Bind("ItemDescription")%>'  Font-Size="11px"  Height="20px" AutoPostBack="True"  Width="68px" AppendDataBoundItems="True"  ><asp:ListItem Text="--SELECT--" Value="-1" /></asp:DropDownList></ItemTemplate></asp:TemplateField>
                 ...
                 <asp:TemplateField HeaderText="Description"><ItemTemplate><asp:TextBox ID="txtDescriptionGVB" runat="server" Text='<%# Bind("Description")%>' Font-Size="11px" Height="15px"  Width="110px"></asp:TextBox></ItemTemplate></asp:TemplateField>
                 
                 <asp:TemplateField HeaderText="UOM"><ItemTemplate>
                     <asp:DropDownList ID="txtUOMGVB" runat="server" Text='<%# Bind("UnitMs")%>' SelectedValue='<%# Bind("UnitMs")%>' DataSourceID="SQLDSUnitMS" DataTextField="UnitMs" Font-Size="11px" Height="20px" Width="53px" AppendDataBoundItems="True">
                     <asp:ListItem Text="--SELECT--" Value="-1" /></asp:DropDownList></ItemTemplate><HeaderStyle HorizontalAlign="Center" /></asp:TemplateField>
                 
                 <asp:TemplateField HeaderText="Qty."><ItemTemplate>
                 <asp:TextBox ID="txtQtyGVB" runat="server" Text='<%# Bind("Quantity", "{0:n2}")%>' Font-Size="11px"  style="text-align:right" Height="15px"  Width="28px" AutoPostBack="true" OnTextChanged="txtQtyGVB_TextChanged"></asp:TextBox></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="Unit Price"><ItemTemplate><asp:TextBox ID="txtPricePerUOMGVB" runat="server" Text='<%# Bind("UnitOriginal", "{0:n2}")%>'  Font-Size="11px"  style="text-align:right" Height="15px"  Width="50px" AutoPostBack="true" OnTextChanged="txtPricePerUOMGVB_TextChanged"></asp:TextBox></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="Total Price"><ItemTemplate>
                 ...
                 <asp:TemplateField HeaderText="Tax %"><ItemTemplate><asp:TextBox ID="txtGSTPercGVB" runat="server" Text='<%# Bind("GstRate", "{0:n2}")%>'   Font-Size="11px" Enabled="false" style="text-align:right" Height="15px" Width="35px"></asp:TextBox></ItemTemplate><HeaderStyle HorizontalAlign="Center" /></asp:TemplateField>
                 <asp:TemplateField HeaderText="Tax Amt."><ItemTemplate>
                 ...
                 <asp:TemplateField HeaderText="Net Price"><ItemTemplate><asp:TextBox ID="txtTotalPriceWithGSTGVB" runat="server" Text='<%# Bind("AppliedBase")%>'  Font-Size="11px" Enabled="false" style="text-align:right" Height="15px" Width="65px" Align="right"></asp:TextBox></ItemTemplate><HeaderStyle HorizontalAlign="Right" /></asp:TemplateField>
                 <asp:TemplateField><ItemTemplate>
                 <asp:TextBox ID="txtLocationIdGVB" runat="server" Text='<%# Bind("LocationID")%>' Font-Size="11px" ReadOnly="true" BackColor="#CCCCCC" BorderStyle="None" Height="18px"  Width="0px"></asp:TextBox></ItemTemplate></asp:TemplateField>
                 <asp:TemplateField ><ItemTemplate><asp:ImageButton ID="btnDeleteDetail" runat="server" CssClass="righttextbox" Height="18px" ImageAlign="Top" ImageUrl="~/Images/delete_icon_color.gif" Width="20px" OnClick="btnDeleteDetail_Click" OnClientClick="currentdatetime(); Confirm()"  /></ItemTemplate></asp:TemplateField><asp:TemplateField><ItemTemplate><asp:TextBox ID="txtServiceLocationGroupGVB" runat="server" Font-Size="11px" ReadOnly="true" BackColor="#CCCCCC" BorderStyle="None" Height="18px"  Width="0px"></asp:TextBox></ItemTemplate></asp:TemplateField>
                 ...
                 <asp:TextBox ID="txtRcnoServiceRecordGVB" runat="server" Visible="false" Height="15px" Text='<%# Bind("RcnoServiceRecord")%>' Width="0px"></asp:TextBox></ItemTemplate></asp:TemplateField>
               
                    <asp:TemplateField><ItemTemplate><asp:TextBox ID="txtClassificationDescGVB" runat="server" Text='<%# Bind("ItemClassificationDesc")%>'   Font-Size="11px" Enabled="false" style="text-align:right" Height="15px" Width="0px"></asp:TextBox></ItemTemplate><HeaderStyle HorizontalAlign="Center" /></asp:TemplateField>
                 <asp:TemplateField ><ItemTemplate><asp:TextBox ID="txtUOMDescGVB" runat="server" Text='<%# Bind("UOMDesc")%>'   Font-Size="11px" Enabled="false" style="text-align:right" Height="15px" Width="0px"></asp:TextBox></ItemTemplate><HeaderStyle HorizontalAlign="Center" /></asp:TemplateField>
                <asp:TemplateField ><ItemTemplate><asp:TextBox ID="txtTaxTypeDescGVB" runat="server" Text='<%# Bind("TaxTypeDesc")%>'   Font-Size="11px" Enabled="false" style="text-align:right" Height="15px" Width="0px"></asp:TextBox></ItemTemplate><HeaderStyle HorizontalAlign="Center" /></asp:TemplateField>
              
                 
                   <asp:TemplateField><ItemTemplate><asp:TextBox ID="txtRcnoInvoiceGVB" runat="server" Visible="false" Height="15px" Text='<%# Bind("Rcno")%>' Width="0px"></asp:TextBox></ItemTemplate></asp:TemplateField>
                 <asp:TemplateField><ItemTemplate><asp:TextBox ID="txtServiceDateGVB" runat="server" Visible="false" Text='<%# Bind("ServiceDate")%>' Height="15px" Width="10px"></asp:TextBox></ItemTemplate></asp:TemplateField>
                 <asp:TemplateField><ItemTemplate>
            ...
            ShowFooter="True" Style="text-align: left" Width="99%" BorderStyle="None" ShowHeader="False" ><Columns>
                ...
                <asp:TemplateField HeaderText="Class Code"><ItemTemplate>
                    <asp:TextBox ID="txtClassificationCodeGV" runat="server" Font-Size="11px" Height="20px" Width="60px" AppendDataBoundItems="True">
                        </asp:TextBox></ItemTemplate><HeaderStyle HorizontalAlign="Center" /></asp:TemplateField>
            
                 <asp:TemplateField><ItemTemplate><asp:ImageButton ID="BtnClassificationCodeGV" runat="server" OnClick="BtnClassificationCodeGV_Click" CssClass="righttextbox" Height="22px" ImageAlign="Middle" ImageUrl="~/Images/searchbutton.jpg" Width="24px" /></ItemTemplate></asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Description"><ItemTemplate><asp:TextBox ID="txtDescriptionGV" runat="server" Font-Size="11px" Height="15px"  Width="110px"></asp:TextBox></ItemTemplate></asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="UOM"><ItemTemplate>
                    <asp:DropDownList ID="txtUOMGV" runat="server" Font-Size="11px" Height="20px" Width="53px" AppendDataBoundItems="True">
                        <asp:ListItem Text="--SELECT--" Value="-1" /></asp:DropDownList></ItemTemplate><HeaderStyle HorizontalAlign="Center" /></asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Unit Price"><ItemTemplate><asp:TextBox ID="txtPricePerUOMGV" runat="server" Font-Size="11px" Text="0.00" style="text-align:right" Height="15px"  Width="50px" AutoPostBack="true" OnTextChanged="txtPricePerUOMGV_TextChanged"></asp:TextBox></ItemTemplate></asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Tax Code"><ItemTemplate><asp:TextBox ID="txtTaxTypeGV" runat="server" Font-Size="11px" style="text-align:center" Height="15px" Width="46px" Enabled="false" AutoPostBack="True" ></asp:TextBox></ItemTemplate></asp:TemplateField>
                  ...
                  <asp:TemplateField HeaderText="Tax %"><ItemTemplate><asp:TextBox ID="txtGSTPercGV" runat="server" Text="0.00"  Font-Size="11px" Enabled="false" style="text-align:right" Height="15px" Width="35px"></asp:TextBox></ItemTemplate><HeaderStyle HorizontalAlign="Center" /></asp:TemplateField>
                <asp:TemplateField HeaderText="Tax Amt."><ItemTemplate><asp:TextBox ID="txtGSTAmtGV" runat="server" Font-Size="11px" Enabled="true" Text="0.00" style="text-align:right" Height="15px" Width="47px" Align="right" AutoPostBack="true" OnTextChanged="txtGSTAmtGV_TextChanged"></asp:TextBox></ItemTemplate></asp:TemplateField>
                ...
                <asp:TemplateField ><ItemTemplate><asp:TextBox ID="txtServiceByGV" runat="server" Font-Size="11px" ReadOnly="true" BackColor="#CCCCCC" Visible="false" BorderStyle="None" Height="18px" Width="0px"></asp:TextBox></ItemTemplate></asp:TemplateField><asp:TemplateField><ItemTemplate><asp:TextBox ID="txtRcnoServiceRecordGV" runat="server" Visible="false" Height="15px" Width="0px"></asp:TextBox></ItemTemplate></asp:TemplateField>
                      ...
                      <asp:TemplateField><ItemTemplate><asp:TextBox ID="txtClassificationDescGV" runat="server"   Font-Size="11px" Enabled="false" style="text-align:right" Height="15px" Width="0px"></asp:TextBox></ItemTemplate><HeaderStyle HorizontalAlign="Center" /></asp:TemplateField>
                 <asp:TemplateField ><ItemTemplate><asp:TextBox ID="txtUOMDescGV" runat="server" Font-Size="11px" Enabled="false" style="text-align:right" Height="15px" Width="0px"></asp:TextBox></ItemTemplate><HeaderStyle HorizontalAlign="Center" /></asp:TemplateField>
                <asp:TemplateField ><ItemTemplate><asp:TextBox ID="txtTaxTypeDescGV" runat="server"  Font-Size="11px" Enabled="false" style="text-align:right" Height="15px" Width="0px"></asp:TextBox></ItemTemplate><HeaderStyle HorizontalAlign="Center" /></asp:TemplateField>
...
<table border="0" style="width:90%; margin:auto; border:solid; border-color:ButtonFace;    "><tr style="width:100%"><td colspan="4" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; text-decoration: underline;padding-left:10%; color:#800000; background-color: #C0C0C0;">AMOUNT&nbsp;SUMMARY </td></tr><tr><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; ">&#160;</td><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:10%; text-align:right; vertical-align:top ">&nbsp;</td><td style="width:20%;font-size:14px;font-weight:bold;font-family:Calibri;color:black;text-align:left;"></td>
    ...
    <asp:Button ID="btnSaveInvoice" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" OnClientClick="if(this.value === 'Saving...') { return false; } else { this.value = 'Saving...'; } ; return DoValidation();" TabIndex="33" Text="SAVE INVOICE" Width="45%" /><asp:Button ID="btnCancel" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="CANCEL" Width="45%" /></td></tr></table></div>
</ContentTemplate>
</asp:UpdatePanel>
    ...
    <table style="width:100%;text-align:center;"><tr><td colspan="2" style="text-align:left;">
                  ...
                  <table style="width:100%;height:1000px">
                      <tr style="height:30%">
                          <td>
                              ...
                              <tr><td class="CellFormat">Invoice No </td>
                                  <td class="CellTextBox"><asp:Label ID="lblFileUploadInvNo" runat="server" BackColor="#CCCCCC" Height="16px" MaxLength="100" ReadOnly="True" Width="50%"></asp:Label></td>

                              </tr>
                           <%--   <tr><td class="CellFormat">Account ID </td>
                                  <td class="CellTextBox"><asp:Label ID="lblFileUploadAccountID" runat="server" BackColor="#CCCCCC" Height="16px" MaxLength="100" ReadOnly="True" Width="50%"></asp:Label></td>
        ...
        <table border="0"  style="width:100%;text-align:center; padding-top:2px; margin-left: 0%; margin-right:0%; border:solid; border-color:ButtonFace; "  >
                 ...
                 <td colspan="6" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; text-decoration: underline;padding-left:3%; color:#800000; background-color: #C0C0C0;"> SEARCH SERVICE RECORDS 
                     ...
                     <tr>
                          ...
                          <td style="width:10%; font-size:15px;font-weight:bold;font-family:'Calibri';color:black;text-align:center;"> 
                              <asp:CheckBox ID="chkFromSalesOrder" runat="server" Text="From Sales Order" AutoPostBack="True" Visible="False" />
                          </td>
                          ...
                          <tr>
                              ...
                              <td style="width:10%;font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:left;">
                                  Target</td>
                                   ...
                                   <td colspan="1" style="width:10%;font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:left;">
                              </td>
                          ...
                          <tr>
                              ...
                              <td style="width:8%;font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:left;">
                                  <asp:TextBox ID="txtServiceAddress" runat="server" AutoCompleteType="Disabled" Height="16px" Width="95%"></asp:TextBox>
                                   ...
                                   <td colspan="1" style="width:10%;font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:left;">
                                       <asp:TextBox ID="txtTargetSearch" runat="server" AutoCompleteType="Disabled" Height="16px" Width="90%"></asp:TextBox>
                              </td>

                              <td style="width:10%;font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:left;">
                                  <asp:TextBox ID="txtSalesOrderNumberSearch" runat="server" AutoCompleteType="Disabled" Height="16px" Width="90%" Visible="False"></asp:TextBox>
                                 <asp:Button ID="btnDummyLocation" runat="server" BackColor="White" BorderStyle="None" CssClass="roundbutton" Font-Bold="True" ForeColor="White" Text="L" Width="4px" />
        ...
        <asp:UpdatePanel ID="updpnlServiceRecs" runat="server" UpdateMode="Conditional"><ContentTemplate>
            ...
            ShowFooter="True" Style="text-align: left" Width="100%">
                ...
                <asp:TemplateField> 
                    <HeaderTemplate><asp:CheckBox ID="CheckBox1" runat="server" AutoPostBack="false" TextAlign="Right" onchange="checkallservicerecs()"  Width="5%" ></asp:CheckBox></HeaderTemplate>
                <ItemTemplate><asp:CheckBox ID="chkSelectGV" runat="server" Font-Size="12px" Enabled="true" Height="18px"  Width="5%" AutoPostBack="false"    onchange="checkoneservicerec()"  CommandName="CHECK" >
             ...
             <asp:TemplateField HeaderText="Service Date"><ItemTemplate><asp:TextBox ID="txtServiceDateGV" runat="server" Text='<%# Bind("ServiceDate", "{0:dd/MM/yyyy}")%>' Font-Size="12px" ReadOnly="true" BackColor="#CCCCCC" BorderStyle="None" Height="18px" Width="70px" ></asp:TextBox></ItemTemplate></asp:TemplateField>
               ...
               <asp:TemplateField HeaderText="Service By" HeaderStyle-HorizontalAlign="Center"><ItemTemplate><asp:TextBox ID="txtServiceByGV" runat="server" Text='<%# Bind("ServiceBy")%>' Font-Size="12px" ReadOnly="true" BackColor="#CCCCCC" Visible="true" BorderStyle="None" Height="18px" Width="80px"></asp:TextBox></ItemTemplate></asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Billing Freq." HeaderStyle-HorizontalAlign="Center"><ItemTemplate><asp:TextBox ID="txtBillingFrequencyGV" runat="server" Text='<%# Bind("BillingFrequency")%>' Font-Size="12px" ReadOnly="true" BackColor="#CCCCCC" BorderStyle="None" Height="18px" Width="80px"></asp:TextBox></ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Sales Order Number"><ItemTemplate><asp:TextBox ID="txtSalsOrderNumberGV" runat="server" Text='<%# Bind("SalesOrderNumber")%>' Font-Size="12px" ReadOnly="true" BackColor="#CCCCCC" BorderStyle="None" style="text-align:center" Height="18px" Width="120px" Align="right"></asp:TextBox></ItemTemplate></asp:TemplateField>
        ...
        <FooterStyle BackColor="#F7DFB5" Font-Bold="True" ForeColor="White" Height="5px" /><RowStyle BackColor="#EFF3FB" Height="17px" /><EditRowStyle BackColor="#2461BF" />
                ...
                <table border="0" style="width:99%; margin:auto; border:solid; border-color:ButtonFace;">
                  ...
                  <asp:Button ID="btnDummyClient" runat="server" BackColor="White" BorderStyle="None" CssClass="roundbutton" Font-Bold="True" ForeColor="White" Text="L" Width="6px" />
                                <asp:Button ID="Button2" runat="server" BackColor="White" BorderStyle="None" CssClass="roundbutton" Font-Bold="True" ForeColor="White" Text="L" Width="6px" />
...
<asp:Panel ID="pnlPopUpClient" runat="server" BackColor="White" Width="98%" Height="80%" BorderColor="#003366" BorderWidth="1px" HorizontalAlign="Center" ScrollBars="Horizontal">
    ...
    <asp:ImageButton ID="btnPopUpClientReset" runat="server" Height="22px" ImageAlign="Middle" ImageUrl="~/Images/resetbutton.jpg" OnClick="btnPopUpClientReset_Click" Width="24px"></asp:ImageButton>
        ...
        <ItemStyle Width="5%" />
            ...
            <asp:BoundField DataField="Location" HeaderText="BranchCode">
            <ItemStyle Wrap="False" />
            </asp:BoundField>
        <asp:BoundField DataField="AccountID" HeaderText="Account ID" SortExpression="AccountID" >
        <ControlStyle Width="8%" />
    ...
    <asp:BoundField DataField="ContractGroup" HeaderText="Contract Group" >
        ...
        <ItemStyle Wrap="False" />
            ...
            <ItemStyle Wrap="False" />
             ...
             <asp:BoundField DataField="SalesTaxRegistrationNo" HeaderText="SSTNo">
            <ItemStyle Wrap="False" />
            </asp:BoundField>
    ...
    <asp:ImageButton ID="btnPopUpGLSearch"  runat="server" ImageUrl="~/Images/searchbutton.jpg" Height="22px" Width="24px" ImageAlign="Middle" Visible="False" /><asp:ImageButton ID="btnPopUpGLReset"  runat="server" ImageUrl="~/Images/resetbutton.jpg" Height="22px" Width="24px" ImageAlign="Middle"/></td><td>
        ...
        <table style="border: 1px solid #CC3300; text-align:center; border-radius: 25px;padding: 5px; width:90%; height:350px; background-color: #F3F3F3;padding-left:15px;">
             ...
             <tr runat="server" id="trInv1" style="padding-top:40px;">
                 ...
                 <td colspan="1" style="text-align:left;padding-left:2PX;">             
                      ...
                      <label style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px; vertical-align: super;">Format 1 : Invoice with Service Record No</label><br />
            ...
            <tr  runat="server" id="trInv2" style="padding-top:40px;">
                 <td colspan="1" style="text-align:left;padding-left:50PX;">
                 ...
                 <td colspan="1" style="text-align:left;padding-left:2PX;">            
                      <label style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px">Format 2 : For Annual Billing</label><br />
            ...
            <tr  runat="server" id="trInv3" style="padding-top:40px;">
                 <td colspan="1" style="text-align:left;padding-left:50PX;">
                 ...
                 <td colspan="1" style="text-align:left;padding-left:2PX;">    
                      <label style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px">Format 3 : No Service Address and No Billing Frequency</label><br />
            ...
            <tr  runat="server" id="trInv4" style="padding-top:40px;">
                 <td colspan="1" style="text-align:left;padding-left:50PX;">
                 ...
                 <td colspan="1" style="text-align:left;padding-left:2PX;">            
                      <label style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px">Format 4 : No System Contract No</label><br />
             ...
             <tr  runat="server" id="trInv5" style="padding-top:40px;">
                 <td colspan="1" style="text-align:left;padding-left:50PX;">
                 ...
                 <td colspan="1" style="text-align:left;padding-left:2PX;">
                      <label style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px">Format 5 : Sales Invoice W/O Service Description</label><br />
            ...
            <tr  runat="server" id="trInv6" style="padding-top:40px;">
                 <td colspan="1" style="text-align:left;padding-left:50PX;">
                 ...
                 <td colspan="1" style="text-align:left;padding-left:2PX;">
                      <label style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px">Format 6 : Sales Invoice W/O Billing Frequency</label><br />
            ...
            <tr  runat="server" id="trInv7" style="padding-top:40px;">
                 <td colspan="1" style="text-align:left;padding-left:50PX;">
                 ...
                 <td colspan="1" style="text-align:left;padding-left:2PX;">
                      <label style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px">Format 7 : Sales Invoice - Lump Sum</label><br />

                             </td>
                 </tr>


            <tr  runat="server" id="trInv8" style="padding-top:40px;">
                 <td colspan="1" style="text-align:left;padding-left:50PX;">
                 ...
                 <td colspan="1" style="text-align:left;padding-left:2PX;"> <label style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px">Format 8 : Simple Sales Invoice Format</label><br />
            ...
            <tr  runat="server" id="trInv9" style="padding-top:40px;">
                 <td colspan="1" style="text-align:left;padding-left:50PX;">
                 ...
                 <td colspan="1" style="text-align:left;padding-left:2PX;"> <label style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px">Format 9 : Location Based Sales Invoice</label><br />

                             </td>
                 </tr>


            <tr  runat="server" id="trInv10" style="padding-top:40px;">
                 <td colspan="1" style="text-align:left;padding-left:50PX;">
                 ...
                 <td colspan="1" style="text-align:left;padding-left:2PX;">
                      <label style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px">Format 10: For PDF Export</label><br />
          ...
          <%--  <tr style="padding-top:40px;">
             ...
             <tr  runat="server" id="trInv11" style="padding-top:40px;">
                 <td colspan="1" style="text-align:left;padding-left:50PX;">
                                    <a href="RV_TaxInvoice_Format11.aspx?Export=PDF" target="_blank" id="btnPrintInvoice11" runat="server"><imagebutton style="border:none;" type="button"><img src="Images/Print.jpg" width="25" height="20" /></imagebutton></a>
                                   </td>
                 <td colspan="1" style="text-align:left;padding-left:2PX;">
                                  <a href="RV_TaxInvoice_Format11.aspx?Export=Word" target="_blank" id="btnExportInvoice11" runat="server"><imagebutton style="border:none;" type="button"><img src="Images/word.jpg" width="20" height="20" /></imagebutton></a>
                                   </td>
                 <td colspan="1" style="text-align:left;padding-left:2PX;">
                      <a href="RV_TaxInvoice_Format11.aspx?Export=View" target="_blank" id="btnViewInvoice11" runat="server"><imagebutton style="border:none;" type="button"><img src="Images/view.jpg" width="28" height="20" /></imagebutton></a>
                                  </td>
                 <td colspan="1" style="text-align:left;padding-left:2PX;">
                               <a href="Email.aspx?Type=InvoiceFormat11" target="_blank" id="btnEmailInvoice11" runat="server"><button style="border:none;background-color:white;" type="button"><img src="Images/email1.png" width="20" height="20" /></button></a>
                                   </td>
                 <td colspan="1" style="text-align:left;padding-left:2PX;">
                      <label style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px">Format 11: Invoice with Service Report</label>&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;<%-- <a href="RV_TaxInvoice_Format11.aspx?Export=PDF" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/Print.jpg" width="25" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp;
                ...
                <tr  runat="server" id="trInv12" style="padding-top:40px;">
                 <td colspan="1" style="text-align:left;padding-left:50PX;">
                                    <a href="RV_TaxInvoice_Format12.aspx?Export=PDF" target="_blank" id="btnPrintInvoice12" runat="server"><imagebutton style="border:none;" type="button"><img src="Images/Print.jpg" width="25" height="20" /></imagebutton></a>
                                   </td>
                 <td colspan="1" style="text-align:left;padding-left:2PX;">
                                  <a href="RV_TaxInvoice_Format12.aspx?Export=Word" target="_blank" id="btnExportInvoice12" runat="server"><imagebutton style="border:none;" type="button"><img src="Images/word.jpg" width="20" height="20" /></imagebutton></a>
                                   </td>
                 <td colspan="1" style="text-align:left;padding-left:2PX;">
                      <a href="RV_TaxInvoice_Format12.aspx?Export=View" target="_blank" id="btnViewInvoice12" runat="server"><imagebutton style="border:none;" type="button"><img src="Images/view.jpg" width="28" height="20" /></imagebutton></a>
                                  </td>
                 <td colspan="1" style="text-align:left;padding-left:2PX;">
                               <a href="Email.aspx?Type=InvoiceFormat12" target="_blank" id="btnEmailInvoice12" runat="server"><button style="border:none;background-color:white;" type="button"><img src="Images/email1.png" width="20" height="20" /></button></a>
                                   </td>
                 <td colspan="1" style="text-align:left;padding-left:2PX;">
                      <label style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px">Format 12: Pest Off</label>&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;</td>
                 </tr>
            
                <tr  runat="server" id="trInv13" style="padding-top:40px;">
                 <td colspan="1" style="text-align:left;padding-left:50PX;">
                                    <a href="RV_TaxInvoice_Format13.aspx?Export=PDF" target="_blank" id="btnPrintInvoice13" runat="server"><imagebutton style="border:none;" type="button"><img src="Images/Print.jpg" width="25" height="20" /></imagebutton></a>
                                   </td>
                 <td colspan="1" style="text-align:left;padding-left:2PX;">
                                  <a href="RV_TaxInvoice_Format13.aspx?Export=Word" target="_blank" id="btnExportInvoice13" runat="server"><imagebutton style="border:none;" type="button"><img src="Images/word.jpg" width="20" height="20" /></imagebutton></a>
                                   </td>
                 <td colspan="1" style="text-align:left;padding-left:2PX;">
                      <a href="RV_TaxInvoice_Format13.aspx?Export=View" target="_blank" id="btnViewInvoice13" runat="server"><imagebutton style="border:none;" type="button"><img src="Images/view.jpg" width="28" height="20" /></imagebutton></a>
                                  </td>
                 <td colspan="1" style="text-align:left;padding-left:2PX;">
                               <a href="Email.aspx?Type=InvoiceFormat13" target="_blank" id="btnEmailInvoice13" runat="server"><button style="border:none;background-color:white;" type="button"><img src="Images/email1.png" width="20" height="20" /></button></a>
                                   </td>
                 <td colspan="1" style="text-align:left;padding-left:2PX;">
                      <label style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px">Format 13: Lumiar</label>&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;</td>
                 </tr>
            
                <tr  runat="server" id="trInv14" style="padding-top:40px;">
                 <td colspan="1" style="text-align:left;padding-left:50PX;">
                                    <a href="RV_TaxInvoice_Format14.aspx?Export=PDF" target="_blank" id="btnPrintInvoice14" runat="server"><imagebutton style="border:none;" type="button"><img src="Images/Print.jpg" width="25" height="20" /></imagebutton></a>
                                   </td>
                 <td colspan="1" style="text-align:left;padding-left:2PX;">
                                  <a href="RV_TaxInvoice_Format14.aspx?Export=Word" target="_blank" id="btnExportInvoice14" runat="server"><imagebutton style="border:none;" type="button"><img src="Images/word.jpg" width="20" height="20" /></imagebutton></a>
                                   </td>
                 <td colspan="1" style="text-align:left;padding-left:2PX;">
                      <a href="RV_TaxInvoice_Format14.aspx?Export=View" target="_blank" id="btnViewInvoice14" runat="server"><imagebutton style="border:none;" type="button"><img src="Images/view.jpg" width="28" height="20" /></imagebutton></a>
                                  </td>
                 <td colspan="1" style="text-align:left;padding-left:2PX;">
                               <a href="Email.aspx?Type=InvoiceFormat14" target="_blank" id="btnEmailInvoice14" runat="server"><button style="border:none;background-color:white;" type="button"><img src="Images/email1.png" width="20" height="20" /></button></a>
                                   </td>
                 <td colspan="1" style="text-align:left;padding-left:2PX;">
                      <label style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px">Format 14: Ascendia</label>&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;</td>
                 </tr>

                <tr  runat="server" id="trInv15" style="padding-top:40px;">
                 <td colspan="1" style="text-align:left;padding-left:50PX;">
                                    <a href="RV_TaxInvoice_Format15.aspx?Export=PDF" target="_blank" id="btnPrintInvoice15" runat="server"><imagebutton style="border:none;" type="button"><img src="Images/Print.jpg" width="25" height="20" /></imagebutton></a>
                                   </td>
                 <td colspan="1" style="text-align:left;padding-left:2PX;">
                                  <a href="RV_TaxInvoice_Format15.aspx?Export=Word" target="_blank" id="btnExportInvoice15" runat="server"><imagebutton style="border:none;" type="button"><img src="Images/word.jpg" width="20" height="20" /></imagebutton></a>
                                   </td>
                 <td colspan="1" style="text-align:left;padding-left:2PX;">
                      <a href="RV_TaxInvoice_Format15.aspx?Export=View" target="_blank" id="btnViewInvoice15" runat="server"><imagebutton style="border:none;" type="button"><img src="Images/view.jpg" width="28" height="20" /></imagebutton></a>
                                  </td>
                 <td colspan="1" style="text-align:left;padding-left:2PX;">
                               <a href="Email.aspx?Type=InvoiceFormat15" target="_blank" id="btnEmailInvoice15" runat="server"><button style="border:none;background-color:white;" type="button"><img src="Images/email1.png" width="20" height="20" /></button></a>
                                   </td>
                 <td colspan="1" style="text-align:left;padding-left:2PX;">
                      <label style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px">Format 15: Invoice with Service Report with Photos</label>&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;</td>
                 </tr>
    ...
    <%--<asp:TemplateField><ItemTemplate>
                    <asp:LinkButton ID="lnkDownload" Text = "Download" CommandArgument = '<%# Eval("FileNameLink")%>' runat="server" OnClick = "DownloadFile"></asp:LinkButton></ItemTemplate></asp:TemplateField>
     --%>       
                   <asp:TemplateField HeaderText="Email">
                                                                      ...
                                                                      <asp:LinkButton ID="lnkEmail1" runat="server" CommandArgument='<%# Eval("FileNameLink")%>' OnClick="EmailFile" OnClientClick="openInNewTab();" Text="Email"></asp:LinkButton>
                                                                             ...
                                                                             <%--<a href="Email.aspx?Type=FileUpload" target="_blank" runat="server">
                                                                             <asp:LinkButton ID="lnkEmail1" runat="server" CommandArgument='<%# Eval("FileNameLink")%>' OnClick="EmailFile" OnClientClick="openInNewTab();" Text="Email"></asp:LinkButton>
         ...
         DataTextField="Filenamelink"                 
         DataNavigateUrlFields="Filenamelink" 
         DataNavigateUrlFormatString="Email.aspx?Type=InvoiceFileUpload" HeaderText="Email" DataTextFormatString="Email" target="_blank" ItemStyle-HorizontalAlign="Center" ItemStyle-BackColor="White" ItemStyle-ForeColor="Black" />--%>
    ...
    <HeaderStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" Font-Names="Calibri" />
            ...
            <asp:Panel ID="pnlStatus" runat="server" BackColor="White" Width="35%" Height="41%" BorderColor="#003366" BorderWidth="1px" ScrollBars="Auto">
                      ...
                      <asp:Label ID="lblAlertStatus" runat="server" BackColor="Red" ForeColor="White"></asp:Label>
                          ...
                          <tr>
                               <td class="CellFormat">Change Status
                                   <asp:Label ID="Label65" runat="server" Font-Size="14px" ForeColor="Red" Text="*"></asp:Label>
                               </td>
                              <td class="CellTextBox" colspan="1"> <asp:DropDownList ID="ddlNewStatus" runat="server" Width="95%" Height="25px">
                                    <asp:ListItem Text="--SELECT--" Value="-1" />
      ...
      <%--   'Start: Classification Code--%>

            <asp:Panel ID="pnlPopClassificationCode" runat="server" BackColor="White" Width="1000px" Height="600px" BorderColor="#003366" BorderWidth="1px"    HorizontalAlign="Left" ScrollBars="Vertical">

                     <table>
           <tr><td colspan="2" style="text-align:center;"><h4 style="color: #000000">Select Classification Code</h4></td><td style="width:1%;text-align:right;"><asp:ImageButton ID="ImageButton7" runat="server" ImageUrl="~/Images/closebutton.png" Height="27px" Width="30px" /></td></tr>
                           
         <tr><td colspan="2" style="width:10%;font-size:15px;font-weight:bold;font-family:Calibri;color:black;text-align:left;padding-left:40px;">&nbsp;Search &nbsp; <asp:TextBox ID="TextBox4" runat="server" MaxLength="50" Height="16px" Width="400px" ForeColor="Gray" onblur = "WaterMarkGL(this, event);" onfocus = "WaterMarkGL(this, event);" AutoPostBack="True">Search Here for GL Code or Description</asp:TextBox>
    <asp:ImageButton ID="btnPopupClassificationCodeSearch"  runat="server" ImageUrl="~/Images/searchbutton.jpg" Height="22px" Width="24px" ImageAlign="Middle" Visible="False" /><asp:ImageButton ID="btnPopupClassificationCodeReset"  runat="server" ImageUrl="~/Images/resetbutton.jpg" Height="22px" Width="24px" ImageAlign="Middle"/></td><td>
                               <asp:TextBox ID="txtPopClassificationCodeSearch" runat="server" Visible="False" Width="20%"></asp:TextBox>
                           </td></tr>
        ...
        <div style="text-align: center; padding-left: 50px; padding-bottom: 5px;">
            <br />
            <asp:GridView ID="GrdViewClassificationCode" runat="server" DataSourceID="SqlDSPopClassificationCode" OnRowDataBound = "OnRowDataBoundgClassificationCode" OnSelectedIndexChanged = "OnSelectedIndexChangedgClassificationCode" ForeColor="#333333" AutoGenerateColumns="False"
                CellPadding="4" GridLines="None" Width="800px"  Font-Size="15px" PageSize="8">
                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                <Columns>
                    <asp:CommandField HeaderText="Select" ShowHeader="True" ShowSelectButton="True" Visible="false">
                    ...
                    <asp:BoundField DataField="ClassificationCode" HeaderText="Code" />
                    <asp:BoundField DataField="Description" HeaderText="Description" />
                </Columns>
                <EditRowStyle BackColor="#999999" />
                <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
            ...
            <asp:SqlDataSource ID="SqlDSPopClassificationCode" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>"
                ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>">
            </asp:SqlDataSource>
   ...
   <asp:ModalPopupExtender ID="mdlClassificationCode" runat="server" CancelControlID="btnCancelStatus" PopupControlID="pnlPopClassificationCode" TargetControlID="ClassificationCode" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
            
          <asp:Button ID="ClassificationCode" runat="server" CssClass="dummybutton" />
    ...
    <%--     'End: Classification Code--%>
      ...
      <asp:Panel ID="pnlMultiPrint" runat="server" BackColor="White" BorderColor="#003366" BorderWidth="1"  ScrollBars="auto"  style="text-align:left; width:1300px; height:600px; margin-left:auto; margin-right:auto;"  Visible="true" >
         ...
         <tr style="width:100%">
             <td  style="width:30%;font-size:18px;font-weight:bold;font-family:Calibri;color:black;text-align:center;padding-left:30px;">&nbsp;Select Records to Print&nbsp; 

             </td>
               <td  style="width:20%;font-size:18px;font-weight:bold;font-family:Calibri;color:black;text-align:center;padding-left:0px;">
                           <asp:CheckBox ID="chkZeroValue" runat="server" Font-Size="12px" Text="Include Zero Value Transactions" AutoPostBack="True" />
                           </td>
               <td  style="width:20%;font-size:18px;font-weight:bold;font-family:Calibri;color:black;text-align:center;padding-left:0px;">
                           <asp:CheckBox ID="chkNoHardCopyInvoice" runat="server" Font-Size="12px" Text="Include Invoices that DO NOT require Hard Copy" AutoPostBack="True" />
                           </td>

                 <td  style="width:15%;font-size:18px;font-weight:bold;font-family:Calibri;color:black;text-align:center;padding-left:0px;">
        ...
        <div style="text-align: center; padding-left: 10px; padding-bottom: 5px;">
            ...
            <div style="text-align:center; width:100%; margin-left:auto; margin-right:auto;" >
                ...
                <asp:Panel ID="Panel3" runat="server" BackColor="White" BorderColor="#003366" BorderWidth="1"  ScrollBars="auto"  style="text-align:left; width:1300px; height:450px; margin-left:auto; margin-right:auto;"  Visible="true" >
                 ...
                 <td colspan="4" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; text-decoration: underline;padding-left:10%; color:#800000; background-color: #C0C0C0;">NEW RECEIPTS INFORMATION
                    ...
                    <tr>
                       ...
                       <td style="width:50%;font-size:14px; font-family:'Calibri';color:black;text-align:left;"> 
                               ...
                               <asp:TextBox ID="txtClassificationCodeFrom" runat="server" AutoCompleteType="Disabled" BackColor="#CCCCCC" CssClass="dummybutton" Height="16px" TabIndex="112" Width="20%"></asp:TextBox>
   ...
   <asp:Button ID="btnDummyImportInvoices" runat="server" BackColor="White" CssClass="roundbutton" Font-Bold="True" Width="24px" BorderStyle="None" /> 
              ...
              <tr style="background-color:navy; color:white;font-size:medium">
               ...
               <tr>
                      <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          &nbsp;<asp:Label ID="lblQuery" runat="server" Text="Are you sure to POST the Invoice?"></asp:Label>
              ...
              <tr style="background-color:navy; color:white;font-size:medium">
               ...
               <tr>
                      <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          &nbsp;<asp:Label ID="Label10" runat="server" Text="Are you sure to REVERSE the Invoice?"></asp:Label>
      ...
      <asp:ModalPopupExtender ID="mdlPopupConfirmReverse" runat="server" CancelControlID="btnConfirmNoReverse" PopupControlID="pnlConfirmReverse" TargetControlID="btndummyReverse" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
         ...
         <%--end--%>
                  ...
                  <%--  popup - print zero value invoice--%>


                 <asp:Panel ID="pnlZeroValuePrint" runat="server" BackColor="White" Width="400px" Height="130px" BorderColor="#003366" BorderWidth="1px" ScrollBars="Auto">
          
         <table border="0" style="font-family: Calibri; font-size: 15px; font-weight: bold; color: white;text-align:left;padding-left:2px;">
              <tr style="background-color:navy; color:white;font-size:medium">
                      <td style="font-family: Calibri; font-size: 17px; font-weight: bold; color: white;text-align:center">
                         
                          <asp:Label ID="Label31" runat="server" Text="Confirm Print"></asp:Label>
               ...
               <tr>
                      <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          &nbsp;<asp:Label ID="Label32" runat="server" Text="This invoice is zero in value, do you really want to print?"></asp:Label>
                            ...
                            <tr style="padding-top:40px;">
                             <td colspan="2" style="text-align:center"><asp:Button ID="btnConfirmZeroValuePrintYes" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="Yes" Width="100px" />
                                 <asp:Button ID="btnConfirmZeroValuePrintNo" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="No" Width="100px" />
                               </td>
                         </tr>                       
        </table>
      ...
      <asp:ModalPopupExtender ID="mdlPopupConfirmZeroValuePrint" runat="server" CancelControlID="btnConfirmZeroValuePrintNo" PopupControlID="pnlZeroValuePrint" TargetControlID="btnDummyZeroValuePrint" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
         <asp:Button ID="btnDummyZeroValuePrint" runat="server" CssClass="dummybutton" />
              ...
              <tr style="background-color:navy; color:white;font-size:medium">
               ...
               <tr>
                      <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          &nbsp;<asp:Label ID="Label12" runat="server" Text="Do you want to POST/UPDATE the Invoice?"></asp:Label>
         ...
         <table border="0" style="font-family: Calibri; font-size: 15px; font-weight: bold; color: white;text-align:left;padding-left:2px;">
               ...
               <tr>
                      <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          &nbsp;<asp:Label ID="lblEInvoiceMsg" runat="server" Text="Invoice Submitted and waiting for approval.... Please wait..."></asp:Label>
      ...
      <asp:ModalPopupExtender ID="mdlPopupMsg" runat="server" CancelControlID="btnCancelMsg" PopupControlID="pnlConfirmMsg" TargetControlID="btndummyMsg" BackgroundCssClass="modalBackground" DynamicServicePath="" ></asp:ModalPopupExtender>
         <asp:Button ID="btndummyMsg" runat="server" CssClass="dummybutton" />
                   <asp:Panel ID="pnlCancelEInvoice" runat="server" BackColor="White" Width="45%" Height="500px" BorderColor="#003366" BorderWidth="1px" ScrollBars="Auto">
              
                     <table style="width:100%;padding-left:15px">
                         <tr>
                             <td colspan="2">
                                 <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">CANCEL EINVOICE</h4>
                             </td>
                         </tr>
                          <tr>
               <td colspan="2" style="width:100%;text-align:center;color:brown;font-size:18px;font-weight:bold;font-family:'Calibri';"> 
                      <asp:Label ID="lblMessageCancelEInvoice" runat="server"></asp:Label>
                      </td> 
            </tr>
             <tr>
               <td colspan="2" style="width:100%;text-align:center;font-size:18px;font-weight:bold;font-family:'Calibri';"> 
                      <asp:Label ID="lblAlertCancelEInvoice" runat="server" BackColor="Red" ForeColor="White"></asp:Label>
                      </td> 
            </tr>
                          <tr>
                      <td class="CellFormat" style="text-align:right;" >Invoice Number </td>
                    <td class="CellTextBox">  
                        <asp:TextBox ID="txtCancelInvoiceNo" runat="server" Forecolor="Black" Height="16px" MaxLength="200" Width="70%"></asp:TextBox>
                                        
                      </td>
                                         
                  </tr>
                           <tr>
                      <td class="CellFormat" style="text-align:right;" >Last Posted </td>
                    <td class="CellTextBox">  
                        <asp:TextBox ID="txtCancelLastPosted" runat="server" Height="16px" MaxLength="200" Width="70%" Enabled="False"></asp:TextBox>
                                        
                      </td>
                                         
                  </tr>
                           <tr>
                      <td class="CellFormat" style="text-align:right;" >Last Posted By </td>
                    <td class="CellTextBox">  
                        <asp:TextBox ID="txtCancelLastPostedBy" runat="server" Height="16px" MaxLength="200" Width="70%" Enabled="False"></asp:TextBox>
                         ...
                         <tr><td colspan="2"><br /><br /></td></tr>
                               <tr>
                      <td class="CellFormat" colspan="2" style="width:100%;text-align:center; margin-left:auto; margin-right:auto;"">
                         
                         &nbsp;<asp:Label ID="Label49" runat="server" Text="Do you want to CANCEL this INVOICE? "></asp:Label>
                   <br /> <br />  </td>
                     </tr>
              ...
              <tr>
                      <td class="CellFormat" colspan="2" style="width:100%;text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          &nbsp;<asp:Label ID="Label50" runat="server" Text="If Yes, please provide the Reason for Cancellation and Confirmation Code. "></asp:Label>
                 <asp:Label ID="lblRCNO" runat="server" Text=""></asp:Label>
                           <br /> <br />   </td>
                     </tr> 
                         <tr>
                             <td class="CellFormat" style="text-align:right;">Reason for Cancellation</td>
                            <td class="CellTextBox">  
                                          <asp:DropDownList ID="ddlReasonforCancellation" runat="server" OnSelectedIndexChanged="ddlReasonforCancellation_SelectedIndexChanged" CssClass="CellFormat" Width="70%" AutoPostBack="True">
                               <asp:ListItem Text="--SELECT--" Value="-1"></asp:ListItem>
                                               <asp:ListItem>Wrong Supplier Details</asp:ListItem>
                                <asp:ListItem>Wrong Buyer Details</asp:ListItem>
                                <asp:ListItem>Wrong Invoice Details</asp:ListItem>
                                <asp:ListItem>Other</asp:ListItem>
                              
                            </asp:DropDownList></td>
                              </tr> 
                         <tr runat="server" id="reasonother">
                             <td class="CellFormat" style="text-align:right;">Details (max 300 characters)</td>
                            <td class="CellTextBox"> 
                        <asp:TextBox ID="txtReasonCancelEInvoice" runat="server" Height="50px" MaxLength="300" Width="70%" TextMode="Multiline" Visible="true" ></asp:TextBox>
                          
              
                      </td>
                         </tr>
                          <tr>
                      <td class="CellFormat" style="text-align:right;" >Confirmation Code </td>
                    <td class="CellTextBox">  
                        <asp:TextBox ID="txtCancelCode" runat="server" Height="16px" MaxLength="200" Width="70%"></asp:TextBox>
                         ...
                         <tr>
                            ...
                            <tr style="padding-top:20px;">
                             <td colspan="2" style="text-align:center"><asp:Button ID="btnConfirmCancelEInvoice" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="PROCEED" Width="120px" OnClientClick="currentdatetime()"/>
                                 <asp:Button ID="btnCancelCancelEInvoice" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="CANCEL" Width="100px" />
                               </td>
                         </tr>
           ...
           <asp:ModalPopupExtender ID="mdlConfirmCancelEInvoice" runat="server" CancelControlID="btnCancelCancelEInvoice" PopupControlID="pnlCancelEInvoice" TargetControlID="btndummyCancelEInvoice" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
   
         
          <asp:Button ID="btndummyCancelEInvoice" runat="server" CssClass="dummybutton" />
             <%--07.12.24--%>
                        ...
                        <asp:TextBox ID="txtSearchClientName" runat="server" Height="16px" MaxLength="100" Width="80%"></asp:TextBox>
                               ...
                               <tr>
                                   ...
                                   <td style="width:10%;font-size:15px;font-weight:bold;font-family:Calibri;color:black;text-align:left;">
                                     ...
                                     <tr>
                                         <td style="width:10%;font-size:15px;font-weight:bold;font-family:Calibri;color:black;text-align:left;">Service Address</td>
                                         <td colspan="3" style="text-align:left;padding-left:5px;width:10%">
                                             <asp:TextBox ID="txtSearchServiceAddress" runat="server" AutoCompleteType="Disabled" Height="16px" MaxLength="50" Width="88%"></asp:TextBox>
                                         </td>
                            ...
                            <tr>
                                ...
                                <td style="text-align:left;padding-left:5px;width:10%">
                                    <asp:TextBox ID="txtSearchValueBaseFrom" runat="server" AutoCompleteType="Disabled" Height="16px" MaxLength="50" Width="80%"></asp:TextBox>
                                </td>
                                <td style="text-align:left; padding-left:15px; font-size:15px;font-weight:bold;font-family:Calibri;color:black; width:2%">To</td>
                                <td style="text-align:left;width:10%; padding-right:8px; ">
                                    <asp:TextBox ID="txtSearchValueBaseTo" runat="server" AutoCompleteType="Disabled" Height="16px" MaxLength="50" Width="80%"></asp:TextBox>
                                </td>
                                <td style="width:8%;font-size:15px;font-weight:bold;font-family:Calibri;color:black;text-align:left;">Over Due Days</td>
                                <td style="width:10%;font-size:15px;font-weight:bold;font-family:Calibri;color:black;text-align:left;">
                       ...
                       <asp:TextBox ID="txtSearchAppliedBaseTo" runat="server" MaxLength="50" Height="16px" Width="80%" AutoCompleteType="Disabled"></asp:TextBox>
                                   ...
                                   <td style="width:8%;font-size:15px;font-weight:bold;font-family:Calibri;color:black;text-align:left;">
                                    ...
                                    <asp:CheckBox ID="chkSearchShowUnPrintedInvoice" runat="server" AutoPostBack="false" Text="Show UnPrinted Invoice Only" />
                                          &nbsp;
                                          <asp:CheckBox ID="chkNoHardCopyInvoice0" runat="server" AutoPostBack="True" Font-Size="12px" Text="Include Invoices that DO NOT require Hard Copy" Visible="False" />
                                   </td>
                               </tr>
...
<asp:Panel ID="pnlPopUpClient2" runat="server" BackColor="White" Width="98%" Height="80%" BorderColor="#003366" BorderWidth="1px" HorizontalAlign="Center" ScrollBars="Horizontal">
    ...
    <asp:ImageButton ID="btnPopUpClientResetSearch2" runat="server" Height="22px" ImageAlign="Middle" ImageUrl="~/Images/resetbutton.jpg" OnClick="btnPopUpClientReset_Click" Width="24px"></asp:ImageButton>
        ...
        <asp:BoundField DataField="ServiceName" HeaderText="Client Name" SortExpression="ServiceName">
        <ControlStyle Width="35%" />
         ...
         CellPadding="2" GridLines="None" Width="99%"><AlternatingRowStyle BackColor="White" ForeColor="#284775" />
           ...
           <asp:Button ID="btnDummyViewEditHistory" runat="server" BackColor="White" CssClass="dummybutton" Font-Bold="True" Text="L" Width="24px" BorderStyle="None" ForeColor="White" />
             ...
             <%-- End:View Edit History--%>
               ...
               <%--'Start: View EInvoice Logs - 08.12.24--%>--%>
             
              
      <asp:Panel ID="pnlViewEInvoiceLogs" runat="server" BackColor="White" Width="1000px" Height="85%" BorderColor="#003366" BorderWidth="1px"
        HorizontalAlign="Left">
                ...
                <table border="0">
                           <tr>
                               <td colspan="2" style="text-align:center;"></td>
                               <td style="width:1%;text-align:right;">
                             <asp:ImageButton ID="ImageButton5" runat="server" ImageUrl="~/Images/closebutton.png" Height="27px" Width="30px" /></td></tr>
                    <tr><td colspan="2" style="width:10%;font-size:15px;font-weight:bold;font-family:Calibri;color:black;text-align:center;padding-left:40px;"> <h4 style="color: #000000">View E-Invoice Record History</h4> 
  </td> <td>
                               <asp:TextBox ID="TextBox3" runat="server" Width="20%" Visible="true" CssClass="dummybutton" ></asp:TextBox>
                           </td></tr>
                
           
                    <tr><td colspan="2" style="text-align:CENTER"><asp:Label ID="Label39" runat="server" Text="" Font-Names="Calibri" Font-Size="20px" Font-Bold="True" ForeColor="Red"></asp:Label></td></tr>
        </table>
              <div style="text-align: center; padding-left: 50px; padding-bottom: 5px;">
        
        <asp:GridView ID="grdViewEInvoiceLogs" runat="server" DataSourceID="sqlDSViewEInvoiceLogs" ForeColor="#333333" AllowPaging="True" AutoGenerateColumns="False" Font-Size="15px"
         CellPadding="2" GridLines="None" Width="99%"><AlternatingRowStyle BackColor="White" ForeColor="#284775" />
            <Columns>  
            ...
            <SortedDescendingHeaderStyle BackColor="#6F8DAE" />
                  ...
                  <asp:SqlDataSource ID="sqlDSViewEInvoiceLogs" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>"
                ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>">
                  </asp:SqlDataSource>
            ...
            <tr style="padding-top:40px; text-align:center; width:auto; " >
                ...
                <asp:ModalPopupExtender ID="mdlViewEInvoiceLogs" runat="server" CancelControlID="ImageButton5" PopupControlID="pnlViewEInvoiceLogs" TargetControlID="btnViewEInvoiceLogs" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
           <asp:Button ID="btnViewEInvoiceLogs" runat="server" BackColor="White" CssClass="dummybutton" Font-Bold="True" Text="L" Width="24px" BorderStyle="None" ForeColor="White" />
  

            <%--'End: View EInvoice Logs - 08.12.24--%>--%>
         ...
         <asp:Button ID="btndummyDeleteUploadedFile" runat="server" CssClass="dummybutton" />
          ...
          <Triggers>
              ...
              <asp:PostBackTrigger ControlID="btnExportToExcel" />
               <asp:PostBackTrigger ControlID="grdManualReports" />
