<%@ Page Title="Service Record Printing With Photos" Language="VB" MasterPageFile="~/MasterPage_Report.master" AutoEventWireup="false" CodeFile="RV_Select_ServiceRecordBatchPrinting.aspx.vb" Inherits="RV_Select_ServiceRecordBatchPrinting" EnableEventValidation="false" Culture="en-GB" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
      ...
      <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" ScriptMode="Release">
       ...
       <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">SERVICE REPORT WITH PHOTOS</h4>
...
<%--            <tr>
      ...
      <table style="width:100%;font-family: Calibri; font-size: 15px; font-weight: bold; color: black;text-align:left;padding-left:20px;line-height:20px;">
               ...
               <tr style="width:100%">
                      ...
                      <td colspan="1" style="width:75%;padding-left:10px;">
             ...
             <tr>
                    ...
                    <td class="CellTextBox"> <cc1:dropdowncheckboxes ID="ddlCompanyGrp" runat="server" Width="35.5%" UseSelectAllNode = "true" DataSourceID="SqlDSCompanyGroup" DataTextField="CompanyGroup" DataValueField="CompanyGroup" AddJQueryReference="true" UseButtons="false" >
     <Style2 SelectBoxWidth="35.5%" DropDownBoxBoxWidth="35.5%" DropDownBoxBoxHeight="120" />
          ...
          <tr>
                    ...
                    <td class="CellTextBox">  <asp:TextBox ID="txtContractNo" runat="server" MaxLength="30" Height="16px" Width="35%" Visible="True"></asp:TextBox></td>
                  <%--  <td class="CellTextBox">
                           </td>--%>
                  </tr>
           <tr>
                         <td colspan="2" style="font-size:15px;font-weight:bold;font-family:'Calibri';color:#800000; text-align:left; text-decoration: underline;padding-left:20%;">Service Details</td>
                       </tr>
               <tr>
                      <td class="CellFormat">
                         Service Record
                             </td>
                     <td class="CellTextBox" colspan="1"><asp:TextBox ID="txtServiceRecord" runat="server" MaxLength="30" Height="16px" Width="35%"></asp:TextBox> </td>
               ...
               <tr>
                             <td class="CellFormat">Service By
                              ...
                              <td class="CellTextBox" colspan="1"> <asp:DropDownList ID="ddlIncharge" runat="server" CssClass="chzn-select" AppendDataBoundItems="True" DataSourceID="SqlDSIncharge" DataTextField="inchargeId" DataValueField="inchargeId" Width="35.5%" Height="25px" ><asp:ListItem Text="--SELECT--" Value="-1" /></asp:DropDownList>
                            </td>
                           </tr>
             <tr>
            ...
            <tr>
                  ...
                  <td class="CellTextBox"> <asp:dropdownlist ID="ddlTargetID" runat="server" AppendDataBoundItems="TRUE" Width="35.5%" DataSourceID="SqlDSTarget" DataTextField="TargetID" DataValueField="Descrip1" >
                <asp:ListItem Selected="TRUE" Text="--SELECT--" Value="-1" />
                </asp:dropdownlist></td>
                
              </tr>
              <tr>
                         <td colspan="2" style="font-size:15px;font-weight:bold;font-family:'Calibri';color:#800000; text-align:left; text-decoration: underline;padding-left:15%;">Account Information</td>
                          </tr>
             ...
             <%--  <tr>
                    ...
                    <td class="CellTextBox" colspan="1">  <asp:TextBox ID="txtCustName" runat="server" MaxLength="200" Height="16px" Width="70%"></asp:TextBox>
                               </td>
                  </tr>--%>
                     <tr>
                      <td class="CellFormat">ServiceLocationID</td>
                    <td class="CellTextBox">  <asp:TextBox ID="txtServiceLocationID" runat="server" MaxLength="17" Height="16px" Width="35%"></asp:TextBox>
              ...
              <tr>
                ...
                <tr>
                    ...
                    <td class="CellTextBox" colspan="2" style="text-align:center;padding-left:30%">
                        <table>
                            <tr>
                                 <td rowspan="2"><asp:ListBox ID="lstSort1" runat="server" width="120px" Rows="6" SelectionMode="Multiple">
                                    ...
                                    <asp:ListItem Text="TimeIn" Value="TimeIn">Time In</asp:ListItem>
                                      <asp:ListItem Text="LocationID" Value="LocationID">Status</asp:ListItem>
