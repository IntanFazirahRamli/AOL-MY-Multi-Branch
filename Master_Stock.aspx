<%@ Page Title="Stock Master" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Master_Stock.aspx.vb" Inherits="Master_Stock" Culture="en-GB" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="text-align:center">
        ...
        <h3 style="font-family: Verdana, Geneva, Calibri, sans-serif; font-weight: bold;COLOR:#000099;">Stock</h3>
...
<asp:Button ID="btnDelete" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="DELETE" Width="100px" OnClientClick = "Confirm(); currentdatetime()"/>
                ...
                <td style="text-align:right;display:inline;" class="auto-style1">
                    ...
                    <td style="text-align:right;width:35%">  <asp:ImageButton ID="btnResetSearch" runat="server" ImageUrl="~/Images/reset1.png" Height="25px" Width="25px" ToolTip="RESET SEARCH" />  <asp:TextBox ID="txtSearchStockItem" runat="server" Width="370px" Height="25px" Text = "Search Here" ForeColor = "Gray" onblur = "WaterMark1(this, event);" onfocus = "WaterMark1(this, event);" AutoPostBack="True"></asp:TextBox>      
            ...
            <Columns>
                ...
                <asp:BoundField DataField="ItemID" HeaderText="Item ID" SortExpression="ID">
                ...
                <ItemStyle Width="200px" HorizontalAlign="Left" />
                  ...
                  <asp:BoundField DataField="UNITMS" HeaderText="Unit" />
          ...
          <tr>
            ...
            <tr>
                    ...
                    <td class="auto-style2">Item ID<asp:Label ID="Label23" runat="server" visible="true" Font-Size="14px" ForeColor="Red" Text="*" Height="20px"></asp:Label></td>
                     

                    <td class="CellTextBoxADM"> <asp:TextBox ID="txtItemID" runat="server" MaxLength="30" Height="16px" Width="30%"></asp:TextBox></td>
              ...
              <tr>
                    ...
                    <td class="auto-style2">Item Name<asp:Label ID="Label3" runat="server" visible="False" Font-Size="14px" ForeColor="Red" Text="*" Height="20px"></asp:Label></td>
                     

                    <td class="CellTextBoxADM"> <asp:TextBox ID="txtItemName" runat="server" MaxLength="200" Height="16px" Width="60%"></asp:TextBox></td>
              ...
              <tr>
                    ...
                    <td class="auto-style2">Unit MS</td>
                     

                    <td class="CellTextBoxADM">  <asp:DropDownList ID="txtUnitMS" runat="server" CssClass="chzn-select" Width="30%" Height="25px" AppendDataBoundItems="True">
                                <asp:ListItem Text="--SELECT--" Value="-1" /> </asp:DropDownList></td>
...
<asp:Button ID="btnCancel" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="CANCEL" Width="100px" /></td>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>" SelectCommand="SELECT * FROM tblstockItem"></asp:SqlDataSource>
