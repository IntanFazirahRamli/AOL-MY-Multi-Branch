...
Partial Class Master_PestSpecies
    ...
    Private Sub InsertIntoTblWebEventLog(events As String, errorMsg As String, ID As String)
        Try
            ...
            insCmds.Parameters.AddWithValue("@LoginId", "PESTSpecies - " + txtCreatedBy.Text)
    ...
    Protected Sub GridView1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles GridView1.SelectedIndexChanged
        ...
        Dim sql As String
        sql = "Select * FROM tblpestSpecies "
        ...
        If dt.Rows.Count > 0 Then
            ...
            If dt.Rows(0)("Species").ToString <> "" Then : txtSpecies.Text = dt.Rows(0)("Species").ToString : End If
    ...
    Private Sub AccessControl()
        Try
            ...
            If Session("SecGroupAuthority") <> "ADMINISTRATOR" Then
                ...
                command.CommandText = "SELECT x0189,  x0189Add, x0189Edit, x0189Delete FROM tblGroupAccess where GroupAccess = '" & Session("SecGroupAuthority") & "'"
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    If String.IsNullOrEmpty(Convert.ToBoolean(dt.Rows(0)("x0189"))) = False Then
                        If Convert.ToBoolean(dt.Rows(0)("x0189")) = False Then
                            Response.Redirect("Home.aspx")
                        End If
                    End If


                    If String.IsNullOrEmpty(dt.Rows(0)("x0189Add")) = False Then
                        Me.btnADD.Enabled = dt.Rows(0)("x0189Add").ToString()
                    End If

                    'Me.btnInsert.Enabled = vpSec2412Add
                    If txtMode.Text = "View" Then
                        If String.IsNullOrEmpty(dt.Rows(0)("x0189Edit")) = False Then
                            Me.btnEdit.Enabled = dt.Rows(0)("x0189Edit").ToString()
                        End If

                        If String.IsNullOrEmpty(dt.Rows(0)("x0189Delete")) = False Then
                            Me.btnDelete.Enabled = dt.Rows(0)("x0189Delete").ToString()
                        End If
                    Else
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        If txtMode.Text = "New" Then
            Try
                ...
                command1.CommandText = "SELECT * FROM tblpestSpecies where PesTID =@PesTID and Species=@Species"
                command1.Parameters.AddWithValue("@PesTID", ddlPestID.Text)
                command1.Parameters.AddWithValue("@Species", txtSpecies.Text)
                ...
                Else
                    ...
                    command.CommandType = CommandType.Text
                    Dim qry As String = "INSERT INTO tblpestSpecies (PestID, Species, Description, CreatedBy,CreatedOn,LastModifiedBy,LastModifiedOn)"
                    qry = qry + "VALUES(@PestID,@Species, @Description,  @CreatedBy,@CreatedOn,@LastModifiedBy,@LastModifiedOn);"
                    ...
                    If ConfigurationManager.AppSettings("UPPERCASE").ToString() = "YES" Then
                        ...
                        command.Parameters.AddWithValue("@Species", txtSpecies.Text.ToUpper)
        ...
        ElseIf txtMode.Text = "Edit" Then
            ...
            Try
                ...
                command2.CommandText = "SELECT * FROM tblpestSpecies where PestID=@PestID and Species=@Species and rcno<>" & Convert.ToInt32(txtRcno.Text)
                command2.Parameters.AddWithValue("@PestID", ddlPestID.Text)
                command2.Parameters.AddWithValue("@Species", txtSpecies.Text)
                ...
                Else
                    ...
                    command1.CommandText = "SELECT * FROM tblPestSpecies where rcno=" & Convert.ToInt32(txtRcno.Text)
                    command1.Connection = conn
                    ...
                    If dt.Rows.Count > 0 Then
                        ...
                        If txtExists.Text = "True" Then
                            qry = "update tblpestSpecies set Species=@Species, Description=@Description, LastModifiedBy=@LastModifiedBy,LastModifiedOn=@LastModifiedOn where rcno=" & Convert.ToInt32(txtRcno.Text)
                        Else
                            qry = "update tblpestSpecies set PestID=@PestID, Species=@Species, Description=@Description, LastModifiedBy=@LastModifiedBy,LastModifiedOn=@LastModifiedOn where rcno=" & Convert.ToInt32(txtRcno.Text)
                        End If
                ...
                conn.Close()
                If txtMode.Text = "NEW" Then
                    CType(Me.Master, MasterPage).EventLog_Insert(Session("UserID"), "PESTSpecies", ddlPestID.Text, "ADD", Convert.ToDateTime(txtCreatedOn.Text), 0, 0, 0, "", "", txtRcno.Text)
                Else
                    CType(Me.Master, MasterPage).EventLog_Insert(Session("UserID"), "PESTSpecies", ddlPestID.Text, "EDIT", Convert.ToDateTime(txtCreatedOn.Text), 0, 0, 0, "", "", txtRcno.Text)
                End If
            Catch ex As Exception
                MessageBox.Message.Alert(Page, ex.ToString, "str")
            End Try
        ...
        If confirmValue = "Yes" Then
            ...
            Try
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    command.CommandType = CommandType.Text
                    Dim qry As String = "delete from tblpestSpecies where rcno=" & Convert.ToInt32(txtRcno.Text)
                ...
                End If
                conn.Close()
                CType(Me.Master, MasterPage).EventLog_Insert(Session("UserID"), "PESTSpecies", ddlPestID.Text, "DELETE", Convert.ToDateTime(txtCreatedOn.Text), 0, 0, 0, "", "", txtRcno.Text)
            Catch ex As Exception
                MessageBox.Message.Alert(Page, ex.ToString, "str")
            End Try
            EnableControls()
