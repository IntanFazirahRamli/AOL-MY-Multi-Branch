<%@ Page Language="vb" AutoEventWireup="false" CodeFile="RV_CompletedSvcList02.aspx.vb" 
    Inherits="RV_CompletedSvcList02" MasterPageFile="~/MasterPage.Master"
    Title="Completed Service Listing Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div style="text-align:center">
        <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">Completed Service Listing Report</h3>
       <br />
    <table style="width: 100%; text-align: center;">
         <tr>
             <td style="text-align:left">
                  ...
                  <a href="RV_Export_CompletedSvcList.aspx" target="_blank"><button class="button" style="background-color:#CFC6C0;font-weight:bold;width:100px;font-family:Calibri;font-size:14px;" type="button">View as PDF</button></a>
        ...
        <tr>
            <td colspan="2">
                ...
                <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                    <Report FileName="Reports\ServiceRecordReports\CompletedSvcList02.rpt">
                    </Report>
