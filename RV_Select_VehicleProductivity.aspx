<%@ Page Title="Vehicle Productivity Report Selection" Language="VB" MasterPageFile="~/MasterPage_Report.master" AutoEventWireup="false" CodeFile="RV_Select_VehicleProductivity.aspx.vb" Inherits="RV_Select_VehicleProductivity" %>
...
<script type="text/javascript">
    ...
    function currentdatetime() {
     ...
     <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" ScriptMode="Release">
       ...
       <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">VEHICLE PRODUCTIVITY REPORT</h4>
...
<%--            <tr>
      ...
      <tr>
             ...
             <tr>
                             <td class="CellFormat">Vehicle
                               </td>
                              <td class="CellTextBox" colspan="1">  <asp:dropdownlist ID="ddlVehicle" runat="server" Width="35.5%" DataSourceID="SqlDSVehicle" DataTextField="assetno" DataValueField="assetno" AutoPostBack="FALSE" AppendDataBoundItems="TRUE" >
     ...
     <Style2 SelectBoxWidth="35.5%" DropDownBoxBoxWidth="35.5%" DropDownBoxBoxHeight="120" />
      ...
      <asp:SqlDataSource ID="SqlDSVehicle" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>" SelectCommand="SELECT assetno FROM tblasset where type='vehicle' order by assetno">
