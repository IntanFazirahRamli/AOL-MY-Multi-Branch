...
Public Class RV_MasterServiceFrequency
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                Dim repPath As String = Server.MapPath("~/Reports/AdministrationReports/Rpt_Master_ServiceFrequency.rpt")
                crReportDocument.Load(repPath)
                Dim selectFormula As String = "{tblServiceFrequency1.RcNo} <> 0"
    ...
    Protected Sub btnQuit_Click(sender As Object, e As EventArgs)
        Response.Redirect("Master_ServiceFrequency.aspx")
    End Sub
End Class