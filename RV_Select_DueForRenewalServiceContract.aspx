<%@ Page Title="Due For Renewal Service Contract Report Selection" Language="VB" MasterPageFile="~/MasterPage_Report.master" AutoEventWireup="false" CodeFile="RV_Select_DueForRenewalServiceContract.aspx.vb" Inherits="RV_Select_DueForRenewalServiceContract" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <script type="text/javascript">
      ...
      <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" ScriptMode="Release">
       ...
       <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">DUE FOR RENEWAL SERVICE CONTRACT LISTING REPORT</h4>
...
<%--            <tr>
      ...
      <table style="width:100%;font-family: Calibri; font-size: 15px; font-weight: bold; color: black;text-align:left;padding-left:20px;line-height:20px;">
             ...
             <tr>
                      <td class="CellFormat">ExpiryDate</td>
...
<td><asp:Button ID="btnSort2" runat="server" Text="<<" /></td>
           ...
           <tr>
               ...
               <asp:Button ID="btnPrintServiceContractList" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="Print" Width="100px"/>
                  ...
                  <td style="text-align:LEFT"> <asp:Button ID="btnCloseServiceContractList" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="Cancel" Width="100px" />
                      </td>
