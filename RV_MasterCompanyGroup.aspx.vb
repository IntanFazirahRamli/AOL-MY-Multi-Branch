...
Public Class RV_MasterCompanyGroup
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                Dim repPath As String = Server.MapPath("~/Reports/AdministrationReports/Rpt_Master_CompanyGroup.rpt")
                crReportDocument.Load(repPath)
                Dim selectFormula As String = "{tblCompanyGroup1.RcNo} <> 0"
    ...
    Protected Sub btnQuit_Click(sender As Object, e As EventArgs)
        Response.Redirect("Master_CompanyGroup.aspx")
    End Sub
End Class