...
Partial Class RV_Select_CombinedRevenue
    ...
    Protected Sub btnPrintServiceRecordList_Click(sender As Object, e As EventArgs) Handles btnPrintServiceRecordList.Click
        ...
        If rbtnSelectDetSumm.SelectedIndex = 0 Then
            Session.Add("rptTitle", "ACTUAL & FORECAST REVENUE REPORT BY TEAM - DETAIL")
        ...
        ElseIf rbtnSelectDetSumm.SelectedIndex = 1 Then
            Session.Add("rptTitle", "ACTUAL & FORECAST REVENUE REPORT BY TEAM - SUMMARY")
    ...
    Protected Sub btnExportToExcel_Click(sender As Object, e As EventArgs) Handles btnExportToExcel.Click
        ...
        If GetData() = True Then
            ...
            Dim attachment As String = "attachment; filename=Revenue.xls"
    ...
    Private Function GetData() As Boolean
        ...
        Dim qry As String = ""
        If rbtnSelectDetSumm.SelectedIndex = 0 Then
            qry = " SELECT distinct tblservicerecord.TeamID,tblservicerecord.RecordNo,tblservicerecord.CustName,tblservicerecord.ServiceDate, tblservicerecord.Address1, tblservicerecord.AddBuilding, tblservicerecord.AddPostal, tblservicerecord.AddStreet,tblservicerecord.LocationID, tblcontract.BillingFrequency,tblcontract.AgreeValue, tblservicerecord.BillAmount"

        ElseIf rbtnSelectDetSumm.SelectedIndex = 1 Then
            qry = " SELECT distinct tblservicerecord.TeamID,count(tblservicerecord.RecordNo) as NoOfServices,tblservicerecord.ServiceDate,sum(tblservicerecord.BillAmount) as BillAmount"
    ...
    Public Sub WriteExcelWithNPOI(ByVal dt As DataTable, ByVal extension As String)
        ...
        Using exportData = New MemoryStream()
            ...
            Dim attachment As String = "attachment; filename=Revenue"
