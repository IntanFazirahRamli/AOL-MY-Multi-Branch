<%@ Page Title="Service Contract Expiry/Renewal Listing Report Selection" Language="VB" MasterPageFile="~/MasterPage_Report.master" AutoEventWireup="false" CodeFile="RV_Select_ServiceContractExpiry.aspx.vb" Inherits="RV_Select_ServiceContractExpiry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <script type="text/javascript">
       ...
       <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">SERVICE CONTRACT EXPIRY/RENEWAL LISTING REPORT</h4>
...
<%--            <tr>
     ...
     <Style2 SelectBoxWidth="56.5%" DropDownBoxBoxWidth="56.5%" DropDownBoxBoxHeight="120" />
            ...
            <tr>
                    ...
                    <td class="CellTextBox"> <asp:DropDownList ID="ddlCategory" runat="server" CssClass="chzn-select" Width="56.5%" Height="25px" AppendDataBoundItems="True">
                                          <asp:ListItem Text="--SELECT--" Value="-1" />
           ...
           <tr>
               ...
               <tr>
                    ...
                    <td class="CellTextBox" colspan="2">  <asp:TextBox ID="txtCustName" runat="server" MaxLength="200" Height="16px" Width="80%"></asp:TextBox>
                               </td>
                    <td class="CellTextBox">  &nbsp;</td>
                  </tr>
