<%@ Page Title="Invoice" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Invoice_Decimal_Truncate.aspx.vb" Inherits="Invoice_Decimal_Truncate" Culture="en-GB" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" ValidateRequest="false"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Button ID="dummy" runat="server" Text="" cssclass="dummybutton" />
     ...
     <div style="text-align:center">
        ...
        <tr >
            ...
            <tr>
                 <td colspan="12"   style="width:100%;text-align:left;color:brown;font-size:16px;font-weight:bold;font-family:'Calibri';"> 
              ...
              <tr>
                <td style="width:5%;text-align:center;"> 
                   <asp:Button ID="btnADD" runat="server" Font-Bold="True" Text="ADD"  CssClass="roundbutton1" BackColor="#CFC6C0" Visible="TRUE" OnClientClick="initialize()"  />
                 
                      </td>
                  
                  <td style="width:5%;text-align:center;">
                             <asp:Button ID="btnCopy" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="COPY" OnClientClick="RefreshSubmit()" Visible="TRUE" />
               
                    </td>
           
                  <td style="width:5%;text-align:center;">
                             <asp:Button ID="btnEdit" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="EDIT" OnClientClick="RefreshSubmit()" Visible="TRUE"  />
               
                  </td>
                  <td style="width:6%;text-align:center;">
                              <asp:Button ID="btnPrint" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="PRINT" Visible="true" />
              
                  </td>
               
                     <td style="width:8%;text-align:center;">
                                 <asp:Button ID="btnMultiPrint" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="MULTI PRINT" Visible="true" />
              
                      </td>
                
                  <td style="width:5%;text-align:center;">
                               <asp:Button ID="btnPost" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" OnClientClick="currentdatetime();" Text="POST" Width="94%" />
             
                  </td>
                  
                   <td style="width:7%;text-align:center;">
                           <asp:Button ID="btnReverse" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="REVERSE" Width="94%" OnClientClick="currentdatetime();" />
              
                    </td>

                    <td style="width:6%;text-align:center;">
                              <asp:Button ID="btnChangeStatus" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="CH.  ST." Width="94%" />
               
                  </td>

                   <td style="width:7%;text-align:center;">
                          <asp:Button ID="btnReceipts" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="RECEIPTS" OnClientClick="currentdatetimereceipt()" Visible="true" Width="94%" />
          
                               </td>
                    <td style="width:7%;text-align:center;">
                          <asp:Button ID="btnCNDN" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="CN/DN"  Visible="true" Width="94%" />
          
                               </td>
                  
                       <td style="width:7%;text-align:center;">
                         <asp:Button ID="btnJournal" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="JOURNAL" Width="94%" />
                  </td>
                   <td style="width:7%;text-align:center;">
                          <asp:Button ID="btnRecalculate" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" OnClientClick="currentdatetime()" Text="RECALCULATE" Width="94%" Visible="True" />
         
                  </td>
                   <td style="width:6%;text-align:center;">
                          <asp:Button ID="btnFilter" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" OnClientClick="currentdatetime()" Text="FILTER" Width="94%" Visible="True" />
         
                  </td>


                     <td style="width:6%;text-align:center;">
                         <asp:Button ID="btnBack" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="BACK" Width="95%" />
                  </td>
                         ...
                         <tr>
                          ...
                          <asp:MaskedEditExtender runat="server" ID="MaskedEditExtender2" ClearMaskOnLostFocus="false"
                            ...
                            <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black;  width:10%; ">
                               ...
                               <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; text-align:right; ">Paid status</td>
                              <td>
                           ...
                           <asp:TextBox ID="txtAccountIdSearch" runat="server" AutoCompleteType="Disabled" Height="16px" MaxLength="50" style="text-align:left; " Width="72%" AutoPostBack="True"></asp:TextBox>
                            ...
                            <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; text-align:right; ">
                             ...
                             <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black;  width:15%; ">
                                  ...
                                  &nbsp;<asp:ImageButton ID="btnClientSearch0" runat="server" CssClass="righttextbox" Height="22px" ImageAlign="Middle" ImageUrl="~/Images/searchbutton.jpg" Width="24px" />
                            </td>
                                          ...
                                          <asp:GridView ID="GridView1" Width="100%" Font-Size="15px" runat="server" OnRowDataBound = "OnRowDataBoundg1" OnSelectedIndexChanged = "OnSelectedIndexChangedg1" AllowSorting="True" AutoGenerateColumns="False" BorderWidth="1px" CellPadding="2" CellSpacing="2" DataKeyNames="Rcno" DataSourceID="SQLDSInvoice" ForeColor="#333333" GridLines="Vertical" AllowPaging="True"> 
                                              <AlternatingRowStyle BackColor="White"/>
                                                <Columns>
                                                  ...
                                                  <asp:BoundField DataField="CustAddStreet" HeaderText="Street" >
                                                    <ItemStyle Wrap="False" HorizontalAlign="Left" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="custAddBuilding" HeaderText="Building">
                                                    <ControlStyle Width="8%" />
                                                    <ItemStyle HorizontalAlign="Left" Wrap="False" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="CustAddCity" HeaderText="City">
                                                    <ControlStyle CssClass="dummybutton" />
                                                    <HeaderStyle CssClass="dummybutton" />
                                                    <ItemStyle Wrap="False" CssClass="dummybutton" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="CustAddCountry" InsertVisible="False" HeaderText="Country">
                                                    <ItemStyle Wrap="False" />
                                                    </asp:BoundField>
    ...
    <asp:TabContainer ID="tb1" runat="server" ActiveTabIndex="0" Font-Names="Calibri" Height="100%" Width="98%" CssClass="ajax__tab_xp"  AutoPostBack="true">
...
<table border="0" style="width:95%; margin:auto; border:solid; border-color:ButtonFace;"><tr style="width:100%"><td colspan="4" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; text-decoration: underline;padding-left:2%; color:#800000; background-color: #C0C0C0;">INVOICE&nbsp;INFORMATION </td></tr><tr><td></td><td><asp:SqlDataSource ID="SqlDSSalesDetail" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" DataSourceMode="DataReader" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>"><SelectParameters><asp:ControlParameter ControlID="txtInvoiceNo" Name="@InvoiceNumber" PropertyName="Text" /></SelectParameters></asp:SqlDataSource></td></tr><tr>
    ...
    <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; ">&#160;<asp:TextBox ID="txtRcnoServiceBillingDetail" runat="server" AutoCompleteType="Disabled" BorderStyle="None" ForeColor="White" Height="16px" TabIndex="105" Width="1%"></asp:TextBox></td><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:10%; text-align:right; ">Country<asp:Label ID="Label61" runat="server" Font-Size="14px" ForeColor="Red" Text="*"></asp:Label></td><td style="width:20%;font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:left;"><asp:TextBox ID="txtBillCountry" runat="server" Height="18px" MaxLength="100" Width="80%" TabIndex="28"></asp:TextBox></td>
    <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; "></td></tr><tr><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; "><asp:TextBox ID="txtServiceName" runat="server" AutoCompleteType="Disabled" BorderStyle="None" Height="16px" TabIndex="106" Width="1%"></asp:TextBox></td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:10%; text-align:right; ">Postal </td><td style="width:20%;font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:left;">
    ...
    <asp:TextBox ID="txtDueDate" runat="server" AutoCompleteType="Disabled" AutoPostBack="True" Height="16px" TabIndex="28" Width="80%"></asp:TextBox><asp:CalendarExtender ID="txtDueDate_CalendarExtender" runat="server" Enabled="True" Format="dd/MM/yyyy" PopupButtonID="txtDueDate" TargetControlID="txtDueDate" /></td><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; ">&nbsp;</td></tr><tr><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; "><asp:TextBox ID="txtCreatedOn" runat="server" BorderStyle="None" ForeColor="White" TabIndex="108" Width="1%"></asp:TextBox></td>
    ...
    <td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; ">&nbsp;</td></tr><tr><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; text-align:right; ">&nbsp;</td><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:10%; text-align:right; ">Tax Code</td><td style="width:20%;font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:left;"><asp:DropDownList ID="txtGST" runat="server" AppendDataBoundItems="True" CssClass="chzn-select" DataTextField="TaxType" DataValueField="TaxType" Height="25px" Value="-1" Width="80.6%" AutoPostBack="True"><asp:ListItem Text="--SELECT--" Value="-1" /></asp:DropDownList></td>
...
<asp:Button ID="btnDummyGL" runat="server" BackColor="White" CssClass="roundbutton" Font-Bold="True" Text="L" Width="24px" BorderStyle="None" ForeColor="White" /><asp:ModalPopupExtender ID="imgBtnGL_ModalPopupExtender" runat="server" BackgroundCssClass="modalBackground" CancelControlID="btnPnlGLClose" PopupControlID="pnlPopUpGL" TargetControlID="btnDummyGL" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender><table border="1" style="width:100%; margin:auto"><tr><td colspan="12" style="text-align:left;"><asp:Label ID="Label22" runat="server" Text="View Records :" CssClass="CellFormat"></asp:Label><asp:DropDownList ID="ddlViewServiceRecs" runat="server" AutoPostBack="True"><asp:ListItem Selected="True">15</asp:ListItem><asp:ListItem>25</asp:ListItem>
             ...
             <Columns><asp:TemplateField><ItemTemplate><asp:CheckBox ID="chkSelectRecB" runat="server" Font-Size="12px" Enabled="true" Height="18px" Visible="true"  Width="4%" AutoPostBack="false" Checked="true"    onchange="checkselectrec()"  CommandName="CHECK" ></asp:CheckBox></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText=" Item Type"><ItemTemplate><asp:TextBox ID="txtItemTypeGVB" runat="server" Text='<%# Bind("SuBcode")%>' Font-Size="11px" Height="15px" ReadOnly="true" Width="65px" Enabled="False" AppendDataBoundItems="True" AutoPostBack="True"  ></asp:TextBox></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="Ref. No."><ItemTemplate>
                 ...
                 <asp:TextBox ID="txtTotalPriceGVB" runat="server" Text='<%# Bind("TotalPrice")%>' Font-Size="11px"   Enabled="false" style="text-align:right" Height="15px" Width="70px" Align="right"></asp:TextBox></ItemTemplate><HeaderStyle HorizontalAlign="Right" /></asp:TemplateField><asp:TemplateField HeaderText="Disc %"><ItemTemplate><asp:TextBox ID="txtDiscPercGVB" runat="server" Text='<%# Bind("DiscP", "{0:n2}")%>' Font-Size="11px"  style="text-align:right" Height="15px"  Width="40px" AutoPostBack="true" OnTextChanged="txtDiscPercGVB_TextChanged"></asp:TextBox></ItemTemplate><HeaderStyle HorizontalAlign="Center" /></asp:TemplateField><asp:TemplateField HeaderText="Disc Amt."><ItemTemplate>
                 <asp:TextBox ID="txtDiscAmountGVB" runat="server" Text='<%# Bind("DiscAmount", "{0:n2}")%>' Font-Size="11px"  style="text-align:right" Height="15px" Enabled="false"  Width="48px" AutoPostBack="true" OnTextChanged="txtDiscAmountGVB_TextChanged"></asp:TextBox></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="Price W Disc"><ItemTemplate><asp:TextBox ID="txtPriceWithDiscGVB" runat="server" Text='<%# Bind("ValueBase")%>' Font-Size="11px"   Enabled="false" style="text-align:right" Height="15px" Width="65px" Align="right"></asp:TextBox></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="Tax Code"><ItemTemplate>
                 <asp:DropDownList ID="txtTaxTypeGVB" runat="server" SelectedValue='<%# bind("GST") %>' DataSourceID="SQLDSTaxType" DataTextField="TaxType" Font-Size="11px" style="text-align:right" Height="20px" Width="48px" AutoPostBack="True" onselectedindexchanged="txtTaxTypeGVB_SelectedIndexChanged" ></asp:DropDownList></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="GST %"><ItemTemplate><asp:TextBox ID="txtGSTPercGVB" runat="server" Text='<%# Bind("GstRate", "{0:n2}")%>'   Font-Size="11px" Enabled="false" style="text-align:right" Height="15px" Width="35px"></asp:TextBox></ItemTemplate><HeaderStyle HorizontalAlign="Center" /></asp:TemplateField><asp:TemplateField HeaderText="GST Amt."><ItemTemplate>
                 <asp:TextBox ID="txtGSTAmtGVB" runat="server" Text='<%# Bind("GSTBase")%>' Font-Size="11px" Enabled="true" AutoPostBack="true"  style="text-align:right" Height="15px" Width="47px" Align="right" OnTextChanged="txtGSTAmtGVB_TextChanged"></asp:TextBox></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="Net Price"><ItemTemplate><asp:TextBox ID="txtTotalPriceWithGSTGVB" runat="server" Text='<%# Bind("AppliedBase")%>'  Font-Size="11px" Enabled="false" style="text-align:right" Height="15px" Width="65px" Align="right"></asp:TextBox></ItemTemplate><HeaderStyle HorizontalAlign="Right" /></asp:TemplateField><asp:TemplateField><ItemTemplate>
            ...
            ShowFooter="True" Style="text-align: left" Width="99%" BorderStyle="None" ShowHeader="False" ><Columns>
                ...
                <asp:TemplateField HeaderText="Ref. No."><ItemTemplate><asp:TextBox ID="txtServiceRecordGV" runat="server" Font-Size="11px" Enabled="true" style="text-align:left" Height="15px" Width="113px" Align="right"  AutoPostBack="True" AppendDataBoundItems="True" OnTextChanged="txtServiceRecordGV_TextChanged" ></asp:TextBox></ItemTemplate><HeaderStyle HorizontalAlign="Center" /></asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Contract No."><ItemTemplate><asp:TextBox ID="txtContractNoGV" runat="server" Height="15px" Width="129px" Font-Size="11px" Enabled="False"  AutoPostBack="True" OnTextChanged="txtContractNoGV_TextChanged"> </asp:TextBox></ItemTemplate><HeaderStyle HorizontalAlign="Center" /></asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Total Price"><ItemTemplate><asp:TextBox ID="txtTotalPriceGV" runat="server" Font-Size="11px" Text="0.00"  Enabled="false" style="text-align:right" Height="15px" Width="70px" Align="right"></asp:TextBox></ItemTemplate><HeaderStyle HorizontalAlign="Right" /></asp:TemplateField>
                <asp:TemplateField HeaderText="Disc %"><ItemTemplate><asp:TextBox ID="txtDiscPercGV" runat="server"  Font-Size="11px" Text="0.00" style="text-align:right" Height="15px"  Width="40px" AutoPostBack="true" OnTextChanged="txtDiscPercGV_TextChanged"></asp:TextBox></ItemTemplate><HeaderStyle HorizontalAlign="Center" /></asp:TemplateField><asp:TemplateField HeaderText="Disc Amt."><ItemTemplate><asp:TextBox ID="txtDiscAmountGV" runat="server" Font-Size="11px" Text="0.00" style="text-align:right" Height="15px" Enabled="false"  Width="48px" AutoPostBack="true" OnTextChanged="txtDiscAmountGV_TextChanged"></asp:TextBox></ItemTemplate></asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Tax Code"><ItemTemplate><asp:DropDownList ID="txtTaxTypeGV" runat="server" Font-Size="11px" style="text-align:right" Height="20px" Width="48px" AutoPostBack="True" onselectedindexchanged="txtTaxTypeGV_SelectedIndexChanged"></asp:DropDownList></ItemTemplate></asp:TemplateField>
                ...
                <asp:TemplateField><ItemTemplate><asp:TextBox ID="txtOriginalBillAmountGV" runat="server" Visible="false" Height="15px" Width="0px"></asp:TextBox></ItemTemplate></asp:TemplateField><asp:TemplateField><FooterStyle HorizontalAlign="Left" /><FooterTemplate><asp:Button ID="btnAddDetail" runat="server" OnClick="btnAddDetail_Click" Text="Add New Row" ValidationGroup="VGroup" Visible="false" /></FooterTemplate><ItemStyle ForeColor="#507CD1" /></asp:TemplateField></Columns><FooterStyle BackColor="#F7DFB5" ForeColor="#8C4510" /><HeaderStyle BackColor="#000066" Font-Bold="True" ForeColor="White" Font-Names="Calibri"/><PagerStyle ForeColor="#8C4510" HorizontalAlign="Center" />
                         <RowStyle BackColor="#E4E4E4" ForeColor="#8C4510" Font-Names="Calibri"/><SelectedRowStyle BackColor="#738A9C" Font-Bold="False" ForeColor="White" /></asp:GridView></td></tr></table></ContentTemplate></asp:UpdatePanel>
                     ...
                     <tr>
                          ...
                          <td style="font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:left;" colspan="4"> Display Services&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
                            ...
                            <tr>
                                ...
                                <td style="width:6%;font-size:12px;font-weight:bold;font-family:'Calibri';color:black;text-align:left;">
                                    <asp:TextBox ID="txtAccountId" runat="server" AutoCompleteType="Disabled" AutoPostBack="True" Height="16px" Width="80%"></asp:TextBox>
        ...
        <asp:UpdatePanel ID="updpnlServiceRecs" runat="server" UpdateMode="Conditional"><ContentTemplate>
            ...
            ShowFooter="True" Style="text-align: left" Width="100%">
             ...
             <asp:TemplateField HeaderText="Service Date"><ItemTemplate><asp:TextBox ID="txtServiceDateGV" runat="server" Text='<%# Bind("ServiceDate", "{0:dd/MM/yyyy}")%>' Font-Size="12px" ReadOnly="true" BackColor="#CCCCCC" BorderStyle="None" Height="18px" Width="70px" ></asp:TextBox></ItemTemplate></asp:TemplateField>
               ...
               <asp:TemplateField HeaderText="Service Record"><ItemTemplate><asp:TextBox ID="txtServiceRecordNoGV" runat="server" Text='<%# Bind("RecordNo")%>' Font-Size="12px" ReadOnly="true" BackColor="#CCCCCC" BorderStyle="None" Height="18px"  Width="123px"></asp:TextBox></ItemTemplate></asp:TemplateField>
               ...
               <asp:TemplateField HeaderText="Service By" HeaderStyle-HorizontalAlign="Center"><ItemTemplate><asp:TextBox ID="txtServiceByGV" runat="server" Text='<%# Bind("ServiceBy")%>' Font-Size="12px" ReadOnly="true" BackColor="#CCCCCC" Visible="true" BorderStyle="None" Height="18px" Width="57px"></asp:TextBox></ItemTemplate></asp:TemplateField>
        ...
        <asp:Panel ID="pnlPrint" runat="server" BackColor="White" Width="50%" Height="98%" BorderColor="#003366" BorderWidth="1px" ScrollBars="Auto">
                     ...
                     <table style="width:100%;padding-left:15px;">
                         ...
                         <tr>
                           ...
                           <table style="border: 1px solid #CC3300; text-align:center; border-radius: 25px;padding: 5px; width:90%; height:370px; background-color: #F3F3F3;padding-left:15px;">
                         <tr><td colspan="2" style="font-size:15px;font-weight:bold;font-family:'Calibri';color:#800000; text-align:left; text-decoration: underline;padding-left:2%;">INVOICE</td></tr>
                            <tr style="padding-top:40px;">
                             <td colspan="2" style="text-align:left;padding-left:50PX;"><br />
                                  <a href="RV_TaxInvoice_Format1.aspx?Export=PDF" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/Print.jpg" width="25" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp;
                                  <a href="RV_TaxInvoice_Format1.aspx?Export=Word" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/word.jpg" width="20" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp; <a href="RV_TaxInvoice_Format1.aspx?Export=View" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/view.jpg" width="28" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp;
                               <a href="Email.aspx?Type=InvoiceFormat1" target="_blank"><button style="border:none;background-color:white;" type="button"><img src="Images/email1.png" width="20" height="20" /></button></a>
                                 &nbsp;&nbsp; <label style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px; vertical-align: super;">Invoice with Service Record No</label><br /><br />

                                    <a href="RV_TaxInvoice_Format2.aspx?Export=PDF" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/Print.jpg" width="25" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp;
                                  <a href="RV_TaxInvoice_Format2.aspx?Export=Word" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/word.jpg" width="20" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp; <a href="RV_TaxInvoice_Format2.aspx?Export=View" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/view.jpg" width="28" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp;
                               <a href="Email.aspx?Type=InvoiceFormat2" target="_blank"><button style="border:none;background-color:white;" type="button"><img src="Images/email1.png" width="20" height="20" /></button></a>
                                 &nbsp;&nbsp; <label style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px">For Annual Billing</label><br /><br />

                                    <a href="RV_TaxInvoice_Format3.aspx?Export=PDF" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/Print.jpg" width="25" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp;
                                  <a href="RV_TaxInvoice_Format3.aspx?Export=Word" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/word.jpg" width="20" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp; <a href="RV_TaxInvoice_Format3.aspx?Export=View" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/view.jpg" width="28" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp;
                               <a href="Email.aspx?Type=InvoiceFormat3" target="_blank"><button style="border:none;background-color:white;" type="button"><img src="Images/email1.png" width="20" height="20" /></button></a>
                                 &nbsp;&nbsp; <label style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px">No Service Address and No Billing Frequency</label><br /><br />

                                    <a href="RV_TaxInvoice_Format4.aspx?Export=PDF" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/Print.jpg" width="25" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp;
                                  <a href="RV_TaxInvoice_Format4.aspx?Export=Word" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/word.jpg" width="20" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp; <a href="RV_TaxInvoice_Format4.aspx?Export=View" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/view.jpg" width="28" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp;
                               <a href="Email.aspx?Type=InvoiceFormat4" target="_blank"><button style="border:none;background-color:white;" type="button"><img src="Images/email1.png" width="20" height="20" /></button></a>
                                 &nbsp;&nbsp; <label style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px">No System Contract No</label><br /><br />

                                    <a href="RV_TaxInvoice_Format5.aspx?Export=PDF" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/Print.jpg" width="25" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp;
                                  <a href="RV_TaxInvoice_Format5.aspx?Export=Word" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/word.jpg" width="20" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp; <a href="RV_TaxInvoice_Format5.aspx?Export=View" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/view.jpg" width="28" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp;
                               <a href="Email.aspx?Type=InvoiceFormat5" target="_blank"><button style="border:none;background-color:white;" type="button"><img src="Images/email1.png" width="20" height="20" /></button></a>
                                 &nbsp;&nbsp; <label style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px">Sales Invoice W/O Service Description</label><br /><br />

                                    <a href="RV_TaxInvoice_Format6.aspx?Export=PDF" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/Print.jpg" width="25" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp;
                                  <a href="RV_TaxInvoice_Format6.aspx?Export=Word" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/word.jpg" width="20" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp; <a href="RV_TaxInvoice_Format6.aspx?Export=View" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/view.jpg" width="28" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp;
                               <a href="Email.aspx?Type=InvoiceFormat6" target="_blank"><button style="border:none;background-color:white;" type="button"><img src="Images/email1.png" width="20" height="20" /></button></a>
                                 &nbsp;&nbsp; <label style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px">Sales Invoice W/O Billing Frequency</label><br /><br />

                                    <a href="RV_TaxInvoice_Format7.aspx?Export=PDF" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/Print.jpg" width="25" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp;
                                  <a href="RV_TaxInvoice_Format7.aspx?Export=Word" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/word.jpg" width="20" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp; <a href="RV_TaxInvoice_Format7.aspx?Export=View" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/view.jpg" width="28" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp;
                               <a href="Email.aspx?Type=InvoiceFormat7" target="_blank"><button style="border:none;background-color:white;" type="button"><img src="Images/email1.png" width="20" height="20" /></button></a>
                                 &nbsp;&nbsp; <label style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px">Sales Invoice - Lump Sum</label><br /><br />

                                    <a href="RV_TaxInvoice_Format8.aspx?Export=PDF" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/Print.jpg" width="25" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp;
                                  <a href="RV_TaxInvoice_Format8.aspx?Export=Word" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/word.jpg" width="20" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp; <a href="RV_TaxInvoice_Format8.aspx?Export=View" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/view.jpg" width="28" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp;
                               <a href="Email.aspx?Type=InvoiceFormat8" target="_blank"><button style="border:none;background-color:white;" type="button"><img src="Images/email1.png" width="20" height="20" /></button></a>
                                 &nbsp;&nbsp; <label style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px">Simple Sales Invoice Format</label><br /><br />

                                 <a href="RV_TaxInvoice_Format10.aspx?Export=PDF" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/Print.jpg" width="25" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp;
                                  <a href="RV_TaxInvoice_Format10.aspx?Export=Word" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/word.jpg" width="20" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp; <a href="RV_TaxInvoice_Format10.aspx?Export=View" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/view.jpg" width="28" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp;
                               <a href="Email.aspx?Type=InvoiceFormat10" target="_blank"><button style="border:none;background-color:white;" type="button"><img src="Images/email1.png" width="20" height="20" /></button></a>
                                 &nbsp;&nbsp; <label style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px">Location Based Sales Invoice</label><br /><br />

                                    <a href="RV_TaxInvoice_Format9.aspx?Export=PDF" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/Print.jpg" width="25" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp;
                                  <a href="RV_TaxInvoice_Format9.aspx?Export=Word" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/word.jpg" width="20" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp; <a href="RV_TaxInvoice_Format9.aspx?Export=View" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/view.jpg" width="28" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp;
                               <a href="Email.aspx?Type=InvoiceFormat9" target="_blank"><button style="border:none;background-color:white;" type="button"><img src="Images/email1.png" width="20" height="20" /></button></a>
                                 &nbsp;&nbsp; <label style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px">For PDF Export</label><br /><br />
                               ...
                               <a href="RV_TaxInvoice_Format11.aspx?Export=Word" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/word.jpg" width="20" height="20" /></imagebutton></a>
                                &nbsp;&nbsp;  <a href="RV_TaxInvoice_Format11.aspx?Export=View" target="_blank"><imagebutton style="border:none;" type="button"><img src="Images/view.jpg" width="28" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp; &nbsp;&nbsp;--%>&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
                                 &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
                                  <a href="Email.aspx?Type=InvoiceFormat11" target="_blank"><button style="border:none;background-color:white;" type="button"><img src="Images/email1.png" width="20" height="20" /></button></a>
                                 &nbsp;&nbsp; <label style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px">Invoice with Service Report</label><br /><br />




                            <%--       <a href="RV_TaxInvoice_Format2.aspx?Export=Word" target="_blank"><imagebutton style="border:none;background-color:white;" type="button"><img src="Images/word.jpg" width="20" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp;
                                <a href="Email.aspx?Type=InvoiceFormat2" target="_blank"><button style="border:none;background-color:white;" type="button"><img src="Images/email1.png" width="20" height="20" /></button></a>
                                 &nbsp;&nbsp;           <a href="RV_TaxInvoice_Format2.aspx?Export=PDF" target="_blank"><linkbutton style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px" type="button">For Annual Billing</linkbutton></a><br /><br />
                                   <a href="RV_TaxInvoice_Format3.aspx?Export=Word" target="_blank"><imagebutton style="border:none;background-color:white;" type="button"><img src="Images/word.jpg" width="20" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp;
                                <a href="Email.aspx?Type=InvoiceFormat3" target="_blank"><button style="border:none;background-color:white;" type="button"><img src="Images/email1.png" width="20" height="20" /></button></a>
                                 &nbsp;&nbsp;       <a href="RV_TaxInvoice_Format3.aspx?Export=PDF" target="_blank"> <linkbutton style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px" type="button">No Service Address and No Billing Frequency</linkbutton></a><br /><br />
                                   <a href="RV_TaxInvoice_Format4.aspx?Export=Word" target="_blank"><imagebutton style="border:none;background-color:white;" type="button"><img src="Images/word.jpg" width="20" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp;
                                   <a href="Email.aspx?Type=InvoiceFormat4" target="_blank"><button style="border:none;background-color:white;" type="button"><img src="Images/email1.png" width="20" height="20" /></button></a>
                                 &nbsp;&nbsp;         <a href="RV_TaxInvoice_Format4.aspx?Export=PDF" target="_blank"> <linkbutton style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px" type="button">No System Contract No</linkbutton></a><br /><br />
                             <a href="RV_TaxInvoice_Format5.aspx?Export=Word" target="_blank"><imagebutton style="border:none;background-color:white;" type="button"><img src="Images/word.jpg" width="20" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp;  <a href="Email.aspx?Type=InvoiceFormat5" target="_blank"><button style="border:none;background-color:white;" type="button"><img src="Images/email1.png" width="20" height="20" /></button></a>
                                 &nbsp;&nbsp;     <a href="RV_TaxInvoice_Format5.aspx?Export=PDF" target="_blank">   <linkbutton style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px" type="button">Sales Invoice W/O Service Description</linkbutton></a><br /><br />
                             <a href="RV_TaxInvoice_Format6.aspx?Export=Word" target="_blank"><imagebutton style="border:none;background-color:white;" type="button"><img src="Images/word.jpg" width="20" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp; <a href="Email.aspx?Type=InvoiceFormat6" target="_blank"><button style="border:none;background-color:white;" type="button"><img src="Images/email1.png" width="20" height="20" /></button></a>
                                 &nbsp;&nbsp;      <a href="RV_TaxInvoice_Format6.aspx?Export=PDF" target="_blank">   <linkbutton style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px" type="button">Sales Invoice W/O Billing Frequency</linkbutton></a><br /><br />
                             <a href="RV_TaxInvoice_Format7.aspx?Export=Word" target="_blank"><imagebutton style="border:none;background-color:white;" type="button"><img src="Images/word.jpg" width="20" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp; <a href="Email.aspx?Type=InvoiceFormat7" target="_blank"><button style="border:none;background-color:white;" type="button"><img src="Images/email1.png" width="20" height="20" /></button></a>
                                &nbsp;&nbsp;      <a href="RV_TaxInvoice_Format7.aspx?Export=PDF" target="_blank">   <linkbutton style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px" type="button">Sales Invoice - Lump Sum</linkbutton></a><br /><br />
                            <a href="RV_TaxInvoice_Format8.aspx?Export=Word" target="_blank"><imagebutton style="border:none;background-color:white;" type="button"><img src="Images/word.jpg" width="20" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp; <a href="Email.aspx?Type=InvoiceFormat8" target="_blank"><button style="border:none;background-color:white;" type="button"><img src="Images/email1.png" width="20" height="20" /></button></a>
                                 &nbsp;&nbsp;       <a href="RV_TaxInvoice_Format8.aspx?Export=PDF" target="_blank">   <linkbutton style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px" type="button">Simple Sales Invoice Format</linkbutton></a><br /><br />
                        
                     <a href="RV_TaxInvoice_Format10.aspx?Export=Word" target="_blank"><imagebutton style="border:none;background-color:white;" type="button"><img src="Images/word.jpg" width="20" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp; <a href="Email.aspx?Type=InvoiceFormat10" target="_blank"><button style="border:none;background-color:white;" type="button"><img src="Images/email1.png" width="20" height="20" /></button></a>
                                 &nbsp;&nbsp;       <a href="RV_TaxInvoice_Format10.aspx?Export=PDF" target="_blank">   <linkbutton style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px" type="button">Location Based Sales Invoice</linkbutton></a><br /><br />
                   <a href="RV_TaxInvoice_Format9.aspx?Export=Word" target="_blank"><imagebutton style="border:none;background-color:white;" type="button"><img src="Images/word.jpg" width="20" height="20" /></imagebutton></a>
                                 &nbsp;&nbsp;  <a href="Email.aspx?Type=InvoiceFormat9" target="_blank"><button style="border:none;background-color:white;" type="button"><img src="Images/email1.png" width="20" height="20" /></button></a>
                               &nbsp;&nbsp;      <a href="RV_TaxInvoice_Format9.aspx?Export=PDF" target="_blank">   <linkbutton style="font-weight:bold;color:black;width:100px;font-family:Calibri;font-size:15px" type="button">For PDF Export</linkbutton></a>
                               &nbsp;&nbsp;    <br /><br />--%>
                                     <br /><br />
                   ...
                   <table style="border: 1px solid #CC3300; text-align:right; border-radius: 25px;padding: 5px; width:90%; height:80px; background-color: #F3F3F3;padding-left:15px;">
             ...
             <asp:TemplateField HeaderText=""><ItemTemplate><asp:TextBox ID="txtContractNoGVQR" runat="server" Visible="false" Enabled="false" Height="15px"  Font-Size="12px" ReadOnly="true" Width="0px"   AutoPostBack="false" ></asp:TextBox></ItemTemplate></asp:TemplateField>
              ...
              <asp:TemplateField HeaderText="" HeaderStyle-HorizontalAlign="Right"><ItemTemplate><asp:TextBox ID="txtGSTAmtGVQR" runat="server" Visible="false" Enabled="false" style="text-align:right" Height="15px"  Font-Size="12px" Width="0px" Align="right"></asp:TextBox></ItemTemplate></asp:TemplateField>
                ...
                <asp:TemplateField HeaderText=""><ItemTemplate><asp:TextBox ID="txtRcnoInvoiceDetailGVQR" runat="server" Visible="false" Enabled="false" Height="15px"  Font-Size="12px" ReadOnly="true" Width="0px"   AutoPostBack="false" ></asp:TextBox></ItemTemplate></asp:TemplateField>
                     ...
                     <asp:TemplateField HeaderText=""><ItemTemplate><asp:TextBox ID="txtDocTypeGVQR" runat="server" Enabled="true" Visible="false" style="text-align:right" Height="15px"  Font-Size="12px" Width="30px" Align="right"></asp:TextBox></ItemTemplate></asp:TemplateField>
                  <asp:TemplateField><ItemTemplate><asp:TextBox ID="txtSourceRcnoGVQR" runat="server" Visible="false" Height="15px" Width="30px"></asp:TextBox></ItemTemplate></asp:TemplateField>
      ...
      <asp:ModalPopupExtender ID="mdlLockedServiceRecord" runat="server" TargetControlID="btnLockedServiceRecord"  CancelControlID="btnCancelLockedServiceRecord" PopupControlID="pnlLockedServiceRecord" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
         <asp:Button ID="btnLockedServiceRecord" runat="server" CssClass="dummybutton" />
                    ...
                    <td class="CellTextBox">  
                        <asp:TextBox ID="txtOurRefEdit" runat="server" Height="16px" MaxLength="25" Width="50%"></asp:TextBox>
                         ...
                         <tr>
                             ...
                             <td class="CellTextBox">
                                 <asp:TextBox ID="txtPONOEdit" runat="server" Height="16px" MaxLength="30" Width="50%"></asp:TextBox>
                             </td>
                         </tr>
            ...
            <%-- popup1--%>
                   ...
                   <asp:Panel ID="pnlEditRemarks" runat="server" BackColor="White" Width="40%" Height="55%" BorderColor="#003366" BorderWidth="1px" ScrollBars="Auto">
            ...
            <%-- start--%>
                ...
                <asp:Panel ID="pnlEditBillingDetails" runat="server" BackColor="White" Width="40%" Height="55%" BorderColor="#003366" BorderWidth="1px" ScrollBars="Auto">
             ...
             <tr>
               <td colspan="2" style="width:100%;text-align:center;font-size:18px;font-weight:bold;font-family:'Calibri';"> 
                    ...
                    <td class="CellTextBox">  
                        <asp:TextBox ID="txtContactPersonEdit" runat="server" Height="16px" MaxLength="100" Width="60%"></asp:TextBox>
                         ...
                         <tr>
                             ...
                             <td class="CellTextBox">
                                 <asp:TextBox ID="txtBillAddressEdit" runat="server" Height="16px" MaxLength="100" Width="60%"></asp:TextBox>
                             </td>
                         </tr>
                         <tr>
                             <td class="CellFormat" style="text-align:right;">&nbsp;</td>
                             <td class="CellTextBox">
                                 <asp:TextBox ID="txtBillStreetEdit" runat="server" Height="16px" MaxLength="100" Width="60%"></asp:TextBox>
                             </td>
                         </tr>
                         <tr>
                             <td class="CellFormat" style="text-align:right;">&nbsp;</td>
                             <td class="CellTextBox">
                                 <asp:TextBox ID="txtBillBuildingEdit" runat="server" Height="16px" MaxLength="100" Width="60%"></asp:TextBox>
                             </td>
                         </tr>
                         ...
                         <tr>
                             ...
                             <td class="CellTextBox">
                                 <asp:TextBox ID="txtBillCountryEdit" runat="server" Height="16px" MaxLength="50" Width="60%"></asp:TextBox>
                             </td>
                         </tr>
                         <tr>
                             <td class="CellFormat" style="text-align: right;">Postal</td>
                             <td class="CellTextBox">
                                 <asp:TextBox ID="txtBillPostalEdit" runat="server" Height="16px" MaxLength="20" Width="60%"></asp:TextBox>
                             </td>
                         </tr>
            ...
            <%-- popup1--%>
             ...
             <tr>
               <td colspan="2" style="width:100%;text-align:center;font-size:18px;font-weight:bold;font-family:'Calibri';"> 
                    ...
                    <td class="CellTextBox">  
                        <asp:DropDownList ID="ddlSalesmanEdit" runat="server" AppendDataBoundItems="True" CssClass="chzn-select" DataSourceID="SqlDSSalesMan" DataTextField="StaffId" DataValueField="StaffId" Height="25px" TabIndex="29" Width="80.5%">
