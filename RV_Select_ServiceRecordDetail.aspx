<%@ Page Title="Service Record Detail Report Selection" Language="VB" MasterPageFile="~/MasterPage_Report.master" AutoEventWireup="false" CodeFile="RV_Select_ServiceRecordDetail.aspx.vb" Inherits="RV_Select_ServiceRecordDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
      ...
      <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" ScriptMode="Release">
       ...
       <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">SERVICE RECORD DETAIL LISTING REPORT</h4>
...
<%--            <tr>
 ...
 </cc1:dropdowncheckboxes> <%-- <asp:DropDownList ID="ddlCompanyGrp" runat="server" CssClass="chzn-select" DataSourceID="SqlDSCompanyGroup" DataTextField="companygroup" DataValueField="companygroup" Width="60.5%" Height="25px" AppendDataBoundItems="True">
             ...
             <%--   <tr>
                     <td class="CellTextBox" colspan="2" style="text-align:center;padding-left:150px">
                        <table>
                            ...
                            <tr>
<td colspan="3"><asp:Button ID="btnSort2" runat="server" Text="<<" /></td>
                            </tr>
                        </table>
           ...
           <%--   <tr>
              ...
              <tr>
                  <td colspan="2" style="text-align:center"><asp:Button ID="btnPrintServiceRecordList" runat="server" CssClass="button" BackColor="#CFC6C0"  Font-Bold="True" Text="Print" Width="100px"/>
                                     <asp:Button ID="btnExportToExcel" runat="server" CssClass="button" BackColor="#CFC6C0"  Font-Bold="True" Text="Export To Excel" Width="150px" Visible="true"/>
