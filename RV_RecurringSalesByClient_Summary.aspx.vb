...
Partial Class RV_RecurringSalesByClient_Summary
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                Dim repPath As String = Server.MapPath("~/Reports/ARReports/RecurringSalesReports/RecurringSalesSummary_Client.rpt")
