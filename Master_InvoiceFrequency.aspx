<%@ Page Title="Invoice Frequency Master" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Master_InvoiceFrequency.aspx.vb" Inherits="Master_InvoiceFrequency"  Culture="en-GB" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="text-align:center">
        ...
        <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">Invoice Frequency</h3>
    <table style="width:100%;text-align:center;">
            ...
            <tr>
                ...
                <td style="width:40%;text-align:left;">
                     ...
                     <asp:Button ID="btnADD" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="ADD" Width="100px" Enabled="False" />
...
<asp:Button ID="btnDelete" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="DELETE" Width="100px" OnClientClick = "Confirm(); currentdatetime()" Enabled="False"/>
            ...
            <tr class="Centered">
                <td colspan="2">
                   ...
                   <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataKeyNames="Frequency" Font-Size="15px" HorizontalAlign="Center" AllowSorting="True" AllowPaging="True">
            <Columns>
                 <asp:CommandField HeaderText="Select" ShowHeader="True" ShowSelectButton="True" >
                <ControlStyle Width="150px" />
                <ItemStyle Width="150px" />
                </asp:CommandField>
                <asp:BoundField DataField="Frequency" HeaderText="Frequency" ReadOnly="True" SortExpression="Frequency">
               <ControlStyle Width="200px" />
                <HeaderStyle Font-Size="12pt" />
                <ItemStyle Width="200px" HorizontalAlign="Left" />
                </asp:BoundField>
                <asp:BoundField DataField="TimesInYears" HeaderText="Time in Years" SortExpression="TimesInYears">
                <ControlStyle Width="250px" />
                <HeaderStyle Font-Size="12pt" />
                <ItemStyle Width="250px" HorizontalAlign="Left" />
                </asp:BoundField>
                <asp:BoundField DataField="IntervalDays" HeaderText="IntervalDays" SortExpression="IntervalDays" Visible="False" />
          ...
          <tr>
            ...
            <tr>
                    ...
                    <td class="CellFormatADM">Frequency<asp:Label ID="Label23" runat="server" visible="true" Font-Size="14px" ForeColor="Red" Text="*" Height="20px"></asp:Label></td>
                     

                    <td class="CellTextBoxADM"> <asp:TextBox ID="txtFrequency" runat="server" MaxLength="50" Height="16px" Width="40%"></asp:TextBox></td>
              ...
              <tr>
                    ...
                    <td class="CellFormatADM">Time in Years</td>
                     

                    <td class="CellTextBoxADM"><asp:TextBox ID="txtTimeinYears" runat="server" MaxLength="100" Height="16px" Width="40%"></asp:TextBox></td>
...
<asp:Button ID="btnCancel" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="CANCEL" Width="100px" /></td>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>" SelectCommand="SELECT * FROM tblfrequency where rcno<>0"></asp:SqlDataSource>
