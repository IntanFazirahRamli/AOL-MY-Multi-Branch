...
Partial Class Master_CompanyGroup
    ...
    Protected Sub GridView1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles GridView1.SelectedIndexChanged
        ...
        Else
            ...
            txtCompanyGroup.Text = Server.HtmlDecode(GridView1.SelectedRow.Cells(1).Text).ToString
        End If
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        If txtMode.Text = "New" Then
            Try
                ...
                command1.CommandText = "SELECT * FROM tblcompanygroup where companygroup=@companygroup"
                command1.Parameters.AddWithValue("@companygroup", txtCompanyGroup.Text)
                ...
                Else
                    ...
                    command.CommandType = CommandType.Text
                    Dim qry As String = "INSERT INTO tblcompanygroup(companygroup,CreatedBy,CreatedOn,LastModifiedBy,LastModifiedOn,Description)"
                    qry = qry + "VALUES(@companygroup,@CreatedBy,@CreatedOn,@LastModifiedBy,@LastModifiedOn,@Description);"
        ...
        ElseIf txtMode.Text = "Edit" Then
            ...
            Try
                ...
                command2.CommandText = "SELECT * FROM tblcompanygroup where companygroup=@companygroup and rcno<>" & Convert.ToInt32(txtRcno.Text)
                command2.Parameters.AddWithValue("@companygroup", txtCompanyGroup.Text)
                ...
                Else
                    ...
                    command1.CommandText = "SELECT * FROM tblcompanygroup where rcno=" & Convert.ToInt32(txtRcno.Text)
                    command1.Connection = conn
                    ...
                    If dt.Rows.Count > 0 Then
                        ...
                        Dim qry As String
                        If txtExists.Text = "True" Then
                            qry = "update tblcompanygroup set LastModifiedBy=@LastModifiedBy,LastModifiedOn=@LastModifiedOn,Description=@Description where rcno=" & Convert.ToInt32(txtRcno.Text)
                        Else
                            qry = "update tblcompanygroup set companygroup=@companygroup,LastModifiedBy=@LastModifiedBy,LastModifiedOn=@LastModifiedOn,Description=@Description where rcno=" & Convert.ToInt32(txtRcno.Text)
                ...
                If txtMode.Text = "NEW" Then
                    CType(Me.Master, MasterPage).EventLog_Insert(Session("UserID"), "COMPGROUP", txtCompanyGroup.Text, "ADD", Convert.ToDateTime(txtCreatedOn.Text), 0, 0, 0, "", "", txtRcno.Text)
                Else
                    CType(Me.Master, MasterPage).EventLog_Insert(Session("UserID"), "COMPGROUP", txtCompanyGroup.Text, "EDIT", Convert.ToDateTime(txtCreatedOn.Text), 0, 0, 0, "", "", txtRcno.Text)
                End If
            Catch ex As Exception
                lblAlert.Text = ex.Message
                'MessageBox.Message.Alert(Page, ex.ToString, "str")
        ...
        If confirmValue = "Yes" Then
            ...
            Try
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    command.CommandType = CommandType.Text
                    Dim qry As String = "delete from tblcompanygroup where rcno=" & Convert.ToInt32(txtRcno.Text)
                    ...
                    CType(Me.Master, MasterPage).EventLog_Insert(Session("UserID"), "COMPGROUP", txtCompanyGroup.Text, "DELETE", Convert.ToDateTime(txtCreatedOn.Text), 0, 0, 0, "", "", txtRcno.Text)
                End If
                conn.Close()
    ...
    Private Function CheckIfExists() As Boolean
        ...
        command1.Parameters.AddWithValue("@data", txtCompanyGroup.Text)
        command1.Connection = conn
        ...
        command2.Parameters.AddWithValue("@data", txtCompanyGroup.Text)
        command2.Connection = conn
        ...
        command3.Parameters.AddWithValue("@data", txtCompanyGroup.Text)
        ...
        command4.Parameters.AddWithValue("@data", txtCompanyGroup.Text)
