...
Partial Class RV_Select_ExtensionContract
    ...
    Protected Sub btnPrintServiceContractList_Click(sender As Object, e As EventArgs) Handles btnPrintServiceContractList.Click
        If GetData() = True Then
            ...
            If chkGrouping.SelectedValue = "ContractGroup" Then
                Session.Add("ReportType", "ExtensionContract02")
                '  Response.Redirect("RV_DueForRenewalContract02.aspx")

            ElseIf chkGrouping.SelectedValue = "AccountID" Then
                Session.Add("ReportType", "ExtensionContract01")
                '  Response.Redirect("RV_DueForRenewalContract01.aspx")

            ElseIf chkGrouping.SelectedValue = "Salesman" Then
                Session.Add("ReportType", "ExtensionContract03")
                ' Response.Redirect("RV_DueForRenewalContract03.aspx")

            End If
            Response.Redirect("RV_ExtensionContract.aspx")
        Else
            Return
    ...
    Private Function GetData() As Boolean
        ...
        selection = ""
        Dim qry As String = ""
        qry = "SELECT distinct tblcontract1.Status,tblcontract1.CompanyGroup,tblcontract1.ContractGroup,tblcontractgroup1.Category,tblcontract1.ContractNo,tblcontract1.YourReference as ManualContractNo,tblcontract1.OurReference as PONo,tblcontract1.ContractDate,tblcontract1.StartDate,"
        qry = qry + "tblcontract1.EndDate,tblcontract1.ActualEnd,tblcontract1.AgreeValue,tblcontract1.ContactType,tblcontract1.AccountID,tblcontractdet1.LocationID,tblcontract1.CustName,replace(replace(tblcontract1.ServiceAddress, char(10), ' '), char(13), ' ') as ServiceAddress,tblcontract1.ServiceDescription,tblcontract1.BillingFrequency,"
        ...
        qry = qry + " WHERE (tblcontract1.AgreementType='EXTENSION')"

        selFormula = "{tblcontract1.rcno} <> 0 and {tblContract1.AgreementType}='EXTENSION'"
        ...
        If String.IsNullOrEmpty(txtContractDateFrom.Text) = False Then
            ...
            Else
                ...
                Return False
            End If
            qry = qry + " and tblcontract1.ActualEnd >='" + Convert.ToDateTime(txtContractDateFrom.Text).ToString("yyyy-MM-dd") + "'"
        ...
        If String.IsNullOrEmpty(txtContractDateTo.Text) = False Then
            ...
            Else
                ...
                Return False
            End If
            qry = qry + " and tblcontract1.ActualEnd <='" + Convert.ToDateTime(txtContractDateTo.Text).ToString("yyyy-MM-dd") + "'"
    ...
    Protected Sub btnExportToExcel_Click(sender As Object, e As EventArgs) Handles btnExportToExcel.Click
        ...
        If GetData() = True Then
            ...
            Dim attachment As String = "attachment; filename=DueForRenewalServiceContractExpiry.xls"
    ...
    Public Sub WriteExcelWithNPOI(ByVal dt As DataTable, ByVal extension As String)
        ...
        Using exportData = New MemoryStream()
            ...
            Dim attachment As String = "attachment; filename=ExtensionContract"
