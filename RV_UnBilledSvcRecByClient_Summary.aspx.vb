...
Partial Class RV_UnBilledSvcRecByClient_Summary
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                Dim repPath As String = Server.MapPath("~/Reports/ARReports/UnbilledServiceRecordReports/UnbilledServiceRecordSummary_Client.rpt")
