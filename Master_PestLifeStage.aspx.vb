...
Partial Class Master_PestLifeStage
    ...
    Private Sub InsertIntoTblWebEventLog(events As String, errorMsg As String, ID As String)
        Try
            ...
            insCmds.Parameters.AddWithValue("@LoginId", "PESTLifeStage - " + txtCreatedBy.Text)
    ...
    Protected Sub GridView1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles GridView1.SelectedIndexChanged
        ...
        Dim sql As String
        sql = "Select * FROM tblpestLifeStage "
        ...
        If dt.Rows.Count > 0 Then
            ...
            If dt.Rows(0)("LifeStage").ToString <> "" Then : txtLifeStage.Text = dt.Rows(0)("LifeStage").ToString : End If
    ...
    Private Sub AccessControl()
        Try
            ...
            If Session("SecGroupAuthority") <> "ADMINISTRATOR" Then
                ...
                command.CommandText = "SELECT x0188,  x0188Add, x0188Edit, x0188Delete FROM tblGroupAccess where GroupAccess = '" & Session("SecGroupAuthority") & "'"
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    If String.IsNullOrEmpty(Convert.ToBoolean(dt.Rows(0)("x0188"))) = False Then
                        If Convert.ToBoolean(dt.Rows(0)("x0188")) = False Then
                            Response.Redirect("Home.aspx")
                        End If
                    End If


                    If String.IsNullOrEmpty(dt.Rows(0)("x0188Add")) = False Then
                        Me.btnADD.Enabled = dt.Rows(0)("x0188Add").ToString()
                    End If

                    'Me.btnInsert.Enabled = vpSec2412Add
                    If txtMode.Text = "View" Then
                        If String.IsNullOrEmpty(dt.Rows(0)("x0188Edit")) = False Then
                            Me.btnEdit.Enabled = dt.Rows(0)("x0188Edit").ToString()
                        End If

                        If String.IsNullOrEmpty(dt.Rows(0)("x0188Delete")) = False Then
                            Me.btnDelete.Enabled = dt.Rows(0)("x0188Delete").ToString()
                        End If
                    Else
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        If txtMode.Text = "New" Then
            Try
                ...
                command1.CommandText = "SELECT * FROM tblpestLifeStage where PesTID =@PesTID and LifeStage=@LifeStage"
                command1.Parameters.AddWithValue("@PesTID", ddlPestID.Text)
                command1.Parameters.AddWithValue("@LifeStage", txtLifeStage.Text)
                ...
                Else
                    ...
                    command.CommandType = CommandType.Text
                    Dim qry As String = "INSERT INTO tblpestLifeStage (PestID, LifeStage, CreatedBy,CreatedOn,LastModifiedBy,LastModifiedOn)"
                    qry = qry + "VALUES(@PestID,@LifeStage, @CreatedBy,@CreatedOn,@LastModifiedBy,@LastModifiedOn);"
                    ...
                    If ConfigurationManager.AppSettings("UPPERCASE").ToString() = "YES" Then
                        ...
                        command.Parameters.AddWithValue("@LifeStage", txtLifeStage.Text.ToUpper)
                    ...
                    ElseIf ConfigurationManager.AppSettings("UPPERCASE").ToString() = "NO" Then
                        ...
                        command.Parameters.AddWithValue("@LifeStage", txtLifeStage.Text)
        ...
        ElseIf txtMode.Text = "Edit" Then
            ...
            Try
                ...
                command2.CommandText = "SELECT * FROM tblpestLifeStage where PestID=@PestID and LifeStage=@LifeStage and rcno<>" & Convert.ToInt32(txtRcno.Text)
                command2.Parameters.AddWithValue("@PestID", ddlPestID.Text)
                command2.Parameters.AddWithValue("@LifeStage", txtLifeStage.Text)
                ...
                Else
                    ...
                    command1.CommandText = "SELECT * FROM tblpestLifeStage where rcno=" & Convert.ToInt32(txtRcno.Text)
                    command1.Connection = conn
                    ...
                    If dt.Rows.Count > 0 Then
                        ...
                        If txtExists.Text = "True" Then
                            qry = "update tblpestLifeStage set LifeStage=@LifeStage, LastModifiedBy=@LastModifiedBy,LastModifiedOn=@LastModifiedOn where rcno=" & Convert.ToInt32(txtRcno.Text)
                        Else
                            qry = "update tblpestLifeStage set PestID=@PestID, LifeStage=@LifeStage,  LastModifiedBy=@LastModifiedBy,LastModifiedOn=@LastModifiedOn where rcno=" & Convert.ToInt32(txtRcno.Text)
                        End If
                ...
                conn.Close()
                If txtMode.Text = "NEW" Then
                    CType(Me.Master, MasterPage).EventLog_Insert(Session("UserID"), "PESTLifeStage", ddlPestID.Text, "ADD", Convert.ToDateTime(txtCreatedOn.Text), 0, 0, 0, "", "", txtRcno.Text)
                Else
                    CType(Me.Master, MasterPage).EventLog_Insert(Session("UserID"), "PESTLifeStage", ddlPestID.Text, "EDIT", Convert.ToDateTime(txtCreatedOn.Text), 0, 0, 0, "", "", txtRcno.Text)
                End If
            Catch ex As Exception
                MessageBox.Message.Alert(Page, ex.ToString, "str")
            End Try
        ...
        If confirmValue = "Yes" Then
            ...
            Try
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    command.CommandType = CommandType.Text
                    Dim qry As String = "delete from tblpestLifeStage where rcno=" & Convert.ToInt32(txtRcno.Text)
                ...
                End If
                conn.Close()
                CType(Me.Master, MasterPage).EventLog_Insert(Session("UserID"), "PESTLifeStage", ddlPestID.Text, "DELETE", Convert.ToDateTime(txtCreatedOn.Text), 0, 0, 0, "", "", txtRcno.Text)
            Catch ex As Exception
                MessageBox.Message.Alert(Page, ex.ToString, "str")
            End Try
            EnableControls()
    ...
    Protected Sub txtDescription_TextChanged(sender As Object, e As EventArgs) Handles txtLifeStage.TextChanged
