...
Partial Class RV_TaxInvoice_Format9
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                CType(Me.Master, MasterPage).EventLog_Insert(Session("UserID"), "TAX INVOICE FORMAT-9", Left(Convert.ToString(Session("InvoiceNumber")), 50), "ADD", DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss", New System.Globalization.CultureInfo("en-GB")), 0, 0, 0, Left(Convert.ToString(Session("InvoiceNumber")), 20), "", "")
