...
Public Class RV_CreditNoteListingByGLCode_Details
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                Dim repPath As String = Server.MapPath("~/Reports/ARReports/CreditNoteReports/CreditNoteListingByGLCode_Details.rpt")
