<%@ Page Title="Credit Note Printing" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="RV_CreditNote.aspx.vb" Inherits="RV_CreditNote" %>
 ...
 <tr>
     <td colspan="2" style="width:100%;text-align:center;">
      <%--   <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="true" 
            ...
            ToolPanelWidth="0px" HasCrystalLogo ="false" EnableParameterPrompt="False" />--%>
       <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
        <Report FileName="Reports\ReportPrinting\CreditNote.rpt">
        </Report>
