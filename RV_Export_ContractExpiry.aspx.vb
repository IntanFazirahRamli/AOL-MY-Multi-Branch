...
Partial Class RV_Export_ContractExpiry
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                If Convert.ToString(Session("ReportType")) = "SvcContractExpRenew" Then

                    crReportDocument.Load(Server.MapPath("~/Reports/ServiceContractReports/SvcContractExpRenew.rpt"))

                ElseIf Convert.ToString(Session("ReportType")) = "SvcContractExpRenew_Format2" Then

                    crReportDocument.Load(Server.MapPath("~/Reports/ServiceContractReports/SvcContractExpRenew_Format2.rpt"))

                ElseIf Convert.ToString(Session("ReportType")) = "OffsetContractExpRenew" Then
                    crReportDocument.Load(Server.MapPath("~/Reports/ServiceContractReports/OffSetContractExpRenew.rpt"))

                    crReportDocument.SetParameterValue("pLessthanAmt", Session("LessthanAmt"))
                    crReportDocument.SetParameterValue("pLessthan", Convert.ToString(Session("Lessthan")))
