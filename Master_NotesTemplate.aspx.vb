...
Partial Class Master_NotesTemplate
    ...
    Private Sub EnableControls()
        ...
        ChkDefaultDisplay.Enabled = False
        AccessControl()
    End Sub
    ...
    Private Sub DisableControls()
        ...
        ChkDefaultDisplay.Enabled = True
        AccessControl()
    ...
    Protected Sub GridView1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles GridView1.SelectedIndexChanged
        ...
        Else
            ...
            txtNoteID.Text = Server.HtmlDecode(GridView1.SelectedRow.Cells(1).Text).ToString
        End If
        If GridView1.SelectedRow.Cells(2).Text = "&nbsp;" Then
            txtContent.Text = ""
        Else
            txtContent.Text = Server.HtmlDecode(GridView1.SelectedRow.Cells(2).Text).ToString
        End If
        If GridView1.SelectedRow.Cells(3).Text = "&nbsp;" Then
            txtModule.Text = ""
        Else
            txtModule.Text = Server.HtmlDecode(GridView1.SelectedRow.Cells(3).Text).ToString
        End If

        If GridView1.SelectedRow.Cells(4).Text = 1 Then
            ChkDefaultDisplay.Checked = True
        Else
            ChkDefaultDisplay.Checked = False
        End If
    ...
    Private Sub AccessControl()
        Try
            ...
            If Session("SecGroupAuthority") <> "ADMINISTRATOR" Then
                ...
                command.CommandText = "SELECT x0170,  x0170Add, x0170Edit, x0170Delete FROM tblGroupAccess where GroupAccess = '" & Session("SecGroupAuthority") & "'"
                ...
                If dt.Rows.Count > 0 Then
                    If Not IsDBNull(dt.Rows(0)("x0170")) Then
                        If String.IsNullOrEmpty(Convert.ToBoolean(dt.Rows(0)("x0170"))) = False Then
                            If Convert.ToBoolean(dt.Rows(0)("x0170")) = False Then
                    ...
                    If Not IsDBNull(dt.Rows(0)("x0170Add")) Then
                        If String.IsNullOrEmpty(dt.Rows(0)("x0170Add")) = False Then
                            Me.btnADD.Enabled = dt.Rows(0)("x0170Add").ToString()
                        End If
                    End If


                    If txtMode.Text = "View" Then
                        If Not IsDBNull(dt.Rows(0)("x0170Edit")) Then
                            If String.IsNullOrEmpty(dt.Rows(0)("x0170Edit")) = False Then
                                Me.btnEdit.Enabled = dt.Rows(0)("x0170Edit").ToString()
                            End If
                        End If

                        If Not IsDBNull(dt.Rows(0)("x0170Delete")) Then
                            If String.IsNullOrEmpty(dt.Rows(0)("x0170Delete")) = False Then
                                Me.btnDelete.Enabled = dt.Rows(0)("x0170Delete").ToString()
                            End If
                        End If
                    Else
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        If txtNoteID.Text = "" Then
            ...
            lblAlert.Text = "NOTE ID CANNOT BE BLANK"
            Return
        ...
        If txtMode.Text = "New" Then
            Try
                ...
                command1.CommandText = "SELECT * FROM tblNotesTemplate where NoteID=@NoteID"
                command1.Parameters.AddWithValue("@NoteID", txtNoteID.Text)
                ...
                Else
                    ...
                    command.CommandType = CommandType.Text
                    Dim qry As String = "INSERT INTO tblNotesTemplate(NoteID,content,module, DefaultDisplay, CreatedBy,CreatedOn,LastModifiedBy,LastModifiedOn)"
                    qry = qry + "VALUES(@NoteID,@content,@module, @DefaultDisplay, @CreatedBy,@CreatedOn,@LastModifiedBy,@LastModifiedOn);"
                    ...
                    If ConfigurationManager.AppSettings("UPPERCASE").ToString() = "YES" Then
                        ...
                        command.Parameters.AddWithValue("@NoteID", txtNoteID.Text.ToUpper)
                        command.Parameters.AddWithValue("@Content", txtContent.Text.ToUpper)
                        command.Parameters.AddWithValue("@Module", txtModule.Text.ToUpper)
                        If ChkDefaultDisplay.Checked = True Then
                            command.Parameters.AddWithValue("@DefaultDisplay", True)
                        Else
                            command.Parameters.AddWithValue("@DefaultDisplay", False)
                        End If
                    ...
                    ElseIf ConfigurationManager.AppSettings("UPPERCASE").ToString() = "NO" Then
                        ...
                        command.Parameters.AddWithValue("@NoteID", txtNoteID.Text)
        ...
        ElseIf txtMode.Text = "Edit" Then
            ...
            Try
                ...
                command2.CommandText = "SELECT * FROM tblNotesTemplate where NoteID=@NoteID and rcno<>" & Convert.ToInt32(txtRcno.Text)
                command2.Parameters.AddWithValue("@NoteID", txtNoteID.Text)
                ...
                Else
                    ...
                    If dt.Rows.Count > 0 Then
                        ...
                        If txtExists.Text = "True" Then
                            qry = "update tblNotesTemplate set Content=@Content,Module=@Module, DefaultDisplay=@DefaultDisplay, LastModifiedBy=@LastModifiedBy,LastModifiedOn=@LastModifiedOn where rcno=" & Convert.ToInt32(txtRcno.Text)
                        Else
                            qry = "update tblNotesTemplate set NoteID=@NoteID,Content=@Content,Module=@Module, DefaultDisplay=@DefaultDisplay, LastModifiedBy=@LastModifiedBy,LastModifiedOn=@LastModifiedOn where rcno=" & Convert.ToInt32(txtRcno.Text)
                        End If
                ...
                conn.Close()
                If txtMode.Text = "NEW" Then
                    CType(Me.Master, MasterPage).EventLog_Insert(Session("UserID"), "NOTES TEMPLATE", txtNoteID.Text, "ADD", Convert.ToDateTime(txtCreatedOn.Text), 0, 0, 0, "", "", txtRcno.Text)
                Else
                    CType(Me.Master, MasterPage).EventLog_Insert(Session("UserID"), "NOTES TEMPLATE", txtNoteID.Text, "EDIT", Convert.ToDateTime(txtCreatedOn.Text), 0, 0, 0, "", "", txtRcno.Text)
                End If
            Catch ex As Exception
                MessageBox.Message.Alert(Page, ex.ToString, "str")
            End Try
        ...
        If confirmValue = "Yes" Then
            ...
            Try
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    command.CommandType = CommandType.Text
                    Dim qry As String = "delete from tblNotesTemplate where rcno=" & Convert.ToInt32(txtRcno.Text)
                ...
                End If
                conn.Close()
                CType(Me.Master, MasterPage).EventLog_Insert(Session("UserID"), "NOTES TEMPLATE", txtNoteID.Text, "DELETE", Convert.ToDateTime(txtCreatedOn.Text), 0, 0, 0, "", "", txtRcno.Text)
            Catch ex As Exception
                MessageBox.Message.Alert(Page, ex.ToString, "str")
            End Try
            EnableControls()
