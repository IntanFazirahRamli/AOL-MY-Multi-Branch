<%@ Page Language="vb" AutoEventWireup="false" CodeFile="RV_ActiveContract02.aspx.vb" MasterPageFile="~/MasterPage.Master"
    Inherits="RV_ActiveContract02" Title="Active Service Contract Listing by Contract Group" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div style="text-align:center">
        <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">Active Service Contract Listing By Contract Group</h3>
    <br />
        ...
        <tr>
            <td colspan="2">
                ...
                <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                    <Report FileName="Reports\ServiceContractReports\ActiveContract02.rpt">
                    </Report>
