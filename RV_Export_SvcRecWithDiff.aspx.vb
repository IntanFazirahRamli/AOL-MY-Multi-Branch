...
Partial Class RV_Export_SvcRecWithDiff
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                If Convert.ToString(Session("ReportType")) = "SvcRecWithDiffSchDtAndActualSvcDt_Format1" Then
                    crReportDocument.Load(Server.MapPath("~/Reports/ServiceRecordReports/SvcRecWithDiffSchedDtAndActualSvcDt_Format1.rpt"))

                ElseIf Convert.ToString(Session("ReportType")) = "SvcRecWithDiffSchDtAndActualSvcDt_Format2" Then
                    crReportDocument.Load(Server.MapPath("~/Reports/ServiceRecordReports/SvcRecWithDiffSchedDtAndActualSvcDt_Format2.rpt"))

                ElseIf Convert.ToString(Session("ReportType")) = "SvcRecWithDuplicateTeamMembers_Format1" Then
                    crReportDocument.Load(Server.MapPath("~/Reports/ServiceRecordReports/SvcRecWithDuplicateTeamMembers_Format1.rpt"))

                ElseIf Convert.ToString(Session("ReportType")) = "SvcRecWithDuplicateTeamMembers_Format2" Then
                    crReportDocument.Load(Server.MapPath("~/Reports/ServiceRecordReports/SvcRecWithDuplicateTeamMembers_Format2.rpt"))
