<%@ Page Title="Outstanding Invoice Details By Due Date" Language="VB" MasterPageFile="~/MasterPage_Report.master" EnableEventValidation="false" AutoEventWireup="false" CodeFile="RV_Select_OutstandingInvoiceDetailsByDueDate1.aspx.vb" Inherits="RV_Select_OutstandingInvoiceDetailsByDueDate" %>
    ...
    <table style="width:100%;">
      ...
      <table style="width:100%;font-family: Calibri; font-size: 15px; font-weight: bold; color: black;text-align:left;padding-left:50px;line-height:20px;">
             ...
             <tr>
              ...
              <tr>
                    ...
                    <td class="CellTextBoxADM"> 
                               <asp:TextBox ID="txtGLFrom" runat="server" MaxLength="10" Height="16px" Width="85.5%"></asp:TextBox><asp:ImageButton ID="btnGL1" runat="server" ImageUrl="~/Images/searchbutton.jpg" Height="22px" Width="22px" ImageAlign="Top"/>
   </td>
                 <td class="CellFormat" style="text-align: right; ">TO</td>
                    <td class="CellTextBox"><asp:TextBox ID="txtGLTo" runat="server" MaxLength="10" Height="16px" Width="85.5%"></asp:TextBox><asp:ImageButton ID="btnGL2" runat="server" ImageUrl="~/Images/searchbutton.jpg" Height="22px" Width="22px" ImageAlign="Top"/>
          ...
          <tr>
                 ...
                 <td class="CellFormat" style="text-align: right; ">Salesman</td>
                    <td class="CellTextBox"><asp:DropDownList ID="ddlSalesMan" runat="server" AppendDataBoundItems="True" CssClass="chzn-select" DataTextField="StaffId" DataValueField="StaffId" Height="25px" Width="85.5%"><asp:ListItem Text="--SELECT--" Value="-1" /></asp:DropDownList>
                                 </td>
        ...
        <%--  <tr>
            ...
            <tr>
                 ...
                 <td class="CellFormat" style="text-align: right; ">AccountID</td>
                    <td class="CellTextBox"><asp:TextBox ID="txtAccountID" runat="server" MaxLength="10" Height="16px" Width="85.5%"></asp:TextBox><asp:ImageButton ID="btnClient" runat="server" ImageUrl="~/Images/searchbutton.jpg" Height="22px" Width="22px" ImageAlign="Top"/>
                    </td>
               ...
               <tr>
                    ...
                    <td class="CellTextBox" colspan="3" style="text-align:left;"> <asp:TextBox ID="txtCustName" runat="server" MaxLength="200" Height="16px" Width="94.5%"></asp:TextBox>
     ...
     <Style2 SelectBoxWidth="85.5%" DropDownBoxBoxWidth="85.5%" DropDownBoxBoxHeight="120" />
             ...
             <tr>
                 ...
                 <td colspan="2" class="CellFormat" style="text-align: center; ">
                          <asp:CheckBox ID="chkUnpaidBal" runat="server" Text="Include UnPaid Bal < 0" TextAlign="Left" Font-Bold="True" Font-Names="Calibri" ForeColor="Black" /></td>
            ...
            <tr>
                      <td class="CellFormat">CutOffDate<asp:CheckBox ID="chkCheckCutOff" runat="server" AutoPostBack="True" /></td>
                 ...
                 <td colspan="3" class="CellFormat" style="text-align: right; ">
                         </td>
                  </tr>
        <%--   <tr>
            ...
            <td colspan="3" style="text-align: left;padding-left:20px ">
              ...
              <tr>
                  <td colspan="4" style="text-align:center; ">
                       <asp:Button ID="btnUpdate" runat="server" CssClass="button" BackColor="#CFC6C0"  Font-Bold="True" Text="Update" Width="100px" Visible="true" />
    ...
    <asp:TextBox ID="txtQuery" runat="server" CssClass="dummybutton" ></asp:TextBox>
     <asp:TextBox ID="txtQueryRecv" runat="server" CssClass="dummybutton" ></asp:TextBox>
      <asp:TextBox ID="txtQueryRecv1" runat="server" CssClass="dummybutton" ></asp:TextBox>
        <asp:TextBox ID="txtQueryRecv2" runat="server" CssClass="dummybutton" ></asp:TextBox>
