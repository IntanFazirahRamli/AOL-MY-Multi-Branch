<%@ Page Title="Sales Performance Summary By Department" Language="VB" MasterPageFile="~/MasterPage.master" ValidateRequest="false" AutoEventWireup="false" CodeFile="RV_SalesPerformanceSummaryByDepartment.aspx.vb" Inherits="RV_SalesPerformanceSummaryByDepartment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
     <div style="text-align:center">
        <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">Sales Performance Summary By Department Report</h3>
    <br />
        ...
        <tr>
            <td colspan="2">
                ...
                <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                    <Report FileName="Reports\ManagementReports\SalesPerformanceReports\SalesPerformaceSummaryByDepartment.rpt">
                    </Report>
