<%@ Page Title="Contract" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="Contract.aspx.vb" Inherits="Contract" Culture="en-GB" MaintainScrollPositionOnPostback="true" ValidateRequest="false" %>
        ...
        <asp:Label ID="lblAccountIdServiceAddress" runat="server" Visible="false" Text="Service Address: " style="width:40%;text-align:left;color:brown;font-size:16px;font-weight:bold;font-family:'Calibri';" ></asp:Label>
              ...
              <tr>
                <td style="width:7%;text-align:center;"> 
                  ...
                  <td style="width:7%;text-align:center;">
                      <asp:Button ID="btnCopy" runat="server" Font-Bold="True" Text="COPY" Width="95%"  CssClass="roundbutton1" OnClientClick="RefreshSubmit();"  BackColor="#CFC6C0" Visible="TRUE" />
                    </td>
                  ...
                  <td style="width:7%;text-align:center;">
                       <asp:Button ID="btnChangeStatus" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="CH. ST." Visible="true" OnClientClick="RefreshSubmit();" Width="95%"  />
                     </td>
                   ...
                   <td style="width:8%;text-align:center;">
                    ...
                    <td style="width:7%;text-align:center;">
                      <asp:Button ID="btnRevision" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="REVISE" Width="95%" Visible="False" OnClientClick = "statuschangerevise()" />
                    </td>
                   <td style="width:7%;text-align:center;">
         ...
         <table  style="width:100%;text-align:center; padding-top:2px; margin-left: 0%; margin-right:0% " >
                 ...
                 <td>
                    ...
                    <asp:SqlDataSource ID="SQLDSContractClientIdLocation" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>">
                               ...
                               <td>
                    <asp:SqlDataSource ID="SqlDSTerminationCode" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>" SelectCommand="SELECT CONCAT(Code, ' - ', Description) AS TC FROM tblterminationcode where Status = 'Y' ORDER BY Code">
                                                
                                  </asp:SqlDataSource>

             <asp:SqlDataSource ID="sqlDSContractCode" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>">
                ...
                <td><asp:TextBox ID="txtclientid" runat="server" BorderStyle="None" ForeColor="White"></asp:TextBox></td>
                             ...
                             <asp:TextBox ID="txtExtendContractEndDate" runat="server" width="1px"  BorderStyle="None" CssClass="dummybutton"></asp:TextBox>
                              ...
                              <asp:TextBox ID="txtEnableAddButtonInContractOnLoad" runat="server" width="1px" Enabled="false" BorderStyle="None" CssClass="dummybutton"></asp:TextBox>
                              
                                        <asp:TextBox ID="txtDisplayFixedDurationType" runat="server" width="1px" Enabled="false" BorderStyle="None" CssClass="dummybutton"></asp:TextBox>
                              <asp:TextBox ID="txtDisplayContinuousDurationType" runat="server" width="1px" Enabled="false" BorderStyle="None" CssClass="dummybutton"></asp:TextBox>
                              ...
                              <asp:TextBox ID="txtContractDateOriginal" runat="server" width="1px" Enabled="false" BorderStyle="None" CssClass="dummybutton"></asp:TextBox>
                            
                              <asp:TextBox ID="txtPOMode" runat="server" width="1px" Enabled="false" BorderStyle="None" CssClass="dummybutton"></asp:TextBox>
                              <asp:TextBox ID="txtMultiplePORcNo" runat="server" width="1px" Enabled="false" BorderStyle="None" CssClass="dummybutton"></asp:TextBox>
                         
                              <asp:TextBox ID="txtDaysBeforeRenewalMessage" runat="server" width="1px" Enabled="false" BorderStyle="None" CssClass="dummybutton"></asp:TextBox>
                              <asp:TextBox ID="txtDaysBeforeScheduleGeneration" runat="server" width="1px" Enabled="false" BorderStyle="None" CssClass="dummybutton"></asp:TextBox>
                              <asp:TextBox ID="txtContractServiceLocked" runat="server" width="1px" Enabled="false" BorderStyle="None" CssClass="dummybutton"></asp:TextBox>
                              ...
                              <asp:TextBox ID="txtLastPriceChangeDateTerminationRevise" runat="server" width="1px" Enabled="false" BorderStyle="None" CssClass="dummybutton"></asp:TextBox>
                            
                                 <asp:TextBox ID="txtDistributionMode" runat="server" width="1px" Enabled="false" BorderStyle="None" CssClass="dummybutton"></asp:TextBox>
                              <asp:TextBox ID="txtDistributionRcno" runat="server" width="1px" Enabled="false" BorderStyle="None" CssClass="dummybutton"></asp:TextBox>
                            
                                 <asp:TextBox ID="txtVoidContract" runat="server" width="1px" Enabled="false" BorderStyle="None" CssClass="dummybutton"></asp:TextBox>
                              <asp:TextBox ID="txtVoidService" runat="server" width="1px" Enabled="false" BorderStyle="None" CssClass="dummybutton"></asp:TextBox>
                                 <asp:TextBox ID="txtVoidContractChSt" runat="server" width="1px" Enabled="false" BorderStyle="None" CssClass="dummybutton"></asp:TextBox>
                                 <asp:TextBox ID="txtContractNoTemp" runat="server" width="1px" Enabled="false" BorderStyle="None" CssClass="dummybutton"></asp:TextBox>
                                        <asp:TextBox ID="txtRcnotemp" runat="server" width="1px" Enabled="false" BorderStyle="None" CssClass="dummybutton"></asp:TextBox>
                                               <asp:TextBox ID="txtRcnoFirstContractPriceHistory" runat="server" width="1px" Enabled="false" BorderStyle="None" CssClass="dummybutton"></asp:TextBox>
                                            <asp:TextBox ID="txtRcnoFirstPrevContractPriceHistory" runat="server" width="1px" Enabled="false" BorderStyle="None" CssClass="dummybutton"></asp:TextBox>
                                            <asp:TextBox ID="txtDuplicateContractGroup" runat="server" width="1px" Enabled="false" BorderStyle="None" CssClass="dummybutton"></asp:TextBox>
                                            <asp:TextBox ID="txtIsContractGroupPercExists" runat="server" width="1px" Enabled="false" BorderStyle="None" CssClass="dummybutton"></asp:TextBox>
                                            <asp:TextBox ID="txtCountContractDetail" runat="server" width="1px" Enabled="false" BorderStyle="None" CssClass="dummybutton"></asp:TextBox>
                                           <asp:TextBox ID="txtUpGradeDownGradeNCR" runat="server" width="1px" Enabled="false" BorderStyle="None" CssClass="dummybutton"></asp:TextBox>
                                   <asp:TextBox ID="txtNCR" runat="server" width="1px" Enabled="false" BorderStyle="None" CssClass="dummybutton"></asp:TextBox>
                                 <asp:TextBox ID="txtErrNCR" runat="server" width="1px" Enabled="false" BorderStyle="None" CssClass="dummybutton"></asp:TextBox>
                                <asp:TextBox ID="txtServiceDescriptionConsPH" runat="server" width="1px" Enabled="false" BorderStyle="None" CssClass="dummybutton"></asp:TextBox>
                                <asp:TextBox ID="txtRevisionUA" runat="server" width="1px" Enabled="false" BorderStyle="None" CssClass="dummybutton"></asp:TextBox>
                              <asp:TextBox ID="txtCentPercent" runat="server" width="1px" Enabled="false" BorderStyle="None" CssClass="dummybutton"></asp:TextBox>
                                 <asp:TextBox ID="txtSelectedDistributionDate" runat="server" width="1px" Enabled="false" BorderStyle="None" CssClass="dummybutton"></asp:TextBox>
                             <asp:TextBox ID="txtErrorMsg" runat="server" width="1px" Enabled="false" BorderStyle="None" CssClass="dummybutton"></asp:TextBox>
                               <asp:TextBox ID="txtRevisionIncreaseLimit" runat="server" width="1px" Enabled="false" BorderStyle="None" CssClass="dummybutton"></asp:TextBox>
                              <asp:TextBox ID="txtRevisionDecreaseLimit" runat="server" width="1px" Enabled="false" BorderStyle="None" CssClass="dummybutton"></asp:TextBox>
                              <asp:TextBox ID="txtAgreementTypeContractCode" runat="server" width="1px" Enabled="false" BorderStyle="None" CssClass="dummybutton"></asp:TextBox>
             ...
             <tr style="text-align:center;width:100%">
                <td colspan="9" style="text-align:left;padding-left:5px; margin-left: 40px;">
...
<asp:TabContainer ID="tb1" runat="server" ActiveTabIndex="0" Font-Names="Calibri" Height="100%" Width="90%" CssClass="ajax__tab_xp" AutoPostBack="True">
    <asp:TabPanel  runat="server"   HeaderText=" General & Billing Info" ID="TabPanel1"><HeaderTemplate>General Info &amp; Summary</HeaderTemplate><ContentTemplate><table border="0" style="width:75%; margin:auto"></table><br /><asp:SqlDataSource ID="SqlDSContractNo" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>" SelectCommand="SELECT ContractNo, ProspectId, StaffId, Status, ContactType, CustCode, CustName, CustAddr, InChargeId, EntryDate, ContractDate, Contact, Telephone, Fax, AgreeValue, Duration, DurationMs, StartDate, EndDate, ActualEnd, ServiceNo, ServiceBal, ServiceAmt, HourNo, HourBal, HourAmt, CallNo, CallBal, CallAmt, ResponseHours, CancelCharges, CompensatePct, CompensateMax, WeekDayFrom1, WeekDayFrom2, WeekDayFrom3, WeekDayTo1, WeekDayTo2, WeekDayTo3, WeekEndFrom1, WeekEndFrom2, WeekEndFrom3, WeekEndTo1, WeekEndTo2, WeekEndTo3, DayVisitRate1, DayVisitRate2, DayVisitRate3, DayHourRate1, DayHourRate2, DayHourRate3, DayTransport1, DayTransport2, DayTransport3, EndVisitRate1, EndVisitRate2, EndVisitRate3, EndHourRate1, EndHourRate2, EndHourRate3, EndTransport1, EndTransport2, EndTransport3, Notes, Rcno, Comments, ActualStaff, ServiceNoActual, HourNoActual, CallNoActual, MinDuration, OContractNo, RenewalSt, RenewalDate, UnitNo, UnitBal, UnitAmt, UnitNoActual, NotedSt, NotedDate, settle, ActualServHrs, CreatedBy, CreatedOn, LastModifiedBy, LastModifiedOn, YourReference, ContractGroup, PrintBody, RenewalContractNo, ServDayMethod, ServDay, GSt, ServiceStart, ServiceEnd, ServiceFrequence, TimeIn, TimeOut, WarrantyStart, WarrantyEnd, ContractValue, PerServiceValue, Disc_Percent, DiscAmt, BillingFrequency, DayService1, DayService2, DayService3, DayService4, Support, ScheduleType, TeamID, WebCreateDeviceID, WebCreateSource, WebFlowFrom, WebFlowTo, WebEditSource, WebDeleteStatus, WebLastEditDevice, Postal, LocateGrp, Scheduler, ContactPersonMobile, SalesMan, OurReference, GSTNos, ServiceDescription, PrintingRemarks, Rev, MainContractNo, AmtCompleted, AmtBalance, AllocatedSvcTime, Remarks, QuotePrice, QuoteUnitMS, CompanyGroup, SalesGRP, AmtBalance FROM tblcontract WHERE (ContractNo = @contractno)"><FilterParameters><asp:ControlParameter ControlID="txtcontractno" Name="ContractNo" PropertyName="Text" /></FilterParameters><SelectParameters><asp:ControlParameter ControlID="txtContractNo" Name="@contractno" PropertyName="Text" /></SelectParameters></asp:SqlDataSource><asp:Panel ID="pnlPopUpClient" runat="server" BackColor="White" Width="98%" Height="80%" BorderColor="#003366" BorderWidth="1px" HorizontalAlign="Center"><table border="0" style="margin-left:auto; margin-right:auto; "><tr><td colspan="2" style="text-align:center;"><h4 style="color: #000000">Select Customer</h4></td><td style="width:1%;text-align:right;"><asp:ImageButton ID="btnPnlClientClose" runat="server" ImageUrl="~/Images/closebutton.png" Height="27px" Width="30px" /></td></tr><tr><td colspan="2" style="width:10%;font-size:15px;font-weight:bold;font-family:Calibri; color:black;text-align:center;padding-left:20px;">&#160;Search Name &#160;&#160; <asp:ImageButton ID="btnPopUpClientReset" runat="server" Height="22px" ImageAlign="Middle" ImageUrl="~/Images/resetbutton.jpg" Width="24px"></asp:ImageButton><asp:TextBox ID="txtPopUpClient" runat="server" Height="16px" MaxLength="50" Width="400px" ForeColor="Gray" onblur = "WaterMarkClient(this, event);" onfocus = "WaterMarkClient(this, event);" AutoPostBack="True">Search Here for AccountID or Client Name or Contact Person</asp:TextBox><asp:ImageButton ID="btnPopUpClientSearch" runat="server" Height="22px" ImageAlign="Middle" ImageUrl="~/Images/searchbutton.jpg" OnClick="btnPopUpClientSearch_Click" Width="24px"></asp:ImageButton></td><td><asp:TextBox ID="txtPopupClientSearch" runat="server" Visible="False"></asp:TextBox></td></tr></table><div style="text-align:center; padding-left: 10px; padding-bottom: 5px;"><div class="AlphabetPager"><asp:Repeater ID="rptClientAlphabets" runat="server" Visible="False"><ItemTemplate><asp:LinkButton ID="LinkButton1" runat="server" Text='<%#Eval("Value")%>' OnClick="ClientAlphabet_Click" ForeColor="Black" /></ItemTemplate></asp:Repeater></div><br /><asp:GridView ID="gvClient" runat="server" DataSourceID="SqlDSClient" OnRowDataBound = "OnRowDataBoundgClient" OnSelectedIndexChanged = "OnSelectedIndexChangedgClient" ForeColor="#333333" AllowPaging="True" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <td style="font-size:20px;font-family:Calibri; font-weight:bold; text-align:left; color:black; padding-left:1%; width:60% ">
                
                
                 <asp:TextBox ID="txtLatestScheduleDetails" runat="server" AutoCompleteType="Disabled" BorderStyle="None" Height="16px" Font-Bold="True" Font-Size="17px" Width="95%" Enabled="False" ReadOnly="True"></asp:TextBox>
                 </td>
        </tr>
                    ...
                    <tr style="width:95%">
                        <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15% ; text-align:right;">&nbsp;</td>
                        <td style="font-size:15px;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:60% ">&nbsp;</td>
             </tr>
             <tr style="width:95%">
                 <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15% ; text-align:right;">&nbsp;</td>
            ...
            <asp:Label ID="lblBranch2" runat="server" Text="Branch"></asp:Label></td><td style="font-size: 15px; font-weight: bold; font-family: Calibri; text-align: left; padding-left: 1%; width: 72%">
             ...
             <tr style="width:95%"><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15%; text-align:right; ">Contract Date <asp:Label ID="Label4" runat="server" Font-Size="14px" ForeColor="Red" Text="*"></asp:Label></td>
                 
                 <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:72% ">
                     <asp:UpdatePanel ID="UpdatePanel3" runat="server"><ContentTemplate><asp:TextBox ID="txtContractDate" runat="server" Height="16px" Width="40%" AutoCompleteType="Disabled" onchange="PopulateOtherDays()" AutoPostBack="True"></asp:TextBox><asp:CalendarExtender ID="calConDate" runat="server" Format="dd/MM/yyyy" PopupButtonID="txtContractDate" TargetControlID="txtContractDate" Enabled="True" /></ContentTemplate></asp:UpdatePanel></td></tr>
                    ...
                    <tr style="width:95%; vertical-align:top">
                        ...
                        <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:72%; vertical-align:top;  ">
                            <asp:DropDownList ID="ddlAgreementType" runat="server" style="vertical-align:top;" AppendDataBoundItems="True" Height="20px" Width="40.5%" AutoPostBack="True" ><asp:ListItem>--SELECT--</asp:ListItem></asp:DropDownList>
                            <asp:Label ID="lblAgreentTypeRemarks" runat="server" style="vertical-align:top;" Font-Size="14px" ForeColor="Red" Height="24px" Width="58%"  ></asp:Label> </td></tr>
                   ...
                   <tr style="width:95%; vertical-align:top">
                     ...
                     <tr style="width:95%">
                 <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15%; text-align:right; ">Account Type
                     <asp:Label ID="Label5" runat="server" Font-Size="14px" ForeColor="Red" Text="*"></asp:Label>
                 </td>
                 <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:72% ">
                     <asp:DropDownList ID="ddlContactType" runat="server" DataTextField="ContType" DataValueField="ContType" Height="20px" Width="40.5%">
             ...
             <tr style="width:95%"><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15%; text-align:right; ">Account Id <asp:Label ID="Label6" runat="server" Font-Size="14px" ForeColor="Red" Text="*"></asp:Label></td><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:72% "><asp:TextBox ID="txtAccountId" runat="server" Height="16px" Width="40%" AutoCompleteType="Disabled" MaxLength="200" AutoPostBack="True" ></asp:TextBox><asp:ImageButton ID="btnClient" runat="server" CssClass="righttextbox" ImageUrl="~/Images/searchbutton.jpg"  Height="22px" Width="24px" ImageAlign="Top"                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      
                    ...
                    <tr style="width:95%"><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15%; text-align:right; ">
                            ...
                            <asp:ImageButton ID="btnClient0" runat="server" CssClass="righttextbox" Height="22px" ImageAlign="Top" ImageUrl="~/Images/Edit.png" Width="24px" /></td></tr><tr style="width:95%"><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15% ; text-align:right;">Latest P.O. No. </td><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:72% ">
            <asp:TextBox ID="txtPONo" runat="server" AutoCompleteType="Disabled" Height="16px" MaxLength="100" Width="40%"></asp:TextBox>
            <asp:ImageButton ID="btnClient1" runat="server" CssClass="righttextbox" Height="22px" ImageAlign="Top" ImageUrl="~/Images/Edit.png" Width="24px" Visible="False" />
                 <asp:Button ID="btnMultiplePO" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="P.O." Width="20%" Visible="False" />
                 </td></td></tr><tr style="width:95%"><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15% ; text-align:right;">Other Reference</td><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:72% ">
            ...
            <asp:ImageButton ID="btnClient2" runat="server" CssClass="righttextbox" Height="22px" ImageAlign="Top" ImageUrl="~/Images/Edit.png" Width="24px" /></td></tr><tr style="width:95%"><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15%; text-align:right; ">Billing Address</td><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:72% "><asp:TextBox ID="txtBillingAddress" runat="server" Font-Names="calibri" Font-Size="15px" AutoCompleteType="Disabled" Height="60px" Width="40%" TextMode="MultiLine"></asp:TextBox></td></tr><tr style="width:95%"><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15%; text-align:right; ">Service Address</td><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:72% "><asp:TextBox ID="txtServiceAddressCons" runat="server" Font-Names="calibri" Font-Size="15px" AutoCompleteType="Disabled" Height="60px" Width="40%" TextMode="MultiLine"></asp:TextBox></td></tr><tr style="width:95%"><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15%; text-align:right; "><asp:TextBox ID="txtAddress" runat="server" AutoCompleteType="Disabled" Height="16px" MaxLength="25" Visible="False" Width="10%"></asp:TextBox></td><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:72% "><asp:DropDownList ID="ddlLocateGrp" runat="server" Width="10%" AppendDataBoundItems="True" Height="20px" Visible="False"><asp:ListItem>--SELECT--</asp:ListItem></asp:DropDownList>
                ...
                <asp:TextBox ID="txtOfficeAddress" runat="server" AutoCompleteType="Disabled" Height="16px" Width="10%" CssClass="dummybutton" ></asp:TextBox><asp:TextBox ID="txtPostal" runat="server" AutoCompleteType="Disabled" Height="16px" MaxLength="20" Width="10%" CssClass="dummybutton"></asp:TextBox></td></tr><table border="0" style="width:75%; margin:auto"><tr style="width:95%"><td colspan="6" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; text-decoration: underline;padding-left:10%; color:#800000;  background-color: #C0C0C0;">Contract Details </td><tr style="width:95%"><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:18%; text-align:right;">Company Group <asp:Label ID="Label12" runat="server" Font-Size="14px" ForeColor="Red" Text="*"></asp:Label></td><td colspan="5" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:40%"><asp:DropDownList ID="ddlCompanyGrp" runat="server" AppendDataBoundItems="True" Height="20px" Width="40.5%"><asp:ListItem>--SELECT--</asp:ListItem></asp:DropDownList><asp:ImageButton ID="btnClient7" runat="server" CssClass="righttextbox" Height="22px" ImageAlign="Top" ImageUrl="~/Images/Edit.png" Width="24px" /></td></tr><tr style="width:95%"><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15%; text-align:right; ">Salesman <asp:Label ID="Label8" runat="server" Font-Size="14px" ForeColor="Red" Text="*"></asp:Label></td><td colspan="5" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:70% "><asp:DropDownList ID="ddlSalesman" runat="server" AppendDataBoundItems="True" Height="20px" Width="40.5%"><asp:ListItem>--SELECT--</asp:ListItem></asp:DropDownList><asp:ImageButton ID="btnClient6" runat="server" CssClass="righttextbox" Height="22px" ImageAlign="Top" ImageUrl="~/Images/Edit.png" Width="24px" /></td></tr><tr style="width:95%"><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15%; text-align:right; ">Scheduler <asp:Label ID="Label9" runat="server" Font-Size="14px" ForeColor="Red" Text="*"></asp:Label></td><td colspan="5" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:70% "><asp:DropDownList ID="ddlScheduler" runat="server" AppendDataBoundItems="True" CssClass="chzn-select" Height="20px" Width="40.5%"><asp:ListItem>--SELECT--</asp:ListItem></asp:DropDownList><asp:ImageButton ID="btnClient5" runat="server" CssClass="righttextbox" Height="22px" ImageAlign="Top" ImageUrl="~/Images/Edit.png" Width="24px" /></td></tr><tr style="width:95%"><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15%; text-align:right; ">Contract Group<asp:Label ID="Label56" runat="server" Font-Size="14px" ForeColor="Red" Text="*"></asp:Label></td><td colspan="5" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:70% "><asp:DropDownList ID="ddlContractGrp" runat="server" AppendDataBoundItems="True" Height="20px" Width="40.5%" AutoPostBack="True"><asp:ListItem>--SELECT--</asp:ListItem></asp:DropDownList>
                 &nbsp;<asp:Button ID="btnContractGroupDistribution" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="DISTRIBUTION" Width="20%" />
                 </td></tr><tr style="width:95%"><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15%; text-align:right;">Category ID</td><td colspan="5" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:70% "><asp:TextBox ID="txtCategoryID" runat="server" AutoCompleteType="Disabled" Height="16px" MaxLength="30" Width="40%"></asp:TextBox></td></tr>
                 <tr style="width:95%">
                     <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15%; text-align:right;">&nbsp;</td>
                 ...
                 &nbsp;</td><td colspan="5" style="font-size:15px;font-weight:bold;font-family:Calibri; color:black; text-align:left; padding-left:1%; width:20% ">
                    ...
                    <tr style="width:95%">
                        ...
                        <td colspan="5" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:20% ">
                            ...
                            &nbsp;<asp:Button ID="btnHistory" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="PRICE HISTORY" Width="20%" />
                        </td>
                 </tr>
                    ...
                    <tr style="width:95%"><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15%; text-align:right; ">Duration <asp:Label ID="Label54" runat="server" Font-Size="14px" ForeColor="Red" Text="*"></asp:Label></td><td colspan="5" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:60% "><asp:TextBox ID="txtDuration" runat="server" AutoCompleteType="Disabled" Height="16px" onchange="CalculateDatesDuration()" Width="40%"></asp:TextBox></td></tr>
                    
                    
                    <tr style="width:95%">
                        
                        <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15%; text-align:right; "><asp:CheckBox ID="chkInactive" runat="server" Text=" Inactive" CssClass="dummybutton" /></td>
                        
                        <td colspan="5" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:60% ">
                        
                       <asp:UpdatePanel ID="UpdatePanel4" runat="server"><ContentTemplate>
                        <asp:Panel ID="Panel2" runat="server" BorderColor="#993300" BorderStyle="Solid" BorderWidth="1px" Font-Size="15px" Height="19%" HorizontalAlign="Center" Width="40%">
                        
                         
                        <asp:RadioButtonList ID="rbtLstDuration" runat="server" Font-Size="15px" ForeColor="Black" onchange="CalculateDates()" RepeatDirection="Horizontal" ValidationGroup="durationtype" Width="80%"><asp:ListItem Text="DAYS" Value="DAYS"></asp:ListItem><asp:ListItem Text="WEEKS" Value="WEEKS"></asp:ListItem><asp:ListItem Text="MONTHS" Value="MONTHS"></asp:ListItem><asp:ListItem Text="YEARS" Value="YEARS"></asp:ListItem>
                 ...
                 <tr style="width:95%">
                     ...
                     <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15% ">
                         <asp:TextBox ID="txtEndofLastSchedule" runat="server" AutoCompleteType="Disabled" AutoPostBack="True" Height="16px" onchange="CalculateContractDates()" Width="95%"></asp:TextBox>
                     ...
                     <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15% ">&nbsp;</td>
                      ...
                      <tr style="width:95%">
                                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:18% ; text-align:right;">Warranty Start </td>
                                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15% ">
                                    <asp:TextBox ID="txtWarrStart" runat="server" AutoCompleteType="Disabled" Height="16px" onchange="ValidateDatesWarrnty()" Width="95%"></asp:TextBox>
                                     <asp:MaskedEditExtender runat="server" ID="MaskedEditExtender1" ClearMaskOnLostFocus="False"
                                         MaskType="Date" Mask="99/99/9999" TargetControlID="txtWarrStart" UserDateFormat="DayMonthYear" Century="2000" CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="" CultureDateFormat="" CultureDatePlaceholder="" CultureDecimalPlaceholder="" CultureThousandsPlaceholder="" CultureTimePlaceholder="" Enabled="True">
                                </asp:MaskedEditExtender>
                                    <asp:CalendarExtender ID="calWarrStart" runat="server" Enabled="True" Format="dd/MM/yyyy" PopupButtonID="txtWarrStart" TargetControlID="txtWarrStart">
                                    </asp:CalendarExtender>
                                </td>
                                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15% ">
                                    <asp:TextBox ID="txtContType2" runat="server" AutoCompleteType="Disabled" BorderStyle="None" ForeColor="White" Height="16px" style="text-align:right" Width="1%"></asp:TextBox>
                                    <asp:ImageButton ID="btnClient11" runat="server" CssClass="righttextbox" Height="22px" ImageAlign="Top" ImageUrl="~/Images/Edit.png" Width="24px" Visible="False" />
                                </td>
                                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:12%; text-align:right; ">Warranty End </td>
                                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15% ">
                                    <asp:TextBox ID="txtWarrEnd" runat="server" AutoCompleteType="Disabled" Height="16px" onchange="ValidateDatesWarranty()" Width="96%"></asp:TextBox>
                                   <asp:MaskedEditExtender runat="server" ID="MaskedEditExtender2" ClearMaskOnLostFocus="False"
                                         MaskType="Date" Mask="99/99/9999" TargetControlID="txtWarrEnd" UserDateFormat="DayMonthYear" Century="2000" CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="" CultureDateFormat="" CultureDatePlaceholder="" CultureDecimalPlaceholder="" CultureThousandsPlaceholder="" CultureTimePlaceholder="" Enabled="True">
                                </asp:MaskedEditExtender>
                                       <asp:CalendarExtender ID="calWarrEnd" runat="server" Enabled="True" Format="dd/MM/yyyy" PopupButtonID="txtWarrEnd" TargetControlID="txtWarrEnd">
                                    </asp:CalendarExtender>
                                </td>
                                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:0%; width:15% ">
                                    <asp:ImageButton ID="btnClient12" runat="server" CssClass="righttextbox" Height="22px" ImageAlign="Top" ImageUrl="~/Images/Edit.png" Width="24px" />
                                </td>
                            </tr>
        ...
        <tr style="display: none; width:95%"><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:10%; text-align:right;">Portfolio Value</td><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:40%"><asp:TextBox ID="txtPortfolioValue" runat="server" AutoCompleteType="Disabled" Height="16px" onchange="getNetAmount()" style="text-align:right" Width="40%"></asp:TextBox></td></tr></table><br />
            ...
            <tr style="width:95%"><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15%; text-align:right; ">Bait Station</td>
                ...
                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:12%">
                  <asp:Button ID="btnRecalculate" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="Recalculate" Width="98%" /></td>
                    ...
                    <table border="0" style="width:75%; margin:auto; display:none"">
                        <tr style="width:95%"><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15%;  "><asp:CheckBox ID="ChkWithWarranty" runat="server" Text="With Warranty" onchange="EnableDisableWarranty()" /></td></tr>

                    </table>
                    <table border="0" style="width:75%; margin:auto;display:none" >
                        <tr><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:#800000; padding-left:10%; text-align:left; text-decoration: underline; background-color: #C0C0C0;" colspan="6">Warranty Details </td>
                            <tr style="width:95%">
                                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:18%; text-align:right;">Warranty Duration </td>
                                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15%">
                                    <asp:TextBox ID="txtWarrDurtion" runat="server" AutoCompleteType="Disabled" Height="16px" onchange="CalculateWarrantyDates()" Width="90%"></asp:TextBox>
                                </td>
                                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15% ">
                                    <asp:TextBox ID="txtContType1" runat="server" AutoCompleteType="Disabled" BorderStyle="None" ForeColor="White" Height="16px" style="text-align:right" Width="1%"></asp:TextBox>
                                </td>
                                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:12%"></td>
                                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15%"></td>
                                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15%"></td>
                            ...
                            <tr style="width:95%">
                                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:18% ; text-align:right;">Warranty Billing Frequency</td>
                                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15% ">
                                    <asp:DropDownList ID="ddlWarrantyFrequency" runat="server" AppendDataBoundItems="True" Width="93%">
                                        <asp:ListItem>--SELECT--</asp:ListItem>
                            ...
                            <tr style="width:95%">
                                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:18% ; text-align:right;">Warranty Billing Amount</td>
                                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15% ">
                                    <asp:TextBox ID="txtWarrantyBillingAmount" runat="server" AutoCompleteType="Disabled" Height="16px" style="text-align:right" Width="90%"></asp:TextBox>
                                </td>
                                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15% ">&nbsp;</td>
                                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:12%; text-align:right; ">&nbsp;</td>
                                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15% ">&nbsp;</td>
                            ...
                            <tr style="width:95%; display:none">
                                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:18% ; text-align:right; display:none">&nbsp;</td>
                                <td colspan="2" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15% ">
                                    <asp:CheckBox ID="ChkRequireInspection" runat="server" onchange="EnableDisableInspection()" Text="Require Inspection" />
                                </td>
                                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:12%"></td>
                                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15%"></td>
                                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15%"></td>
                            ...
                            <tr style="width:95%">
                                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:18%; text-align:right;">Inspection Frequency </td>
                                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15%">
                                    <asp:DropDownList ID="ddlInspectionFrequency" runat="server" AppendDataBoundItems="True" Width="94%">
                                        <asp:ListItem>--SELECT--</asp:ListItem>
                                        <asp:ListItem>WEEKLY</asp:ListItem>
                                        <asp:ListItem>MNOTHLY</asp:ListItem>
                                        <asp:ListItem>YEARLY</asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15% ">
                                    <asp:TextBox ID="txtContType3" runat="server" AutoCompleteType="Disabled" BorderStyle="None" ForeColor="White" Height="16px" style="text-align:right" Width="1%"></asp:TextBox>
                                </td>
                                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:12%"></td>
                                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15%"></td>
                                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15%"></td>
                            ...
                            <tr>
                                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:18% ; text-align:right;">Inspection Start </td>
                                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15% ">
                                    <asp:TextBox ID="TxtInspectionStart" runat="server" AutoCompleteType="Disabled" Height="16px" onchange="ValidateDatesWarrnty()" Width="90%"></asp:TextBox>
                                    <asp:CalendarExtender ID="CalendarExtender1" runat="server" Enabled="True" Format="dd/MM/yyyy" PopupButtonID="TxtInspectionStart" TargetControlID="TxtInspectionStart">
                                    </asp:CalendarExtender>
                                </td>
                                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15% ">
                                    <asp:TextBox ID="txtContType4" runat="server" AutoCompleteType="Disabled" BorderStyle="None" ForeColor="White" Height="16px" style="text-align:right" Width="1%"></asp:TextBox>
                                </td>
                                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:12% ; text-align:right;">End </td>
                                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15% ">
                                    <asp:TextBox ID="TxtInspectionEnd" runat="server" AutoCompleteType="Disabled" Height="16px" onchange="ValidateDatesWarranty()" Width="90%"></asp:TextBox>
                                    <asp:CalendarExtender ID="CalendarExtender18" runat="server" Enabled="True" Format="dd/MM/yyyy" PopupButtonID="TxtInspectionEnd" TargetControlID="TxtInspectionEnd">
                                    </asp:CalendarExtender>
                                </td>
                                <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15% "></td>
                            </tr>
            ...
            <asp:TabPanel ID="TabPanel2" runat="server" HeaderText="Service Details"><HeaderTemplate>
                ...
                <table border="0" style="width:75%; margin:auto"><tr style="width:95%"><td style="width:100%;text-align:center; ">
                    ...
                    <asp:Panel ID="Panel4" runat="server" BackColor="White" BorderColor="#003366" BorderWidth="1px" Height="100%" ScrollBars="Vertical" Width="100%">
                        ...
                        <asp:GridView ID="grvContractDetail" runat="server" AllowPaging="True" AllowSorting="True" OnRowDataBound = "OnRowDataBound2" OnSelectedIndexChanged = "OnSelectedIndexChanged2" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataKeyNames="ContractNo" DataSourceID="SqlDSContractDet" Font-Size="15px"  HorizontalAlign="Center" ForeColor="#333333" GridLines="Vertical">
                            ...
                            <Columns><asp:CommandField HeaderText="Select" ShowHeader="True" ShowSelectButton="True" Visible="False">
                                ...
                                <asp:BoundField DataField="Value" HeaderText="Per Service Value" SortExpression="Value" >
                                    <ItemStyle Width="5%" />
                                ...
                                <asp:TemplateField HeaderText="Rcno" InsertVisible="False" SortExpression="Rcno" Visible="False">
                                    <EditItemTemplate><asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("Rcno") %>'>

                                                      </asp:TextBox></EditItemTemplate>
                                    
                                    <ItemTemplate><asp:Label ID="Label1" runat="server" Text='<%# Bind("Rcno") %>'></asp:Label></ItemTemplate>
                ...
                </asp:GridView></asp:Panel></td></tr><tr>
                    ...
                    <table border="0" style="width:75%; margin:auto"><tr style="width:95%"><td colspan="6" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; text-decoration: underline;padding-left:10%; color:#800000; background-color: #C0C0C0;">Service Details </td></tr><tr style="width:95%"><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15%; text-align:right; ">Contract No. </td><td colspan="2" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15%"><asp:Label ID="lblContractNo" runat="server" BackColor="#CCCCCC" Height="18px" MaxLength="100" ReadOnly="True" Width="100%" ForeColor="Black"></asp:Label></td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15% "></td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:12%; text-align:right; "></td><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15% "></td></tr><tr style="width:95%"><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15%; text-align:right; ">Account ID </td><td colspan="2" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15% "><asp:Label ID="lblAccountID" runat="server" BackColor="#CCCCCC" Height="18px" MaxLength="100" ReadOnly="True" Width="100%" ForeColor="Black"></asp:Label></td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15% "></td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:12%; text-align:right; "></td><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15% "></td></tr><tr style="width:95%"><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15%; text-align:right; ">Account Name </td><td colspan="2" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15% "><asp:Label ID="lblName" runat="server" BackColor="#CCCCCC" Height="32px" MaxLength="100" ReadOnly="True" Width="100%" ForeColor="Black"></asp:Label></td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15% "></td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:12%; text-align:right; "></td><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15% "></td></tr><tr><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15%; text-align:right; ">Service Start </td><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15% "><asp:TextBox ID="txtServStartSvc" runat="server" AutoCompleteType="Disabled" BackColor="#CCCCCC" ForeColor="Black" Height="16px" onchange="ValidateDatesService()" Width="98%" BorderStyle="None"></asp:TextBox></td><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15% "><asp:TextBox ID="txtServStartDaySvc" runat="server" AutoCompleteType="Disabled" BackColor="#CCCCCC" ForeColor="Black" Height="16px" Width="100%" BorderStyle="None"></asp:TextBox></td><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:12%; text-align:right; ">End </td><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15% "><asp:TextBox ID="txtServEndSvc" runat="server" AutoCompleteType="Disabled" BackColor="#CCCCCC" ForeColor="Black" Height="16px" onchange="ValidateDatesService()" Width="90%" BorderStyle="None"></asp:TextBox></td><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15% "><asp:TextBox ID="txtServEndDaySvc" runat="server" AutoCompleteType="Disabled" BackColor="#CCCCCC" ForeColor="Black" Height="16px" Width="85%" BorderStyle="None"></asp:TextBox></td></tr><tr style="width:95%"><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15%; text-align:right; ">Schedule Type <asp:Label ID="Label13" runat="server" Font-Size="14px" ForeColor="Red" Text="*"></asp:Label></td><td colspan="2" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15% "><asp:DropDownList ID="ddlScheduleType" runat="server"  AppendDataBoundItems="True" Height="20px" Width="100%"><asp:ListItem>--SELECT--</asp:ListItem ></asp:DropDownList></td></tr><tr style="width:95%"><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15%; text-align:right; ">Preferred Time </td><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15% "><asp:TextBox ID="txtServTimeIn" runat="server" AutoCompleteType="Disabled" Height="16px" Width="98%"></asp:TextBox></td><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15% "><asp:TextBox ID="txtServTimeOut" runat="server" AutoCompleteType="Disabled" Height="16px"  style="padding-right:0%" Width="98%"></asp:TextBox><asp:MaskedEditExtender ID="txtServTimeIn_MaskedEditExtender" runat="server" Century="2000" CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="" CultureDateFormat="" CultureDatePlaceholder="" CultureDecimalPlaceholder="" CultureThousandsPlaceholder="" CultureTimePlaceholder="" Enabled="True" Mask="99:99" MaskType="Time" TargetControlID="txtServTimeIn"></asp:MaskedEditExtender><asp:MaskedEditExtender ID="txtServTimeOut_MaskedEditExtender" runat="server" Century="2000" CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="" CultureDateFormat="" CultureDatePlaceholder="" CultureDecimalPlaceholder="" CultureThousandsPlaceholder="" CultureTimePlaceholder="" Enabled="True" Mask="99:99" MaskType="Time" TargetControlID="txtServTimeOut"></asp:MaskedEditExtender></td></td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:12%; text-align:right; "></td><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15% "><asp:TextBox ID="txtSelectedIndex" runat="server" AutoCompleteType="Disabled" Height="16px"  style="padding-right: 0%" Visible="False" Width="20%"></asp:TextBox><asp:MaskedEditExtender ID="txtSelectedIndex_MaskedEditExtender" runat="server" Century="2000" CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="" CultureDateFormat="" CultureDatePlaceholder="" CultureDecimalPlaceholder="" CultureThousandsPlaceholder="" CultureTimePlaceholder="" Enabled="True" Mask="99:99" MaskType="Time" TargetControlID="txtSelectedIndex"></asp:MaskedEditExtender></td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15% "></td></tr><tr style="width:95%"><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15%; text-align:right; ">Allocated Time<asp:Label ID="Label63" runat="server" Font-Size="14px" ForeColor="Red" Text="*"></asp:Label></td><td style="font-size:15px;font-weight:bold;font-family:Calibri; color:black; text-align:left; padding-left:1%; width:15% "><asp:TextBox ID="txtAllocTime" runat="server" AutoCompleteType="Disabled" Height="16px" Width="98%"></asp:TextBox></td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15% ">Mins</td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:12%; text-align:right; "></td><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15% "></td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15%; text-align:right; ">&nbsp;</td></tr><tr style="width:95%"><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15%; text-align:right; ">Assign Team<asp:Label ID="Label72" runat="server" Font-Size="14px" ForeColor="Red" Text="*"></asp:Label>
                        ...
                        <td colspan="2"  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15% ">
              
                      <asp:TextBox ID="txtTeam" runat="server" AutoCompleteType="Disabled" Height="16px" Width="100%" AutoPostBack="True"></asp:TextBox>
                ...
                &nbsp;&nbsp;</td><td colspan="2" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15% "><asp:TextBox ID="txtServiceBy" runat="server" AutoCompleteType="Disabled" Height="16px" Width="100%" MaxLength="25"></asp:TextBox></td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15% "></td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:12%; text-align:right; "></td><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15% "></td></tr><tr style="width:95%"><td  style="font-size:15px;font-weight:bold;font-family:Calibri;  text-align:left; color:black; padding-left:1%; width:15%; text-align:right; ">Supervisor </td><td colspan="2" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15% "><asp:TextBox ID="txtSupervisor" runat="server" AutoCompleteType="Disabled" Height="16px" Width="100%" MaxLength="25"></asp:TextBox>
                    ...
                    <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15% "></td></tr>
                        ...
                        <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:1%; width:15% ">
                            <asp:TextBox ID="txtAccountIdSelection" runat="server" AutoCompleteType="Disabled" Height="16px" Visible="False" Width="35%"></asp:TextBox></td></tr>
                ...
                <table border="0" style="width:75%; margin:auto"><tr style="width:95%">
                    <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; text-decoration: underline;padding-left:10%; color:#800000; background-color: #C0C0C0;">Service Locations </td></tr><tr style="width:95%"><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:0%; width:60% ">
                    <asp:UpdatePanel ID="updpnlLocation" runat="server" UpdateMode="Conditional"><ContentTemplate>
                <asp:GridView ID="grvServiceLocation" runat="server" AllowSorting="True" 
                                                          ...
                                                          OnRowDeleting="grvServiceLocation_RowDeleting" ShowFooter="True" Style="text-align: left" Width="60%"><Columns><asp:TemplateField HeaderText="Location Id"><ItemTemplate><asp:TextBox ID="ddlLocationIdGV" runat="server" Height="19px" width="130px" AutoPostBack="True" OnTextChanged="ddlLocationIdGV_TextChanged">
                    </asp:TextBox></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText=""><ItemTemplate>
                        
                        <asp:ImageButton ID="BtnLocation" runat="server" CssClass="righttextbox" Height="22px" ImageAlign="Middle" ImageUrl="~/Images/searchbutton.jpg" Width="24px" />
                        
                        <asp:ModalPopupExtender ID="imgBtnService_ModalPopupExtender" runat="server" BackgroundCssClass="modalBackground" CancelControlID="btnPnlServiceClose" PopupControlID="pnlPopUpLocation" TargetControlID="BtnLocation">

                        </asp:ModalPopupExtender>

                                                                                                      </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="Service Name"><ItemTemplate><asp:TextBox ID="txtServiceNameGV" runat="server" Enabled="false" Height="15px" ReadOnly="true" Width="250px"></asp:TextBox></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="Service Address"><ItemTemplate><asp:TextBox ID="txtServiceAddressGV" runat="server" Enabled="false" Height="15px" ReadOnly="true" Width="300px"></asp:TextBox></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="Zone"><ItemTemplate><asp:TextBox ID="txtZoneGV" runat="server" Enabled="false" Height="15px" ReadOnly="true" Width="80px"></asp:TextBox></ItemTemplate></asp:TemplateField>
        ...
        HorizontalAlign="Left" ScrollBars="Auto" style="text-align:center; margin-left:auto; margin-right:auto;"><table style="width:1100px; margin-left:auto; margin-right:auto; "><tr><td style="text-align: center;"><h4 style="color: #000000">Select Location</h4></td><td style="width: 1%; text-align: right;">
            ...
            <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/Images/closebutton.png" Height="27px" Width="30px" /></td></tr></table><div style="text-align: center; padding-left: 5px; padding-bottom: 5px;"><br />
                ...
                CellPadding="4" GridLines="None" Width="1100px"  Font-Size="15px" PageSize="20"><AlternatingRowStyle BackColor="White" ForeColor="#284775" /><Columns><asp:CommandField HeaderText="Select" ShowHeader="True" ShowSelectButton="True" Visible="False"><ControlStyle Width="45px" /><ItemStyle Width="45px" /></asp:CommandField><asp:BoundField DataField="LocationID" HeaderText="LocationID" SortExpression="LocationID" ><ControlStyle Width="70px" /><ItemStyle Width="70px" Wrap="False" /></asp:BoundField>
                    ...
                    <asp:BoundField DataField="Location" HeaderText="Branch" />
                </Columns><EditRowStyle BackColor="#999999" /><FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" /><HeaderStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" Font-Names="Calibri" /><PagerStyle BackColor="#284775" ForeColor="White" HorizontalAlign="Center" /><RowStyle BackColor="#F7F6F3" ForeColor="#333333" Font-Names="Calibri" HorizontalAlign="Left" /><SelectedRowStyle BackColor="#E2DED6" Font-Bold="True" ForeColor="#333333" /><SortedAscendingCellStyle BackColor="#E9E7E2" />
                    <SortedAscendingHeaderStyle BackColor="#506C8C" /><SortedDescendingCellStyle BackColor="#FFFDF8" /><SortedDescendingHeaderStyle BackColor="#6F8DAE" />
                ...
                <table border="0" style="width:75%; margin:auto"><tr style="width:95%">
                    ...
                    <tr style="width:95%"><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:0%; width:60% "><asp:UpdatePanel ID="updpnlFreq" runat="server"><ContentTemplate><asp:GridView ID="grvFreqDetails" runat="server"
                                                ...
                                                OnRowDeleting="grvFreqDetails_RowDeleting"  ><Columns><asp:TemplateField HeaderText="Seq. No."><ItemTemplate><asp:TextBox ID="txtSeqNoGV" runat="server" Enabled="false" Height="15px" ReadOnly="true" Style="text-align: center" Width="60px"></asp:TextBox></ItemTemplate></asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Freq MTD"><ItemTemplate><asp:DropDownList ID="ddlFreqMTDGV" runat="server" AutoPostBack="True" 
                                                                DataTextField="FreMTD" DataValueField="FreMTD" Height="20px" AppendDataBoundItems="True"
                                                                 width="100px" onselectedindexchanged="ddlFreqMTDGV_SelectedIndexChanged"><asp:ListItem Text="--SELECT--" Value="-1" /><asp:ListItem>DAY</asp:ListItem><asp:ListItem>DOW</asp:ListItem><asp:ListItem>MONTH</asp:ListItem><asp:ListItem>DATE</asp:ListItem></asp:DropDownList></ItemTemplate></asp:TemplateField>
                                                    <asp:TemplateField  HeaderText="Month No."><ItemTemplate><asp:TextBox ID="txtMonthNoGV" runat="server" 
                                                                Enabled="false" Height="15px" AutoPostBack="True" Style="text-align:center" OnTextChanged="txtMonthNoGV_TextChanged" Width="70px"></asp:TextBox></ItemTemplate></asp:TemplateField>
                                                    <asp:TemplateField  HeaderText="Day No."><ItemTemplate><asp:TextBox ID="txtDayNoGV" runat="server" 
                                                                Enabled="false" Height="15px" AutoPostBack="true" Style="text-align:center"  OnTextChanged="txtDayNoGV_TextChanged"  Width="65px"></asp:TextBox></ItemTemplate></asp:TemplateField>
                                                    <asp:TemplateField  HeaderText="Week No."><ItemTemplate><asp:TextBox ID="txtWeekNoGV" runat="server" AutoPostBack="True" Style="text-align:center"  OnTextChanged="txtWeekNoGV_TextChanged"
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional"><ContentTemplate><table border="0" style="width:75%; margin:auto"><tr><td  style="font-size:14px;font-weight:bold; width:5%;font-family:'Calibri';color:black;text-align:left;"><asp:TextBox ID="txtLocationId" runat="server" AutoCompleteType="Disabled" BackColor="White" BorderStyle="None" ForeColor="White" Height="16px" style="text-align:right" Width="25%"></asp:TextBox>&nbsp;<asp:TextBox ID="txtSalesman" runat="server" AutoCompleteType="Disabled" BackColor="White" BorderStyle="None" ForeColor="White" Height="16px" style="text-align:right" Width="25%"></asp:TextBox><asp:TextBox ID="txtContractGroupSelected" runat="server" AutoCompleteType="Disabled" BackColor="White" Height="16px" Visible="False" Width="35%"></asp:TextBox></td>
                    ...
                    <td  style="font-size:14px;font-weight:bold; width:5%;font-family:'Calibri';color:black;text-align:left;">
                        <asp:TextBox ID="txtFrequency" runat="server" AutoCompleteType="Disabled" Height="16px" Width="35%" BorderStyle="None" ForeColor="White"></asp:TextBox>
       ...
       <asp:TabPanel ID="TabPanel6" runat="server" HeaderText="Items Issued"><HeaderTemplate><asp:Label ID="lblItemsIssuedCount" runat="server" Font-Size="11px" Text="Items Issued"></asp:Label></HeaderTemplate><ContentTemplate><div style="text-align:center"><h3 style="font-family: Verdana, Geneva, Calibri, sans-serif; font-weight: bold;COLOR:#000099;">Items Issued</h3><table style="width:100%;text-align:center;"><tr><td colspan="2" style="text-align:left;"><asp:Button ID="Button1" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="ADD" Width="100px" Visible="False" /><asp:Button ID="Button2" runat="server" Font-Bold="True" Text="EDIT" Width="100px"  CssClass="roundbutton1" BackColor="#CFC6C0" Visible="False" /><asp:Button ID="Button3" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="DELETE" Width="100px" OnClientClick = "Confirm(); currentdatetime()" Visible="False"/><asp:Button ID="Button4" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="PRINT" Width="100px" Visible="False" /><asp:Button ID="Button5" runat="server" Visible="False"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="CLOSE" Width="100px" /></td></tr><tr><td colspan="2"><br /></td></tr><tr class="Centered"><td colspan="2">
           <asp:GridView ID="gvItemsIssued" runat="server" DataSourceID="sqlDSItemsIssued" OnSelectedIndexChanged="gvItemsIssued_SelectedIndexChanged" OnRowDataBound="gvItemsIssued_RowDataBound" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataKeyNames="ItemId" Font-Size="15px" HorizontalAlign="Center" AllowSorting="True" GridLines="Vertical" ForeColor="#333333" ><AlternatingRowStyle BackColor="White" />
               ...
               <asp:BoundField DataField="ItemID" HeaderText="Item ID" SortExpression="ItemID"><ControlStyle Width="150px" /><HeaderStyle Font-Size="12pt" HorizontalAlign="Left" /><ItemStyle Width="150px" HorizontalAlign="Left" /></asp:BoundField>
               <asp:BoundField DataField="ItemName" HeaderText="Item Name" SortExpression="ItemName"><ControlStyle Width="300px" />
           ...
           <asp:GridView ID="gvItemsIssuedDetail" runat="server" DataSourceID="sqlDSItemsIssuedDetail" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataKeyNames="rcno" Font-Size="15px" HorizontalAlign="Center" AllowSorting="True" GridLines="Vertical" ForeColor="#333333" Width="800 px"><AlternatingRowStyle BackColor="White" />
               <Columns><asp:CommandField HeaderText="Select" ShowHeader="True" ShowSelectButton="True" Visible="False" ><ControlStyle Width="150px" /><ItemStyle Width="150px" /></asp:CommandField>
                   <asp:BoundField DataField="ServiceDate" DataFormatString="{0:dd/MM/yyyy}" HeaderText="ServiceDate" SortExpression="ServiceDate"><ControlStyle Width="150px" /><HeaderStyle Font-Size="12pt" HorizontalAlign="Left" /><ItemStyle Width="150px" HorizontalAlign="Left" /></asp:BoundField>
                   <asp:BoundField DataField="ServiceRecordNo" HeaderText="ServiceRecordNo" SortExpression="ServiceRecordNo"><ControlStyle Width="300px" />
               <HeaderStyle Font-Size="12pt" HorizontalAlign="Left" /><ItemStyle Width="300px" HorizontalAlign="Left" /></asp:BoundField>
               <asp:BoundField DataField="Qty" HeaderText="Qty" />
           ...
           <tr><td colspan="2"><br /></td></tr><tr><td class="CellFormat" style="text-align:right;padding-right:5px;"></td><td class="CellTextBox"><asp:Label ID="lbItemsIssued" runat="server" MaxLength="100" Height="18px" Width="40%" ReadOnly="True" BackColor="#CCCCCC" Visible="False"></asp:Label></td></tr><tr><td class="CellFormat" style="text-align:right;padding-right:5px;">
           &nbsp;</td><td class="CellTextBox">&nbsp;</td></tr><tr><td class="CellFormat" style="text-align:right;padding-right:5px;">&nbsp;</td><td class="CellTextBox">&nbsp;</td></tr><tr><td colspan="2" style="text-align:right"><asp:Button ID="Button6" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="SAVE" Width="100px" OnClientClick="currentdatetime()" Visible="False"/><asp:Button ID="Button7" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="CANCEL" Width="100px" Visible="False" /></td></tr></table>
           <asp:SqlDataSource ID="sqlDSItemsIssued" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>"></asp:SqlDataSource>
           <asp:SqlDataSource ID="sqlDSItemsIssuedDetail" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>"></asp:SqlDataSource>

                                                                                                                                                                                                                                   </div><asp:TextBox ID="TextBox6" runat="server" CssClass="dummybutton"></asp:TextBox><asp:TextBox ID="TextBox7" runat="server" CssClass="dummybutton"></asp:TextBox></ContentTemplate>
     ...
     <asp:TabPanel ID="TabPanel7" runat="server" HeaderText="Rate Schedule"><HeaderTemplate><asp:Label ID="lblRatescheduleCount" runat="server" Font-Size="11px" Text="Schedule of Rate"></asp:Label></HeaderTemplate><ContentTemplate><div style="text-align:center"><h3 style="font-family: Verdana, Geneva, Calibri, sans-serif; font-weight: bold;COLOR:#000099;">Rate Schedule</h3><table style="width:100%;text-align:center;"><tr><td colspan="2" style="text-align:left;"><asp:Button ID="btnAddRateSchedule" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="ADD" Width="100px" /><asp:Button ID="btnEditRateSchedule" runat="server" Font-Bold="True" Text="EDIT" Width="100px"  CssClass="roundbutton1" BackColor="#CFC6C0" /><asp:Button ID="btnDeleteRateSchedule" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="DELETE" Width="100px" OnClientClick = "Confirm(); currentdatetime()"/><asp:Button ID="Button11" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="PRINT" Width="100px" Visible="False" />
      ...
      <asp:TabPanel ID="TabPanel3" runat="server" HeaderText="File Upload"><HeaderTemplate> <asp:Label ID="lblFileUploadCount" runat="server" Font-Size="11px" Text="File Upload"></asp:Label></HeaderTemplate><ContentTemplate><table style="width:100%;height:1000px"><tr><td><table style="text-align:center;width:100%;padding-top:10px;" class="centered"><tr><td class="CellFormat">Contract No.</td><td class="CellTextBox"><asp:Label ID="lblContractNo1" runat="server" BackColor="#CCCCCC" Height="18px" MaxLength="100" ReadOnly="True" Width="50%"></asp:Label></td></tr><tr><td class="CellFormat">Account ID </td><td class="CellTextBox"><asp:Label ID="lblAccountID1" runat="server" BackColor="#CCCCCC" Height="18px" MaxLength="100" ReadOnly="True" Width="50%"></asp:Label></td></tr><tr><td class="CellFormat">Contract Name </td><td class="CellTextBox"><asp:Label ID="lblName1" runat="server" MaxLength="100" Height="18px" Width="50%" ReadOnly="True" BackColor="#CCCCCC"></asp:Label></td></tr><tr><td><asp:TextBox ID="txtDeleteUploadedFile" runat="server" AutoCompleteType="Disabled" AutoPostBack="True" Height="16px" MaxLength="50" style="text-align: left;" Visible="False" Width="5%"></asp:TextBox><br /></td></tr><asp:TextBox ID="txtFileLink" runat="server" AutoCompleteType="Disabled" Height="16px" MaxLength="50" style="text-align: left;" Visible="False" Width="5%"></asp:TextBox><caption><br /></caption>
       ...
       <asp:TabPanel ID="TabPanel5" runat="server" HeaderText="Notes"><HeaderTemplate><asp:Label ID="lblNotesCount" runat="server" Font-Size="11px" Text="Notes"></asp:Label></HeaderTemplate><ContentTemplate><div style="text-align:center"><h3 style="font-family: Verdana, Geneva, Calibri, sans-serif; font-weight: bold;COLOR:#000099;">Notes</h3><table style="width:100%;text-align:center;">
           <tr><td colspan="2" style="text-align:left;"><asp:Button ID="btnAddNotesMaster" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="ADD" Width="100px" /><asp:Button ID="btnEditNotesMaster" runat="server" Font-Bold="True" Text="EDIT" Width="100px"  CssClass="roundbutton1" BackColor="#CFC6C0" /><asp:Button ID="btnDeleteNotesMaster" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="DELETE" Width="100px" OnClientClick = "Confirm(); currentdatetime()"/><asp:Button ID="btn" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="PRINT" Width="100px" Visible="False" /><asp:Button ID="btnQuitNotesMaster" runat="server" Visible="False"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="CLOSE" Width="100px" /></td></tr><tr><td colspan="2"><br /></td></tr>
    ...
    <asp:Panel ID="PnlChSt" runat="server" BackColor="White" Width="45%" Height="62%" BorderColor="#003366" BorderWidth="1" Visible="true" ScrollBars="Auto">
              <br />
               <table border="0" style="width:100%;padding-left:5px; margin-left:auto; margin-right:auto;">
                 <tr>
                     <td style="font-size:18px; font-weight:bold;font-family:Calibri;color:black;text-align:center;"  colspan="4">Change Status</td>
                 </tr>
                   <tr>
                       <td colspan="4" style="font-size:18px; font-weight:bold;font-family:Calibri;color:black;text-align:center;">
                   ...
                   <tr>
                       ...
                       <td colspan="4" style="font-size:18px; font-weight:bold;font-family:Calibri;text-align:left;">
              ...
              <tr>
                   ...
                   <tr>                          
                    ...
                    <tr>
                              ...
                              <td  style="text-align:left;padding-left:5px;width:10%">  
                                    <asp:DropDownList ID="ddlTerminationCode" runat="server" Width="99%" AppendDataBoundItems="true" DataSourceID="SqlDSTerminationCode" DataTextField="TC" DataValueField="TC">
                                 <asp:ListItem>--SELECT--</asp:ListItem>
                                           </asp:DropDownList>
                            </td>
                             </tr>
...
<tr><td colspan="2" style="width:10%;font-size:15px;font-weight:bold;font-family:Calibri;color:black;text-align:left;padding-left:10px;">
     ...
     <asp:ModalPopupExtender ID="ModalPopupNotestemplate" runat="server"  CancelControlID="btnCloseTemplate" PopupControlID="pnlNotesTemplate" TargetControlID="btndummyPrint" BackgroundCssClass="modalBackground"  ></asp:ModalPopupExtender>
         ...
         <%--end--%>
           ...
           <%-- '31.05.22--%>
                ...
                <%-- start: New Method of Contract Revision--%>
         ...
         <%--Add, EDIT Buttons--%>
            ...
            <asp:Panel ID="pnlNCR" runat="server" BackColor="White" Width="75%" Height="95%" BorderColor="#003366" BorderWidth="1px" ScrollBars="Auto">
              

                  <table border="0" style="width:80%; margin:auto; padding-top:0%">
                
                <tr style="width:95%">
                    <td colspan="6" style="text-align:center;color:brown;font-size:16px;font-weight:bold;font-family:'Calibri';">
                    
                    <asp:Label ID="txtSvcModeNCR" runat="server" CssClass="dummybutton" ></asp:Label>  
                    <asp:TextBox ID="txtPopupScrollNCR" runat="server" Enabled="True" Height="0px" MaxLength="25" Width="0px" BorderStyle="None" BorderWidth="0px"></asp:TextBox>
                  </td>
                </tr>

                       <tr>
                             <td colspan="6">
                                 <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">Contract Revision</h4>
                             </td>
                         </tr>
                        <tr>
               <td colspan="6" style="width:100%;text-align:center;color:brown;font-size:18px;font-weight:bold;font-family:'Calibri';"> 
                      <asp:Label ID="lblMessageNCR" runat="server"></asp:Label>
                      </td> 
            </tr>

             <tr>
               <td colspan="6" style="width:100%;text-align:center;font-size:18px;font-weight:bold;font-family:'Calibri';"> 
                      <asp:Label ID="lblAlertNCR" runat="server" BackColor="Red" ForeColor="White"></asp:Label>
                      </td> 
            </tr>

                         <tr>
                             <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:right; color:black; padding-left:1%; width:16%; ">
                                Contract No.
                                </td>
                             <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; "> 
                                 <asp:TextBox ID="txtContractNoNCR" runat="server" Enabled="False" Height="16px" MaxLength="25" Width="95%"></asp:TextBox>
                             </td>
                             <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:right; color:black; padding-left:1%; width:12%;">&nbsp;</td>
                             <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:10%;">&nbsp;</td>
                             <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:right; color:black; padding-left:1%; width:16%;">&nbsp;</td>
                             <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:right; color:black; padding-left:1%; width:15%;">&nbsp;</td>
                         </tr>
                         
                          <tr>
                              <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:right; color:black; padding-left:1%; width:16%; ">Duration </td>
                              <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%; ">
                                  <asp:TextBox ID="txtDurationNCR" runat="server" Enabled="False" Height="16px" MaxLength="25" Width="95%"></asp:TextBox>
                              </td>
                              <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:right; color:black; padding-left:1%; width:12%;">Contract Date </td>
                              <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:10%;">
                                  <asp:TextBox ID="txtContractDateNCR" runat="server" Enabled="False" Height="16px" MaxLength="50" Width="70%"></asp:TextBox>
                              </td>
                              <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:right; color:black; padding-left:1%; width:16%;">Current Agree Value </td>
                              <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:right; color:black; padding-left:1%; width:15%;">
                                  <asp:TextBox ID="txtCurrentAgreeValueNCR" runat="server" Enabled="False" Height="16px" MaxLength="25" style="text-align:right" Width="95%">
                         ...
                         <tr>
                             <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:right; color:black; padding-left:1%; width:19%;" >
                                 Revision Effective Date <asp:Label ID="Label86" runat="server" Font-Size="14px" ForeColor="Red" Text="*"></asp:Label>

                             </td>
                             <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:20%;">
                                 <asp:TextBox ID="txtEffectiveDateNCR" runat="server" AutoCompleteType="Disabled" Height="16px" Width="95%" AutoPostBack="True"></asp:TextBox>
                                      
                                  <asp:CalendarExtender ID="CalendarExtender25" runat="server" Format="dd/MM/yyyy" PopupButtonID="txtEffectiveDateNCR" TargetControlID="txtEffectiveDateNCR" />
                             </td>
                             <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:right; color:black; padding-left:1%; width:12%;">
                                 New Agreed Value<asp:Label ID="Label107" runat="server" Font-Size="14px" ForeColor="Red" Text="*"></asp:Label>
                             </td>
                             <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:10%;">
                                  <asp:TextBox ID="txtAgreeValueNCR" runat="server" AutoCompleteType="Disabled" Height="16px"  MaxLength="100" Width="70%" AutoPostBack="True"></asp:TextBox>
                                  &nbsp;<asp:TextBox ID="txtEditAgreeValuePercChangeNCR" runat="server" AutoCompleteType="Disabled" AutoPostBack="True" Height="16px" MaxLength="100" Width="10%" Visible="False"></asp:TextBox>
                             </td>
                             <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:right; color:black; padding-left:1%; width:15%;" >Last Price Change Date</td>
                             <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:right; color:black; padding-left:1%; width:15%;" >
                                 <asp:TextBox ID="txtLastPriceChangeDateNCR" runat="server" Enabled="False" Height="16px" MaxLength="25" style="text-align:right" Width="95%"></asp:TextBox>
                             </td>
                         </tr>
                        
                         <tr>
                             <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:right; color:black; padding-left:1%; width:19%; ">
                                 Service Instruction</td>
                             <td colspan="3" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; ">
                                  
                                 <asp:TextBox ID="txtServInstNCR" runat="server" Enabled="True" Height="60px" MaxLength="25" TextMode="MultiLine" Width="92%"></asp:TextBox>
                         ...
                         <tr>
                             <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:right; color:black; padding-left:1%; width:19%; ">
                                 Reason of Revision<asp:Label ID="Label108" runat="server" Font-Size="14px" ForeColor="Red" Text="*"></asp:Label>
                                 
                             </td>
                             <td colspan="3" style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; ">
                                  
                                 <asp:TextBox ID="txtRevisionReason" runat="server" Enabled="True" Height="60px" MaxLength="25" TextMode="MultiLine" Width="92%"></asp:TextBox>
                         ...
                         <tr>
                             <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:right; color:black; padding-left:1%; width:17%; ">
                                 <asp:TextBox ID="txtEndDateNCR" runat="server" AutoCompleteType="Disabled" AutoPostBack="False" Height="16px" Width="50%" Visible="False"></asp:TextBox>
                ...
                <tr style="width:85%; text-align: center">
                    <td style="width:17%;text-align:left;">&nbsp;</td>
                    <td style="width:18%;text-align:center;">
                        <asp:Button ID="btnSvcAddNCR" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" OnClientClick="RefreshSubmit();" Text="ADD" Width="75%" />
                    </td>
                <td style="width:16%;text-align:center;"><asp:Button ID="btnSvcEditNCR" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" OnClientClick="RefreshSubmit();" Text="EDIT" Width="90%" /></td>
                <td style="width:16%;text-align:center;">
                    <asp:Button ID="btnSvcDeleteNCR" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="DELETE" OnClientClick="RefreshSubmit();"  Width="90%" />
                    </td>
                     
              
                        <td colspan="1" style="width:13%;text-align:right;vertical-align: middle">
                            <asp:Button ID="btnsvcCloseNCR" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="CLOSE" Width="90%" />
                    </td></tr></table>
                     ...
                     <table border="0" style="width:100%;padding-left:15px">
                        ...
                        <tr>
                         ...
                         <tr>
                             ...
                             <td class="CellTextBox" colspan="9">
 ...
 <table border="0" style="width:95%; text-align:center ">
     ...
     <tr style="width:95%; text-align:center">
       ...
       <td >              
                    <asp:Panel ID="pnlContractDetailNCR" runat="server" BackColor="White" BorderColor="#003366" BorderWidth="1px" Height="100%" ScrollBars="Vertical" Width="100%">
                        
                        <asp:GridView ID="grvContractDetailNCR" runat="server" AllowPaging="True" AllowSorting="True" OnRowDataBound = "OnRowDataBoundNCR" OnSelectedIndexChanged = "OnSelectedIndexChangedNCR" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataKeyNames="ContractNo" DataSourceID="SqlDSContractDetNCR" Font-Size="15px"  HorizontalAlign="center" ForeColor="#333333" GridLines="Vertical" Width="100%">
                            <AlternatingRowStyle BackColor="White" />
                            <Columns><asp:CommandField HeaderText="Select" ShowHeader="True" ShowSelectButton="True" Visible="False">
                                <ControlStyle Width="50px" /><ItemStyle Width="3%" Wrap="False" /></asp:CommandField>
                                <asp:BoundField DataField="LocationId" HeaderText="Location Id" SortExpression="LocationId" >
                                    <ControlStyle Width="13%" /><ItemStyle Width="13%" Wrap="False" />
                                ...
                                <asp:BoundField DataField="TargetDesc" HeaderText="Target Description" SortExpression="TargetDesc" >
                                    <ControlStyle Width="19%" />
                                    <ItemStyle Width="19%" Wrap="False" />
                                ...
                                <asp:BoundField DataField="Rcno" HeaderText="Rcno" InsertVisible="False" ReadOnly="True" SortExpression="Rcno" Visible="False" />
                                <asp:TemplateField HeaderText="Rcno" InsertVisible="False" SortExpression="Rcno" Visible="False">
                                    <EditItemTemplate><asp:TextBox ID="txtRcnoContractDetNCR" runat="server" Text='<%# Bind("Rcno") %>'>

                                                      </asp:TextBox></EditItemTemplate>
                                    
                                    <ItemTemplate><asp:Label ID="lblRcnoContractDetNCR" runat="server" Text='<%# Bind("Rcno") %>'></asp:Label></ItemTemplate>
                            ...
                            <FooterStyle BackColor="#507CD1" ForeColor="White" Font-Bold="True" />
                            <HeaderStyle BackColor="#2461BF" Font-Bold="True" ForeColor="White" Font-Names="Calibri" />
                            <PagerStyle ForeColor="White"  BackColor="#507CD1" />
                            <RowStyle BackColor="#EFF3FB" Font-Names="Calibri" />
                            <SelectedRowStyle BackColor="#00CCFF" Font-Bold="True" ForeColor="#333333" />
                            <SortedAscendingCellStyle BackColor="#F5F7FB" /><SortedAscendingHeaderStyle BackColor="#6D95E1" />
                            <SortedDescendingCellStyle BackColor="#E9EBEF" /><SortedDescendingHeaderStyle BackColor="#4870BE" />
                    ...
                    <asp:SqlDataSource ID="SqlDSContractDetNCR" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>"></asp:SqlDataSource></tr>
                         ...
                         <tr>
                             <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:right; color:black; padding-left:1%; width:20%; ">&nbsp;</td>
                             <td class="CellTextBox" colspan="8">
 ...
 <table border="0" style="width:75%; margin:auto">
     ...
     <tr style="width:95%">
<td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; text-decoration: underline;padding-left:10%; color:#800000; background-color: #C0C0C0;">Service Locations </td></tr>

<tr style="width:95%">
    <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:0%; width:60% ">
<asp:UpdatePanel ID="updpnlLocationNCR" runat="server" UpdateMode="Conditional">

<ContentTemplate>

               <asp:GridView ID="grvServiceLocationNCR" runat="server" AllowSorting="True" 
                      AutoGenerateColumns="False" CellPadding="1" CssClass="table_head_bdr " 
                      GridLines="None" Height="17px" Font-Size="15px"
                      onpageindexchanging="grvServiceLocationNCR_PageIndexChanging" 
                      onrowdatabound="grvServiceLocationNCR_RowDataBound" 
                      OnRowDeleting="grvServiceLocationNCR_RowDeleting" ShowFooter="True" Style="text-align: left" Width="60%">
<Columns>
<asp:TemplateField HeaderText="Location Id">
<ItemTemplate>
<asp:TextBox ID="ddlLocationIdGVNCR" runat="server" Height="19px" width="130px" AutoPostBack="True" OnTextChanged="ddlLocationIdGVNCR_TextChanged">
                    </asp:TextBox>
</ItemTemplate>
</asp:TemplateField>

<asp:TemplateField HeaderText="">
<ItemTemplate><asp:ImageButton ID="BtnLocationNCR" runat="server" CssClass="righttextbox" Height="22px" ImageAlign="Middle" ImageUrl="~/Images/searchbutton.jpg" Width="24px" OnClick="BtnLocationNCR_click" />

</ItemTemplate></asp:TemplateField>

<asp:TemplateField HeaderText="Service Name">
<ItemTemplate>
<asp:TextBox ID="txtServiceNameGVNCR" runat="server" Enabled="false" Height="15px" ReadOnly="true" Width="250px"></asp:TextBox></ItemTemplate></asp:TemplateField>

<asp:TemplateField HeaderText="Service Address">
<ItemTemplate>
<asp:TextBox ID="txtServiceAddressGVNCR" runat="server" Enabled="false" Height="15px" ReadOnly="true" Width="300px"></asp:TextBox></ItemTemplate></asp:TemplateField>

<asp:TemplateField HeaderText="Zone">
<ItemTemplate>
<asp:TextBox ID="txtZoneGVNCR" runat="server" Enabled="false" Height="15px" ReadOnly="true" Width="80px"></asp:TextBox></ItemTemplate></asp:TemplateField>

<asp:TemplateField HeaderText="Location Code">
<ItemTemplate><asp:TextBox ID="txtLocationGroupGVNCR" runat="server" Enabled="false" Height="15px" ReadOnly="true" Width="85px"></asp:TextBox></ItemTemplate></asp:TemplateField>
                                                              
<asp:TemplateField HeaderText="Branch">
<ItemTemplate><asp:TextBox ID="txtBranchGVNCR" runat="server" Enabled="false" Height="15px" ReadOnly="true" Width="85px"></asp:TextBox></ItemTemplate></asp:TemplateField>
                                                            
<asp:TemplateField>
<ItemTemplate>
<asp:TextBox ID="txtContractNoGVNCR" runat="server" Height="15px" Visible="false" Width="5px"></asp:TextBox></ItemTemplate></asp:TemplateField>

<asp:TemplateField>
<ItemTemplate><asp:TextBox ID="txtAccountIdGVNCR" runat="server" Height="15px" Visible="false" Width="5px"></asp:TextBox></ItemTemplate></asp:TemplateField>

<asp:TemplateField><ItemTemplate><asp:TextBox ID="txtRcnoGVNCR" runat="server" Visible="false" Height="15px" Width="15px"></asp:TextBox></ItemTemplate></asp:TemplateField>

<asp:CommandField ButtonType="Image"  DeleteImageUrl="~/Images/delete_icon_color.gif" ShowDeleteButton="False">

<FooterStyle VerticalAlign="Top" /><ItemStyle Height="15px" /></asp:CommandField>

<asp:TemplateField><FooterStyle HorizontalAlign="Left" /><FooterTemplate>

<asp:Button ID="btnAddDetailLocNCR" runat="server" OnClick="btnAddDetailLocNCR_Click" Text="Add New Row" ValidationGroup="VGroup" Visible="false" /></FooterTemplate>

<ItemStyle ForeColor="#507CD1" /></asp:TemplateField></Columns>
...
<Triggers><asp:AsyncPostBackTrigger ControlID="grvServiceLocationNCR" EventName="SelectedIndexChanged" /></Triggers></asp:UpdatePanel>&nbsp;</td></tr>
  ...
  <asp:Panel ID="pnlPopUpLocationNCR" runat="server" BackColor="White" Width="1250px" Height="600px" BorderColor="#003366" BorderWidth="1px"
        HorizontalAlign="Left" ScrollBars="Auto" style="text-align:center; margin-left:auto; margin-right:auto;">

<table style="width:1100px; margin-left:auto; margin-right:auto; "><tr><td style="text-align: center;"><h4 style="color: #000000">Select Location (Contract Revision)</h4></td>
    <td style="text-align: center;">
        &nbsp;</td>
    <td style="width: 1%; text-align: right;">

<asp:ImageButton ID="ImageButton1NCR" runat="server" ImageUrl="~/Images/closebutton.png" Height="27px" Width="30px" /></td></tr></table>

<div style="text-align: center; padding-left: 5px; padding-bottom: 5px;"><br />

    <asp:UpdatePanel ID="UpdatePanel6" runat="server" UpdateMode="Conditional">

<ContentTemplate>
<asp:GridView ID="gvLocationNCR" runat="server" DataSourceID="SqlDSCompanyLocationNCR" 
OnRowDataBound = "OnRowDataBoundgLocNCR" OnSelectedIndexChanged = "OnSelectedIndexChangedgLocNCR" ForeColor="#333333" AutoGenerateColumns="False"
                CellPadding="4" GridLines="None" Width="1100px"  Font-Size="15px" PageSize="20">
...
<ItemStyle Width="45px" /></asp:CommandField>
<asp:BoundField DataField="LocationID" HeaderText="LocationID" SortExpression="LocationID" >

<ControlStyle Width="70px" /><ItemStyle Width="70px" Wrap="False" /></asp:BoundField>
                    
<asp:BoundField DataField="ContractGroup" HeaderText="Contract Group" />

<asp:BoundField DataField="ServiceName" HeaderText="Service Name" SortExpression="ServiceName" >

<HeaderStyle HorizontalAlign="Left" /><ItemStyle Wrap="False" /></asp:BoundField>

<asp:BoundField DataField="Address1" HeaderText="Address" ><HeaderStyle HorizontalAlign="Left" /><ItemStyle Wrap="False" /></asp:BoundField>

<asp:BoundField DataField="AddStreet" HeaderText="Street" ><HeaderStyle HorizontalAlign="Left" /></asp:BoundField>

<asp:BoundField DataField="AddBuilding" HeaderText="Building" ><HeaderStyle HorizontalAlign="Left" /></asp:BoundField>

<asp:BoundField DataField="AddCity" HeaderText="City" ><HeaderStyle HorizontalAlign="Left" /></asp:BoundField>

<asp:BoundField DataField="LocateGRP" HeaderText="Zone" ><HeaderStyle HorizontalAlign="Left" /></asp:BoundField>

<asp:BoundField DataField="ContactPerson" ><HeaderStyle CssClass="dummybutton" /><ItemStyle CssClass="dummybutton" /></asp:BoundField>

<asp:BoundField DataField="ContactPerson2"  ><ControlStyle CssClass="dummybutton" /><HeaderStyle CssClass="dummybutton" /><ItemStyle CssClass="dummybutton" /></asp:BoundField >

<asp:BoundField DataField="Contact1Position" ><ControlStyle CssClass="dummybutton" /><HeaderStyle CssClass="dummybutton" /><ItemStyle CssClass="dummybutton" /></asp:BoundField >

<asp:BoundField DataField="Contact2Position" ><ControlStyle CssClass="dummybutton" /><HeaderStyle CssClass="dummybutton" /><ItemStyle CssClass="dummybutton" /></asp:BoundField >

<asp:BoundField DataField="Telephone" ><ControlStyle CssClass="dummybutton" /><HeaderStyle CssClass="dummybutton" />

<ItemStyle CssClass="dummybutton" /></asp:BoundField >

<asp:BoundField DataField="Telephone2" ><ControlStyle CssClass="dummybutton" /><HeaderStyle CssClass="dummybutton" /><ItemStyle CssClass="dummybutton" /></asp:BoundField >

<asp:BoundField DataField="Fax" ><ControlStyle CssClass="dummybutton" /><HeaderStyle CssClass="dummybutton" /><ItemStyle CssClass="dummybutton" /></asp:BoundField >

<asp:BoundField DataField="Contact2Fax" ><ControlStyle CssClass="dummybutton" /><HeaderStyle CssClass="dummybutton" /><ItemStyle CssClass="dummybutton" /></asp:BoundField >

<asp:BoundField DataField="Contact2Tel" ><ControlStyle CssClass="dummybutton" /><HeaderStyle CssClass="dummybutton" /><ItemStyle CssClass="dummybutton" /></asp:BoundField >

<asp:BoundField DataField="Contact2Tel2" ><ControlStyle CssClass="dummybutton" /><HeaderStyle CssClass="dummybutton" /><ItemStyle CssClass="dummybutton" /></asp:BoundField >

<asp:BoundField DataField="Mobile" ><ControlStyle CssClass="dummybutton" /><HeaderStyle CssClass="dummybutton" /><ItemStyle CssClass="dummybutton" /></asp:BoundField >

<asp:BoundField DataField="Contact2Mobile" ><ControlStyle CssClass="dummybutton" /><HeaderStyle CssClass="dummybutton" /><ItemStyle CssClass="dummybutton" /></asp:BoundField >

<asp:BoundField DataField="Email" ><ControlStyle CssClass="dummybutton" /><HeaderStyle CssClass="dummybutton" /><ItemStyle CssClass="dummybutton" /></asp:BoundField >

<asp:BoundField DataField="Contact2Email" ><ControlStyle CssClass="dummybutton" /><HeaderStyle CssClass="dummybutton" /><ItemStyle CssClass="dummybutton" /></asp:BoundField >

<asp:BoundField DataField="ServiceLocationGroup" HeaderText="Location Code"><HeaderStyle HorizontalAlign="Left" /></asp:BoundField>

<asp:BoundField DataField="AddPostal" HeaderText="Postal" ><HeaderStyle HorizontalAlign="Left" /></asp:BoundField>
               
     <asp:BoundField DataField="Location" HeaderText="Branch" />
                </Columns>

<EditRowStyle BackColor="#999999" /><FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" /><HeaderStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" Font-Names="Calibri" />
...
<asp:SqlDataSource ID="SqlDSCompanyLocationNCR" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>"
                ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>"></asp:SqlDataSource>

<asp:SqlDataSource ID="SqlDSPersonLocationNCR" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>"
                ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>"></asp:SqlDataSource></div>

  </asp:Panel>
   
      <asp:ModalPopupExtender ID="imgBtnService_ModalPopupExtenderNCR" runat="server" BackgroundCssClass="modalBackground" CancelControlID="" PopupControlID="pnlPopUpLocationNCR" TargetControlID="btnDummygvLocationNCR">

    </asp:ModalPopupExtender>
 <asp:Button ID="btnDummygvLocationNCR" runat="server" cssclass="dummybutton" />
                	<%--3.--%>


    <asp:UpdatePanel ID="updnLocationDet1NCR" runat="server" UpdateMode="Conditional">

<ContentTemplate><table border="0" style="width:75%; margin:auto"><tr><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:18%; text-align:right; ">Contact Person-1 </td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:.5%; width:30%; text-align:right; ">
    
    <asp:TextBox ID="txtContactPersonNCR" runat="server"  Width="98%" AutoCompleteType="Disabled" MaxLength="100"></asp:TextBox></td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15%; text-align:right; ">Position </td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:.5%; width:30%; text-align:right; ">

<asp:TextBox ID="txtPositionNCR" runat="server" Height="16px" Width="98%" AutoCompleteType="Disabled" MaxLength="100"></asp:TextBox></td></tr><tr><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:18%; text-align:right; ">Contact No. </td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:.5%; width:30%; text-align:right; ">

<asp:TextBox ID="txtTelephoneNCR" runat="server" Height="16px" Width="98%" AutoCompleteType="Disabled" MaxLength="50"></asp:TextBox></td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15%; text-align:right; ">Fax </td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:.5%; width:30%; text-align:right; ">

<asp:TextBox ID="txtFaxNCR" runat="server" Height="16px" Width="98%" AutoCompleteType="Disabled" MaxLength="50"></asp:TextBox></td></tr><tr><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:18%; text-align:right; ">Contact No.-2 </td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:.5%; width:30%; text-align:right; ">

<asp:TextBox ID="txtTelephone2NCR" runat="server" Height="16px" Width="98%" AutoCompleteType="Disabled" MaxLength="50"></asp:TextBox></td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15%; text-align:right; ">Mobile </td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:.5%; width:30%; text-align:right; ">

<asp:TextBox ID="txtConPerMobileNCR" runat="server"  AutoCompleteType="Disabled" Width="98%" MaxLength="50"></asp:TextBox></td></tr><tr><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:18%; text-align:right; ">Email </td><td colspan="3"  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:.5%; width:30%; text-align:right; ">

<asp:TextBox ID="txtEmail1NCR" runat="server"  AutoCompleteType="Disabled" Width="99%" MaxLength="100"></asp:TextBox></td></tr></table></ContentTemplate></asp:UpdatePanel><br />
                
<asp:UpdatePanel ID="updnLocationDet2NCR" runat="server" UpdateMode="Conditional"><ContentTemplate><table border="0" style="width:75%; margin:auto"><tr><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:18%; text-align:right; ">Contact Person-2 </td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:.5%; width:30%; text-align:right; ">

<asp:TextBox ID="txtContactPerson2NCR" runat="server"  Width="98%" AutoCompleteType="Disabled" MaxLength="100"></asp:TextBox></td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15%; text-align:right; ">Position </td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:.5%; width:30%; text-align:right; ">

<asp:TextBox ID="txtPosition2NCR" runat="server" Height="16px" Width="98%" AutoCompleteType="Disabled" MaxLength="100"></asp:TextBox></td></tr><tr><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:18%; text-align:right; ">Contact No. </td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:.5%; width:30%; text-align:right; ">

<asp:TextBox ID="txtCP2TelephoneNCR" runat="server" Height="16px" Width="98%" AutoCompleteType="Disabled" MaxLength="50"></asp:TextBox></td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15%; text-align:right; ">Fax </td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:.5%; width:30%; text-align:right; ">

<asp:TextBox ID="txtFax2NCR" runat="server"  AutoCompleteType="Disabled" Width="98%" MaxLength="50"></asp:TextBox></td></tr><tr><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:18%; text-align:right; ">Contact No.-2 </td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:.5%; width:30%; text-align:right; ">

<asp:TextBox ID="txtCP2Telephone2NCR" runat="server" Height="16px" Width="98%" AutoCompleteType="Disabled" MaxLength="50"></asp:TextBox></td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:15%; text-align:right; ">Mobile </td><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:.5%; width:30%; text-align:right; ">

<asp:TextBox ID="txtConPerMobile2NCR" runat="server" Height="16px" Width="98%" AutoCompleteType="Disabled" MaxLength="50"></asp:TextBox></td></tr><tr><td  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:1%; width:18%; text-align:right; ">Email </td><td colspan="3"  style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black; padding-left:.5%; width:100%; text-align:right; ">

<asp:TextBox ID="txtEmail2NCR" runat="server"  AutoCompleteType="Disabled" Width="99%" MaxLength="100"></asp:TextBox></td></tr></table></ContentTemplate></asp:UpdatePanel>
        
                        
                <br />

<table border="0" style="width:75%; margin:auto"><tr style="width:95%">
    <td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; text-decoration: underline;padding-left:10%; color:#800000; background-color: #C0C0C0;">Services </td></tr>
    <tr style="width:95%"><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:0%; width:60% ">

<asp:UpdatePanel ID="updpnlServiceNCR" runat="server" UpdateMode="Conditional">

<ContentTemplate><asp:GridView ID="grvServicesNCR" runat="server" AllowSorting="True" 
                                                          AutoGenerateColumns="False" CellPadding="1" CssClass="table_head_bdr " 
                                                          GridLines="None" Height="17px" 
                                                          onpageindexchanging="grvServicesNCR_PageIndexChanging" 
                                                          onrowdatabound="grvServicesNCR_RowDataBound" 
                                                          OnRowDeleting="grvServicesNCR_RowDeleting" ShowFooter="True" Style="text-align: left" Width="50%">

<Columns>
<asp:TemplateField HeaderText="Service Id"><ItemTemplate><asp:DropDownList ID="ddlServiceIdGVNCR" runat="server" AppendDataBoundItems="True" AutoPostBack="True" DataTextField="Descrip1" DataValueField="Descrip1" Height="19px" 
onselectedindexchanged="ddlServiceIdGVNCR_SelectedIndexChanged" width="140px">

<asp:ListItem Text="--SELECT--" Value="--Select--" /></asp:DropDownList></ItemTemplate></asp:TemplateField>

<asp:TemplateField HeaderText="Service Description"><ItemTemplate><asp:TextBox ID="txtServiceDescriptionGVNCR" runat="server" Enabled="false" Height="15px" ReadOnly="true" Width="150px"></asp:TextBox></ItemTemplate></asp:TemplateField>
                                                              
<asp:TemplateField HeaderText="Service Frequency"><ItemTemplate><asp:DropDownList ID="ddlServiceFrequencyGVNCR" runat="server" AppendDataBoundItems="True" Enabled="true"   AutoPostBack="True"  DataTextField="Frequency" DataValueField="Frequency" Height="19px"  Width="185px" onselectedindexchanged="ddlServiceFrequencyGVNCR_SelectedIndexChanged">

<asp:ListItem Text="--SELECT--" Value="--Select--" /></asp:DropDownList></ItemTemplate></asp:TemplateField>

<asp:TemplateField HeaderText="Price Per Service"><ItemTemplate>

<asp:TextBox ID="txtPricePerServiceGVNCR" runat="server" Enabled="true" Visible="true"  Height="15px" ReadOnly="false" Width="75px" Style="text-align:right" ></asp:TextBox></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="Total Svcs.">

<ItemTemplate>

<asp:TextBox ID="txtTotalServicesGVNCR" runat="server" Enabled="false" Height="15px" Style="text-align:center" ReadOnly="true" Width="70px"></asp:TextBox></ItemTemplate></asp:TemplateField>

<asp:TemplateField HeaderText="Completed Svcs."><ItemTemplate><asp:TextBox ID="txtCompletedServicesGVNCR" runat="server" Enabled="false" Height="15px" ReadOnly="true" Width="75px"></asp:TextBox></ItemTemplate></asp:TemplateField>

<asp:TemplateField HeaderText="Bal. Svcs."><ItemTemplate>

<asp:TextBox ID="txtBalanceServicesGVNCR" runat="server" Enabled="false" Height="15px" ReadOnly="true" Width="60px"></asp:TextBox></ItemTemplate></asp:TemplateField>

<asp:TemplateField HeaderText=""><ItemTemplate><asp:DropDownList ID="txtUOMGVNCR" runat="server" AppendDataBoundItems="True" Visible="false"  Enabled="true" Height="19px" ReadOnly="false" Width="75px" Style="text-align:right" ><asp:ListItem Text="--SELECT--" Value="--Select--" /></asp:DropDownList></ItemTemplate></asp:TemplateField>

<asp:TemplateField HeaderText=""><ItemTemplate><asp:TextBox ID="txtAreaGVNCR" runat="server" Enabled="true" Height="15px" Visible="false"  ReadOnly="True" Width="60px" Style="text-align:right" ></asp:TextBox></ItemTemplate></asp:TemplateField><asp:TemplateField><ItemTemplate><asp:TextBox ID="txtNoofIntervalGV" runat="server" Height="15px" Visible="false" Width="2px"></asp:TextBox></ItemTemplate></asp:TemplateField>

<asp:TemplateField><ItemTemplate><asp:TextBox ID="txtNoofSvcIntervalGVNCR" runat="server" Height="15px" Visible="false" Width="2px"></asp:TextBox></ItemTemplate></asp:TemplateField>

<asp:TemplateField><ItemTemplate><asp:TextBox ID="txtContractNoGVNCR" runat="server" Height="15px" Visible="false" Width="2px"></asp:TextBox></ItemTemplate></asp:TemplateField>

<asp:TemplateField><ItemTemplate><asp:TextBox ID="txtAccountIdGVNCR" runat="server" Height="15px" Visible="false" Width="2px"></asp:TextBox></ItemTemplate></asp:TemplateField>

<asp:TemplateField><ItemTemplate><asp:TextBox ID="txtRcnoGVNCR" runat="server" Visible="false" Height="15px" Width="2px"></asp:TextBox></ItemTemplate></asp:TemplateField>

<asp:TemplateField><ItemTemplate><asp:TextBox ID="txtMonthByWhichMonthGVNCR" runat="server" Height="15px" Visible="false" Width="2px"></asp:TextBox></ItemTemplate></asp:TemplateField>

<asp:TemplateField><ItemTemplate><asp:TextBox ID="txtDOWByWhichWeekGVNCR" runat="server" Height="15px" Visible="false" Width="2px"></asp:TextBox></ItemTemplate></asp:TemplateField>

<asp:CommandField ButtonType="Image"  DeleteImageUrl="~/Images/delete_icon_color.gif" ShowDeleteButton="False">

<FooterStyle VerticalAlign="Top" /><ItemStyle Height="15px" /></asp:CommandField><asp:TemplateField><FooterStyle HorizontalAlign="Left" /><FooterTemplate>

<asp:Button ID="btnAddDetailServicesNCR" runat="server" OnClick="btnAddDetailServicesNCR_Click" Text="Add" ValidationGroup="VGroup" Visible="false" /></FooterTemplate><ItemStyle ForeColor="#507CD1" /></asp:TemplateField></Columns>
...
<SelectedRowStyle BackColor="#D1DDF1" Font-Bold="True" ForeColor="#333333" /><PagerStyle BackColor="#2461BF" ForeColor="White" HorizontalAlign="Center" /><HeaderStyle BackColor="#000066" Font-Bold="True" ForeColor="White" /><AlternatingRowStyle BackColor="White" /></asp:GridView></ContentTemplate><Triggers>
    
    <asp:AsyncPostBackTrigger ControlID="grvServicesNCR" EventName="SelectedIndexChanged" /></Triggers>
 ...
 <table border="0" style="width:75%; margin:auto">
     <tr style="width:95%"><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; text-decoration: underline;padding-left:10%; color:#800000; background-color: #C0C0C0;">Service Schedules </td>
         <asp:TextBox ID="txtAccountIdSelectionNCR" runat="server" AutoCompleteType="Disabled" Height="16px" Visible="False" Width="35%"></asp:TextBox>

     </tr>
     <tr style="width:95%"><td style="font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; padding-left:0%; width:60% ">

<asp:UpdatePanel ID="updpnlFreqNCR" runat="server">

<ContentTemplate><asp:GridView ID="grvFreqDetailsNCR" runat="server"
                                                AllowSorting="True" AutoGenerateColumns="False" CellPadding="1" 
                                                GridLines="None" CssClass="table_head_bdr "
                                                ShowFooter="True" Style="text-align: left" Width="45%" Height="20px"
                                                onrowdatabound="grvFreqDetailsNCR_RowDataBound" 
                                                OnRowDeleting="grvFreqDetailsNCR_RowDeleting"  >

<Columns><asp:TemplateField HeaderText="Seq. No."><ItemTemplate>

<asp:TextBox ID="txtSeqNoGVNCR" runat="server" Enabled="false" Height="15px" ReadOnly="true" Style="text-align: center" Width="60px"></asp:TextBox></ItemTemplate></asp:TemplateField>

<asp:TemplateField HeaderText="Freq MTD"><ItemTemplate><asp:DropDownList ID="ddlFreqMTDGVNCR" runat="server" AutoPostBack="True" 
    DataTextField="FreMTD" DataValueField="FreMTD" Height="20px" AppendDataBoundItems="True" 
    width="100px" 

onselectedindexchanged="ddlFreqMTDGVNCR_SelectedIndexChanged"><asp:ListItem Text="--SELECT--" Value="-1" /><asp:ListItem>DAY</asp:ListItem>

<asp:ListItem>DOW</asp:ListItem>
<asp:ListItem>MONTH</asp:ListItem>
<asp:ListItem>DATE</asp:ListItem></asp:DropDownList></ItemTemplate>
</asp:TemplateField><asp:TemplateField  HeaderText="Month No.">
<ItemTemplate><asp:TextBox ID="txtMonthNoGVNCR" runat="server" 
   Enabled="false" Height="15px" AutoPostBack="True" Style="text-align:center" OnTextChanged="txtMonthNoGVNCR_TextChanged" Width="70px"></asp:TextBox></ItemTemplate></asp:TemplateField>

<asp:TemplateField  HeaderText="Day No."><ItemTemplate><asp:TextBox ID="txtDayNoGVNCR" runat="server" Enabled="false" Height="15px" AutoPostBack="true" Style="text-align:center"  OnTextChanged="txtDayNoGVNCR_TextChanged"  Width="65px"></asp:TextBox></ItemTemplate></asp:TemplateField>

<asp:TemplateField  HeaderText="Week No."><ItemTemplate><asp:TextBox ID="txtWeekNoGVNCR" runat="server" AutoPostBack="True" Style="text-align:center"  OnTextChanged="txtWeekNoGVNCR_TextChanged" Enabled="false" Height="15px"   Width="75px"></asp:TextBox></ItemTemplate></asp:TemplateField>
                                                    
  <asp:TemplateField HeaderText="Day of Week"><ItemTemplate><asp:DropDownList ID="ddlWeekDOWGVNCR" runat="server" AutoPostBack="True" 
  DataTextField="WeekDOW" DataValueField="WeekDOW" Height="20px" onselectedindexchanged="ddlWeekDOWGVNCR_SelectedIndexChanged" AppendDataBoundItems="True"
           width="115px" ><asp:ListItem Text="--SELECT--" Value="-1" /><asp:ListItem>MONDAY</asp:ListItem><asp:ListItem>TUESDAY</asp:ListItem><asp:ListItem>WEDNESDAY</asp:ListItem><asp:ListItem>THURSDAY</asp:ListItem><asp:ListItem>FRIDAY</asp:ListItem><asp:ListItem>SATURDAY</asp:ListItem><asp:ListItem style="color:red">SUNDAY</asp:ListItem></asp:DropDownList></ItemTemplate></asp:TemplateField>
                                                    
     <asp:TemplateField HeaderText="Location" Visible="False">

<ItemTemplate><asp:DropDownList ID="ddlLocationGVNCR" runat="server" AutoPostBack="True" Visible="false" 
             DataTextField="Location" DataValueField="Location" Height="20px" AppendDataBoundItems="True"
                            width="150px" ><asp:ListItem Text="--SELECT--" Value="-1" /></asp:DropDownList></ItemTemplate></asp:TemplateField>

<asp:TemplateField HeaderText="Branch ID" Visible="False"><ItemTemplate>

<asp:DropDownList ID="ddlBranchIDGVNCR" runat="server" AutoPostBack="True" Visible="false"
           DataTextField="BranchID" DataValueField="BranchID" Height="20px" AppendDataBoundItems="True" width="150px" >

<asp:ListItem Text="--SELECT--" Value="-1" /></asp:DropDownList></ItemTemplate></asp:TemplateField>

<asp:TemplateField><ItemTemplate><asp:TextBox ID="txtContractNoGVFNCR" runat="server" Height="15px" Visible="false" Width="5px"></asp:TextBox></ItemTemplate></asp:TemplateField>

<asp:TemplateField><ItemTemplate><asp:TextBox ID="txtSourceSQLIDGVFNCR" runat="server" Visible="false" Height="15px" Width="15px"></asp:TextBox></ItemTemplate></asp:TemplateField>

<asp:TemplateField><ItemTemplate><asp:TextBox ID="txtRcnoGVFNCR"  runat="server" Visible="false" Height="15px" Width="15px"></asp:TextBox></ItemTemplate></asp:TemplateField><asp:CommandField ButtonType="Image"  Visible="False"    
                                                        DeleteImageUrl="~/Images/delete_icon_color.gif" 
                                                        ShowDeleteButton="True"><ItemStyle Height="15px" /></asp:CommandField>

<asp:TemplateField><FooterStyle HorizontalAlign="Left" /><FooterTemplate><asp:Button ID="btnAddDetailNCR" runat="server" OnClick="btnAddDetailNCR_Click" Text="Add New Row" ValidationGroup="VGroup" Visible="false" /></FooterTemplate><ItemStyle ForeColor="#507CD1" /></asp:TemplateField></Columns><FooterStyle BackColor="#F7DFB5" Font-Bold="True" ForeColor="White" Height="5px" />

<RowStyle BackColor="#EFF3FB" Height="17px" /><EditRowStyle BackColor="#2461BF" /><SelectedRowStyle BackColor="#D1DDF1" Font-Bold="True" ForeColor="#333333" /><PagerStyle BackColor="#2461BF" ForeColor="White" HorizontalAlign="Center" /><HeaderStyle BackColor="#000066" Font-Bold="True" ForeColor="White" /><AlternatingRowStyle BackColor="White" /></asp:GridView></ContentTemplate>
...
<asp:UpdatePanel ID="updpnlTargetNCR" runat="server"><ContentTemplate>

<asp:GridView ID="grvTargetDetailsNCR" runat="server" AllowSorting="True" 
                   AutoGenerateColumns="False" CellPadding="1" CssClass="table_head_bdr " 
                   GridLines="None" Height="17px" 
                   onpageindexchanging="grvTargetDetailsNCR_PageIndexChanging" 
                   onrowdatabound="grvTargetDetailsNCR_RowDataBound" 
                  OnRowDeleting="grvTargetDetailsNCR_RowDeleting" ShowFooter="True" Style="text-align: left" Width="50%"><Columns>

<asp:TemplateField HeaderText="Target Description"><ItemTemplate>

<asp:DropDownList ID="ddlTargetDescGVNCR" runat="server" AppendDataBoundItems="True" AutoPostBack="True" DataTextField="Descrip1" DataValueField="Descrip1" Height="19px" onselectedindexchanged="ddlTargetDescGVNCR_SelectedIndexChanged" width="250px"><asp:ListItem Text="--SELECT--" Value="-1" /></asp:DropDownList></ItemTemplate></asp:TemplateField>

<asp:TemplateField HeaderText="Target ID"><ItemTemplate><asp:TextBox ID="txtTargtIdGVNCR" runat="server" Enabled="false" Height="15px"  Style="text-align:center" ReadOnly="true" Width="75px"></asp:TextBox></ItemTemplate></asp:TemplateField>

<asp:TemplateField><ItemTemplate><asp:TextBox ID="txtContractNoGVNCR" runat="server" Height="15px" Visible="false" Width="5px"></asp:TextBox></ItemTemplate></asp:TemplateField>

<asp:TemplateField><ItemTemplate><asp:TextBox ID="txtServiceIDGVNCR" runat="server" Height="15px" Visible="false" Width="5px"></asp:TextBox></ItemTemplate></asp:TemplateField>

<asp:TemplateField><ItemTemplate><asp:TextBox ID="txtSourceSQLIDGVNCR" runat="server" Visible="false" Height="15px" Width="15px"></asp:TextBox></ItemTemplate></asp:TemplateField>

<asp:TemplateField><ItemTemplate><asp:TextBox ID="txtRcnoGVNCR" runat="server" Visible="false" Height="15px" Width="15px"></asp:TextBox></ItemTemplate></asp:TemplateField>

<asp:CommandField ButtonType="Image"  DeleteImageUrl="~/Images/delete_icon_color.gif" ShowDeleteButton="True" ><FooterStyle VerticalAlign="Top" /><ItemStyle Height="15px" /></asp:CommandField>

<asp:TemplateField><FooterStyle HorizontalAlign="Left" /><FooterTemplate>

<asp:Button ID="btnAddDetailNCR" runat="server" OnClick="btnAddDetailNCR_Click" Text="Add New Row" ValidationGroup="VGroup" Visible="false" /></FooterTemplate><ItemStyle ForeColor="#507CD1" /></asp:TemplateField></Columns><FooterStyle BackColor="#F7DFB5" Font-Bold="True" ForeColor="White" Height="5px" /><RowStyle BackColor="#EFF3FB" Height="17px" /><EditRowStyle BackColor="#2461BF" /><SelectedRowStyle BackColor="#D1DDF1" Font-Bold="True" ForeColor="#333333" /><PagerStyle BackColor="#2461BF" ForeColor="White" HorizontalAlign="Center" /><HeaderStyle BackColor="#000066" Font-Bold="True" ForeColor="White" /><AlternatingRowStyle BackColor="White" /></asp:GridView></ContentTemplate>

</asp:UpdatePanel>&nbsp;</td></tr><caption><br /><tr style="width:95%"><td style="text-align:right;">

<asp:Button ID="btnSvcSaveNCR" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" OnClientClick="return DoValidationSvcNCR()"  Text="SAVE" Width="10%"></asp:Button>
    <asp:Button ID="btnSvcSaveScheduleNCR" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="SAVE &amp; FINALIZE" Width="20%"  ></asp:Button>
    <asp:Button ID="btnSvcCancelNCR" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="CANCEL" Width="10%"></asp:Button></td></tr></caption>
...
<asp:UpdatePanel ID="UpdatePanel1NCR" runat="server" UpdateMode="Conditional">

<ContentTemplate><table border="0" style="width:75%; margin:auto"><tr><td  style="font-size:14px;font-weight:bold; width:5%;font-family:'Calibri';color:black;text-align:left;">

<asp:TextBox ID="txtLocationIdNCR" runat="server" AutoCompleteType="Disabled" BackColor="White" BorderStyle="None" ForeColor="White" Height="16px" style="text-align:right" Width="15%"></asp:TextBox>&nbsp;

<asp:TextBox ID="txtSalesmanNCR" runat="server" AutoCompleteType="Disabled" BackColor="White" BorderStyle="None" ForeColor="White" Height="16px" style="text-align:right" Width="25%"></asp:TextBox>

<asp:TextBox ID="txtContractGroupSelectedNCR" runat="server" AutoCompleteType="Disabled" BackColor="White" Height="16px" Visible="False" Width="35%"></asp:TextBox></td><td  style="font-size:14px;font-weight:bold; width:5%;font-family:'Calibri';color:black;text-align:left;">

<asp:TextBox ID="txtFrequencyNCR" runat="server" AutoCompleteType="Disabled" Height="16px" Width="35%" BorderStyle="None" ForeColor="White"></asp:TextBox>
                
<asp:TextBox ID="txtBranchNCR" runat="server" AutoCompleteType="Disabled" BorderStyle="None" ForeColor="White" Height="16px" Width="35%"></asp:TextBox>
                </td><td style="font-size:15px;font-weight:bold;font-family:Calibri; color:black; text-align:left; padding-left:1%; width:5% ">

<asp:TextBox ID="txtFrequencyDescNCR" runat="server" AutoCompleteType="Disabled" BackColor="White" Height="16px" Width="35%" Visible="False"></asp:TextBox></td><td style="font-size:14px;font-weight:bold;width:3%;font-family:'Calibri';color:black;text-align:left; ">

<asp:TextBox ID="txtNoofIntervalNCR" runat="server" AutoCompleteType="Disabled" Height="16px" Width="55%" BackColor="White" ReadOnly="True" style="text-align:right" Visible="False"></asp:TextBox></td><td style="font-size:15px;font-weight:bold;font-family:Calibri; color:black; text-align:left; padding-left:1%; width:5% ">

<asp:TextBox ID="txtNoofSvcIntervalNCR" runat="server" AutoCompleteType="Disabled" Height="16px" Width="35%" style="text-align:right" Visible="False"></asp:TextBox></td><td style="font-size:15px;font-weight:bold;font-family:Calibri; color:black; text-align:left; padding-left:1%; width:5% ">

<asp:Label ID="lblIntervalNCR" runat="server" Text=" " Visible="false" ForeColor="Black"></asp:Label>

<asp:TextBox ID="txtZoneNCR" runat="server" AutoCompleteType="Disabled" BackColor="White" Height="16px" ReadOnly="True" style="text-align:right" Visible="False" Width="25%"></asp:TextBox>

<asp:TextBox ID="txtCreatedOnNCR" runat="server" BorderStyle="None" ForeColor="White" Width="50%"></asp:TextBox></td><td>

<asp:TextBox ID="txtServiceNameNCR" runat="server" AutoCompleteType="Disabled" BackColor="White" Height="16px" ReadOnly="True" style="text-align:right" Width="55%" BorderStyle="None" ForeColor="White"></asp:TextBox></td><td>

<asp:TextBox ID="txtServiceAddressNCR" runat="server" AutoCompleteType="Disabled" BackColor="White" Height="16px" ReadOnly="True" style="text-align:right" Visible="False" Width="55%"></asp:TextBox></td><td>

<asp:TextBox ID="txtUOMNCR" runat="server" AutoCompleteType="Disabled" BackColor="White" Height="16px" ReadOnly="True" style="text-align:right" Visible="False" Width="55%"></asp:TextBox></td><td>

<asp:TextBox ID="txtAreaNCR" runat="server" AutoCompleteType="Disabled" BackColor="White" Height="16px" ReadOnly="True" style="text-align:right" Visible="False" Width="55%"></asp:TextBox></td><td style="font-size:15px;font-weight:bold;font-family:Calibri; color:black; text-align:left; padding-left:1%; width:5% ">

<asp:TextBox ID="txtServiceIdNCR" runat="server" AutoCompleteType="Disabled" Height="16px" Width="35%" BorderStyle="None" ForeColor="White"></asp:TextBox></td><td  style="font-size:14px;font-weight:bold;font-family:'Calibri';color:black;text-align:left;">

<asp:TextBox ID="txtServiceDescNCR" runat="server" AutoCompleteType="Disabled" BackColor="White" Height="16px" Width="35%" Visible="False"></asp:TextBox></td><td style="font-size:15px;font-weight:bold;font-family:Calibri; color:black; text-align:left; padding-left:1%; width:5% ">

<asp:TextBox ID="txtNoServiceNCR" runat="server" AutoCompleteType="Disabled" Height="16px" Width="35%" BackColor="White" ReadOnly="True" style="text-align:right" Visible="False"></asp:TextBox></td><td style="font-size:15px;font-weight:bold;font-family:Calibri; color:black; text-align:left; padding-left:1%; width:5% ">

<asp:TextBox ID="txtValuePerServiceNCR" runat="server" AutoCompleteType="Disabled" Height="16px" Width="35%" style="text-align:right" Visible="False" ></asp:TextBox></td><td style="font-size:15px;font-weight:bold;font-family:Calibri; color:black; text-align:left; padding-left:1%; width:5% ">

<asp:TextBox ID="txtServiceNotesNCR" runat="server" AutoCompleteType="Disabled" Height="16px" Width="35%" Visible="False"></asp:TextBox></td><td style="font-size:15px;font-weight:bold;font-family:Calibri; color:black; text-align:left; padding-left:1%; width:5% ">

<asp:TextBox ID="txtRecordAddedNCR" runat="server" AutoCompleteType="Disabled" Height="16px" Width="40%" Visible="False"></asp:TextBox></td><td style="font-size:15px;font-weight:bold;font-family:Calibri; color:black; text-align:left; padding-left:1%; width:5% ">

<asp:TextBox ID="txtMonthByWhichMonthNCR" runat="server" AutoCompleteType="Disabled" Height="16px" style="text-align:right" Width="35%" Visible="False"></asp:TextBox></td><td style="font-size:15px;font-weight:bold;font-family:Calibri; color:black; text-align:left; padding-left:1%; width:5% ">

<asp:TextBox ID="txtDuplicateTargetNCR" runat="server" AutoCompleteType="Disabled" Height="16px" Visible="False" Width="35%"></asp:TextBox></td><td style="font-size:15px;font-weight:bold;font-family:Calibri; color:black; text-align:left; padding-left:1%; width:5% ">

<asp:TextBox ID="txtDOWByWhichWeekNCR" runat="server" AutoCompleteType="Disabled" Height="16px" style="text-align:left" Width="40%" Visible="False"></asp:TextBox></td><td style="font-size:15px;font-weight:bold;font-family:Calibri; color:black; text-align:left; padding-left:1%; width:5% ">

<asp:TextBox ID="txtValueNCR" runat="server" AutoCompleteType="Disabled" Height="16px" Visible="False" Width="40%"></asp:TextBox></td><td style="font-size:15px;font-weight:bold;font-family:Calibri; color:black; text-align:left; padding-left:1%; width:5% ">

<asp:TextBox ID="txtOrigCodeNCR" runat="server" AutoCompleteType="Disabled" Height="16px" Visible="False" Width="20%"></asp:TextBox></td><td style="font-size:15px;font-weight:bold;font-family:Calibri; color:black; text-align:left; padding-left:1%; width:5% ">

<asp:TextBox ID="txtSourceSQLIDNCR" runat="server" AutoCompleteType="Disabled" Height="16px" Visible="False" Width="35%"></asp:TextBox>&#160;

<asp:TextBox ID="txtServiceDescriptionConsNCR" runat="server" AutoCompleteType="Disabled" Height="16px" Visible="False" Width="35%"></asp:TextBox></td><td style="font-size:15px;font-weight:bold;font-family:Calibri; color:black; text-align:left; padding-left:1%; width:5% ">

<asp:TextBox ID="txtTargetDescNCR" runat="server" AutoCompleteType="Disabled" Height="16px" Width="1%" BorderStyle="None" ForeColor="White"></asp:TextBox>

<asp:TextBox ID="txtTargetIdNCR" runat="server" AutoCompleteType="Disabled" Height="16px" Width="1%" BorderStyle="None" ForeColor="White"></asp:TextBox>

<asp:TextBox ID="txtIsPopupNCR" runat="server" AutoCompleteType="Disabled" Height="16px" Visible="False" Width="35%"></asp:TextBox>

<asp:TextBox ID="txtSearchPopupNCR" runat="server" AutoCompleteType="Disabled" Height="16px" Visible="False" Width="35%"></asp:TextBox></td><td style="font-size:15px;font-weight:bold;font-family:Calibri; color:black; text-align:left; padding-left:1%; width:5% ">

<asp:TextBox ID="txtRecordDeletedNCR" runat="server" AutoCompleteType="Disabled" Height="16px" Width="20%" Visible="False"></asp:TextBox>&nbsp;
                                                              

<asp:TextBox ID="txtLocationGroupNCR" runat="server" AutoCompleteType="Disabled" BackColor="White" Height="16px" ReadOnly="True" style="text-align:right" Visible="False" Width="25%"></asp:TextBox></td><td>

<asp:TextBox ID="txtDuplicateFreqNCR" runat="server" AutoCompleteType="Disabled" Height="16px" Visible="False" Width="35%"></asp:TextBox></td></tr>
               ...
               <asp:ModalPopupExtender ID="mdlPopupNCR" runat="server" CancelControlID="btnCancelNCR" PopupControlID="pnlNCR" TargetControlID="btnDummyNCR" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
        <asp:Button ID="btnDummyNCR" runat="server" cssclass="dummybutton" />
                    <%-- 'Paste Code--%>
        ...
        <%-- end:New Method of Contract Revision--%>
                 ...
                 <tr>
                   ...
                   <tr>
                       ...
                       <td colspan="2" style="font-size:18px; font-weight:bold;font-family:Calibri;text-align:center;">
                          ...
                          <%-- <asp:CalendarExtender ID="CalendarExtenderExtendContract" runat="server" Format="dd/MM/yyyy" PopupButtonID="txtEditExtendContract" TargetControlID="txtEditExtendContract" />--%>
       ...
       <%--  end Extend Contract--%>
        ...
        <%-- 12.05.22--%>
           ...
           <%--Edit Warranty Dates--%>
             ...
             <asp:Panel ID="pnlEditWarrantyDates" runat="server" BackColor="White" Width="50%" Height="55%" BorderColor="#003366" BorderWidth="1" Visible="true" ScrollBars="Auto">
              <br />
               <table border="0" style="width:100%;padding-left:25px; margin-left:auto; margin-right:auto;">
                 <tr>
                     <td style="font-size:18px; font-weight:bold;font-family:Calibri;color:black;text-align:center;"  colspan="2">Edit Warranty Dates</td>
                 </tr>
                   <tr>
                       <td colspan="2" style="font-size:18px; font-weight:bold;font-family:Calibri;color:black;text-align:center;">
                           <asp:Label ID="lblMessageEditWarrantyDates" runat="server"></asp:Label>
                       </td>
                   </tr>
                   <tr>
                       ...
                       <td colspan="2" style="font-size:18px; font-weight:bold;font-family:Calibri;text-align:center;">
                           <asp:TextBox ID="txtAlertEditWarrantyDates" runat="server" style="font-size:18px; font-weight:bold;font-family:Calibri;text-align:center;" AutoCompleteType="Disabled" Height="16px" Width="80%" BackColor="Red" BorderStyle="None" ForeColor="White" ></asp:TextBox>
  ...
  <tr>
                              <td style="width:30%; font-size:15px;font-weight:bold;font-family:Calibri;color:black;text-align:left;">
                                  &nbsp;</td>
                              <td colspan="1" style="text-align:left;padding-left:5px;width:70%">
                                  <asp:CalendarExtender ID="CalendarExtender19" runat="server" Format="dd/MM/yyyy" PopupButtonID="txtEditEndDate" TargetControlID="txtEditEndDate" />
                              </td>
                   </tr>
                          ...
                          <tr>
                              <td style="width:30%; font-size:15px;font-weight:bold;font-family:Calibri;color:black;text-align:left;" >
                                  Warranty Start Date</td>
                              <td colspan="1" style="text-align:left;padding-left:5px;width:70%">
                                  <asp:TextBox ID="txtWarrStartEdit" runat="server" AutoCompleteType="Disabled" Height="16px" Width="20%"></asp:TextBox>
                                
                                   <asp:MaskedEditExtender runat="server" ID="MaskedEditExtender4" ClearMaskOnLostFocus="False"
                                         MaskType="Date" Mask="99/99/9999" TargetControlID="txtWarrStartEdit" UserDateFormat="DayMonthYear" Century="2000" CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="" CultureDateFormat="" CultureDatePlaceholder="" CultureDecimalPlaceholder="" CultureThousandsPlaceholder="" CultureTimePlaceholder="" Enabled="True">
                                </asp:MaskedEditExtender>
                                  
                                    <asp:CalendarExtender ID="CalendarExtender24" runat="server" Format="dd/MM/yyyy" PopupButtonID="txtWarrStartEdit" TargetControlID="txtWarrStartEdit" />
                          ...
                          <tr>
                              <td style="width:30%; font-size:15px;font-weight:bold;font-family:Calibri;color:black;text-align:left;">
                                  <asp:Label ID="Label84" runat="server" Text="Warranty End Date"></asp:Label>
                                  &nbsp;<asp:Label ID="Label85" runat="server" Font-Size="14px" ForeColor="Red" Text="*"></asp:Label>
                              </td>
                              <td colspan="1" style="text-align:left;padding-left:5px;width:70%">
                                  <asp:TextBox ID="txtWarrEndEdit" runat="server" AutoCompleteType="Disabled" Height="16px" Width="20%"></asp:TextBox>
                              
                                     <asp:MaskedEditExtender runat="server" ID="MaskedEditExtender5" ClearMaskOnLostFocus="False"
                                         MaskType="Date" Mask="99/99/9999" TargetControlID="txtWarrEndEdit" UserDateFormat="DayMonthYear" Century="2000" CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="" CultureDateFormat="" CultureDatePlaceholder="" CultureDecimalPlaceholder="" CultureThousandsPlaceholder="" CultureTimePlaceholder="" Enabled="True">
                                </asp:MaskedEditExtender>
                                      <asp:CalendarExtender ID="CalendarExtender23" runat="server" Format="dd/MM/yyyy" PopupButtonID="txtWarrEndEdit" TargetControlID="txtWarrEndEdit" />
                          ...
                          <tr>
                               ...
                               <td >
                                   <asp:TextBox ID="TextBox10" runat="server" AutoCompleteType="Disabled" BackColor="White" Height="16px" Width="35%" BorderStyle="None" ForeColor="White"></asp:TextBox>
                                   <br />
                               </td>
                             </tr>
                     ...
                     <tr><td colspan="1" style="text-align:center" >
                             &nbsp;</td>
                             <td style="text-align:left">
                                 <asp:Button ID="btnConfirmEditWarrantyDates" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="Save" Width="100px" OnClientClick="ConfirmChSt()"/>
                                 <asp:Button ID="btnCancelEditWarrantyDates" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="Cancel" Width="100px" />
                             </td>
                         </tr>
     ...
     <asp:ModalPopupExtender ID="mdlPopupEditWarrantyDates" runat="server"  CancelControlID="" PopupControlID="pnlEditWarrantyDates" TargetControlID="btnDummyEditWarrantyDates" BackgroundCssClass="modalBackground"  ></asp:ModalPopupExtender>
                    <asp:Button ID="btnDummyEditWarrantyDates" runat="server" cssclass="dummybutton" />
       ...
       <%--  12.05.22--%>
        ...
        <%-- 01.09.21--%>
           ...
           <%--Start Multiple PO --%>
             ...
             <asp:Panel ID="pnlMultiplePO" runat="server" BackColor="White" Width="55%" Height="75%" BorderColor="#003366" BorderWidth="1" Visible="true" ScrollBars="Auto">
              <br />
               <table border="0" style="width:100%;padding-left:25px; margin-left:auto; margin-right:auto;">
                 <tr>
                     <td style="font-size:18px; font-weight:bold;font-family:Calibri;color:black;text-align:center;"  colspan="2">P.O. Number</td>
                 </tr>
                   <tr>
                       <td colspan="2" style="font-size:18px; font-weight:bold;font-family:Calibri;color:black;text-align:center;">
                           <asp:Label ID="lblMessagePO" runat="server"></asp:Label>
                       </td>
                   </tr>
                   <tr>
                       ...
                       <td colspan="2" style="font-size:18px; font-weight:bold;font-family:Calibri;  color:black;  text-align:center;">
                           <asp:Label ID="lblAlertPO" runat="server" Text="" BackColor="Red" ForeColor="White" Width="99%"></asp:Label>
                        <%--   <asp:CalendarExtender ID="CalendarExtender19" runat="server" Format="dd/MM/yyyy" PopupButtonID="txtEditExtendContract" TargetControlID="txtAlertStatus" />--%>
                                 </td>
                   </tr>
                          ...
                          <tr>
                              <td colspan="2" style="width:30%; font-size:15px;font-weight:bold;font-family:Calibri;color:black;text-align:left;">
                                  <asp:Button ID="btnAddMultiplePO" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="ADD" Width="100px" />
                                <asp:Button ID="btnEditMultiplePO" runat="server" Font-Bold="True" Text="EDIT" Width="100px"  CssClass="roundbutton1" BackColor="#CFC6C0" />
                                <asp:Button ID="btnDeleteMultiplePO" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="DELETE" Width="100px" OnClientClick = "Confirm(); currentdatetime()"/>
                                <asp:Button ID="Button18" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="PRINT" Width="100px" Visible="False" />
                                <asp:Button ID="btnQuitMultiplePO" runat="server" Visible="True"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="CLOSE" Width="100px" />

                              </td>
                              <td colspan="1" style="text-align:left;padding-left:5px;width:70%">&nbsp;</td>
                   </tr>
                  
                         
                          <tr>
                              <td colspan="2" style="width:30%; font-size:15px;font-weight:bold;font-family:Calibri;color:black;text-align:left;">&nbsp;</td>
                              <td colspan="1" style="text-align:left;padding-left:5px;width:70%">&nbsp;</td>
                   </tr>
                  
                         
                          <tr>
                              <td style="width:30%; font-size:15px;font-weight:bold;font-family:Calibri;color:black;text-align:right;">Contract No.: </td>
                              <td style="width:30%; font-size:15px;font-weight:bold;font-family:Calibri;color:black;text-align:left;">
                                  <asp:TextBox ID="txtContractNoPONo" runat="server" Enabled="false" Height="16px" MaxLength="150" style="text-align:left" Width="40%"></asp:TextBox>
                              </td>
                              <td colspan="1" style="text-align:left;padding-left:5px;width:70%">&nbsp;</td>
                   </tr>
                          ...
                          <tr>
                              <td style="width:30%; font-size:15px;font-weight:bold;font-family:Calibri;color:black;text-align:right;">&nbsp;</td>
                              <td style="width:30%; font-size:15px;font-weight:bold;font-family:Calibri;color:black;text-align:left;">&nbsp;</td>
                              <td colspan="1" style="text-align:left;padding-left:5px;width:70%">&nbsp;</td>
                   </tr>
                  
                         
                          <tr>
                              <td colspan="2" style="font-size:15px;font-weight:normal;font-family:Calibri;color:black;text-align:left;">
                                  <asp:GridView ID="grdViewMultiplePO" runat="server" DataSourceID="SqlDSMultiplePO"   AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataKeyNames="Rcno" Font-Size="15px" HorizontalAlign="Center" AllowSorting="True" GridLines="Vertical" ForeColor="#333333" >
               <AlternatingRowStyle BackColor="White" /><Columns><asp:CommandField HeaderText="Select" ShowHeader="True" ShowSelectButton="True" Visible="False" >
                   <ControlStyle Width="150px" />
                   <ItemStyle Width="150px" /></asp:CommandField>
                   <asp:BoundField DataField="StartDate" DataFormatString="{0:dd/MM/yyyy}" HeaderText="Start Date" SortExpression="Notes"><ControlStyle Width="100px" /><HeaderStyle Font-Size="12pt" /><ItemStyle Width="100px" HorizontalAlign="Left" /></asp:BoundField>
                                          <asp:BoundField DataField="EndDate" DataFormatString="{0:dd/MM/yyyy}" HeaderText="End Date" >
                                          <ControlStyle Width="100px" />
                                          <ItemStyle Width="100px" />
                                          </asp:BoundField>
                   <asp:BoundField DataField="PONumber" HeaderText="P.O. Number" SortExpression="PONumber"><ControlStyle Width="500px" /><HeaderStyle Font-Size="12pt" /><ItemStyle Width="500px" HorizontalAlign="Left" /></asp:BoundField>
                   <asp:TemplateField HeaderText="Rcno" InsertVisible="False" SortExpression="Rcno" Visible="False">
                       <EditItemTemplate>
                       <asp:Label ID="Label1" runat="server" Text='<%# Eval("Rcno") %>'></asp:Label></EditItemTemplate><ItemTemplate><asp:Label ID="Label1" runat="server" Text='<%# Bind("Rcno") %>'></asp:Label>
                           </ItemTemplate>
                   ...
                   <asp:BoundField DataField="CreatedOn" DataFormatString="{0:dd/MM/yyyy}" HeaderText="Created On" SortExpression="CreatedOn" /><asp:BoundField DataField="LastModifiedBy" HeaderText="EditedBy" SortExpression="LastModifiedBy" />
                   <asp:BoundField DataField="LastModifiedOn" DataFormatString="{0:dd/MM/yyyy}" HeaderText="EditedOn" SortExpression="LastModifiedOn" /></Columns><EditRowStyle BackColor="#2461BF" /><FooterStyle BackColor="#507CD1" ForeColor="White" Font-Bold="True" /><HeaderStyle BackColor="#2461BF" Font-Bold="True" ForeColor="White" Font-Names="Calibri" /><PagerStyle ForeColor="White" HorizontalAlign="Center" BackColor="#507CD1" /><RowStyle BackColor="#EFF3FB" Font-Names="Calibri" /><SelectedRowStyle BackColor="#00CCFF" Font-Bold="True" ForeColor="#333333" /><SortedAscendingCellStyle BackColor="#F5F7FB" /><SortedAscendingHeaderStyle BackColor="#6D95E1" /><SortedDescendingCellStyle BackColor="#E9EBEF" /><SortedDescendingHeaderStyle BackColor="#4870BE" />

                                                </asp:GridView>
 <asp:SqlDataSource ID="SqlDSMultiplePO" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>"></asp:SqlDataSource>
                              </td>
                   </tr>
                   <tr>
                       <td style="width:30%; font-size:15px;font-weight:bold;font-family:Calibri;color:black;text-align:left;">&nbsp;</td>
                   ...
                   <tr>
                       <td style="width:30%; font-size:15px;font-weight:bold;font-family:Calibri;color:black;text-align:right;">P.O. Start Date
                           <asp:Label ID="Label106" runat="server" Font-Size="14px" ForeColor="Red" Text="*"></asp:Label>
                       </td>
                       <td colspan="1" style="text-align:left;padding-left:5px;width:70%">
                           <asp:TextBox ID="txtContractStartDatePO" runat="server" AutoCompleteType="Disabled" Height="16px" Width="20%"></asp:TextBox>
                           <asp:CalendarExtender ID="CalendarExtender20" runat="server" Format="dd/MM/yyyy" PopupButtonID="txtContractStartDatePO" TargetControlID="txtContractStartDatePO" Enabled="True" />
                       </td>
                   </tr>
                  
                         
                          <tr>
                              <td style="width:30%; font-size:15px;font-weight:bold;font-family:Calibri;color:black;text-align:right;">
                                  P.O. End Date
                               
                                  </td>
                              <td colspan="1" style="text-align:left;padding-left:5px;width:70%">
                                  <asp:TextBox ID="txtContractEndDatePO" runat="server" AutoCompleteType="Disabled" Height="16px" Width="20%"></asp:TextBox>
                                <asp:CalendarExtender ID="CalendarExtender21" runat="server" Format="dd/MM/yyyy" PopupButtonID="txtContractEndDatePO" TargetControlID="txtContractEndDatePO" Enabled="True" />
                                              </td>
                   </tr>
                            ...
                            <tr>
                             <td style="width:30%; font-size:15px;font-weight:bold;font-family:Calibri;color:black;text-align:right;">
                                 P.O. Number
                                    <asp:Label ID="Label50" runat="server" Font-Size="14px" ForeColor="Red" Text="*"></asp:Label>
                             </td>
                             <td colspan="1" style="text-align:left;padding-left:5px;width:70%">
                                    <asp:TextBox ID="txtPONumber" runat="server" Height="16px" MaxLength="150" Width="70%" ></asp:TextBox>
                      </td>
                         </tr>
                          ...
                          <tr>
                               ...
                               <td >
                                   <asp:TextBox ID="TextBox14" runat="server" AutoCompleteType="Disabled" BackColor="White" Height="16px" Width="35%" BorderStyle="None" ForeColor="White"></asp:TextBox>
                                   <br />
                               </td>
                             </tr>
                     ...
                     <tr><td colspan="1" style="text-align:center" >
                             &nbsp;</td>
                             <td style="text-align:left">
                                 <asp:Button ID="btnSaveMultiplePO" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="SAVE" Width="100px" OnClientClick="ConfirmChSt()"/>
                                 <asp:Button ID="btnCancelMultiplePO" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="CANCEL" Width="100px" />
                             </td>
                         </tr>
     ...
     <asp:ModalPopupExtender ID="mdlMultiplePO" runat="server"  CancelControlID="" PopupControlID="pnlMultiplePO" TargetControlID="btnDummyMultiplePO" BackgroundCssClass="modalBackground"  ></asp:ModalPopupExtender>
                    <asp:Button ID="btnDummyMultiplePO" runat="server" cssclass="dummybutton" />
       ...
       <%--  01.09.21--%>
            ...
            <asp:Panel ID="pnlContractGroupDistribution" runat="server" BackColor="White" Width="65%" Height="85%" BorderColor="#003366" BorderWidth="1px" ScrollBars="Auto">
              
                     <table border="0" style="width:100%;padding-left:10px">
                         <tr>
                             <td colspan="6" >
                                 <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">Contract Group Distribution</h4>
                             </td>
                         </tr>
                          <tr>
               <td colspan="6" style="width:100%;text-align:center;color:brown;font-size:18px;font-weight:bold;font-family:'Calibri';"> 
             ...
             <tr>
               <td colspan="6" style="width:100%;text-align:center;font-size:18px;font-weight:bold;font-family:'Calibri';"> 
                      <asp:Label ID="lblAlertContractGroupDistribution" runat="server" BackColor="Red" ForeColor="White"></asp:Label>
                            ...
                            <tr style="padding-top:40px;">
                             <td class="CellFormat" style="text-align:right; width:10%">&nbsp;</td>
                         ...
                         <tr style="padding-top:40px;">
                             <td class="CellFormat" style="text-align:left; " colspan="5">
                                 <asp:Button ID="btnAddDistribution" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="ADD" Width="100px" OnClientClick="RefreshSubmit();" />
                                 &nbsp;
                                 <asp:Button ID="btnEditDistribution" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="EDIT" OnClientClick="RefreshSubmit();"  Width="100px" />

                                      <asp:Button ID="btnDeleteDistribution" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" OnClientClick="RefreshSubmit();"  Text="VOID" Width="100px" />&nbsp;<asp:Button ID="btnCloseDistribution" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="CLOSE" Width="100px" />
                             </td>
                         ...
                         <tr style="padding-top:40px;">
                             ...
                             <td style="text-align:center;width:20%">
                                 &nbsp;</td>
                             <td class="CellFormat" style ="text-align:center;width:10%">&nbsp;</td>
                             <td class="CellFormat" style="text-align:center;width:15%">&nbsp;</td>
                             <td class="CellFormat" style="text-align:center;width:10%">&nbsp;</td>
                             <td style="text-align:center;width:15%">
                                 &nbsp;</td>                            
                         </tr>
                         <tr style="padding-top:40px;">
                             <td class="CellFormat" style="text-align:left; width:10%">Contract No.</td>
                             <td style="text-align:left;width:20%">
                                 <asp:TextBox ID="txtContractNoDistribution" runat="server" Enabled="false" Height="16px" MaxLength="150" style="text-align:left" Width="95%"></asp:TextBox>
                             </td>
                             <td class="CellFormat" style="text-align:left; width:10%">Date of Latest Price History</td>
                             <td style="text-align:left;width:20%">
                                    <asp:TextBox ID="txtLatestPriceHistoryDate" runat="server" Enabled="false" Height="16px" MaxLength="150" style="text-align:right" Width="85%"></asp:TextBox>
                             
                             </td>
                             <td class="CellFormat" style="text-align:right;width:10%">Agreed Value</td>
                             <td style="text-align:left;width:15%">
                                 <asp:TextBox ID="txtTotalAgreedValueDistribution" runat="server" Enabled="false" Height="16px" MaxLength="150" style="text-align:right" Width="90%"></asp:TextBox>
                             </td>
                         </tr>
                         <tr style="padding-top:40px;">
                             <td  style="font-size:15px;font-weight:normal;font-family:Calibri;color:black;text-align:left;" colspan="6">
                                 <asp:GridView ID="grdViewDistributionSummary" runat="server" AllowSorting="True" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataKeyNames="Rcno" DataSourceID="SqlDSDistributionSummary" Font-Size="15px" ForeColor="#333333" GridLines="Vertical" HorizontalAlign="Center">
                                     <AlternatingRowStyle BackColor="White" />
                                     <Columns>
                                         <asp:CommandField HeaderText="Select" ShowHeader="True" ShowSelectButton="True" Visible="False">
                                         <ControlStyle Width="150px" />
                                         ...
                                         <asp:BoundField DataField="DistributionDate" DataFormatString="{0:dd/MM/yyyy}" HeaderText="Date" SortExpression="">
                                         <ControlStyle Width="100px" />
                                         <HeaderStyle Font-Size="12pt" />
                                         <ItemStyle HorizontalAlign="Left" Width="100px" />
                                         </asp:BoundField>
                                         <asp:BoundField DataField="DistributionSummary" HeaderText="Summary">
                                         <ControlStyle Width="1500px" />
                                         <HeaderStyle Font-Size="12pt" />
                                         <ItemStyle HorizontalAlign="Left" Width="1500px" />
                                         </asp:BoundField>
                                         <asp:TemplateField HeaderText="Rcno" InsertVisible="False" SortExpression="Rcno" Visible="False">
                                             <EditItemTemplate>
                                                 <asp:Label ID="LabelDist" runat="server" Text='<%# Eval("Rcno") %>'></asp:Label>
                                             </EditItemTemplate>
                                             <ItemTemplate>
                                                 <asp:Label ID="LabelDist" runat="server" Text='<%# Bind("Rcno") %>'></asp:Label>
                                             </ItemTemplate>
                                         </asp:TemplateField>
                         ...
                         <tr style="padding-top:40px;">
                             <td class="CellFormat" style="text-align:right; width:10%">
                                 <asp:SqlDataSource ID="SqlDSDistributionSummary" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>"></asp:SqlDataSource>
                             </td>
                         ...
                         <tr style="padding-top:40px;">
                             ...
                             <td class="CellFormat" style="text-align:left; width:20%"> 
                                    <asp:UpdatePanel ID="updPanelDistribution" runat="server" UpdateMode="Conditional"><ContentTemplate>
                                 <asp:TextBox ID="txtDistributionDate" runat="server" Enabled="false" Height="16px" MaxLength="150" style="text-align:left" Width="88%" AutoPostBack="True"></asp:TextBox>
                                 <asp:Label ID="Label78" runat="server" Font-Size="14px" ForeColor="Red" Text="*"></asp:Label>


                            <asp:MaskedEditExtender runat="server" ID="MaskedEditExtender3" ClearMaskOnLostFocus="False"
                                         MaskType="Date" Mask="99/99/9999"  TargetControlID="txtDistributionDate" UserDateFormat="DayMonthYear" Century="2000" CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="" CultureDateFormat="" CultureDatePlaceholder="" CultureDecimalPlaceholder="" CultureThousandsPlaceholder="" CultureTimePlaceholder="" Enabled="True">
                                </asp:MaskedEditExtender>
                                    <asp:CalendarExtender ID="CalendarExtender22" runat="server"  Enabled="True"  Format="dd/MM/yyyy" PopupButtonID="txtDistributionDate"  TargetControlID="txtDistributionDate">
                                    </asp:CalendarExtender>
                                    </ContentTemplate>
                                     </asp:UpdatePanel>
                             ...
                             <td class="CellFormat" style="text-align:left; width:15%">&nbsp;</td>
                             <td class="CellFormat" style="text-align:left; width:10%">
                 ...
                 <table border="0" style="width:100%;padding-left:10px">       
                                              ...
                                              <asp:GridView ID="grvContractGroupDistributionDetails" runat="server" AllowSorting="True" AutoGenerateColumns="False" CellPadding="1" CssClass="table_head_bdr " GridLines="None" Height="17px" onpageindexchanging="grvContractGroupDistributionDetails_PageIndexChanging" onrowdatabound="grvContractGroupDistributionDetails_RowDataBound" OnRowDeleting="grvContractGroupDistributionDetails_RowDeleting" ShowFooter="True" HorizontalAlign="Center" Style="text-align: left" Width="50%">
                                                  <Columns>
                                                      ...
                                                      <asp:TemplateField HeaderText="Percentage">
                                                          <ItemTemplate>
                                                              <asp:TextBox ID="txtPercContractGroupDistributionGV" runat="server" Enabled="true" Height="15px" ReadOnly="false" AutoPostBack="True" OnTextChanged="txtPercContractGroupDistributionGV_TextChanged" Style="text-align:center" Width="75px"></asp:TextBox>
                                                          </ItemTemplate>
                                                      </asp:TemplateField>

                                                        <asp:TemplateField HeaderText="Value">
                                                          <ItemTemplate>
                                                              <asp:TextBox ID="txtCalculatedValueGV" runat="server" Enabled="False" Height="15px" ReadOnly="false" AutoPostBack="False"  Style="text-align:center" Width="75px"></asp:TextBox>
                                                          </ItemTemplate>
                                                      </asp:TemplateField>

                                                      <asp:TemplateField>
                                                          <ItemTemplate>
                                                              <asp:TextBox ID="txtContractNoContractGroupDistributionGV" runat="server" Height="15px" Visible="false" Width="2px"></asp:TextBox>
                                                          </ItemTemplate>
                                                      </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField>
                                                          <ItemTemplate>
                                                              <asp:TextBox ID="txtDistibutionDateGV" runat="server" Height="15px" Visible="false" Width="2px"></asp:TextBox>
                                                          </ItemTemplate>
                                                      </asp:TemplateField>

                                                      <asp:TemplateField>
                                                          <ItemTemplate>
                                                              <asp:TextBox ID="txtRcnoContractGroupDistributionGV" runat="server" Height="15px" Visible="false" Width="2px"></asp:TextBox>
                                                          </ItemTemplate>
                                                      </asp:TemplateField>

                                                         <asp:TemplateField>
                                                          <ItemTemplate>
                                                              <asp:TextBox ID="txtNeworExistingGV" runat="server" Height="15px" Visible="true" cssclass="dummybutton" Text="N"  Width="10px"></asp:TextBox>
                                                          </ItemTemplate>
                                                      </asp:TemplateField>
                            ...
                            <tr style="padding-top:40px;">
                             <td class="CellFormat" style="text-align:right; width:36%">Total Percentage
                                </td>
                                <td style="text-align:center;width:35%"><asp:TextBox ID="txtTotalPercent" runat="server" Height="16px" MaxLength="150" Enabled="false" style="text-align:right" Width="28%"></asp:TextBox> 
                                    <asp:Label ID="Label79" runat="server" Font-Size="14px" ForeColor="Black" Text="%"></asp:Label>
                                </td>
                                <td style="text-align:center;width:10%">&nbsp;</td>
                                <td style="text-align:center;width:10%">&nbsp;</td>
                         </tr>
                         ...
                         <tr style="padding-top:40px;">
                             <td colspan="4" style="text-align:center">
                                 <asp:Button ID="btnSaveContractGroupDistribution" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" OnClientClick="return dovalidationdistribution()" Text="SAVE" Width="120px" />
               ...
               <asp:ModalPopupExtender ID="mdlContractGroupDistribution" runat="server" CancelControlID="" PopupControlID="pnlContractGroupDistribution" TargetControlID="btnDummyContractGroupDistribution" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
...
<ContentTemplate>    
     ...
     <asp:ModalPopupExtender ID="ModalPopupNotestemplateGrid" runat="server"  CancelControlID="btnCloseNotesTemplateGrid" PopupControlID="pnlNotesTemplateGrid" TargetControlID="ImageButton5" BackgroundCssClass="modalBackground"  ></asp:ModalPopupExtender>
      ...
      <%--   06.09--%>
           <%--Confirm Zeo value--%>
                 ...
                 <asp:Panel ID="pnlZeroValueNCR" runat="server" BackColor="White" Width="400px" Height="130px" BorderColor="#003366" BorderWidth="1px" ScrollBars="Auto">
          
         <table border="0" style="font-family: Calibri; font-size: 15px; font-weight: bold; color: white;text-align:left;padding-left:2px;">
              <tr style="background-color:navy; color:white;font-size:medium">
                      <td style="font-family: Calibri; font-size: 17px; font-weight: bold; color: white;text-align:center">
                         
                          <asp:Label ID="Label10NCR" runat="server" Text="ZERO VALUE CONTRACT (CONTRACT REVISION)"></asp:Label>
               ...
               <tr>
                      <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          &nbsp;<asp:Label ID="Label11NCR" runat="server" Text="Agreed Value is set to ZERO, Do you wish to confirm?"></asp:Label>
                            ...
                            <tr style="padding-top:40px;">
                             <td colspan="2" style="text-align:center"><asp:Button ID="btnZeroValueYesNCR" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="Yes" Width="100px"/>
                                 <asp:Button ID="btnZeroValueNoNCR" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="No" Width="100px" OnClientClick="return RefreshSubmit()" />
                               </td>
                         </tr>                       
        </table>
      ...
      <asp:ModalPopupExtender ID="mdlPopupZeroValueNCR" runat="server" CancelControlID="" PopupControlID="pnlZeroValueNCR" TargetControlID="btnZeroValueNCR" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
         <asp:Button ID="btnZeroValueNCR" runat="server" CssClass="dummybutton" />
                          ...
                          &nbsp;<asp:Label ID="LabelServiceID" runat="server" Text="Contract Group and Service ID do not match."></asp:Label>
                            ...
                            <tr style="padding-top:40px;">
                             <td style="text-align:center"><asp:Button ID="btnDiffContGrpYes" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="Yes" Width="100px"/>
                                 <asp:Button ID="btnDiffContGrpNo" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="No" Width="100px" OnClientClick="RefreshSubmit();"/>
                               </td>
                         </tr>                       
        </table>
      ...
      <asp:ModalPopupExtender ID="mdlPopupServiceID" runat="server" CancelControlID="btnDiffContGrpNo" PopupControlID="pnlServiceID" TargetControlID="btnDummyServiceID" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
         <asp:Button ID="btnDummyServiceID" runat="server" CssClass="dummybutton" />
            ...
            <%-- Start: Confirm Different Contract Group and Service ID in NCR--%>
                                              
                 <asp:Panel ID="pnlServiceIDNCR" runat="server" BackColor="White" Width="400px" Height="150px" BorderColor="#003366" BorderWidth="1px" ScrollBars="Auto">
          
         <table border="0" style="font-family: Calibri; font-size: 15px; font-weight: bold; color: white;text-align:left;padding-left:2px;">
              <tr style="background-color:navy; color:white;font-size:medium">
                      <td style="font-family: Calibri; font-size: 17px; font-weight: bold; color: white;text-align:center">
                         
                          <asp:Label ID="Label2ServiceIDNCR" runat="server" Text="DIFFERENT CONTRACT GROUP AND SERVICE ID (REV)"></asp:Label>
               ...
               <tr>
                      <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          &nbsp;<asp:Label ID="LabelServiceIDNCR" runat="server" Text="Contract Group and Service ID do not match."></asp:Label>
                        
                      </td>
                           </tr>
                            <tr>
                             <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                                 <asp:Label ID="LabelServiceID0NCR" runat="server" Text="Do you wish to proceed and save the record?"></asp:Label>
                                </td>
                         </tr>
                            <tr>
                             <td>
                            ...
                            <tr style="padding-top:40px;">
                             <td style="text-align:center"><asp:Button ID="btnDiffContGrpYesNCR" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="Yes" Width="100px"/>
                                 <asp:Button ID="btnDiffContGrpNoNCR" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="No" Width="100px" OnClientClick="RefreshSubmit();" />
                               </td>
                         </tr>                       
        </table>
      ...
      <asp:ModalPopupExtender ID="mdlPopupServiceIDNCR" runat="server" CancelControlID="btnDiffContGrpNoNCR" PopupControlID="pnlServiceIDNCR" TargetControlID="btnDummyServiceIDNCR" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
         <asp:Button ID="btnDummyServiceIDNCR" runat="server" CssClass="dummybutton" />

             <%-- End:  Confirm Different Contract Group and Service ID in NCR--%>
                          ...
                          <asp:Label ID="Label17Schdl" runat="server" Text="Contract Group and Service ID do not match."></asp:Label>
                            ...
                            <tr style="padding-top:40px;">
                             <td style="text-align:center"><asp:Button ID="btnDiffContGrpYesSchdl" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="Yes" Width="100px"/>
                                 <asp:Button ID="btnDiffContGrpNoSchdl" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="No" Width="100px" OnClientClick="RefreshSubmit();"/>
                               </td>
                         </tr>                       
        </table>
      ...
      <asp:ModalPopupExtender ID="mdlPopupServiceIDSchdl" runat="server" CancelControlID="btnDiffContGrpNoSchdl" PopupControlID="pnlServiceIDSchdl" TargetControlID="btnDummyServiceIDSchdl" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
        ...
        <%-- '22.02.23--%>
            ...
            <%--Start: Schedule: Confirm Different Contract Group and Service ID (NCR)--%>
                                              
                 <asp:Panel ID="pnlServiceIDSchdlNCR" runat="server" BackColor="White" Width="400px" Height="150px" BorderColor="#003366" BorderWidth="1px" ScrollBars="Auto">
          
         <table border="0" style="font-family: Calibri; font-size: 15px; font-weight: bold; color: white;text-align:left;padding-left:2px;">
              <tr style="background-color:navy; color:white;font-size:medium">
                      <td style="font-family: Calibri; font-size: 17px; font-weight: bold; color: white;text-align:center">
                         
                          <asp:Label ID="Label2SchdlNCR" runat="server" Text="DIFFERENT CONTRACT GROUP AND SERVICE ID (Rev)"></asp:Label>
               ...
               <tr>
                      <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          <asp:Label ID="Label17SchdlNCR" runat="server" Text="Contract Group and Service ID do not match."></asp:Label>
                        
                      </td>
                           </tr>
                            <tr>
                              <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                                               <asp:Label ID="Label17Schdl0NCR" runat="server" Text="Do you wish to proceed and save the record?"></asp:Label>
                            ...
                            <tr style="padding-top:40px;">
                             <td style="text-align:center"><asp:Button ID="btnDiffContGrpYesSchdlNCR" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="Yes" Width="100px"/>
                                 <asp:Button ID="btnDiffContGrpNoSchdlNCR" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="No" Width="100px" OnClientClick="RefreshSubmit();"/>
                               </td>
                         </tr>                       
        </table>
      ...
      <asp:ModalPopupExtender ID="mdlPopupServiceIDSchdlNCR" runat="server" CancelControlID="btnDiffContGrpNoSchdlNCR" PopupControlID="pnlServiceIDSchdlNCR" TargetControlID="btnDummyServiceIDSchdlNCR" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
         <asp:Button ID="btnDummyServiceIDSchdlNCR" runat="server" CssClass="dummybutton" />

             <%-- End: Schedule: Confirm Different Contract Group and Service ID (NCR)--%>

        <%-- '22.02.23--%>


          <%--Start: Close/Cancel: New Contract Revision--%>
                                              
                 <asp:Panel ID="pnlCancelNCR" runat="server" BackColor="White" Width="400px" Height="150px" BorderColor="#003366" BorderWidth="1px" ScrollBars="Auto">
          
         <table border="0" style="font-family: Calibri; font-size: 15px; font-weight: bold; color: white;text-align:left;padding-left:2px;">
              <tr style="background-color:navy; color:white;font-size:medium">
                      <td style="font-family: Calibri; font-size: 17px; font-weight: bold; color: white;text-align:center">
                         
                          <asp:Label ID="Label87" runat="server" Text="CANCEL CONTRACT REVISION?"></asp:Label>
               ...
               <tr>
                      <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          <asp:Label ID="lblCancelContractRevisionNCR1" runat="server" Text="This contract revision will be cancelled and all data entered"></asp:Label>
                        
                      </td>
                           </tr>
                            <tr>
                              <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                                               <asp:Label ID="lblCancelContractRevisionNCR2" runat="server" Text=" will be discarded. Do you wish to CANCEL?"></asp:Label>
                            ...
                            <tr style="padding-top:40px;">
                             <td style="text-align:center"><asp:Button ID="btnCancelYesNCR" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="Yes" Width="100px"/>
                                 <asp:Button ID="btnCancelNoNCR" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="No" Width="100px" OnClientClick="return RefreshSubmit()"/>
                               </td>
                         </tr>                       
        </table>
      ...
      <asp:ModalPopupExtender ID="mdlPopupCancelNCR" runat="server" CancelControlID="btnCancelNoNCR" PopupControlID="pnlCancelNCR" TargetControlID="btnDummyCancelNCR" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
         <asp:Button ID="btnDummyCancelNCR" runat="server" CssClass="dummybutton" />

             <%-- End:  Close/Cancel: New Contract Revision--%>
              ...
              <%--Start: Finalise: New Contract Revision--%>
                                              
                 <asp:Panel ID="pnlFinaliseNCR" runat="server" BackColor="White" Width="400px" Height="150px" BorderColor="#003366" BorderWidth="1px" ScrollBars="Auto">
          
         <table border="0" style="font-family: Calibri; font-size: 15px; font-weight: bold; color: white;text-align:left;padding-left:2px;">
              <tr style="background-color:navy; color:white;font-size:medium">
                      <td style="font-family: Calibri; font-size: 17px; font-weight: bold; color: white;text-align:center">
                         
                          <asp:Label ID="Label88" runat="server" Text="FINALISE CONTRACT REVISION?"></asp:Label>
               ...
               <tr>
                      <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          <asp:Label ID="lblFinaliseContractRevisionNCR1" runat="server" Text="Do you wish to finalise this contract revision? "></asp:Label>
                        
                      </td>
                           </tr>
                            <tr>
                              <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                                               <asp:Label ID="lblFinaliseContractRevisionNCR2" runat="server" Text=""></asp:Label>
                            ...
                            <tr style="padding-top:40px;">
                             <td style="text-align:center"><asp:Button ID="btnFinaliseYesNCR" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="Yes" Width="100px" />
                                 <asp:Button ID="btnFinaliseNoNCR" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="No" Width="100px" />
                               </td>
                         </tr>                       
        </table>
      ...
      <asp:ModalPopupExtender ID="mdlPopupFinaliseNCR" runat="server" CancelControlID="btnFinaliseNoNCR" PopupControlID="pnlFinaliseNCR" TargetControlID="btnDummyFinaliseNCR" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
         <asp:Button ID="btnDummyFinaliseNCR" runat="server" CssClass="dummybutton" />

             <%-- End:  Finalise: New Contract Revision--%>
     ...
     <tr>
              ...
              <tr style="background-color:navy; color:white;font-size:medium">
               ...
               <tr>
                      <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          &nbsp;<asp:Label ID="Label35" runat="server" Text="The Duration Type in the Contract Group master "></asp:Label>
                ...
                <tr>
                      <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          &nbsp;<asp:Label ID="Label36" runat="server" Text="must be configured first to be able to proceed."></asp:Label>
      ...
      <asp:ModalPopupExtender ID="mdlDurationType" runat="server" CancelControlID="" PopupControlID="pnlDurationType" TargetControlID="btnDummyDurationType" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
         <asp:Button ID="btnDummyDurationType" runat="server" CssClass="dummybutton" />
             ...
             <%-- End: Duration in Contract Group--%>
                    ...
                    <%--Start: Due for Extension --%>
                                              
                 <asp:Panel ID="pnlDueForExtension" runat="server" BackColor="White" Width="450px" Height="150px" BorderColor="#003366" BorderWidth="1px" ScrollBars="Auto">
          
         <table border="0" style="font-family: Calibri; font-size: 15px; font-weight: bold; color: white;text-align:left;padding-left:2px;">
              <tr style="background-color:navy; color:white;font-size:medium">
                      <td style="font-family: Calibri; font-size: 17px; font-weight: bold; color: white;text-align:center">
                         
                          <asp:Label ID="lblDueForExtension" runat="server" Text="DUE FOR RENEWAL"></asp:Label>
               ...
               <tr>
                      <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          &nbsp;<asp:Label ID="Label37" runat="server" Text="REMINDER: The NEW SCHEDULE of this contract is due to be generated."></asp:Label>
                ...
                <tr>
                      <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          &nbsp;<asp:Label ID="Label38" runat="server" Text="Please review and generate as needed.."></asp:Label>
                            ...
                            <tr style="padding-top:40px;">
                             <td colspan="2" style="text-align:center"><asp:Button ID="Button14" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="OK" Width="100px"/>
                               </td>
                         </tr>                       
        </table>
      ...
      <asp:ModalPopupExtender ID="mdlDueForExtension" runat="server" CancelControlID="" PopupControlID="pnlDueForExtension" TargetControlID="btnDummyDueForExtension" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
         <asp:Button ID="btnDummyDueForExtension" runat="server" CssClass="dummybutton" />

             <%-- End: Due for Extension--%>



                     <%--Start: Past Due for Extension --%>
                                              
                 <asp:Panel ID="pnlPastDueForExtension" runat="server" BackColor="White" Width="450px" Height="150px" BorderColor="#003366" BorderWidth="1px" ScrollBars="Auto">
          
         <table border="0" style="font-family: Calibri; font-size: 15px; font-weight: bold; color: white;text-align:left;padding-left:2px;">
              <tr style="background-color:navy; color:white;font-size:medium">
                      <td style="font-family: Calibri; font-size: 17px; font-weight: bold; color: white;text-align:center">
                         
                          <asp:Label ID="lblPastDuration" runat="server" Text="PAST DUE FOR RENEWAL"></asp:Label>
               ...
               <tr>
                      <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          &nbsp;<asp:Label ID="Label41" runat="server" Text="REMINDER: There are no more scheduled jobs for this contract."></asp:Label>
                ...
                <tr>
                      <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          &nbsp;<asp:Label ID="Label42" runat="server" Text="Please review and generate a new set of schedule."></asp:Label>
                            ...
                            <tr style="padding-top:40px;">
                             <td colspan="2" style="text-align:center"><asp:Button ID="Button16" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="OK" Width="100px"/>
                               </td>
                         </tr>                       
        </table>
      ...
      <asp:ModalPopupExtender ID="mdlPastDueForExtension" runat="server" CancelControlID="" PopupControlID="pnlPastDueForExtension" TargetControlID="btnDummyPastDueForExtension" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
         <asp:Button ID="btnDummyPastDueForExtension" runat="server" CssClass="dummybutton" />

             <%-- End: Past Due for Extension--%>



              <%--Start: No Contract Details --%>
                                              
                 <asp:Panel ID="pnlNoContractDetail" runat="server" BackColor="White" Width="400px" Height="140px" BorderColor="#003366" BorderWidth="1px" ScrollBars="Auto">
          
         <table border="0" style="font-family: Calibri; font-size: 15px; font-weight: bold; color: white;text-align:left;padding-left:2px;">
              <tr style="background-color:navy; color:white;font-size:medium">
                      <td style="font-family: Calibri; font-size: 17px; font-weight: bold; color: white;text-align:center">
                         
                          <asp:Label ID="lblNoContractDetails" runat="server" Text="NO SERVICE DETAILS"></asp:Label>
               ...
               <tr>
                      <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          &nbsp;<asp:Label ID="Label39" runat="server" Text="This contract does not have any service detail. "></asp:Label>
                ...
                <tr>
                      <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          &nbsp;<asp:Label ID="Label44" runat="server" Text="Please review and do the necessary action."></asp:Label>
                            ...
                            <tr style="padding-top:40px;">
                             <td colspan="2" style="text-align:center"><asp:Button ID="Button15" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="OK" Width="100px"/>
                               </td>
                         </tr>                       
        </table>
      ...
      <asp:ModalPopupExtender ID="mdlNoContractDetail" runat="server" CancelControlID="" PopupControlID="pnlNoContractDetail" TargetControlID="btnDummyNoContractDetail" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
         <asp:Button ID="btnDummyNoContractDetail" runat="server" CssClass="dummybutton" />

             <%-- End: No Contract Detail--%>


              <%--Start: Mismatch Contract Group and Location ID --%>
                                              
                 <asp:Panel ID="pnlMismatchContractGroupLocationID" runat="server" BackColor="White" Width="380px" Height="160px" BorderColor="#003366" BorderWidth="1px" ScrollBars="Auto">
          
         <table border="0" style="font-family: Calibri; font-size: 15px; font-weight: bold; color: white;text-align:left;padding-left:2px;">
              <tr style="background-color:navy; color:white;font-size:medium">
                      <td style="font-family: Calibri; font-size: 17px; font-weight: bold; color: white;text-align:center">
                         
                          <asp:Label ID="Label45" runat="server" Text="INVALID CONTRACT GROUP FOR THE SELECTED LOCATION ID"></asp:Label>
               ...
               <tr>
                      <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          &nbsp;<asp:Label ID="Label46" runat="server" Text= "The Contract Group of Location ID" ></asp:Label> 
                          <asp:Label ID="lblLocationID" runat="server" Text= "" ></asp:Label>
                ...
                <tr>
                      <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          &nbsp;<asp:Label ID="Label47" runat="server" Text="does not match with the Contract Group of this contract."></asp:Label>
                            ...
                            <tr style="padding-top:40px;">
                             <td colspan="2" style="text-align:center"><asp:Button ID="Button17" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="OK" Width="100px"/>
                               </td>
                         </tr>                       
        </table>
      ...
      <asp:ModalPopupExtender ID="mdlMismatchContractGroupLocationID" runat="server" CancelControlID="" PopupControlID="pnlMismatchContractGroupLocationID" TargetControlID="btnDummyMismatchContractGroupLocationID" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
         <asp:Button ID="btnDummyMismatchContractGroupLocationID" runat="server" CssClass="dummybutton" />

             <%-- End: Mismatch Contract Group and Location ID--%>
         ...
         <table border="0" style="font-family: Calibri; font-size: 15px; font-weight: bold; color: white;text-align:left;padding-left:2px;">
              <tr style="background-color:navy; color:white;font-size:medium">
                      <td style="font-family: Calibri; font-size: 17px; font-weight: bold; color: white;text-align:center">
                          ...
                          <asp:Label ID="lblEditPONOLabel" runat="server" Text="EDIT P.O. NO. & MANUAL CONTRACT NO."></asp:Label>
      ...
      <asp:ModalPopupExtender ID="mdlEditPONOSave" runat="server" CancelControlID="" PopupControlID="pnlEditPONOSave" TargetControlID="btnDummyEditPONOSave" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
        ...
        <%-- '12.01.22--%>
           ...
           <%--Start : Edit PO NO--%>
                 ...
                 <asp:Panel ID="pnlUpdateConfirmationMultiplePO" runat="server" BackColor="White" Width="450px" Height="170px" BorderColor="#003366" BorderWidth="1px" ScrollBars="None">
          
         <table border="0" style="font-family: Calibri; font-size: 15px; font-weight: bold; color: white;text-align:left;padding-left:2px;">
              <tr style="background-color:navy; color:white;font-size:medium">
                      <td style="font-family: Calibri; font-size: 17px; font-weight: bold; color: white;text-align:center">
                         
                          <asp:Label ID="Label48" runat="server" Text="ADD/EDIT FOR MULTIPLE P.O."></asp:Label>
               ...
               <tr>
                      <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          &nbsp;<asp:Label ID="Label53" runat="server" Text="There are Services from "></asp:Label>
               ...
               <tr>
                      <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          &nbsp;<asp:Label ID="Label59" runat="server" Text="and all service records starting from "></asp:Label>
               ...
               <tr>
                      <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          &nbsp;<asp:Label ID="Label76" runat="server" Text="Do you wish to continue?"></asp:Label>
                            ...
                            <tr style="padding-top:40px;">
                             <td colspan="2" style="text-align:center"><asp:Button ID="btnYesMultiplePO" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0" OnClientClick="calculateportfoliovaluesAgreeValueEdit()"  Font-Bold="True" Text="Yes" Width="100px"/>
                                 <asp:Button ID="btnNoMultiplePO" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="No" Width="100px" />
                               </td>
                         </tr>                       
        </table>
      ...
      <asp:ModalPopupExtender ID="mdlUpdateConfirmationMultiplePO" runat="server" CancelControlID="" PopupControlID="pnlUpdateConfirmationMultiplePO" TargetControlID="btnDummyUpdateConfirmationMultiplePO" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
         <asp:Button ID="btnDummyUpdateConfirmationMultiplePO" runat="server" CssClass="dummybutton" />
        ...
        <%-- 11.09.21--%>
           ...
           <%--Start : Edit Contract--%>
                 ...
                 <asp:Panel ID="pnlEditContract" runat="server" BackColor="White" Width="480px" Height="170px" BorderColor="#003366" BorderWidth="1px" ScrollBars="None">
          
         <table border="0" style="font-family: Calibri; font-size: 15px; font-weight: bold; color: white;text-align:left;padding-left:2px;">
              <tr style="background-color:navy; color:white;font-size:medium">
                      <td style="font-family: Calibri; font-size: 17px; font-weight: bold; color: white;text-align:center">
                         
                          <asp:Label ID="Label49" runat="server" Text="EDIT CONTRACT"></asp:Label>
               ...
               <tr>
                      <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          &nbsp;<asp:Label ID="Label51" runat="server" Text="This contract is dated  which is more than 60 days in the past. "></asp:Label>
               ...
               <tr>
                      <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          &nbsp;<asp:Label ID="Label52" runat="server" Text="Do you confirm that you know the portfolio implications and wish to edit?" ></asp:Label>
               ...
               <tr>
                      <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          &nbsp;<asp:Label ID="Label55" runat="server" Text="" Visible="False"></asp:Label>
                            ...
                            <tr style="padding-top:40px;">
                             <td colspan="2" style="text-align:center"><asp:Button ID="btnYesEditContract" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"   Font-Bold="True" Text="Yes" Width="100px"/>
                                 <asp:Button ID="btnNoEditContract" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="No" Width="100px" />
                               </td>
                         </tr>                       
        </table>
      ...
      <asp:ModalPopupExtender ID="mdlEditContract" runat="server" CancelControlID="" PopupControlID="pnlEditContract" TargetControlID="btnDummyEditContract" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
         <asp:Button ID="btnDummyEditContract" runat="server" CssClass="dummybutton" />
      ...
      <asp:ModalPopupExtender ID="mdlInActiveAccount" runat="server" CancelControlID="" PopupControlID="pnlInActiveAccount" TargetControlID="btnDummyInActiveAccount" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
        ...
        <%-- End : Inactive Accounts--%>
           ...
           <%--  14.07.22--%>
                 ...
                 <%--Confirm delete Detail Record--%>
                                              
                 <asp:Panel ID="pnlContractDetailDelete" runat="server" BackColor="White" Width="400px" Height="150px" BorderColor="#003366" BorderWidth="1px" ScrollBars="Auto">
          
         <table border="0" style="font-family: Calibri; font-size: 15px; font-weight: bold; color: white;text-align:left;padding-left:2px;">
              <tr style="background-color:navy; color:white;font-size:medium">
                      <td style="font-family: Calibri; font-size: 17px; font-weight: bold; color: white;text-align:center">
                         
                          <asp:Label ID="Label82" runat="server" Text="Confirm DELETE"></asp:Label>
               ...
               <tr>
                      <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          &nbsp;<asp:Label ID="Label83" runat="server" Text="Are you sure to DELETE this detail record?"></asp:Label>
                            ...
                            <tr style="padding-top:40px;">
                             <td colspan="2" style="text-align:center"><asp:Button ID="btnDetailDeleteOK" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="Yes" Width="100px"/>
                                 <asp:Button ID="btnDetailDeleteCancel" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="No" Width="100px" />
                               </td>
                         </tr>                       
        </table>
      ...
      <asp:ModalPopupExtender ID="mdlPopupContractDetailDelete" runat="server" CancelControlID="btnDetailDeleteCancel" PopupControlID="pnlContractDetailDelete" TargetControlID="btnDummContractDetailDelete" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
         <asp:Button ID="btnDummContractDetailDelete" runat="server" CssClass="dummybutton" />
         ...
         '
             <%--Confirm delete Revision Detail Record--%>
                                              
                 <asp:Panel ID="pnlContractDetailDeleteNCR" runat="server" BackColor="White" Width="400px" Height="150px" BorderColor="#003366" BorderWidth="1px" ScrollBars="Auto">
          
         <table border="0" style="font-family: Calibri; font-size: 15px; font-weight: bold; color: white;text-align:left;padding-left:2px;">
              <tr style="background-color:navy; color:white;font-size:medium">
                      <td style="font-family: Calibri; font-size: 17px; font-weight: bold; color: white;text-align:center">
                         
                          <asp:Label ID="Label82NCR" runat="server" Text="Confirm DELETE (Revision)"></asp:Label>
               ...
               <tr>
                      <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          &nbsp;<asp:Label ID="Label83NCR" runat="server" Text="Are you sure to DELETE this detail record?"></asp:Label>
                            ...
                            <tr style="padding-top:40px;">
                             <td colspan="2" style="text-align:center"><asp:Button ID="btnDetailDeleteOKNCR" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="Yes" Width="100px"/>
                                 <asp:Button ID="btnDetailDeleteCancelNCR" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="No" Width="100px" />
                               </td>
                         </tr>                       
        </table>
      ...
      <asp:ModalPopupExtender ID="mdlPopupContractDetailDeleteNCR" runat="server" CancelControlID="btnDetailDeleteCancelNCR" PopupControlID="pnlContractDetailDeleteNCR" TargetControlID="btnDummContractDetailDeleteNCR" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
         <asp:Button ID="btnDummContractDetailDeleteNCR" runat="server" CssClass="dummybutton" />
       ...
       <%--  '23.01.22--%>
                 ...
                 <%--Confirm delete Distribution Record--%>
                                              
                 <asp:Panel ID="pnlDistributionDelete" runat="server" BackColor="White" Width="400px" Height="150px" BorderColor="#003366" BorderWidth="1px" ScrollBars="Auto">
          
         <table border="0" style="font-family: Calibri; font-size: 15px; font-weight: bold; color: white;text-align:left;padding-left:2px;">
              <tr style="background-color:navy; color:white;font-size:medium">
                      <td style="font-family: Calibri; font-size: 17px; font-weight: bold; color: white;text-align:center">
                         
                          <asp:Label ID="Label80" runat="server" Text="Confirm DELETE"></asp:Label>
               ...
               <tr>
                      <td class="CellFormat" style="text-align:center; margin-left:auto; margin-right:auto;"">
                          ...
                          &nbsp;<asp:Label ID="Label81" runat="server" Text="Are you sure to VOID the Distribution record?"></asp:Label>
                            ...
                            <tr style="padding-top:40px;">
                             <td colspan="2" style="text-align:center"><asp:Button ID="btnDistributionDeleteSave" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="Yes" Width="100px"/>
                                 <asp:Button ID="btnDistributionDeleteCancel" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="No" Width="100px" />
                               </td>
                         </tr>                       
        </table>
      ...
      <asp:ModalPopupExtender ID="mdlDistributionDelete" runat="server" CancelControlID="btnDistributionDeleteCancel" PopupControlID="pnlDistributionDelete" TargetControlID="btnDummyDistributionDelete" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
         <asp:Button ID="btnDummyDistributionDelete" runat="server" CssClass="dummybutton" />
      ...
      <asp:ModalPopupExtender ID="mdlWarning" runat="server" CancelControlID="" PopupControlID="pnlWarning" TargetControlID="btnDummyWarning" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
         <asp:Button ID="btnDummyWarning" runat="server" CssClass="dummybutton" />
             ...
             <%-- End: SAVE: Edit Agree Value --%>
               ...
               <%-- Start: Display Service Records--%>

                 <asp:Panel ID="pnlSelectionofDisplayServiceRecords" runat="server" BackColor="White" Width="35%" Height="28%" BorderColor="#003366" BorderWidth="1px" ScrollBars="Auto">
              
                     <table style="width:100%;padding-left:15px" border="0">
                         <tr>
                             <td colspan="2">
                                 <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;"> Selection of Display Service Records </h4>
                             </td>
                         </tr>
                          <tr>
               <td style="width:100%;text-align:center;color:brown;font-size:18px;font-weight:bold;font-family:'Calibri'; "  colspan="2"> 
                      <asp:Label ID="Label77" runat="server"></asp:Label>
                         ...
                         <tr >
                             <td class="CellFormat" style="text-align:left; padding-left:3%;" colspan="2">
                           <asp:RadioButton ID="chkLatestSchedule" runat="server" Checked="True" GroupName="CopyLatestSchedule" Text="Latest List of Schedule" />
                         ...
                         <tr>
                              ...
                              <td class="CellFormat" style="text-align:left; padding-left:3%;" colspan="2">
                                  <asp:RadioButton ID="chkAllService" runat="server" GroupName="CopyLatestSchedule" Text="All Service Records" />
                             </td>
                         </tr>
                            <tr>
                                <td class="CellFormat" style="text-align:left" colspan="2">&nbsp;</td>
                         </tr>
                            ...
                            <tr style="padding-top:40px;">
                                ...
                                <td style="text-align:center" colspan="2">
                                    <asp:Button ID="btnSaveopyAddress" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="OK" Width="120px" />
                      ...
                      <asp:ModalPopupExtender ID="mdlSelectionofDisplayServiceRecords" runat="server" CancelControlID="btnCancelCopyAddress" PopupControlID="pnlSelectionofDisplayServiceRecords" TargetControlID="btnSelectionofDisplayServiceRecords" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
           <asp:Button ID="btnSelectionofDisplayServiceRecords" runat="server" Text="Button" cssclass="dummybutton" />

              <%-- End:Display Service Records--%>
        ...
        <%--'28.02--%>
            ...
            <asp:Panel ID="pnlEditPONo" runat="server" BackColor="White" Width="40%" Height="45%" BorderColor="#003366" BorderWidth="1px" ScrollBars="None">
                     ...
                     <table border="0" style="width:100%;padding-left:15px">
                         <tr>
                             <td colspan="2">
                                 <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">Edit Manual Contract No., P.O. No and Other Reference</h4>
                             </td>
                         </tr>
                          <tr>
        ...
        <%-- end:Edit PO--%>
            ...
            <asp:Panel ID="pnlGSTInclusive" runat="server" BackColor="White"  Width="26%" Height="38%" BorderColor="#003366" BorderWidth="1px" ScrollBars="Auto" >
    ...
    <%-- Start: Display Service Records--%>
                 ...
                 <asp:Panel ID="pnlDisplayServiceRecords" runat="server" BackColor="White" Width="35%" Height="30%" BorderColor="#003366" BorderWidth="1px" ScrollBars="Auto">
              
                     <table style="width:100%;padding-left:15px" border="0">
                         <tr>
                             <td colspan="2">
                                 <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">Display Service Records</h4>
                             </td>
                         </tr>
                          <tr>
               <td style="width:100%;text-align:center;color:brown;font-size:18px;font-weight:bold;font-family:'Calibri';"  colspan="2"> 
                      <asp:Label ID="lblMsgDisplayServiceRecords" runat="server"></asp:Label>
                      </td> 
            </tr>
             <tr>
               <td style="width:100%;text-align:center;font-size:18px;font-weight:bold;font-family:'Calibri';"  colspan="2"> 
                      <asp:Label ID="lblAlertDisplayServiceRecords" runat="server" BackColor="Red" ForeColor="White"></asp:Label>
                      </td> 
            </tr>
                         ...
                         <tr>
                             <td class="CellFormat" style="text-align:left">
                                 <asp:RadioButton ID="chkLatestSetofSchedule" runat="server" Checked="True" GroupName="DisplayServiceRecords" Text="Latest Set of Schedule" AutoPostBack="True" /> &nbsp; &nbsp; &nbsp; &nbsp; 
                            <asp:TextBox ID="txtDisplayLatestServiceRecordsFrom" runat="server" AutoCompleteType="Disabled" Height="16px" Width="25%" AutoPostBack="False" Enabled="False"></asp:TextBox> &nbsp; and onwards&nbsp;&nbsp;       					
							<asp:TextBox ID="txtDisplayLatestServiceRecordsTo" runat="server" AutoCompleteType="Disabled" Height="16px" Width="25%" AutoPostBack="False" Enabled="False" Visible="False"></asp:TextBox>
				...
				<tr>
                              <td class="CellFormat" style="text-align:left">
                                  <asp:RadioButton ID="chkSelectedServiceRecords" runat="server" GroupName="DisplayServiceRecords" Text="Selected Service Record" AutoPostBack="True" /> &nbsp; &nbsp;  
						<asp:TextBox ID="txtDisplaySelectedServiceRecordsFrom" runat="server" AutoCompleteType="Disabled" Height="16px" Width="25%" AutoPostBack="False"></asp:TextBox> &nbsp; To&nbsp;&nbsp;   
                                   <asp:MaskedEditExtender runat="server" ID="MaskedEditExtender6" ClearMaskOnLostFocus="false"
    MaskType="Date" Mask="99/99/9999" TargetControlID="txtDisplaySelectedServiceRecordsFrom" UserDateFormat="DayMonthYear"> </asp:MaskedEditExtender>    					
							<asp:TextBox ID="txtDisplaySelectedServiceRecordsTo" runat="server" AutoCompleteType="Disabled" Height="16px" Width="25%" AutoPostBack="False"></asp:TextBox>
                              <asp:MaskedEditExtender runat="server" ID="MaskedEditExtender7" ClearMaskOnLostFocus="false"
    MaskType="Date" Mask="99/99/9999" TargetControlID="txtDisplaySelectedServiceRecordsTo" UserDateFormat="DayMonthYear"> </asp:MaskedEditExtender>                    
				...
				<tr>
                              <td class="CellFormat" style="text-align:left">
                                  <asp:RadioButton ID="chkAllServiceRecords" runat="server" GroupName="DisplayServiceRecords" Text="All Service Records" />
                             </td>
                         </tr>
                            ...
                            <tr style="padding-top:40px;">
                                ...
                                <td style="text-align:center" colspan="2">
                                    <asp:Button ID="btnDisplayServiceRecords" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="OK" Width="120px" />
                                    <asp:Button ID="btnCancelDisplayServiceRecords" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="Cancel" Width="100px" />
                                </td>
                         </tr>
                      ...
                      <asp:ModalPopupExtender ID="mdlDisplayServiceRecords" runat="server" CancelControlID="btnDummyDisplayServiceRecords" PopupControlID="pnlDisplayServiceRecords" TargetControlID="btnDummyDisplayServiceRecords" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
           <asp:Button ID="btnDummyDisplayServiceRecords" runat="server" Text="Button" cssclass="dummybutton" />

              <%-- End: DisplayServiceRecords--%>
        ...
        <%-- end:Scheduler--%>
           ...
           <%-- start: Salesman--%>
            ...
            <asp:Panel ID="pnlEditSalesman" runat="server" BackColor="White" Width="30%" Height="30%" BorderColor="#003366" BorderWidth="1px" ScrollBars="Auto">
            ...
            <asp:Panel ID="pnlEditAgreeValue" runat="server" BackColor="White" Width="90%" Height="95%" BorderColor="#003366" BorderWidth="1px" ScrollBars="Auto">
                     ...
                     <table border="0" style="width:100%;padding-left:25px">
                         <tr>
                          ...
                          <tr>
               <td colspan="9" style="width:100%;text-align:center;color:brown;font-size:18px;font-weight:bold;font-family:'Calibri';"> 
                      <asp:Label ID="Label15" runat="server"></asp:Label>
                      </td> 
            </tr>
             <tr>
               <td colspan="9" style="width:100%;text-align:center;font-size:18px;font-weight:bold;font-family:'Calibri';"> 
                      <asp:Label ID="lblAlertEditAgreeValue" runat="server" BackColor="Red" ForeColor="White"></asp:Label>
                           ...
                           <tr>
                                  ...
                                  <td style="color:black;  text-align:left; width:10%;">
                                   ...
                                   <td style= "width:7%; font-size:15px; font-weight:bold; font-family:Calibri; color:black; text-align:right;" colspan="2">
                                 Account ID
                                   </td>
                         ...
                         <tr>
                             <td class="CellFormat1" colspan="1">Contract Group</td>
                             <td style="color:black;  text-align:left;">
                                 <asp:TextBox ID="txtContractGrpEditAgreeValue" runat="server" AutoPostBack="True" BackColor="#C8C8C8" BorderStyle="None" ReadOnly="true" style="text-align:left" Width="98%"></asp:TextBox>
                      </td>
                             <td style="color:black;  text-align:left;">&nbsp;</td>
                             <td colspan="2" style="color:black;  text-align:left;">&nbsp;</td>
                             <td colspan="4" style="color:black;  text-align:left;">&nbsp;</td>
                         </tr>
                             ...
                             <tr>
                                  ...
                                  <td style="color:black;  text-align:left;" colspan="8">
                         ...
                         <tr >
                             ...
                             <td class="CellTextBox" colspan="8" style="font-size:15px;  font-weight:bold; font-family:Calibri; color:red; text-align:center;">   <asp:Label ID="lblTotalRecords" runat="server" Text="Records found" style="font-size:15px;  font-weight:bold; font-family:Calibri; color:red; text-align:center;"></asp:Label> 
                               </td>
                         </tr>
                         <tr >
    ...
    <HeaderStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" Font-Names="Calibri" />
           ...
           <asp:Button ID="btnDummyViewEditHistory" runat="server" BackColor="White" CssClass="dummybutton" Font-Bold="True" Text="L" Width="24px" BorderStyle="None" ForeColor="White" />
             ...
             <%-- End:View Edit History--%>
              ...
              <asp:Panel ID="pnlViewBilledServices" runat="server" BackColor="White" Width="900px" Height="85%" BorderColor="#003366" BorderWidth="1px"
        HorizontalAlign="Left">
                ...
                <table border="0">
                           <tr>
                               <td colspan="2" style="text-align:center;">
                                     <asp:Button ID="btnCloseViewBilledServices" runat="server" CssClass="button" BackColor="#CFC6C0"  Font-Bold="True" Text="Close" Width="100px" Visible="True" />
                               </td>
                    ...
                    <tr>
<td colspan="2" style="width:10%;font-size:15px;font-weight:bold;font-family:Calibri;color:black;text-align:center;padding-left:20px; padding-top:20px"> 
    The following Services are already Billed which cannot be revised. 
  </td> 
...
<td colspan="2" style="width:10%;font-size:15px;font-weight:bold;font-family:Calibri;color:black;text-align:center;padding-left:20px;"> 
    If you need to revise these services, please issue a Credit Note first then Revise this contract. 
  </td> 
                               ...
                               <caption>
                                   ...
                                   <tr>
                                       <td colspan="2" style="text-align:CENTER">
                                           <asp:Label ID="Label89" runat="server" Font-Bold="True" Font-Names="Calibri" Font-Size="20px" ForeColor="Red" Text=""></asp:Label>
                                       </td>
                                   </tr>
                           </caption>
                        
        </table>
              <div style="text-align: center; padding-left: 50px; padding-bottom: 5px; padding-top: 10px; ">
        
        <asp:GridView ID="grdViewBilledServices" runat="server" DataSourceID="sqlDSViewBilledServices" ForeColor="#333333" AllowPaging="True" AutoGenerateColumns="False" Font-Size="15px"
         CellPadding="2" GridLines="None" Width="99%"><AlternatingRowStyle BackColor="White" ForeColor="#284775" />
            <Columns>  
                ...
                <asp:BoundField DataField="ServiceDate" HeaderText="Service Date" DataFormatString="{0:dd/MM/yyyy}" >
                <HeaderStyle HorizontalAlign="Left" />
                <ItemStyle Width="12%" />
                </asp:BoundField>
             
                <asp:BoundField DataField="BillAmount" HeaderText="Service Value">
                <HeaderStyle HorizontalAlign="Left" />
                <ItemStyle Width="15%" />
                </asp:BoundField>
                <asp:BoundField DataField="BilledAmt" HeaderText="Billed Amount">
                <HeaderStyle HorizontalAlign="Left" />
    ...
    <HeaderStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" Font-Names="Calibri" />
            ...
            <SortedDescendingHeaderStyle BackColor="#6F8DAE" />
                  ...
                  <asp:SqlDataSource ID="sqlDSViewBilledServices" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>"
                ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>">
                  </asp:SqlDataSource>
            ...
            <tr style="padding-top:40px; text-align:center; width:auto; " >
                ...
                <asp:ModalPopupExtender ID="mdlViewBilledServices" runat="server" CancelControlID="ImageButton4" PopupControlID="pnlViewBilledServices" TargetControlID="btnDummyViewBilledServices" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
           <asp:Button ID="btnDummyViewBilledServices" runat="server" BackColor="White" CssClass="dummybutton" Font-Bold="True" Text="L" Width="24px" BorderStyle="None" ForeColor="White" />
        ...
        <%-- start--%>
           ...
           <asp:Panel ID="pnlViewContractPriceHistory" runat="server" BackColor="White" BorderColor="#003366" BorderWidth="1"  ScrollBars="auto"  style="text-align:left; width:1500px; height:97%; margin-left:auto; margin-right:auto;"  Visible="true" >
                ...
                <table border="0">
                           <tr>
                               ...
                               <td style="width:1%;text-align:right;">
                                   &nbsp;</td>
                               <td style="width:1%;text-align:right;">
                                   <asp:ImageButton ID="ImageButton7" runat="server" Height="27px" ImageUrl="~/Images/closebutton.png" Width="30px" />
                               </td>
                           </tr>
                    <tr><td colspan="7" style="width:10%;font-size:15px;font-weight:bold;font-family:Calibri;color:black;text-align:center;padding-left:20px;"> <h4 style="color: #000000">View Contract Price History</h4> 
                        ...
                        <td>
                               &nbsp;</td>
                        <td>
                            <asp:TextBox ID="TextBox8" runat="server" CssClass="dummybutton" Visible="true" Width="20%"></asp:TextBox>
                        </td>
                           </tr>
                           ...
                           <tr>
                               <td colspan="9" style="text-align:CENTER">
                                   <asp:Label ID="LabelContractPriceHistory" runat="server" Font-Bold="True" Font-Names="Calibri" Font-Size="16px" ForeColor="Red" Text=""></asp:Label>
                               </td>
                           </tr>
                           <tr>
                               <td style="text-align:center; width: 8%; font-size:15px;font-weight:bold;font-family:Calibri;  color:black;">Contract No</td>
                               <td style="text-align:left; width: 15%; font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black;" >
                                <asp:TextBox ID="txtContractNoPH" runat="server" AutoCompleteType="Disabled" Height="16px" Width="90%" Enabled="false"></asp:TextBox>    
                               </td>
                               <td style="text-align:center; width: 8%; font-size:15px;font-weight:bold;font-family:Calibri; color:black;">Name</td>
                               ...
                               <td style="text-align:center; width: 10%; font-size:15px;font-weight:bold;font-family:Calibri; text-align:center; color:black;">
                                   Fixed/Continuous</td>
                                    <td style="text-align:center; width: 9%; font-size:15px;font-weight:bold;font-family:Calibri; color:black;">
                                        <asp:TextBox ID="txtFixedContinuousPH" runat="server" AutoCompleteType="Disabled" Enabled="false" Height="16px" Width="90%"></asp:TextBox>
                               </td>
                         
                               <td style="text-align:center; width: 20%; font-size:15px;font-weight:bold;font-family:Calibri; color:black;">
                                   <asp:CheckBox ID="chkShowVoidRcords" runat="server" AutoPostBack="True" Enabled="True" Text="Show Void Records" />
                               </td>
                         
                           </tr>
                           <tr>
                               <td style="text-align:center; width: 8%; font-size:15px;font-weight:bold;font-family:Calibri;  color:black;">Agree Value</td>
                               <td  style="text-align:left; font-size:15px;font-weight:bold;font-family:Calibri; text-align:left; color:black;">
                                   <asp:TextBox ID="txtAgreeValuePH" runat="server" AutoCompleteType="Disabled" Enabled="false" Height="16px" Width="90%"></asp:TextBox>
                               </td>
                               <td style="text-align:center; width: 8%; font-size:15px;font-weight:bold;font-family:Calibri; color:black;">Start Date</td>
                               ...
                               <td style="text-align:center; width: 8%; font-size:15px;font-weight:bold;font-family:Calibri; color:black;">End Date</td>
                               <td style="text-align:left; width: 15%; font-size:15px;font-weight:bold;font-family:Calibri;  color:black;">
                                   <asp:TextBox ID="txtContractEndPH" runat="server" AutoCompleteType="Disabled" Height="16px"  Width="90%" Enabled="false"></asp:TextBox>
                               </td>
                               <td style="text-align:center; width: 10%; font-size:15px;font-weight:bold;font-family:Calibri; color:black;">Actual End</td>
                                <td style="text-align:center; width: 9%; font-size:15px;font-weight:bold;font-family:Calibri; color:black;">
                                    <asp:TextBox ID="txtActualEndPH" runat="server" AutoCompleteType="Disabled" Enabled="false" Height="16px" Width="90%"></asp:TextBox>
                               </td>
                         
                                <td style="text-align:center; width: 20%; font-size:15px;font-weight:bold;font-family:Calibri; color:black;">&nbsp;</td>
                         
                                </tr>
        </table>
              <div style="text-align: center; padding-left: 10px; padding-bottom: 5px;">
        
        <asp:GridView ID="grdViewPriceHistory" runat="server" DataSourceID="SqlDSViewPriceHistory" ForeColor="#333333" AutoGenerateColumns="False" Font-Size="15px"
         CellPadding="2" GridLines="None" Width="99%"><AlternatingRowStyle BackColor="White" ForeColor="#284775" />
            <Columns>  
                ...
                <ItemStyle Width="15%" />               
                 ...
                 <asp:BoundField DataField="RefRcNo" HeaderText="Ref ID">
               ...
               <td style="width:20%;text-align:right;">&nbsp;</td>
                ...
                <tr style="padding-top:40px; text-align:center; width:auto; ">
                   <td style="width:20%;text-align:right;">&nbsp;</td>
                     <td style="width:40%;text-align:right;">
                         <asp:GridView ID="grdViewPriceHistory0" runat="server" AutoGenerateColumns="False" CellPadding="2" DataSourceID="SqlDSViewPriceHistory0" Font-Size="15px" ForeColor="#333333" GridLines="None" Width="70%">
                             <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                             <Columns>
                                 <asp:BoundField DataField="ContractGroup" HeaderText="Contract Group">
                                 ...
                                 <asp:BoundField DataField="TotalPriceChange" DataFormatString="{0:N2}" HeaderText="Price Change">
                             ...
                             <EditRowStyle BackColor="#999999" />
                             <FooterStyle BackColor="#0099CC" Font-Bold="True" ForeColor="White" />
                             <HeaderStyle BackColor="#5D7B9D" Font-Bold="True" Font-Names="Calibri" ForeColor="White" />
                             <PagerStyle BackColor="#284775" ForeColor="White" HorizontalAlign="Center" />
                             <RowStyle BackColor="#F7F6F3" Font-Names="Calibri" ForeColor="#333333" HorizontalAlign="Left" />
                             <SelectedRowStyle BackColor="#E2DED6" Font-Bold="True" ForeColor="#333333" />
                             <SortedAscendingCellStyle BackColor="#E9E7E2" />
                             <SortedAscendingHeaderStyle BackColor="#506C8C" />
                             <SortedDescendingCellStyle BackColor="#FFFDF8" />
                ...
                <tr style="padding-top:40px; text-align:center; width:auto; ">
                    <td style="width:20%;text-align:right;">
                        <asp:SqlDataSource ID="SqlDSViewPriceHistory0" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>"></asp:SqlDataSource>
                    </td>
                    <td style="width:40%;text-align:right;">&nbsp;</td>
                    <td style="width:1%;text-align:right;">&nbsp;</td>
                </tr>
                <tr style="padding-top:40px; text-align:center; width:auto; ">
                    <td colspan="2" style="text-align:center;">
                        <asp:Button ID="Button9" runat="server" BackColor="#CFC6C0" CssClass="button" Font-Bold="True" Text="Close" Visible="False" Width="100px" />
                    </td>
                    <td style="width:1%;text-align:right;"></td>
                </tr>
         ...
         <Triggers>
            <asp:PostBackTrigger ControlID="tb1$TabPanel3$btnUpload" />
             ...
             <asp:AsyncPostBackTrigger ControlID="tb1$TabPanel1$ddlContractGrp" EventName="SelectedIndexChanged" />
              <asp:AsyncPostBackTrigger ControlID="txtDistributionDate" EventName="TextChanged" />
        </Triggers>
</asp:UpdatePanel>
       ...
       //     }
        ...
        function CalculateRateSchedule() {
         ...
         function DoValidationSvc() {
             ...
             if (!isSubmitted) {
                           //alert("2");
                 $('#<%=btnSvcSave.ClientID%>').val('SAVING..WAIT');
                  isSubmitted = true;
                  currentdatetime();
                  valid = true;
                  return valid;
    ...
    //    29.03.23
        ...
        function DoValidationSvcSch() {
            ...
            if (!isSubmitted) {
                          //alert("2");
                $('#<%=btnSvcSaveSchedule.ClientID%>').val('SAVING..WAIT');
     ...
     //   again
        ...
        function dovalidationdistribution() {
            ...
            if (!isSubmitted) {
                //           alert("2");
                $('#<%=btnSaveContractGroupDistribution.ClientID%>').val('SAVING..WAIT');
           //     $('#<%=btnSaveContractGroupDistribution.ClientID%>').attr("disabled", true);
                isSubmitted = true;
                currentdatetime();
                valid = true;
                return valid;
     ...
     //   29.03.23
       ...
       // 12.08.22
        ...
        function DoValidationSvcNCR() {
            ...
            if (!isSubmitted) {
                           //alert("2");
                $('#<%=btnSvcSaveNCR.ClientID%>').val('SAVING..WAIT');
      ...
      //       if (scheduleType == '--SELECT--') {
        ...
        var service = document.getElementById("<%=txtServiceIdNCR.ClientID%>").value;

            if (service == '') {
               
                    document.getElementById("<%=lblAlertNCR.ClientID%>").innerText = "Please Select Service";
                 //   ResetScrollPosition();
                 //     ResetScrollPositionPopup();
                
               //  lblAlertNCR.focus();
                valid = false;
               
                document.getElementById('<%=txtPopupScrollNCR.ClientID%>').focus();
               ...
               var frequency = document.getElementById("<%=txtFrequencyNCR.ClientID%>").value;

                       if (frequency == '') {
                         document.getElementById("<%=lblAlertNCR.ClientID%>").innerText = "Please Select Service Frequency";
             //     ResetScrollPosition();
              //    ResetScrollPositionPopup();
                  valid = false;
                  document.getElementById('<%=txtPopupScrollNCR.ClientID%>').focus();
     ...
     function currentdatetimecontract() {
        ...
        function allowOnlyNumber(evt) {
            ...
            function PopulateOtherDays() {
              ...
              //  var contdate = document.getElementById("<%=txtContractDate.ClientID%>").value;
                //   var contdateorig = document.getElementById("<%=txtContractDateOriginal.ClientID%>").value;

                //   if (contdateorig != '') {
                //       var timein1 = contdate.split('/');
                //     var startdate1 = parseInt(timein1[0], 10);
                //     var startmonth1 = parseInt(timein1[1], 10);
                //     var startyear1 = parseInt(timein1[2], 10);

                //      var timein2 = contdateorig.split('/');
                //     var startdate2 = parseInt(timein2[0], 10);
                //     var startmonth2 = parseInt(timein2[1], 10);
                //    var startyear2 = parseInt(timein2[2], 10);

                //     if ((startmonth1 == startmonth2) && (startyear1 == startyear2)) {

                //    }
                //    else {
                //        alert("Month and Year of the Contract Date cannot be modified");
                //         document.getElementById("<%=txtContractDate.ClientID%>").value = document.getElementById("<%=txtContractDateOriginal.ClientID%>").value;
        ...
        function CalculateContractDates() {
                ...
                if (dur != "") {
                   ...
                   //     document.getElementById("<%=txtServEnd.ClientID%>").value = document.getElementById("<%=txtContractEnd.ClientID%>").value;
                        ...
                        if ((dd == 29) && (mm == 02) && (y == 2025)) {
                           
                            dd = 28
                        }

                        if ((dd == 29) && (mm == 02) && (y == 2026)) {
                            
                            dd = 28
                        }

                        if ((dd == 29) && (mm == 02) && (y == 2027)) {
                           
                            dd = 28
                        }

                        if ((dd == 29) && (mm == 02) && (y == 2029)) {
             ...
             //   alert("1");
                ...
                if (dateone != "" && dur1 != "") {
                    ...
                    if (optionselected1 == 0) {
                     ...
                     //   if ((radio.item(2).checked == true)) {
                     //       document.getElementById("<%=txtDuration.ClientID%>").value = 12;
                     //    }


                   //     10.11.22
                    //     if ((radio.item(3).checked == true)) {
                    //         document.getElementById("<%=txtDuration.ClientID%>").value = 1;
                    //     }
                        //     10.11.22
                  ...
                  //  alert (optionselected1);
                    ...
                    if (optionselected1 == 1) {
                        ...
                        radio2.item(0).disabled = true;
                        radio2.item(1).disabled = true;

                        if ((radio2.item(0).checked == true) || (radio2.item(1).checked == true)) {
                            radio2.item(3).checked = true;
                        }
                     //   alert(dur1);

                        if ((radio2.item(2).checked == true)){
                            document.getElementById("<%=txtDuration.ClientID%>").value = 12;
                        }

                        if ((radio2.item(3).checked == true)) {
                            document.getElementById("<%=txtDuration.ClientID%>").value = 1;
                        }
                        document.getElementById("<%=txtServEnd.ClientID%>").disabled = true;
                        //     var optionselected;

                        var dur2 = parseInt(document.getElementById("<%=txtDuration.ClientID%>").value);
                        var durationms = document.getElementById("<%=rbtLstDuration.ClientID%>");
                        var radio = durationms.getElementsByTagName("input");
                        for (var i = 0; i < radio.length; i++) {
                            if (radio[i].checked) {
                        ...
                        if (optionselected == 0) {
                            if (dur2 == 1) {
                                ...
                                startTime.setDate(startTime.getDate() + dur2);
                            ...
                            startTime.setDate(startTime.getDate() - 1);
                            startTime.setDate(startTime.getDate() + (dur2 * 7));
                            ...
                            startTime.setDate(startTime.getDate() - 1);
                            startTime.setMonth(startTime.getMonth() + (dur2));
                            ...
                            var dd = startTime.getDate();
                            var mm = startTime.getMonth() + 1;
                            var y = startTime.getFullYear() + (dur2);
                        }
        ...
        function CalculateDatesDuration() {
            ...
            if (Number.isInteger(dur1) == false)
                document.getElementById("<%=txtDuration.ClientID%>").value = "1";
              ...
              if (dateone != "" && dur != "") {
                  ...
                  var durationms = document.getElementById("<%=rbtLstDuration.ClientID%>");
                    ...
                    if (optionselected1 == 1) {
                        ...
                        if ((radio2.item(2).checked == true) && (dur1 < 12)) {
                            document.getElementById("<%=txtDuration.ClientID%>").value = 12;
                        }
            ...
            //    var datetwo = (document.getElementById("<%=txtServEnd.ClientID%>").value);
                ...
                var fixedcontinuous = document.getElementById("<%=rbtFixedContinuous.ClientID%>");
                 ...
                 if (optionselected1 == 0) {
                     ...
                     var datetwo = (document.getElementById("<%=txtEndofLastSchedule.ClientID%>").value);
                 }
        ...
        function NoOfMonthsEdit() {
            ...
            var durationms = document.getElementById("<%=rbtLstDuration.ClientID%>");
            var radio2 = durationms.getElementsByTagName("input");
        ...
        //        alert("13");
            ...
            if ((optionselected1 == 1) && (radio2.item(3).checked == true)){
                (document.getElementById("<%=txtNoofMonth.ClientID%>").value) = dur2 * 12;

            }

            if ((optionselected1 == 1) && (radio2.item(2).checked == true)) {
                (document.getElementById("<%=txtNoofMonth.ClientID%>").value) = dur2 ;
            ...
            function ResetScrollPositionPopup() {
