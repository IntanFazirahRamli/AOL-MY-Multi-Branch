...
Public Class RV_MasterIndustry
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                Dim repPath As String = Server.MapPath("~/Reports/AdministrationReports/Rpt_Master_Industry.rpt")
                crReportDocument.Load(repPath)
                Dim selectFormula As String = "{tblIndustry1.RcNo} <> 0"
    ...
    Protected Sub btnQuit_Click(sender As Object, e As EventArgs)
        Response.Redirect("Master_Industry.aspx")
    End Sub
End Class