<%@ page title="Statement of Accounts" language="VB" masterpagefile="~/MasterPage_Report.master" enableeventvalidation="false" autoeventwireup="false" CodeFile="RV_Select_StatementOfAccounts.aspx.vb" inherits="RV_Select_StatementOfAccounts" culture="en-GB" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
  ...
  function clearLabelValue(){
    ...
    <table style="width:100%;">
        <tr>
            <td colspan="2">
                  <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">STATEMENT OF ACCOUNTS</h4>
      ...
      <table style="width:100%;font-family: Calibri; font-size: 15px; font-weight: bold; color: black;text-align:left;padding-left:50px;line-height:20px;">
        ...
        <%--  <tr>
            ...
            <tr>
                    ...
                    <td class="CellTextBox">  <asp:DropDownList ID="ddlAccountType" runat="server" Width="87%" Height="20px" CssClass="chzn-select" >
        ...
        <tr>
                 <td class="CellFormat" style="text-align: right; ">AccountIDFrom</td>
                    <td class="CellTextBox"><asp:TextBox ID="txtAccountIDFrom" runat="server" MaxLength="10" Height="16px" Width="85.5%"></asp:TextBox><asp:ImageButton ID="btnClient" runat="server" ImageUrl="~/Images/searchbutton.jpg" Height="22px" Width="22px" ImageAlign="Top"/>
                    </td>
                  <td class="CellFormat" style="text-align: right; ">AccountIDTo</td>
                    <td class="CellTextBox"><asp:TextBox ID="txtAccountIDTo" runat="server" MaxLength="10" Height="16px" Width="85.5%"></asp:TextBox><asp:ImageButton ID="btnClientTo" runat="server" ImageUrl="~/Images/searchbutton.jpg" Height="22px" Width="22px" ImageAlign="Top"/>
                    </td>
               ...
               <tr>
                    ...
                    <td class="CellTextBox" colspan="3" style="text-align:left;"> <asp:TextBox ID="txtCustName" runat="server" MaxLength="200" Height="16px" Width="94%"></asp:TextBox>
                              <asp:ImageButton ID="btnClientName" runat="server" ImageUrl="~/Images/searchbutton.jpg" Height="22px" Width="22px" ImageAlign="Top"/>
                              </td>
                  </tr>
             <tr>
                    ...
                    <td class="CellTextBox">  <%--<asp:DropDownList ID="ddlCompanyGrp" runat="server" CssClass="chzn-select" DataSourceID="SqlDSCompanyGroup" DataTextField="companygroup" DataValueField="companygroup" Width="25.5%" Height="25px" AppendDataBoundItems="True">
                         ...
                         <cc1:dropdowncheckboxes ID="ddlCompanyGrp" runat="server" Width="17%" UseSelectAllNode = "true" DataSourceID="SqlDSCompanyGroup" DataTextField="CompanyGroup" DataValueField="CompanyGroup" AddJQueryReference="true" UseButtons="false" style="top: 0px; left: 0px" >
     <Style2 SelectBoxWidth="85.5%" DropDownBoxBoxWidth="85.5%" DropDownBoxBoxHeight="120" />
                 ...
                 <td class="CellFormat" style="text-align: right; ">LocationGroup</td>
                    <td class="CellTextBox"><asp:DropDownList ID="ddlLocateGrp" runat="server" AppendDataBoundItems="True" CssClass="chzn-select" DataSourceID="SqlDSLocateGroup" DataTextField="locationgroup" DataValueField="locationgroup" Width="88%" Height="25px" ><asp:ListItem Text="--SELECT--" Value="-1" /></asp:DropDownList>
          ...
          <tr>
                    ...
                    <td class="CellTextBox"><asp:TextBox ID="txtIncharge" runat="server" MaxLength="10" Height="16px" Width="85.5%"></asp:TextBox><asp:ImageButton ID="btnImgIncharge" runat="server" ImageUrl="~/Images/searchbutton.jpg" Height="22px" Width="22px" ImageAlign="Top"/>                        
                                 </td>
                 <td class="CellFormat" style="text-align: right; ">Salesman</td>
                    <td class="CellTextBox"><asp:DropDownList ID="ddlSalesMan" runat="server" AppendDataBoundItems="True" CssClass="chzn-select" DataSourceID="SqlDSSalesMan" DataTextField="StaffId" DataValueField="StaffId" Height="25px" Width="88%"><asp:ListItem Text="--SELECT--" Value="-1" /></asp:DropDownList>
                                 </td>
           ...
           <%--   <tr>
             ...
             <tr>
                  ...
                  <td class="CellFormat">CutOffDate<asp:CheckBox ID="chkCheckCutOff" runat="server" AutoPostBack="True" Checked="True" Enabled="False" Visible="False" /><asp:Label ID="Label23" runat="server" visible="true" Font-Size="14px" ForeColor="Red" Text="*" Height="20px"></asp:Label></td>
            ...
            <td colspan="3" style="text-align: left;padding-left:20px ">
                <asp:Panel ID="Panel1" runat="server" Height="90%" BorderStyle="Solid" BorderColor="#CCCCCC" BorderWidth="2px" Width="70%" HorizontalAlign="Center">
                    <div style="padding-left: 20px; text-align: left; padding-bottom: 10px;">
                        <asp:RadioButtonList ID="rbtnSelectDetSumm" runat="server" CellSpacing="5" CellPadding="5" RepeatDirection="horizontal" Width="80%">
                           <%--  <asp:ListItem Text="O/S Invoice" Value="1" Selected="true"></asp:ListItem>--%>
                            <asp:ListItem Text="Invoice & Receipt" Value="2" Selected="true"></asp:ListItem>
                             <asp:ListItem Text="Zero & CreditBalance" Value="3"></asp:ListItem>
                        </asp:RadioButtonList>
                    </div>
                </asp:Panel>
            </td>
              ...
              <tr>
                  <td colspan="4" style="text-align:center; ">
                               <asp:Button ID="btnEmailSOA" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="Email SOA" Width="120px" Visible="true" OnClientClick="clearLabelValue();"/>
                   
                      <asp:Button ID="btnPrintServiceRecordList" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="Print" Width="100px" OnClientClick="clearLabelValue();"/>
                      
                      <asp:Button ID="btnCancel" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="Cancel" Width="100px" />
                      
                      <asp:Button ID="btnExportToExcel" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="Export To Excel" Width="120px" Visible="false"/>
        ...
        <asp:Panel ID="pnlPopUpClient" runat="server" BackColor="White" Width="900px" Height="600px" BorderColor="#003366" BorderWidth="1px" HorizontalAlign="Left">
          <table><tr>
                               ...
                               <td colspan="2" style="font-size:15px;font-weight:bold;font-family:'Calibri';color:black;text-align:center;">
                                   <asp:RadioButton ID="rdbAccountName" runat="server" AutoPostBack="True" Checked="True" GroupName="sortitem" Text="By Account Name" />
                                   <asp:RadioButton ID="rdbAccountId" runat="server" AutoPostBack="True" GroupName="sortitem" Text="By Account ID" />
...
<%--                    <asp:BoundField DataField="Address1" >
    ...
    <asp:TextBox ID="txtQueryJrnl" runat="server" Visible="false"></asp:TextBox>
    <asp:TextBox ID="txtQueryJrnl1" runat="server" Visible="false"></asp:TextBox>
</asp:Content>
