<%@ Page Title="Service Record Listing by Client ID" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="RV_ServiceRecordClient.aspx.vb" Inherits="RV_ServiceRecordClient" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <%-- <a href="RV_ServiceRecord02.aspx"><span style="color: #FFFFFF">RV_ServiceRecord02.aspx</span></a>--%><%--<a href="RV_ServiceRecordClient.aspx">RV_ServiceRecordClient.aspx</a>--%><a href="RV_ServiceRecordClient.aspx">RV_ServiceRecordClient.aspx</a><CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="true" 
    ...
    <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
        <Report FileName="Reports\ServiceRecordReports\ServiceRecordClient.rpt">
        </Report>
