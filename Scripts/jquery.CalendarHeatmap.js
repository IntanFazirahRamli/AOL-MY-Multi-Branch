...
var MonthlyLowColor;
var MonthlyMedium;
var MonthlyMediumColor;
var MonthlyHigh;
var MonthlyHighColor;
var MonthlyVeryHigh;
var MonthlyVeryHighColor;
var stylecolor = "";
...
; (function ($, window, document, undefined) {
    ...
    $.extend(Plugin.prototype, {
        ...
        calendarHeatmap: function () {
            ...
            this.index(data);
            var date = data[0].date; //To get the month of the data Start
            var strdatemnth = [];
            strdatemnth = date.split("-");
            var mnth='';
            if (strdatemnth.length > 0)
            {
                mnth = strdatemnth[1];
            }
            var bprefix = mnth.startsWith("0");
            if (bprefix)
            {
                mnth = mnth.replace("0", "");
            ...
            var currMonth = mnth; // Setting Month of the data
            var currYear = this.settings.lastYear+1;
          ...
          /////  for (i = months; i > 0; i--) {
            ...
            var month = currMonth;
                ...
                // Build Month
                var monthName = moment().set({ "month": month-1 , "year": year }).format("MMM");


                if (this.settings.labels.custom.monthLabels) {
                    if ($.type(this.settings.labels.custom.monthLabels) === "array") {
                        monthName = this.settings.labels.custom.monthLabels[month - 1] || "";
                    } else {
                        monthName = moment().set({ "month": month - 1, "year": year })
                ...
                if (this.settings.labels.months) {
                    $(".ch-month:last", this.element)
                    .append("<div style='color:black;' class=\"ch-month-label\">" + monthName + "</div>");
                }
                ...
                for (var j = 0; j < days; j++) {
                    ...
                    if (obj) {
                        ...
                        if (obj.count <= MonthlyLow)
                        {
                            
                            stylecolor = MonthlyLowColor;
                        }
                        else if (obj.count <= MonthlyMedium)
                        {
                            stylecolor = MonthlyMediumColor;
                        }
                        else if (obj.count <= MonthlyHigh) {

                            stylecolor = MonthlyHighColor;
                        }
                        else if (obj.count <= MonthlyVeryHigh) {

                            stylecolor = MonthlyVeryHighColor;
                        }
                        ...
                        $("<div/>", {
                            ...
                            "data-toggle": "tooltip",
                            "id": "id_div" + obj.level,
                            "style": "background-color:"+ stylecolor +" !important"
                        }).appendTo(
           ...
           /////// }
            ...
            //            "title": MonthlyLow,
            //            "data-toggle": "tooltip",
            //            "style": "background-color:" + MonthlyLowColor + " !important"
            //        })
            ...
            //            "title": MonthlyMedium,
            //            "data-toggle": "tooltip",
            //            "style": "background-color:" + MonthlyMediumColor + " !important"
            //        })
            ...
            //            "title": MonthlyHigh,
            //            "data-toggle": "tooltip",
            //            "style": "background-color:" + MonthlyHighColor + " !important"
            //        })
            ...
            //        $("<li>", {
            //            "class": "ch-lvl lvl-" + i,
            //            "title": MonthlyVeryHigh,
            //            "data-toggle": "tooltip",
            //            "style": "background-color:" + MonthlyVeryHighColor + " !important"
            //        })
