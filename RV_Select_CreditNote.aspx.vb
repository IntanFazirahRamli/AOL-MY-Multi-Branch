...
Partial Class RV_Select_CreditNote
    ...
    Protected Sub btnPrintServiceRecordList_Click(sender As Object, e As EventArgs) Handles btnPrintServiceRecordList.Click
        ...
        selection = ""
        selFormula = "{tblsales1.rcno} <> 0 and {tblsales1.postStatus}='P' and {tblsales1.docType}='ARCN'"
        ...
        If rbtnSelect.SelectedValue = "1" Then
            If rbtnSelectDetSumm.SelectedValue = "1" Then
                Session.Add("ReportType", "CreditNoteListingByClient_Details")
                Response.Redirect("RV_CreditNoteListingByClient_Details.aspx")
            ElseIf rbtnSelectDetSumm.SelectedValue = "2" Then
                Session.Add("ReportType", "CreditNoteListingByClient_Summary")
                Response.Redirect("RV_CreditNoteListingByClient_Summary.aspx")
            End If
        ElseIf rbtnSelect.SelectedValue = "2" Then
            If rbtnSelectDetSumm.SelectedValue = "1" Then
                Session.Add("ReportType", "CreditNoteListingByCompanyGrp_Details")
                Response.Redirect("RV_CreditNoteListingByCompanyGrp_Details.aspx")
            ElseIf rbtnSelectDetSumm.SelectedValue = "2" Then
                Session.Add("ReportType", "CreditNoteListingByCompanyGrp_Summary")
                Response.Redirect("RV_CreditNoteListingByCompanyGrp_Summary.aspx")
            End If
      
        ElseIf rbtnSelect.SelectedValue = "3" Then
            If rbtnSelectDetSumm.SelectedValue = "1" Then
                Session.Add("ReportType", "CreditNoteListingBySalesPerson_Details")
                Response.Redirect("RV_CreditNoteListingBySalesPerson_Details.aspx")
            ElseIf rbtnSelectDetSumm.SelectedValue = "2" Then
                Session.Add("ReportType", "CreditNoteListingBySalesPerson_Summary")
                Response.Redirect("RV_CreditNoteListingBySalesPerson_Summary.aspx")
            End If
        ElseIf rbtnSelect.SelectedValue = "4" Then
            If rbtnSelectDetSumm.SelectedValue = "1" Then
                Session.Add("ReportType", "CreditNoteListingByGLCode_Details")
                Response.Redirect("RV_CreditNoteListingByGLCode_Details.aspx")
            ElseIf rbtnSelectDetSumm.SelectedValue = "2" Then
                Session.Add("ReportType", "CreditNoteListingByGLCode_Summary")
                Response.Redirect("RV_CreditNoteListingByGLCode_Summary.aspx")
            End If
        ElseIf rbtnSelect.SelectedValue = "5" Then
            If rbtnSelectDetSumm.SelectedValue = "1" Then
                Session.Add("ReportType", "CreditNoteListingByCN_Details")
                Response.Redirect("RV_CreditNoteListingByCN_Details.aspx")
            ElseIf rbtnSelectDetSumm.SelectedValue = "2" Then
                Session.Add("ReportType", "CreditNoteListingByCN_Summary")
                Response.Redirect("RV_CreditNoteListingByCN_Summary.aspx")
            End If
        End If
        '  
