...
Partial Class Master_PestLevelofInfestation
    ...
    Private Sub EnableControls()
        ...
        txtLevelofInfestation.Enabled = False
        AccessControl()
    End Sub
    ...
    Private Sub DisableControls()
        ...
        txtLevelofInfestation.Enabled = True
        AccessControl()
    End Sub
    ...
    Protected Sub GridView1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles GridView1.SelectedIndexChanged
        ...
        Dim sql As String
        sql = "Select * FROM tblpestlevelofinfestation "
        ...
        If dt.Rows.Count > 0 Then
            ...
            If dt.Rows(0)("LevelofInfestation").ToString <> "" Then : txtLevelofInfestation.Text = dt.Rows(0)("LevelofInfestation").ToString : End If
    ...
    Private Sub AccessControl()
        Try
            ...
            If Session("SecGroupAuthority") <> "ADMINISTRATOR" Then
                ...
                command.CommandText = "SELECT x0186,  x0186Add, x0186Edit, x0186Delete FROM tblGroupAccess where GroupAccess = '" & Session("SecGroupAuthority") & "'"
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    If String.IsNullOrEmpty(Convert.ToBoolean(dt.Rows(0)("x0186"))) = False Then
                        If Convert.ToBoolean(dt.Rows(0)("x0186")) = False Then
                            Response.Redirect("Home.aspx")
                        End If
                    End If


                    If String.IsNullOrEmpty(dt.Rows(0)("x0186Add")) = False Then
                        Me.btnADD.Enabled = dt.Rows(0)("x0186Add").ToString()
                    End If

                    'Me.btnInsert.Enabled = vpSec2412Add
                    If txtMode.Text = "View" Then
                        If String.IsNullOrEmpty(dt.Rows(0)("x0186Edit")) = False Then
                            Me.btnEdit.Enabled = dt.Rows(0)("x0186Edit").ToString()
                        End If

                        If String.IsNullOrEmpty(dt.Rows(0)("x0186Delete")) = False Then
                            Me.btnDelete.Enabled = dt.Rows(0)("x0186Delete").ToString()
                        End If
                    Else
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        If txtLevelofInfestation.Text = "" Then
            '   MessageBox.Message.Alert(Page, "Group cannot be blank!!!", "str")
            lblAlert.Text = "LEVEL OF INFESTATION CANNOT BE BLANK"
            Return
        ...
        If txtMode.Text = "New" Then
            Try
                ...
                command1.CommandText = "SELECT * FROM tblpestlevelofinfestation where levelofinfestation =@levelofinfestation"
                command1.Parameters.AddWithValue("@levelofinfestation", txtLevelofInfestation.Text)
                command1.Connection = conn
                ...
                Else
                    ...
                    command.CommandType = CommandType.Text
                    Dim qry As String = "INSERT INTO tblpestlevelofinfestation (levelofinfestation, CreatedBy,CreatedOn,LastModifiedBy,LastModifiedOn)"
                    qry = qry + "VALUES(@levelofinfestation,@CreatedBy,@CreatedOn,@LastModifiedBy,@LastModifiedOn);"
                    ...
                    If ConfigurationManager.AppSettings("UPPERCASE").ToString() = "YES" Then
                        ...
                        command.Parameters.AddWithValue("@levelofinfestation", txtLevelofInfestation.Text.ToUpper)
                    ...
                    ElseIf ConfigurationManager.AppSettings("UPPERCASE").ToString() = "NO" Then
                        ...
                        command.Parameters.AddWithValue("@levelofinfestation", txtLevelofInfestation.Text)
        ...
        ElseIf txtMode.Text = "Edit" Then
            ...
            Try
                ...
                command2.CommandText = "SELECT * FROM tblpestlevelofinfestation where levelofinfestation=@levelofinfestation and rcno<>" & Convert.ToInt32(txtRcno.Text)
                command2.Parameters.AddWithValue("@levelofinfestation", txtLevelofInfestation.Text)
                ...
                Else
                    ...
                    command1.CommandText = "SELECT * FROM tblpestlevelofinfestation where rcno=" & Convert.ToInt32(txtRcno.Text)
                    command1.Connection = conn
                    ...
                    If dt.Rows.Count > 0 Then
                        ...
                        If txtExists.Text = "True" Then
                            qry = "update tblpestlevelofinfestation set levelofinfestation=@levelofinfestation,  LastModifiedBy=@LastModifiedBy,LastModifiedOn=@LastModifiedOn where rcno=" & Convert.ToInt32(txtRcno.Text)
                        Else
                            qry = "update tblpestlevelofinfestation set levelofinfestation=@levelofinfestation,  LastModifiedBy=@LastModifiedBy,LastModifiedOn=@LastModifiedOn where rcno=" & Convert.ToInt32(txtRcno.Text)
                        End If
                ...
                conn.Close()
                If txtMode.Text = "NEW" Then
                    CType(Me.Master, MasterPage).EventLog_Insert(Session("UserID"), "PEST", txtLevelofInfestation.Text, "ADD", Convert.ToDateTime(txtCreatedOn.Text), 0, 0, 0, "", "", txtRcno.Text)
                Else
                    CType(Me.Master, MasterPage).EventLog_Insert(Session("UserID"), "PEST", txtLevelofInfestation.Text, "EDIT", Convert.ToDateTime(txtCreatedOn.Text), 0, 0, 0, "", "", txtRcno.Text)
                End If
            Catch ex As Exception
                MessageBox.Message.Alert(Page, ex.ToString, "str")
            End Try
        ...
        If confirmValue = "Yes" Then
            ...
            Try
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    command.CommandType = CommandType.Text
                    Dim qry As String = "delete from tblpestlevelofinfestation where rcno=" & Convert.ToInt32(txtRcno.Text)
                ...
                End If
                conn.Close()
                CType(Me.Master, MasterPage).EventLog_Insert(Session("UserID"), "LEVELOFINFESTATION", txtLevelofInfestation.Text, "DELETE", Convert.ToDateTime(txtCreatedOn.Text), 0, 0, 0, "", "", txtRcno.Text)
            Catch ex As Exception
                MessageBox.Message.Alert(Page, ex.ToString, "str")
            End Try
            EnableControls()
