<%@ Page Title="Manpower Productivity by Team Leader Report Selection" Language="VB" MasterPageFile="~/MasterPage_Report.master" AutoEventWireup="false" CodeFile="RV_Select_ManpowerProdByTeamLead.aspx.vb" Inherits="RV_Select_ManpowerProductivityByTeamLead" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    function currentdatetime() {
     ...
     <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" ScriptMode="Release">
       ...
       <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">MANPOWER PRODUCTIVITY BY TEAM LEADER REPORT</h4>
      ...
      <tr>
             ...
             <tr>
                     ...
                     <td class="CellTextBox" colspan="1">
                        <%--  <asp:dropdownlist ID="txtServiceID" runat="server" Width="35.5%" DataSourceID="SqlDSService" DataTextField="ContractGroup" DataValueField="ContractGroup" AutoPostBack="FALSE" AppendDataBoundItems="TRUE" >
