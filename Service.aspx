<%@ Page Title="Service" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"  CodeFile="Service.aspx.vb" Inherits="Service" Culture="en-GB" EnableEventValidation="false"  %>
    ...
    <asp:UpdatePanel ID="updPanelService1" runat="server" UpdateMode="Conditional">
      ...
      <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" ScriptMode="Release">
       ...
       <div style="text-align:center">
            ...
            <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">SERVICE</h3>
        ...
        <table border="0" style="width:100%;text-align:center;">
            ...
            <tr>
                 <td colspan="1" rowspan="1" style="width:10%; text-align:center;color:brown;font-size:18px;font-weight:bold;font-family:'Calibri';"> 
            <asp:ImageButton ID="btnWorkLoadDateL"  runat="server" CssClass="righttextbox" Height="18px" Visible="true" OnClientClick="currentdatetime()" ImageAlign="Middle" ImageUrl="~/Images/ArrowL.gif" Width="14px" OnClick="btnWorkLoadDateL_Click" />

                     <asp:Label ID="Label16" runat="server" Text="Date: "></asp:Label> <asp:Label ID="Label14" runat="server" Text=""></asp:Label>  
                          <asp:ImageButton ID="btnWorkLoadDateR"  runat="server" CssClass="righttextbox" Height="18px" Visible="true" OnClientClick="currentdatetime()" ImageAlign="Middle" ImageUrl="~/Images/ArrowR.gif" Width="14px" OnClick="btnWorkLoadDateR_Click" />

              
                     </td>


                 <td colspan="1" rowspan="1" style= "text-align:left;color:brown;font-size:18px;font-weight:bold;font-family:'Calibri';"> 
     
        </td>
                          

            <td style=" text-align:left;color:brown;font-size:18px;font-weight:bold;font-family:'Calibri';padding-left:10px;"> 
                <asp:TextBox ID="txtSearchCustRequest" Visible="true" runat="server" MaxLength="50" Height="16px" Width="300px" Text = "Search Here for Request details" ForeColor = "Gray" onblur = "WaterMarkRequest(this, event);" onfocus = "WaterMarkRequest(this, event);" AutoPostBack="True"></asp:TextBox>
                     <asp:ImageButton ID="btnResetCustRequest" runat="server" ImageUrl="~/Images/reset1.png" Height="16px" Width="18px" ToolTip="RESET CUST REQUEST" />
 
        <asp:TextBox ID="txtSearchCustRequest1" runat="server" Visible="False"></asp:TextBox>
                         
      </td>      
                 <td colspan="1" rowspan="1" style=" text-align:left;color:brown;font-size:18px;font-weight:bold;font-family:'Calibri';"></td>
            </tr>
      ...
      <asp:Panel ID="pnlGrid" runat="server" BackColor="White" BorderColor="#003366" BorderWidth="1" Height="100px" ScrollBars="Auto" style="text-align:center; margin-left:0%; margin-right:auto;"    Visible="true" Width="240px">
             
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">            
          <ContentTemplate>
            <asp:GridView id="grdWorkLoad" runat="server" DataSourceID="SqlDSWorkLoad" BackColor="White" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" Font-Size="15px"  AllowSorting="True" Font-Names="Calibri" RowStyle-CssClass="gridcell" ForeColor="#333333" GridLines="Vertical" Height="10%"  Width="100%">
       ...
       <asp:SqlDataSource ID="SqlDSWorkLoad" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>" SqlCacheDependency="CommandNotification">
              ...
              <td colspan="1" rowspan="1" style="width:6%; text-align:left;color:brown;font-size:18px;font-weight:bold;font-family:'Calibri';"> 
                 ...
                 <asp:ImageButton ID="btnReset" runat="server" ImageUrl="~/Images/reset1.png" Height="25px" Width="25px" ToolTip="RESET WORKLOAD" />
                             ...
                             <td colspan="1" rowspan="1" style="text-align:left;color:brown;font-size:18px;font-weight:bold;font-family:'Calibri';padding-left:10px;padding-top:0px;">
                                  ...
                                  <asp:Panel ID="pnlCustomerRequest" runat="server" BackColor="White" BorderColor="#003366" BorderWidth="1" Height="100px" ScrollBars="Auto" style="text-align:left;margin-left:0%; margin-right:auto;" Visible="true" Width="700px">
                         <%-- <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                              <ContentTemplate>--%>
                                  <asp:GridView ID="grdCustRequest" runat="server" AutoGenerateColumns="false" AllowSorting="True" BackColor="White" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataSourceID="SqlDSCustRequest" Font-Names="Calibri" Font-Size="15px" ForeColor="#333333" GridLines="Vertical" Height="10%" RowStyle-CssClass="gridcell" Width="100%">
                                      <Columns>
               ...
               <ItemTemplate>
                ...
                <ItemTemplate>
                    ...
                    <ItemStyle Wrap="True" Width="150px" />
                              ...
                              <asp:TemplateField><ItemTemplate><asp:LinkButton ID="lnkViewCustRequest" runat="server" CommandArgument='<%# Eval("Rcno")%>' OnClick="ViewCustRequest" Text="View" /></ItemTemplate>
                                  ...
                                  <asp:SqlDataSource ID="SqlDSCustRequest" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>"></asp:SqlDataSource>
                              <%--</ContentTemplate>
                             
        <Triggers>
           
             <asp:PostBackTrigger ControlID="ContentPlaceHolder1_grdCustRequest_lnkViewCustRequest" />
            ...
            <td rowspan="1" style="width:10%; text-align:left;color:brown;font-size:18px;font-weight:bold;font-family:'Calibri';"> 
                      <asp:Panel ID="pnlAvailableTechnician" runat="server" BackColor="White" Height="100px" ScrollBars="Auto" style="text-align:center; margin-left:0%; margin-right:auto;padding-top:5px" Visible="true" Width="180px" BorderStyle="None">
                          <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                              <ContentTemplate>
                                  <asp:GridView ID="grdAvailableTechnician" runat="server" Visible="false" AllowSorting="True" BackColor="White" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataSourceID="SqlDSAvailableTechnician" Font-Names="Calibri" Font-Size="15px" ForeColor="#333333" GridLines="Vertical" Height="10%" RowStyle-CssClass="gridcell" Width="100%">
                                      <Columns>
                                      </Columns>
                                      <EditRowStyle BackColor="#2461BF" />
                                      <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                  ...
                                  <asp:SqlDataSource ID="SqlDSAvailableTechnician" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>" SqlCacheDependency="CommandNotification"></asp:SqlDataSource>
                              </ContentTemplate>
                          </asp:UpdatePanel>
                      </asp:Panel>
                  </td> 
           ...
           <%-- <tr>
            ...
            <tr>
                <td colspan="8" style="width:100%;text-align:left;"> 
                    ...
                    <asp:Button ID="btnADD" runat="server" CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="ADD" Width="90px" Height="30px" />
                         <asp:Button ID="btnCopy" runat="server" Font-Bold="True" Text="COPY" Width="90px"  CssClass="roundbutton1" BackColor="#CFC6C0" visible="TRUE" Height="30px" />
               
                         <asp:Button ID="btnEdit" runat="server" Font-Bold="True" Text="EDIT" Width="90px"  CssClass="roundbutton1" BackColor="#CFC6C0" visible="TRUE" Height="30px" />
               
                    <asp:Button ID="btnDelete" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="DELETE" Width="90px" OnClientClick = "ConfirmDeleteSvc()" Height="30px" Visible="False"/>
                  <asp:Button ID="btnPrint" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="PRINT" Width="100px" Visible="TRUE" Height="30px" />
                ...
                <asp:Button ID="btnUpdate" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="UPDATE/REVERSE" Width="140px" Height="30px" OnClientClick = "ConfirmUpdate()" />
             
                <asp:Button ID="btnUpdateContract" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="UPDATE CONTRACT" Width="150px" Height="30px" Visible="False" />
               <asp:Button ID="btnTransactions" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="TRANSACTIONS" Width="150px" Height="30px" Visible="TRUE" />
           
               <asp:Button ID="btnReCalculate" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="RECALCULATE" Width="120px" Height="30px" />
             <asp:Button ID="btnUpdateWorkLoad" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="UPDATE WORKLOAD" Width="160px" Height="30px" Visible="False" />
             
                 </td>            
                      
                       
                 <td style="text-align:right;"> <asp:Button ID="btnBack" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="BACK" Width="90px" Height="30px" Visible="False" />
...
<%--                 <tr class="left">
    ...
    <tr>
        ...
        <td class="CellFormat" style="text-align:left;width:100px;">Completed</td>
   
        <td style="background-color:Gold;width:40px;height:20px">&nbsp;</td>
        <td class="CellFormat" style="text-align:left;width:90px">OnGoing</td>
   
         <td style="background-color:Red;width:40px;height:20px">&nbsp;</td>
        <td class="CellFormat" style="text-align:left;width:90px">Overdue</td>

        <td style="background-color:magenta;width:40px;height:20px">&nbsp;</td>
        <td class="CellFormat" style="text-align:left;width:300px">Originally scheduled on previous month</td>
    </tr>
    ...
    <div style="overflow:scroll; color: #000000; background-color: #FFFFFF;text-align:center" onscroll="OnScrollDiv(this)" id="DivMainContent">
            ...
            <Columns>   
              ...
              <%-- 0  --%> <asp:CommandField HeaderText="Select" ShowHeader="false" ShowSelectButton="True" Visible="false" >
      ...
      <%-- 10  --%>                <asp:BoundField DataField="SchServiceTime" HeaderText="Sch. TimeIn" SortExpression="SchServiceTime">
           ...
           <%-- 20 --%>     <asp:TemplateField ><ItemTemplate> <asp:ImageButton ID="btnEditBillAmt" runat="server" CssClass="righttextbox" Height="18px" ImageAlign="Top" ImageUrl="~/Images/Edit.png" Width="20px" OnClick="btnEditBillAmt_Click"  />
              </ItemTemplate></asp:TemplateField>
        ...
        <%-- 30 --%>        <asp:BoundField DataField="ContractNo" HeaderText="ContractNo" SortExpression="ContractNo">
                     <ControlStyle Width="150px" />
                  <ItemStyle Width="150px" Wrap="False" />
                </asp:BoundField>
       ...
       <%-- 40  --%>           <asp:TemplateField HeaderText="Remarks" >
                <ItemTemplate>
                    <div style="width: 300px;text-align:left;height:37px;overflow-y:auto;">
                        <%# Eval("Remarks")%>
                    </div>
           ...
           <%-- 50 --%>        <asp:BoundField DataField="TabletID" HeaderText="Mobile Device ID" SortExpression="TabletID">
                  <ItemStyle Wrap="False" />
                  </asp:BoundField>
           ...
           <%-- 60 --%>        <asp:BoundField DataField="SchServiceDate">
                  <ControlStyle CssClass="dummybutton" />
                  <HeaderStyle CssClass="dummybutton" />
                  <ItemStyle CssClass="dummybutton" />
                  </asp:BoundField>
      ...
      <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>" OnSelecting="SqlDataSource1_Selecting">
            ...
            <asp:Button ID="Button1" runat="server" Text="Add" OnClick="Insert" />
             ...
             <tr style="width:100%" >
                ...
                <td style="width:14%; text-align:left; font-family:Calibri; vertical-align:middle; padding-left:1%"  >
                    <asp:Label ID="lblContractStartDate" runat="server" Font-Bold="True" ForeColor="Red" Text=""  ></asp:Label>       
                </td>

                 <td style="width:14%; text-align:left; font-family:Calibri; vertical-align:middle; padding-left:1%" >
                    <asp:Label ID="lblContractEndDate" runat="server" Font-Bold="True" ForeColor="Red" Text=""  ></asp:Label>
                 </td>

                
                 <td style="width:14%; text-align:center; font-family:Calibri; vertical-align:middle;" >
                    <asp:Label ID="lblActualEnd" runat="server" Font-Bold="True" ForeColor="Red" Text=""  ></asp:Label>
                 </td>
               
                
                 <td style="width:12%; text-align:center; font-family:Calibri; ">
                     <asp:Label ID="lblTotalServices" runat="server" Font-Bold="True" ForeColor="Red" Text=""  ></asp:Label>
                 </td>

                <td style="width:12%; text-align:center; font-family:Calibri; ">
                     <asp:Label ID="lblCompletedServices" runat="server" Font-Bold="True" ForeColor="Red" Text=""  ></asp:Label>
                 </td>

                <td style="width:12%; text-align:center; font-family:Calibri; ">
                     <asp:Label ID="lblOutstandingServices" runat="server" Font-Bold="True" ForeColor="Red" Text=""  ></asp:Label>
                 </td>

                <td colspan="1" style="width:12%; text-align:right; font-family:Calibri; ">
                       <asp:Label ID="Label21" runat="server" Font-Bold="True" ForeColor="Red" Text="Total Service Value: "></asp:Label>    
                 </td>
                 ...
                 <tr style="width:100%; " >
                     ...
                     <td  style="width:14%; text-align:left; font-family:Calibri; vertical-align:middle; padding-left:1% "  >
		                 <asp:Label ID="lblWarrantyStartDate" runat="server" Font-Bold="True" ForeColor="Red" Text=""  ></asp:Label></td>

                <td style="width:14%; text-align:left; font-family:Calibri; vertical-align:middle; padding-left:1% "  >
			         <asp:Label ID="lblWarrantyEndDate" runat="server" Font-Bold="True" ForeColor="Red" Text=""  ></asp:Label></td>

               
                           
                     <td style="width:14%; text-align:center; font-family:Calibri; vertical-align:middle;">&nbsp;</td>
                     <td style="width:12%; text-align:center; font-family:Calibri; ">&nbsp;</td>
                     <td style="width:12%; text-align:center; font-family:Calibri; ">&nbsp;</td>
                     <td style="width:12%; text-align:center; font-family:Calibri; ">&nbsp;</td>
                     <td colspan="1" style="width:12%; text-align:right; font-family:Calibri; ">&nbsp;</td>
                     <td style="width:10%; text-align:left; font-family:Calibri; ">&nbsp;</td>
                      ...
                      <tr>
                     <td style="width:14%; text-align:left; font-family:Calibri; vertical-align:middle; ">&nbsp;</td>
                     <td colspan="8" style="width:14%; text-align:left; font-family:Calibri; vertical-align:middle; ">&nbsp;</td>
                </tr>

                <tr>

                     <td  style="width:14%; text-align:left; font-family:Calibri; vertical-align:middle; "  >
		        </td>

                    <td colspan="7" style="width:14%; text-align:left; font-family:Calibri; vertical-align:middle; ">
                         <asp:CheckBox ID="chkDisplayforSameSite" runat="server" AutoPostBack="True" CssClass="CellFormat" Text="Display record for this site regardless of the Contract number" />
                 ...
                 <tr>
                  ...
                  <tr>
                    <td colspan="8">
                        <asp:GridView ID="grdLastServiceDetails" runat="server" AllowSorting="True" AutoGenerateColumns="False" BorderColor="White" BorderStyle="None" DataSourceID="SqlDSLastServiceDetails" Font-Names="Calibri" Font-Size="15px" GridLines="None" Height="10%" RowStyle-CssClass="gridcell" Width="95%">
                            <Columns>
                                <asp:BoundField DataField="ServiceBy" HeaderText="ServiceBy">
                                <HeaderStyle HorizontalAlign="Center" />
                                ...
                                <asp:BoundField DataField="ServiceDate" DataFormatString="{0:dd/MM/yyyy}" HeaderText="LastServiceDate" />
                                <asp:BoundField DataField="ReportServiceStart" HeaderText="Report Service Start" SortExpression="ReportServiceStart" />
                                <asp:BoundField DataField="ReportServiceEnd" HeaderText="Report Service End" SortExpression="ReportServiceEnd" />
                                <%--      <asp:TemplateField HeaderText="Report Service Start">  
                                              <ItemTemplate><asp:Label ID="txtReportServiceStart" runat="server" Width="50px" Height="15px" BorderStyle="None"  Font-Names="Calibri" Font-Size="15px"  ForeColor="Red" Font-Bold="true"  AutoPostBack="False" > </asp:Label></ItemTemplate><HeaderStyle HorizontalAlign="Center" />
                                       
                                                   </asp:TemplateField>  <asp:TemplateField HeaderText="Report Service End">  
                                              <ItemTemplate><asp:Label ID="txtReportServiceEnd" runat="server" Width="50px" Height="15px" BorderStyle="None"  Font-Names="Calibri" Font-Size="15px"  ForeColor="Red" Font-Bold="true"  AutoPostBack="False" > </asp:Label></ItemTemplate><HeaderStyle HorizontalAlign="Center" />
                                          </asp:TemplateField>--%><%--     <asp:BoundField DataField="ServiceDate" HeaderText="Report Service Start" SortExpression="ServiceDate" />

                                          <asp:BoundField DataField="ServiceDate" HeaderText="Report Service End" SortExpression="ServiceDate" />--%>
                                <asp:TemplateField HeaderText="Report Duration">
                                    <ItemTemplate>
                                        <asp:Label ID="txtReportDuration" runat="server" AutoPostBack="False" BorderStyle="None" Font-Bold="true" Font-Names="Calibri" Font-Size="15px" ForeColor="Red" Height="15px" Width="50px"> </asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" />
                                </asp:TemplateField>
                                <asp:BoundField DataField="ServiceDate" DataFormatString="{0:dddd}" HeaderText="Day" />
                                <asp:BoundField DataField="Time" HeaderText="ActualTime" />
                                <asp:BoundField DataField="TotalActualDuration" HeaderText="Total Duration" />
                                <asp:TemplateField HeaderText="Action Done">
                                    <ItemTemplate>
                                        <asp:Button ID="btnViewActionDone" runat="server" CssClass="righttextbox" Height="25px" ImageAlign="Top" OnClick="btnViewActionDone_Click" OnClientClick="currentdatetime()" Text="View" Visible="True" Width="70px" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField Visible="False">
                                    <EditItemTemplate>
                            ...
                            <HeaderStyle Font-Bold="True" Font-Names="Calibri" Font-Underline="True" ForeColor="Blue" />
                            <RowStyle Font-Bold="True" Font-Names="Calibri" ForeColor="Red" />
                        </asp:GridView>
                        <br />
    ...
    <tr><td class="CellFormat">ContractNo<asp:Label ID="Label58" runat="server" Font-Size="14px" ForeColor="Red" Height="20px" Text="*"></asp:Label></td><td class="CellTextBox" colspan="4"><asp:TextBox ID="txtContractNo" runat="server" Height="16px" MaxLength="25" Width="20%" AutoPostBack="True"></asp:TextBox></td></tr>
     <tr><td class="CellFormat">ContractGroup</td><td class="CellTextBox" colspan="4"><asp:TextBox ID="txtContractGroup" runat="server" Height="16px" MaxLength="25" Width="20%" ReadOnly="True" Enabled="False"></asp:TextBox></td>
         ...
         <tr>
             ...
             <td class="CellTextBox" colspan="1">
                 <asp:TextBox ID="txtReportServiceStart" runat="server" Height="16px" MaxLength="10" Width="47%"></asp:TextBox>
             ...
             <td class="CellTextBox" colspan="1">
                 <asp:TextBox ID="txtReportServiceStartTime" runat="server" AutoCompleteType="Disabled" Height="16px" MaxLength="8" Width="38%"></asp:TextBox>
          ...
          <tr>
             ...
             <td class="CellTextBox" colspan="1">
                 <asp:TextBox ID="txtReportServiceEnd" runat="server" Height="16px" MaxLength="10" Width="47%"></asp:TextBox>
             ...
             <td class="CellTextBox" colspan="1">
                 <asp:TextBox ID="txtReportServiceEndTime" runat="server" AutoCompleteType="Disabled" Height="16px" MaxLength="8" Width="38%"></asp:TextBox>
         ...
         <tr>
             <td colspan="5" style="font-size:15px;font-weight:bold;font-family:'Calibri';color:#800000; text-align:left; text-decoration: underline;padding-left:10%;">Billing Information</td>
         </tr>
         <tr>
             <td class="CellFormat">AmountToBill</td>
             <td class="CellTextBox" colspan="4">
                 <asp:TextBox ID="txtAmtBill" runat="server" Height="16px" MaxLength="18" style="text-align:right" Width="20%"></asp:TextBox>
             </td>
         </tr>
         <tr>
             <td class="CellFormat">InvoiceNo.</td>
             <td class="CellTextBox" colspan="4">
                 <asp:TextBox ID="txtInvoiceNo" runat="server" Height="16px" MaxLength="25" Width="20%"></asp:TextBox>
             </td>
         </tr>
         <tr>
             <td class="CellFormat">InvoicedAmount</td>
             <td class="CellTextBox" colspan="4">
                 <asp:TextBox ID="txtInvoicedAmt" runat="server" Height="16px" MaxLength="10" style="text-align:right" Width="20%"></asp:TextBox>
             </td>
         </tr>
         <tr>
             <td colspan="5">
         ...
         <tr>
             <td colspan="5" style="font-size:15px;font-weight:bold;font-family:'Calibri';color:#800000; text-align:left; text-decoration: underline;padding-left:10%;">Payment Information</td>
         </tr>
         <tr>
             <td></td>
             <td class="CellTextBox" colspan="4">
                 <asp:CheckBox ID="chkPayment" runat="server" CssClass="CellFormat" Text="Collect Payment Upon Service" />
             </td>
         </tr>
         <tr>
             <td class="CellFormat">AmountToCollect</td>
             <td class="CellTextBox" colspan="4">
                 <asp:TextBox ID="txtCollectAmt" runat="server" Height="16px" MaxLength="10" style="text-align:right" Width="20%"></asp:TextBox>
             </td>
         </tr>
         <tr>
             <td class="CellFormat">CollectedAmount</td>
             <td class="CellTextBox" colspan="4">
                 <asp:TextBox ID="txtAmountRecvd" runat="server" BackColor="#EBEBEB" Height="16px" MaxLength="10" ReadOnly="True" style="text-align:right" Width="20%"></asp:TextBox>
                 <asp:ImageButton ID="btnEditCollectedAmount" runat="server" CssClass="righttextbox" Height="22px" ImageAlign="Top" ImageUrl="~/Images/Edit.png" Width="24px" />
             </td>
         </tr>
         <tr>
             <td class="CellFormat">PaymentType</td>
             <td class="CellTextBox" colspan="4">
                 <asp:TextBox ID="txtPaymentType" runat="server" BackColor="#EBEBEB" Height="16px" MaxLength="20" ReadOnly="True" Width="20%"></asp:TextBox>
         ...
         <tr>
             <td class="CellFormat">ReferenceNo.</td>
             <td class="CellTextBox" colspan="4">
                 <asp:TextBox ID="txtRefNo" runat="server" BackColor="#EBEBEB" Height="16px" MaxLength="25" ReadOnly="True" Width="20%"></asp:TextBox>
             </td>
         </tr>
         <tr>
             <td colspan="5" style="font-size:15px;font-weight:bold;font-family:'Calibri';color:#800000; text-align:left; text-decoration: underline;padding-left:10%;">Signature</td>
         </tr>
         <tr>
             <td colspan="5">
                 <table class="Centered" style="width:80%">
                     <tr>
                         <td class="CellFormat" rowspan="2" style="width:10%">CustomerSign</td>
                         <td class="CellTextBox">
                             <asp:CheckBox ID="chkReqCustSign" runat="server" CssClass="CellFormat" Text="Require Client Signature" />
                             &nbsp;&nbsp;<asp:ImageButton ID="btnEditClientSign" runat="server" CssClass="righttextbox" Height="22px" ImageAlign="Top" ImageUrl="~/Images/Edit.png" Width="24px" />
                             <asp:Panel ID="Panel6" runat="server" BorderColor="Silver" BorderStyle="Solid" BorderWidth="2px" Height="100px" Width="95%">
                                 <asp:Image ID="Image1" runat="server" Height="100px" Width="100%" />
                             </asp:Panel>
                             <asp:Label ID="lblCustomerSignName" runat="server" Font-Names="Calibri" ForeColor="Black"></asp:Label>
                             <br />
                             <asp:Label ID="lblCustomerSignDate" runat="server" Font-Names="Calibri" ForeColor="Black"></asp:Label>
                         </td>
                         <td class="CellFormat" rowspan="2" style="width:10%">ServiceStaffSign</td>
                         <td rowspan="2" style="width:40%">
                             <asp:Panel ID="Panel7" runat="server" BorderColor="Silver" BorderStyle="Solid" BorderWidth="2px" Height="100px" Width="95%">
                                 <asp:Image ID="Image2" runat="server" Height="100px" Width="100%" />
                             </asp:Panel>
                             <asp:Label ID="lblSvcStaffSignName" runat="server" Font-Names="Calibri" ForeColor="Black"></asp:Label>
                             <asp:Label ID="lblSvcStaffSignDate" runat="server" Font-Names="Calibri" ForeColor="Black"></asp:Label>
                         </td>
                     </tr>
                 </table>
             </td>
...
<asp:SqlDataSource ID="SqlDSTS1" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" FilterExpression="RecordNo = '{0}'" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>"><FilterParameters><asp:ControlParameter ControlID="lblRecordNo" Name="RecordNo" PropertyName="Text" Type="String" /></FilterParameters><SelectParameters><asp:ControlParameter ControlID="txtServiceRecord" Name="@RecordNo" PropertyName="Text" /></SelectParameters></asp:SqlDataSource>
                                   ...
                                   <asp:TabPanel ID="TabPanel8" runat="server" HeaderText="Items Issued"><HeaderTemplate>
 <asp:Label ID="lblItemCount" runat="server" Font-Size="13px" Text="Items Issued"></asp:Label>
</HeaderTemplate>
<ContentTemplate>
<table style="padding-top:5px;width:100%;"><tr><td colspan="2" style="text-align:center;color:brown;font-size:16px;font-weight:bold;font-family:'Calibri';"><asp:Label ID="txtItemsIssuedMode" runat="server" CssClass="dummybutton"></asp:Label></td></tr><tr style="vertical-align: middle"><td colspan="2" style="text-align:left;"><asp:Button ID="btnItemsIssuedAdd" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" OnClientClick="currentdatetime()" Text="ADD" Width="90px" /><asp:Button ID="btnItemsIssuedEdit" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" OnClientClick="currentdatetime()" Text="EDIT" Width="90px" /><asp:Button ID="btnItemsIssuedDelete" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" OnClientClick="Confirm()" Text="DELETE" Width="90px" /></td></tr><tr><td colspan="2"><br /></td></tr><tr><td colspan="2" style="text-align:center">
    <asp:GridView ID="grdViewItemsIssued" runat="server" AllowSorting="True" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataKeyNames="Rcno" Font-Size="12pt" ForeColor="#333333" GridLines="Vertical" HorizontalAlign="Center"><AlternatingRowStyle BackColor="White" /><Columns><asp:CommandField HeaderText="Select" ShowHeader="True" ShowSelectButton="True" Visible="False"><ControlStyle Width="50px" /><ItemStyle Width="50px" /></asp:CommandField><asp:BoundField DataField="ItemID" HeaderText="Item ID" SortExpression="ItemID"><HeaderStyle Width="150px" /><ItemStyle Width="150px" Wrap="False" /></asp:BoundField><asp:BoundField DataField="ItemName" HeaderText="Item Name" SortExpression="ItemName"><HeaderStyle Width="250px" /><ItemStyle Width="250px" Wrap="False" /></asp:BoundField><asp:BoundField DataField="Qty" DataFormatString="{0:f2}" HeaderText="Qty" SortExpression="Qty"><ItemStyle Width="100px" /></asp:BoundField><asp:BoundField DataField="UnitMS" HeaderText="Unit" SortExpression="UnitMS" /><asp:BoundField DataField="Remarks" HeaderText="Remarks" /><asp:BoundField DataField="RecordNo" HeaderText="RecordNo" SortExpression="RecordNo" Visible="False" /><asp:TemplateField HeaderText="Rcno" InsertVisible="False" SortExpression="Rcno" Visible="False"><EditItemTemplate><asp:Label ID="Label1" runat="server" Text='<%# Eval("Rcno") %>'></asp:Label></EditItemTemplate><ItemTemplate><asp:Label ID="Label1" runat="server" Text='<%# Bind("Rcno") %>'></asp:Label></ItemTemplate></asp:TemplateField><asp:BoundField DataField="CreatedBy" HeaderText="CreatedBy" SortExpression="CreatedBy" Visible="False" /><asp:BoundField DataField="CreatedOn" HeaderText="CreatedOn" SortExpression="CreatedOn" Visible="False" /><asp:BoundField DataField="LastModifiedBy" HeaderText="LastModifiedBy" SortExpression="LastModifiedBy" Visible="False" /><asp:BoundField DataField="LastModifiedOn" HeaderText="LastModifiedOn" SortExpression="LastModifiedOn" Visible="False" /></Columns><EditRowStyle BackColor="#2461BF" /><FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" /><HeaderStyle BackColor="#2461BF" Font-Bold="True" Font-Names="Calibri" ForeColor="White" /><PagerStyle BackColor="#507CD1" ForeColor="White" HorizontalAlign="Center" /><RowStyle BackColor="#EFF3FB" Font-Names="Calibri" /><SelectedRowStyle BackColor="#00CCFF" Font-Bold="True" ForeColor="#333333" /><SortedAscendingCellStyle BackColor="#F5F7FB" /><SortedAscendingHeaderStyle BackColor="#6D95E1" /><SortedDescendingCellStyle BackColor="#E9EBEF" /><SortedDescendingHeaderStyle BackColor="#4870BE" /></asp:GridView></td></tr><tr><td colspan="2"><br /></td></tr><tr><td class="CellFormat" style="width:350px">RecordNo </td><td class="CellTextBox" colspan="1"><asp:Label ID="lblRecordNoItemsIssued" runat="server" BackColor="#CCCCCC" Height="18px" MaxLength="100" Width="40%"></asp:Label></td></tr><tr><td colspan="2"><br /></td></tr><tr><td class="CellFormat" style="width:350px">Item ID <asp:Label ID="Label27" runat="server" Font-Size="14px" ForeColor="Red" Height="20px" Text="*"></asp:Label></td><td class="CellTextBox" colspan="1"><asp:DropDownList ID="ddlItemIDItemsIssued" runat="server" AppendDataBoundItems="True" AutoPostBack="True" DataTextField="IDNAME" DataValueField="ItemID" Width="40%"><asp:ListItem Text="--SELECT--" Value="-1" /></asp:DropDownList></td></tr><tr><td class="CellFormat" style="width:350px">Quantity <asp:Label ID="Label59" runat="server" Font-Size="14px" ForeColor="Red" Height="20px" Text="*"></asp:Label></td><td class="CellTextBox" colspan="1"><asp:TextBox ID="txtQtyItemsIssued" runat="server" Height="16px" MaxLength="100" Width="40%"></asp:TextBox></td></tr><tr><td class="CellFormat" style="width:350px">Unit of MS</td><td class="CellTextBox" colspan="1"><asp:TextBox ID="txtUnitItemsIssued" runat="server" Height="16px" MaxLength="100" Width="40%"></asp:TextBox></td></tr><tr><td class="CellFormat" style="width:350px">Remarks</td><td class="CellTextBox" colspan="1"><asp:TextBox ID="txtRemarksItemsIssued" runat="server" Height="16px" MaxLength="100" Width="40%"></asp:TextBox></td></tr><tr><td colspan="2" style="text-align:right;"><asp:Button ID="btnItemsIssuedSave" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" OnClientClick="currentdatetime()" Text="SAVE" Width="100px" /><asp:Button ID="btnItemsIssuedCancel" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="CANCEL" Width="100px" /></td></tr></table>
    <asp:SqlDataSource ID="SQLDSItems" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" FilterExpression="RecordNo = '{0}'" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>"><FilterParameters><asp:ControlParameter ControlID="lblRecordNo" Name="RecordNo" PropertyName="Text" Type="String" /></FilterParameters><SelectParameters><asp:ControlParameter ControlID="txtServiceRecord" Name="@RecordNo" PropertyName="Text" /></SelectParameters></asp:SqlDataSource>
    <asp:SqlDataSource ID="sqlDSItemsIssued" runat="server" OnSelected="sqlDSItemsIssued_Selected" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>" SelectCommand="
         "></asp:SqlDataSource><asp:TextBox ID="txtItemsIssuedRcNo" runat="server" Visible="False"></asp:TextBox>
</ContentTemplate>
</asp:TabPanel>
...
'>
    ...
    <asp:SqlDataSource ID="SqlDSServiceArea" runat="server" OnSelected="SqlDSServiceArea_Selected" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" FilterExpression="RecordNo = '{0}'" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>" SelectCommand="SELECT distinct rcno,Description, PricePerSquareMeter, AreaCompleted, TotalPriceOfCompletedArea, RecordNo,CreatedBy, CreatedOn, LastModifiedBy, LastModifiedOn from tblservicerecordservicearea  where Recordno =@RecordNo"><FilterParameters><asp:ControlParameter ControlID="lblRecordNo" Name="RecordNo" PropertyName="Text" Type="String" /></FilterParameters><SelectParameters><asp:ControlParameter ControlID="txtServiceRecord" Name="@RecordNo" PropertyName="Text" /></SelectParameters></asp:SqlDataSource><asp:TextBox ID="txtAreaRcNo" runat="server" Visible="False"></asp:TextBox>
</ContentTemplate>
</asp:TabPanel>
                                <asp:TabPanel ID="TabPanel6" runat="server" HeaderText="Service Photos" TabIndex="6"><HeaderTemplate>
<asp:Label ID="lblServicePhotosCount" runat="server" Font-Size="13px" Text="Service Photos"></asp:Label>
</HeaderTemplate>
<ContentTemplate>
     <asp:Label ID="lblPhotoMessage" runat="server" BackColor="Red" ForeColor="White" Font-Bold="True" Font-Size="18px"></asp:Label>
<asp:TextBox ID="txtLargePhotoRcNo" runat="server" Visible="False"></asp:TextBox>
    <asp:TextBox ID="txtCheckboxValue" runat="server" Visible="False"></asp:TextBox>
<table class="centered" style="text-align:center;width:70%;padding-top:10px;">
  
    <tr><td class="CellFormat">RecordNo </td><td class="CellTextBox"><asp:Label ID="lblRecordNo6" runat="server" BackColor="#CCCCCC" Height="16px" MaxLength="100" ReadOnly="True" Width="50%"></asp:Label></td></tr>
    <tr><td colspan="2"><br /></td></tr><tr><td colspan="2"><asp:TextBox ID="TextBox2" runat="server" AutoCompleteType="Disabled" AutoPostBack="True" Height="16px" MaxLength="50" style="text-align: left;" Visible="False" Width="5%"></asp:TextBox>
        <asp:TextBox ID="TextBox3" runat="server" AutoCompleteType="Disabled" AutoPostBack="false" Height="16px" MaxLength="50" style="text-align: left;" Visible="False" Width="5%"></asp:TextBox><br /></td></tr>
    <tr ><td class="left" colspan="2"><asp:Button ID="btnViewPhotos" runat="server" Text="View Uploaded Photos" /><br /><br /></td></tr>
    <tr><td class="CellFormat">Select Photo to Upload </td><td class="CellTextBox" colspan="1" style="text-align:center"><asp:FileUpload ID="FileUpload2" runat="server" CssClass="Centered" Width="100%" AllowMultiple="True" /></td></tr>
    <tr><td class="CellFormat">Description </td><td class="CellTextBox" colspan="1" style="text-align:left"><asp:TextBox ID="txtPhotoDescription" runat="server" Width="70%"></asp:TextBox></td></tr>
      <tr><td class="CellFormat">LargePhoto </td><td class="CellTextBox" colspan="1" style="text-align:left">
          <asp:CheckBox ID="chkLargePhoto" runat="server" /></td></tr>
  
    <tr><td class="centered" colspan="2"><asp:Button ID="btnPhotoUpload" runat="server" Text="Upload" /></td></tr>
    <tr><td colspan="1" style="text-align:left;"><br /><asp:Button ID="btnDeleteAllPhotos" runat="server" Text="Delete All Photos" /></td>
        <td colspan="1" style="text-align:right;padding-right:10%"><br /><asp:Button ID="btnDownloadPhotos" runat="server" Text="Download All Photos" /></td></tr>
    <tr><td colspan="2" style="width:100%"><asp:GridView ID="gvImages" runat="server" AutoGenerateColumns="False" CssClass="Centered" ForeColor="#333333" GridLines="Vertical" OnRowDataBound="OnRowDataBound1" OnSelectedIndexChanged="OnSelectedIndexChangedImg" AllowPaging="False" OnPageIndexChanging="OnPageIndexChanging" >
        <AlternatingRowStyle BackColor="White" />
        <Columns>
           ...
           <asp:Label ID="Label1" runat="server" Text='<%# Bind("Rcno") %>'></asp:Label>
            ...
            <asp:TemplateField HeaderText="Image" Visible="true"><ItemTemplate><asp:Image ID="ImageView" runat="server" Height="180" Width="280" /></ItemTemplate></asp:TemplateField>
                 <asp:TemplateField><ItemTemplate><asp:LinkButton ID="lnkRotate" runat="server" CommandArgument='<%# Eval("Rcno")%>' OnClick="RotateImage" Text="Rotate" /></ItemTemplate></asp:TemplateField>
     
            <asp:TemplateField HeaderText="Preview Image" Visible="False"><ItemTemplate><asp:ImageButton ID="ImageButton1" runat="server" Height="200px" Visible="false" Width="200px" /></ItemTemplate></asp:TemplateField>
            <asp:BoundField DataField="Description" HeaderText="Description" />
            <asp:TemplateField><ItemTemplate><asp:LinkButton ID="lnkEditPhotoDesc" runat="server" CommandArgument='<%# Eval("Rcno")%>' OnClick="EditPhotoDesc" Text="Edit Description" /></ItemTemplate></asp:TemplateField>
            <asp:TemplateField><ItemTemplate><asp:LinkButton ID="lnkDelete" runat="server" CommandArgument='<%# Eval("Rcno")%>' OnClick="DeletePhoto" Text="Delete" /></ItemTemplate></asp:TemplateField>
                                ...
                                <asp:TabPanel ID="TabPanel5" runat="server" HeaderText="File Upload"><HeaderTemplate>
<asp:Label ID="lblFileUploadCount" runat="server" Font-Size="13px" Text="File Upload"></asp:Label>
</HeaderTemplate>
<ContentTemplate>
<table style="width:100%;height:1000px;text-align:center">
    <tr><td>
        <table style="text-align:left;width:100%;padding-top:10px;">
            <tr><td class="CellFormatnew">RecordNo </td>
            <td class="CellTextBoxnew"><asp:Label ID="lblRecordNo5" runat="server" BackColor="#CCCCCC" Height="18px" MaxLength="100" ReadOnly="True" Width="50%"></asp:Label></td></tr>
            <tr><td colspan="2"><asp:TextBox ID="txtDeleteUploadedFile" runat="server" AutoCompleteType="Disabled" AutoPostBack="True" Height="16px" MaxLength="50" style="text-align: left;" Visible="False" Width="5%"></asp:TextBox>
                ...
                <br /></td></tr>
            <tr><td class="CellFormatnew">Select File to Upload (Max. 20MB)</td>
                <td class="CellTextBoxnew">
                    <asp:FileUpload ID="FileUpload1" runat="server" CssClass="Centered" Width="100%" /></td></tr>
            <tr><td class="CellFormatnew">Description <asp:Label ID="Label65" runat="server" Font-Size="14px" ForeColor="Red" Height="20px" Text="*"></asp:Label></td>
                <td class="CellTextBoxnew">
                    <asp:TextBox ID="txtFileDescription" runat="server" Width="70%"></asp:TextBox></td></tr>
            <tr><td class="CellFormatnew"></td>
                <td class="CellTextBoxnew">
                    <asp:CheckBox ID="chkManualReport" runat="server" Font-Bold="True" Text="Manual Report" /></td></tr>
            <tr>
                <td class="centered" colspan="2" style="text-align:center">
                    <asp:Button ID="btnUpload" runat="server" CssClass="roundbutton1" OnClientClick="currentdatetime()" Text="Upload" /></td></tr><tr><td><br /></td></tr>
    <tr><td colspan="2">
        <asp:GridView ID="gvUpload" runat="server" AutoGenerateColumns="False" CssClass="Centered" DataSourceID="SqlDSUpload" EmptyDataText="No files uploaded" Width="90%">
            <Columns><asp:BoundField DataField="FileName" HeaderText="File Name" />
                 <asp:TemplateField HeaderText="ManualReport"> 
              <%-- <HeaderTemplate><asp:CheckBox ID="chkSelectAllPhotoPrintGV" runat="server" AutoPostBack="false" TextAlign="left" onchange="checkmultiprint()" Width="5%" OnCheckedChanged="chkServicesPrint_CheckedChanged" ></asp:CheckBox></HeaderTemplate>    <HeaderStyle HorizontalAlign="Left" />--%>
                     <ItemTemplate>
           <asp:Label ID="Label1" runat="server" Text='<%# Bind("Rcno") %>'></asp:Label>
     </ItemTemplate>
               <ItemTemplate>
                         <asp:CheckBox ID="chkManualReportGV" runat="server" Checked='<%# IIf(Eval("ManualReport").ToString().Equals("Y"), True, False)%>' Enabled="false"/>
</ItemTemplate>
                                                          </asp:TemplateField> 
                ...
                <asp:TemplateField><ItemTemplate><asp:LinkButton ID="lnkPreview" runat="server" CommandArgument='<%# Eval("FileNameLink")%>' OnClick="PreviewFile" Text="Preview" /></ItemTemplate></asp:TemplateField>
                <asp:TemplateField><ItemTemplate><asp:LinkButton ID="lnkDownload" runat="server" CommandArgument='<%# Eval("FileNameLink")%>' OnClick="DownloadFile" Text="Download"></asp:LinkButton></ItemTemplate></asp:TemplateField>
                <asp:TemplateField><ItemTemplate><a href="Email.aspx?Type=FileUpload" target="_blank"><asp:LinkButton ID="lnkEmail" runat="server" CommandArgument='<%# Eval("FileNameLink")%>' OnClick="EmailFile" OnClientClick="openInNewTab();" Text="Email"></asp:LinkButton></a><%--<a href ="#" title ="Update" onclick="return jsPopup('Email.aspx?Type=FileUpload&FileName=<%#Eval("FileNameLink")%> '); "> Email</a>--%></ItemTemplate></asp:TemplateField>
            ...
            </Columns><FooterStyle BackColor="#F7DFB5" ForeColor="#8C4510" /><HeaderStyle BackColor="#000066" Font-Bold="True" Font-Names="Calibri" ForeColor="White" /><PagerStyle ForeColor="#8C4510" HorizontalAlign="Center" /><RowStyle BackColor="#E4E4E4" Font-Names="Calibri" ForeColor="#8C4510" /><SelectedRowStyle BackColor="#738A9C" Font-Bold="True" ForeColor="White" /><sortedascendingcellstyle backcolor="#E4E4E4" /><sortedascendingheaderstyle backcolor="#000066" /><sorteddescendingcellstyle backcolor="#E4E4E4" /><sorteddescendingheaderstyle backcolor="#000066" /></asp:GridView><asp:SqlDataSource ID="SqlDSUpload" runat="server" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>"></asp:SqlDataSource></td></tr></table></td></tr><tr style="height:800px;width:100%"><td style="height:100%;width:100%"><br /><iframe id="iframeid" runat="server" style="width:80%;height:80%"></iframe></td></tr></table>
</ContentTemplate>
</asp:TabPanel>
                                <asp:TabPanel ID="TabPanel7" runat="server" HeaderText="Notes"><HeaderTemplate>
<asp:Label ID="lblNotesCount" runat="server" Font-Size="13px" Text="Notes"></asp:Label>
</HeaderTemplate>
<ContentTemplate>
<div style="text-align:center"><h3 style="font-family: Verdana, Geneva, Calibri, sans-serif; font-weight: bold;COLOR:#000099;">Notes</h3><table style="width:100%;text-align:center;"><tr><td colspan="2" style="text-align:left;"><asp:Button ID="btnAddNotesMaster" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="ADD" Width="100px" /><asp:Button ID="btnEditNotesMaster" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="EDIT" Width="100px" /><asp:Button ID="btnDeleteNotesMaster" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" OnClientClick="Confirm(); currentdatetime()" Text="DELETE" Width="100px" /><asp:Button ID="btn" runat="server" BackColor="#CFC6C0" CssClass="button" Font-Bold="True" Text="PRINT" Visible="False" Width="100px" /><asp:Button ID="btnQuitNotesMaster" runat="server" BackColor="#CFC6C0" CssClass="button" Font-Bold="True" Text="CLOSE" Visible="False" Width="100px" /></td></tr><tr><td colspan="2"><br /></td></tr><tr class="Centered"><td colspan="2">
    <asp:GridView ID="gvNotesMaster" runat="server" AllowSorting="True" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataKeyNames="Rcno" DataSourceID="SqlDSNotesMaster" Font-Size="15px" ForeColor="#333333" GridLines="Vertical" HorizontalAlign="Center" OnRowDataBound="OnRowDataBoundgNotes" OnSelectedIndexChanged="OnSelectedIndexChangedgNotes"><AlternatingRowStyle BackColor="White" /><Columns><asp:CommandField HeaderText="Select" ShowHeader="True" ShowSelectButton="True" Visible="False"><ControlStyle Width="150px" /><ItemStyle Width="150px" /></asp:CommandField><asp:BoundField DataField="StaffID" HeaderText="StaffID" SortExpression="StaffID"><ControlStyle Width="150px" /><HeaderStyle Font-Size="12pt" /><ItemStyle HorizontalAlign="Left" Width="150px" /></asp:BoundField><asp:BoundField DataField="Notes" HeaderText="Notes" SortExpression="Notes"><ControlStyle Width="300px" /><HeaderStyle Font-Size="12pt" /><ItemStyle HorizontalAlign="Left" Width="300px" /></asp:BoundField><asp:BoundField DataField="CreatedOn" DataFormatString="{0:dd/MM/yyyy}" HeaderText="EntryDate" SortExpression="CreatedOn" /><asp:TemplateField HeaderText="Rcno" InsertVisible="False" SortExpression="Rcno" Visible="False"><EditItemTemplate><asp:Label ID="Label1" runat="server" Text='<%# Eval("Rcno") %>'></asp:Label></EditItemTemplate><ItemTemplate><asp:Label ID="Label1" runat="server" Text='<%# Bind("Rcno") %>'></asp:Label></ItemTemplate></asp:TemplateField><asp:BoundField DataField="CreatedBy" HeaderText="EntryStaff" SortExpression="CreatedBy" /><asp:BoundField DataField="LastModifiedBy" HeaderText="EditedBy" SortExpression="LastModifiedBy" /><asp:BoundField DataField="LastModifiedOn" DataFormatString="{0:dd/MM/yyyy}" HeaderText="EditedOn" SortExpression="LastModifiedOn" /></Columns><EditRowStyle BackColor="#2461BF" /><FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" /><HeaderStyle BackColor="#2461BF" Font-Bold="True" Font-Names="Calibri" ForeColor="White" /><PagerStyle BackColor="#507CD1" ForeColor="White" HorizontalAlign="Center" /><RowStyle BackColor="#EFF3FB" Font-Names="Calibri" /><SelectedRowStyle BackColor="#00CCFF" Font-Bold="True" ForeColor="#333333" /><SortedAscendingCellStyle BackColor="#F5F7FB" /><SortedAscendingHeaderStyle BackColor="#6D95E1" /><SortedDescendingCellStyle BackColor="#E9EBEF" /><SortedDescendingHeaderStyle BackColor="#4870BE" /></asp:GridView></td></tr><tr><td colspan="2"><br /></td></tr><tr><td class="CellFormat"></td><td class="CellTextBox"><asp:Label ID="lblNotesKeyField" runat="server" BackColor="#CCCCCC" Height="16px" MaxLength="100" ReadOnly="True" Visible="False" Width="40%"></asp:Label></td></tr><tr><td class="CellFormat">StaffID </td><td class="CellTextBox"><asp:Label ID="lblNotesStaffID" runat="server" BackColor="#CCCCCC" Height="16px" MaxLength="100" ReadOnly="True" Width="40%"></asp:Label></td></tr><tr><td class="CellFormat">Notes<asp:Label ID="Label23" runat="server" Font-Size="14px" ForeColor="Red" Height="20px" Text="*"></asp:Label></td><td class="CellTextBox"><asp:TextBox ID="txtNotes" runat="server" Height="60px" MaxLength="50" TextMode="MultiLine" Width="80%"></asp:TextBox></td></tr><tr><td colspan="2" style="text-align:right"><asp:Button ID="btnSaveNotesMaster" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" OnClientClick="currentdatetime()" Text="SAVE" Width="100px" /><asp:Button ID="btnCancelNotesMaster" runat="server" BackColor="#CFC6C0" CssClass="roundbutton1" Font-Bold="True" Text="CANCEL" Width="100px" /></td></tr></table>
    <asp:SqlDataSource ID="SqlDSNotesMaster" runat="server" OnSelected="SqlDSNotesMaster_Selected" ConnectionString="<%$ ConnectionStrings:sitadataConnectionString %>" ProviderName="<%$ ConnectionStrings:sitadataConnectionString.ProviderName %>"></asp:SqlDataSource></div><asp:TextBox ID="txtNotesRcNo" runat="server" CssClass="dummybutton"></asp:TextBox><asp:TextBox ID="txtNotesMode" runat="server" CssClass="dummybutton"></asp:TextBox>
</ContentTemplate>
</asp:TabPanel>
                            </asp:TabContainer>
                        </td>
   ...
   <asp:Button ID="btnDummyEditVehNo" runat="server" CssClass="dummybutton" />
      ...
      <asp:ModalPopupExtender ID="mdlContractNotOpenCopy" runat="server" CancelControlID="" PopupControlID="pnlContractNotOpenCopy" TargetControlID="btndummyContractNotOpenCopy" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></asp:ModalPopupExtender>
         <asp:Button ID="btndummyContractNotOpenCopy" runat="server" CssClass="dummybutton" />
             ...
             <%-- Confirm Contract is not OPEN do you still wish to COPY a service report.--%>
...
<%--                           <tr>
   ...
   <tr>
    ...
    <asp:TextBox ID="txtOldSvcBy" runat="server" Visible="false"></asp:TextBox>
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="txtSearchCustRequest" />
            <asp:PostBackTrigger ControlID="txtSearchImportCustRequest" />
            <%--<asp:PostBackTrigger ControlID ="btnResetImportCustRequest" />--%>
            <asp:PostBackTrigger ControlID="tb1$TabPanel5$btnUpload" />
             <asp:PostBackTrigger ControlID="tb1$TabPanel5$gvUpload" />
   <asp:PostBackTrigger ControlID="btnExportToExcel" />
            <asp:PostBackTrigger ControlID="tb1$TabPanel6$btnPhotoUpload" />
            <asp:PostBackTrigger ControlID="tb1$TabPanel9$btnPestPhotoUpload" />
           <asp:PostBackTrigger ControlID="tb1$TabPanel6$btnDownloadPhotos" />
...
<script type="text/javascript">
    ...
    function TabChanged(sender, e) {
        ...
        if (sender.get_activeTabIndex() != 0) {
            ...
            //document.getElementById("<%=btnCopy.ClientID%>").style.display = 'none';
            ...
            //document.getElementById("<%=btnStatus.ClientID%>").style.display = 'none';
            ...
            //document.getElementById("<%=btnCopy.ClientID%>").style.display = 'inline';
            ...
            //document.getElementById("<%=btnStatus.ClientID%>").style.display = 'inline';
