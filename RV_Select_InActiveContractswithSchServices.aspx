<%@ Page Title="Scheduled Services for Inactive Contracts" Language="VB" MasterPageFile="~/MasterPage_Report.master" AutoEventWireup="false" CodeFile="RV_Select_InActiveContractswithSchServices.aspx.vb" Inherits="RV_Select_InActiveContractswithSchServices" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <script type="text/javascript">
     ...
     <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" ScriptMode="Release">
       ...
       <h4 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold;COLOR:#000099;">Scheduled Services for Inactive Contracts</h4>
      ...
      <tr>
             ...
             <tr>
                ...
                <asp:ListItem Text="--SELECT--" Value="-1" />
                         ...
                         <cc1:dropdowncheckboxes ID="txtServiceID" runat="server" Width="38%" UseSelectAllNode = "true" DataSourceID="SqlDSContractGroup" DataTextField="ContractGroup" DataValueField="ContractGroup" AddJQueryReference="true" UseButtons="false" >
