<%@ Page Title="City Master" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Master_City.aspx.vb" Inherits="Master_City" Culture="en-GB" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="text-align:center">
        ...
        <h3 style="font-family: Verdana, Geneva, Calibri, sans-serif; font-weight: bold;COLOR:#000099;">City.</h3>
...
<asp:Button ID="btnDelete" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="DELETE" Width="100px" OnClientClick = "Confirm(); currentdatetime()"/>
                        ...
                        <asp:Button ID="btnPrint0" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Width="20px" Visible="False" />
            ...
            <Columns>
                ...
                <asp:BoundField DataField="CountrySqlCode" HeaderText="CountrySqlCode" SortExpression="CountrySqlCode" Visible="False" >
                </asp:BoundField>
          ...
          <tr>
            ...
            <tr>
                    ...
                    <td class="CellFormatADM">City<asp:Label ID="Label23" runat="server" visible="true" Font-Size="14px" ForeColor="Red" Text="*" Height="20px"></asp:Label></td>
                     

                    <td class="CellTextBoxADM"> <asp:TextBox ID="txtCity" runat="server" MaxLength="50" Height="16px" Width="30%"></asp:TextBox></td>
              ...
              <tr>
                    ...
                    <td class="CellFormatADM">Country<asp:Label ID="Label3" runat="server" visible="False" Font-Size="14px" ForeColor="Red" Text="*" Height="20px"></asp:Label></td>
                     

                    <td class="CellTextBoxADM"><asp:DropDownList ID="ddlCountry" runat="server" AppendDataBoundItems="True" CssClass="chzn-select" DataSourceID="SqlDataSource2" DataTextField="Country" DataValueField="Country" Width="30%" Height="22px">
           ...
           <tr>
               <td colspan="2" style="text-align:right">    <asp:Button ID="btnSave" runat="server"  CssClass="roundbutton1" BackColor="#CFC6C0"  Font-Bold="True" Text="SAVE" Width="100px" OnClientClick="currentdatetime(); if(this.value === 'Saving...') { return false; } else { this.value = 'Saving...'; }"/>
